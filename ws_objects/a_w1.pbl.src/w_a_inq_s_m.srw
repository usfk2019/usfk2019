$PBExportHeader$w_a_inq_s_m.srw
$PBExportComments$single master,multi row Inquiry ( from w_a_s_master)
forward
global type w_a_inq_s_m from w_a_s_master
end type
type dw_detail from u_d_base within w_a_inq_s_m
end type
type st_horizontal from statictext within w_a_inq_s_m
end type
end forward
...
global w_a_inq_s_m w_a_inq_s_m
...
type dw_cond from w_a_s_master`dw_cond within w_a_inq_s_m
integer y = 44
integer width = 2240
integer height = 248
integer taborder = 10
...
type p_ok from w_a_s_master`p_ok within w_a_inq_s_m
end type

type p_close from w_a_s_master`p_close within w_a_inq_s_m
end type

type gb_cond from w_a_s_master`gb_cond within w_a_inq_s_m
end type

type dw_master from w_a_s_master`dw_master within w_a_inq_s_m
integer y = 320
integer width = 3003
integer height = 408
integer taborder = 0
...
event dw_master::constructor;call super::constructor;//InsertRow(0)
end event

type dw_detail from u_d_base within w_a_inq_s_m
event type integer ue_retrieve ( integer al_select_row )
integer x = 32
integer y = 768
integer width = 3003
integer height = 1048
