$PBExportHeader$w_a_reg_m_m3.srw
$PBExportComments$multi master,multi 2 row Register ( from w_a_m_master)
forward
global type w_a_reg_m_m3 from w_a_m_master
end type
type dw_detail from u_d_indicator within w_a_reg_m_m3
end type
type p_insert from u_p_insert within w_a_reg_m_m3
end type
type p_delete from u_p_delete within w_a_reg_m_m3
end type
type p_save from u_p_save within w_a_reg_m_m3
end type
type p_reset from u_p_reset within w_a_reg_m_m3
end type
type dw_detail2 from u_d_indicator within w_a_reg_m_m3
end type
type st_horizontal2 from statictext within w_a_reg_m_m3
end type
type st_horizontal from statictext within w_a_reg_m_m3
end type
end forward
...
global w_a_reg_m_m3 w_a_reg_m_m3
...
type dw_cond from w_a_m_master`dw_cond within w_a_reg_m_m3
integer width = 2167
integer taborder = 20
end type

type p_ok from w_a_m_master`p_ok within w_a_reg_m_m3
integer x = 2391
end type

type p_close from w_a_m_master`p_close within w_a_reg_m_m3
integer x = 2693
end type

type gb_cond from w_a_m_master`gb_cond within w_a_reg_m_m3
end type

type dw_master from w_a_m_master`dw_master within w_a_reg_m_m3
event ue_select ( )
integer y = 316
integer width = 3150
integer height = 372
