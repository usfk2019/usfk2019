$PBExportHeader$w_a_reg_m_tm.srw
$PBExportComments$multi master,tab,multi row Register ( from w_a_m_master)
forward
global type w_a_reg_m_tm from w_a_m_master
end type
type p_insert from u_p_insert within w_a_reg_m_tm
end type
type p_delete from u_p_delete within w_a_reg_m_tm
end type
type p_save from u_p_save within w_a_reg_m_tm
end type
type p_reset from u_p_reset within w_a_reg_m_tm
end type
type tab_1 from u_tab_reg within w_a_reg_m_tm
end type
type tab_1 from u_tab_reg within w_a_reg_m_tm
end type
type st_horizontal from statictext within w_a_reg_m_tm
end type
end forward
...
global w_a_reg_m_tm w_a_reg_m_tm
...
For li_tab_index = 1 To tab_1.ii_enable_max_tab
	If tab_1.ib_tabpage_check[li_tab_index] Then
...
type dw_cond from w_a_m_master`dw_cond within w_a_reg_m_tm
integer width = 2190
end type

type p_ok from w_a_m_master`p_ok within w_a_reg_m_tm
end type

type p_close from w_a_m_master`p_close within w_a_reg_m_tm
integer x = 2693
end type

type gb_cond from w_a_m_master`gb_cond within w_a_reg_m_tm
end type

type dw_master from w_a_m_master`dw_master within w_a_reg_m_tm
integer y = 324
integer width = 3013
integer height = 408
end type
...
event selectionchanged;call super::selectionchanged;Long ll_selected_row
