$PBExportHeader$w_a_reg_m_tm2hhm.srw
$PBExportComments$[kenn] multi master,tab,multi row Register - Update for tab selctionchanged ( from w_a_m_master)
forward
global type w_a_reg_m_tm2hhm from w_a_m_master
end type
type p_insert from u_p_insert within w_a_reg_m_tm2hhm
end type
type p_delete from u_p_delete within w_a_reg_m_tm2hhm
end type
type p_save from u_p_save within w_a_reg_m_tm2hhm
end type
type p_reset from u_p_reset within w_a_reg_m_tm2hhm
end type
type tab_1 from u_tab_reg within w_a_reg_m_tm2hhm
end type
type tab_1 from u_tab_reg within w_a_reg_m_tm2hhm
end type
end forward
...
global w_a_reg_m_tm2hhm w_a_reg_m_tm2hhm
...
type dw_cond from w_a_m_master`dw_cond within w_a_reg_m_tm2hhm
end type

type p_ok from w_a_m_master`p_ok within w_a_reg_m_tm2hhm
integer x = 2386
end type

type p_close from w_a_m_master`p_close within w_a_reg_m_tm2hhm
integer x = 2693
end type

type gb_cond from w_a_m_master`gb_cond within w_a_reg_m_tm2hhm
end type

type dw_master from w_a_m_master`dw_master within w_a_reg_m_tm2hhm
integer width = 3013
integer height = 464
end type
