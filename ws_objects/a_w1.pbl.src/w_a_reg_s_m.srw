$PBExportHeader$w_a_reg_s_m.srw
$PBExportComments$single master,multi row Register ( from w_a_s_master)
forward
global type w_a_reg_s_m from w_a_s_master
end type
type dw_detail from u_d_indicator within w_a_reg_s_m
end type
type p_insert from u_p_insert within w_a_reg_s_m
end type
type p_delete from u_p_delete within w_a_reg_s_m
end type
type p_save from u_p_save within w_a_reg_s_m
end type
type p_reset from u_p_reset within w_a_reg_s_m
end type
type st_horizontal from statictext within w_a_reg_s_m
end type
end forward
...
global w_a_reg_s_m w_a_reg_s_m

type variables
//NVO For Common Processing
u_cust_db_app iu_cust_db_app

//AncestorReturnValue의 사용으로 의미가 없어짐
//int ii_error_chk
...
type dw_cond from w_a_s_master`dw_cond within w_a_reg_s_m
integer width = 2203
integer taborder = 10
end type

type p_ok from w_a_s_master`p_ok within w_a_reg_s_m
integer x = 2487
integer y = 52
end type

type p_close from w_a_s_master`p_close within w_a_reg_s_m
integer x = 2784
integer y = 52
end type

type gb_cond from w_a_s_master`gb_cond within w_a_reg_s_m
end type

type dw_master from w_a_s_master`dw_master within w_a_reg_s_m
integer x = 37
integer y = 320
integer width = 3008
integer height = 408
