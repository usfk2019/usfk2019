$PBExportHeader$b0u_dbmgr.sru
$PBExportComments$[ceusee] DB 접속
forward
global type b0u_dbmgr from u_cust_a_db
end type
end forward

global type b0u_dbmgr from u_cust_a_db
end type
global b0u_dbmgr b0u_dbmgr
...
Choose Case is_caller
	Case "b0w_reg_standard_zone%display"
...
public subroutine uf_prc_db_01 ();String ls_parttype, ls_partcod, ls_areanum, ls_remark, ls_data
