$PBExportHeader$b0w_inq_zoncst2_popup.srw
$PBExportComments$[cuesee] 표준요금 load 파업
forward
global type b0w_inq_zoncst2_popup from w_base
end type
type dw_check from u_d_base within b0w_inq_zoncst2_popup
end type
type dw_cond from u_d_external within b0w_inq_zoncst2_popup
end type
type p_close from u_p_close within b0w_inq_zoncst2_popup
end type
type p_ok from u_p_ok within b0w_inq_zoncst2_popup
end type
type gb_1 from groupbox within b0w_inq_zoncst2_popup
end type
end forward
...
global b0w_inq_zoncst2_popup b0w_inq_zoncst2_popup
...
on b0w_inq_zoncst2_popup.create
int iCurrent
call super::create
...
on b0w_inq_zoncst2_popup.destroy
call super::destroy
...
f_center_window(b0w_inq_zoncst2_popup)
...
integer height = 672
integer taborder = 20
string dataobject = "b0dw_reg_zoncst2_check"
...
integer height = 280
integer taborder = 10
string dataobject = "b0dw_cnd_reg_standard_zoncst2"
