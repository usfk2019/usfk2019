$PBExportHeader$b0w_inq_zoncst3_enddt_popup_v20.srw
$PBExportComments$[ohj] 대역별 요율 등록 popup v20
forward
global type b0w_inq_zoncst3_enddt_popup_v20 from w_base
end type
type st_2 from statictext within b0w_inq_zoncst3_enddt_popup_v20
end type
type st_1 from statictext within b0w_inq_zoncst3_enddt_popup_v20
end type
type p_close from u_p_close within b0w_inq_zoncst3_enddt_popup_v20
end type
type p_ok from u_p_ok within b0w_inq_zoncst3_enddt_popup_v20
end type
type dw_cond from u_d_external within b0w_inq_zoncst3_enddt_popup_v20
end type
type gb_1 from groupbox within b0w_inq_zoncst3_enddt_popup_v20
end type
end forward
...
global b0w_inq_zoncst3_enddt_popup_v20 b0w_inq_zoncst3_enddt_popup_v20
...
String   ls_priceplan, ls_pgm_id, ls_enddt
...
b0u_dbmgr_v20 lu_dbmgr
//저장
lu_dbmgr = Create b0u_dbmgr_v20
lu_dbmgr.is_caller = "b0w_inq_zoncst3_enddt_popup_v20%update"
...
on b0w_inq_zoncst3_enddt_popup_v20.create
int iCurrent
call super::create
...
on b0w_inq_zoncst3_enddt_popup_v20.destroy
call super::destroy
destroy(this.st_2)
destroy(this.st_1)
...
event open;call super::open;/*-------------------------------------------------------
	Name	: b0w_inq_zoncst3_enddt_popup_v20
...
f_center_window(b0w_inq_zoncst3_enddt_popup_v20)
...
integer height = 132
integer taborder = 10
string dataobject = "b0dw_cnd_reg_zoncst3_enddt_v20"
