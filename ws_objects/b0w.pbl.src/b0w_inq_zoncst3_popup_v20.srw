$PBExportHeader$b0w_inq_zoncst3_popup_v20.srw
$PBExportComments$[ohj] 대역별 요율 등록 popup v20
forward
global type b0w_inq_zoncst3_popup_v20 from w_base
end type
type dw_check from u_d_base within b0w_inq_zoncst3_popup_v20
end type
type p_close from u_p_close within b0w_inq_zoncst3_popup_v20
end type
type p_ok from u_p_ok within b0w_inq_zoncst3_popup_v20
end type
type dw_cond from u_d_external within b0w_inq_zoncst3_popup_v20
end type
type gb_1 from groupbox within b0w_inq_zoncst3_popup_v20
end type
end forward
...
global b0w_inq_zoncst3_popup_v20 b0w_inq_zoncst3_popup_v20
...
on b0w_inq_zoncst3_popup_v20.create
int iCurrent
call super::create
...
on b0w_inq_zoncst3_popup_v20.destroy
call super::destroy
...
event open;call super::open;/*-------------------------------------------------------
	Name	: b0w_inq_zoncst3_popup_v20
	Desc.	: 표준 요금 Load
	Ver.	: 1.0
	Date	: 2005.04.18
...
f_center_window(b0w_inq_zoncst3_popup_v20)
...
integer height = 672
integer taborder = 20
string dataobject = "b0dw_reg_zoncst3_check_v20"
...
integer height = 332
integer taborder = 10
string dataobject = "b0dw_cnd_reg_standard_zoncst3_v20"
