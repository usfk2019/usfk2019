$PBExportHeader$b0w_inq_zoncst4_popup_1.srw
$PBExportComments$[kjm] 표준요금 load 파업4
forward
global type b0w_inq_zoncst4_popup_1 from w_base
end type
type dw_check from u_d_base within b0w_inq_zoncst4_popup_1
end type
type dw_cond from u_d_external within b0w_inq_zoncst4_popup_1
end type
type p_close from u_p_close within b0w_inq_zoncst4_popup_1
end type
type p_ok from u_p_ok within b0w_inq_zoncst4_popup_1
end type
type gb_1 from groupbox within b0w_inq_zoncst4_popup_1
end type
end forward
...
global b0w_inq_zoncst4_popup_1 b0w_inq_zoncst4_popup_1
...
on b0w_inq_zoncst4_popup_1.create
int iCurrent
call super::create
...
on b0w_inq_zoncst4_popup_1.destroy
call super::destroy
...
f_center_window(b0w_inq_zoncst4_popup_1)
