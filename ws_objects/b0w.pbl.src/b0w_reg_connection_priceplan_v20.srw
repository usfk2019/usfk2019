$PBExportHeader$b0w_reg_connection_priceplan_v20.srw
$PBExportComments$[ssong] 접속료 발생 가격정책 등록
forward
global type b0w_reg_connection_priceplan_v20 from w_a_reg_m
end type
end forward
...
global b0w_reg_connection_priceplan_v20 b0w_reg_connection_priceplan_v20
...
on b0w_reg_connection_priceplan_v20.create
call super::create
end on

on b0w_reg_connection_priceplan_v20.destroy
call super::destroy
end on
...
IF ls_sacnum_kind <> "" THEN	
	...
	ls_where += "sacnum_kind = '" + ls_sacnum_kind + "' AND customer_type = '" + is_customer_type + "' "
END IF

//"a.partner_prefixno LIKE '" + ls_prefixno + "%'AND a.priceplan = '"+ ls_priceplan + "' AND a.limit_flag = '"+ is_limit_flag + "'"
...
If ib_check Then
	dw_detail.DataObject = "b0dw_reg_det_connection_priceplan_4_v20"
	dw_detail.SetTransObject(SQLCA)
	dw_detail.is_where = ls_where
	
Else
	dw_detail.DataObject = "b0dw_reg_det_connection_priceplan_3_v20"
	dw_detail.SetTransObject(SQLCA)
	dw_detail.is_where = ls_where
End If
...
event type integer ue_extra_save();call super::ue_extra_save;String	ls_sacnum_kind, ls_priceplan, ls_customer_type, ls_connectfee_type, ls_check, ls_svccod
...
type dw_cond from w_a_reg_m`dw_cond within b0w_reg_connection_priceplan_v20
integer x = 37
integer width = 1541
integer height = 132
...
type p_ok from w_a_reg_m`p_ok within b0w_reg_connection_priceplan_v20
integer x = 1641
integer y = 32
end type

type p_close from w_a_reg_m`p_close within b0w_reg_connection_priceplan_v20
integer x = 1934
integer y = 32
boolean originalsize = false
end type

type gb_cond from w_a_reg_m`gb_cond within b0w_reg_connection_priceplan_v20
integer x = 23
integer width = 1573
integer height = 196
end type

type p_delete from w_a_reg_m`p_delete within b0w_reg_connection_priceplan_v20
integer x = 315
integer y = 1664
end type

type p_insert from w_a_reg_m`p_insert within b0w_reg_connection_priceplan_v20
integer x = 23
integer y = 1664
end type

type p_save from w_a_reg_m`p_save within b0w_reg_connection_priceplan_v20
integer x = 608
integer y = 1664
end type

type dw_detail from w_a_reg_m`dw_detail within b0w_reg_connection_priceplan_v20
integer x = 23
integer y = 212
integer width = 2194
integer height = 1412
string dataobject = "b0dw_reg_det_connection_priceplan_3_v20"
end type
...
If dw_detail.DataObject = "b0dw_reg_det_connection_priceplan_4_v20" Then
...
type p_reset from w_a_reg_m`p_reset within b0w_reg_connection_priceplan_v20
integer y = 1664
end type
