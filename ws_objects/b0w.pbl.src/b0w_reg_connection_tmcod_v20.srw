$PBExportHeader$b0w_reg_connection_tmcod_v20.srw
$PBExportComments$[ssong] 접속료 시간대 구성 등록  v20
forward
global type b0w_reg_connection_tmcod_v20 from w_a_reg_m
end type
end forward
...
global b0w_reg_connection_tmcod_v20 b0w_reg_connection_tmcod_v20
...
on b0w_reg_connection_tmcod_v20.create
call super::create
end on

on b0w_reg_connection_tmcod_v20.destroy
call super::destroy
end on
...
If ls_opendt <> "" Then
	If ls_where <> "" Then ls_where += "And "
	ls_where += "to_char(opendt, 'YYYYMMDD')  = '"   + ls_opendt + "' AND customer_type = '" + is_customer_type + "' "
End If
...
type dw_cond from w_a_reg_m`dw_cond within b0w_reg_connection_tmcod_v20
integer x = 78
integer y = 40
integer width = 1915
integer height = 224
string dataobject = "b0dw_reg_cnd_connection_tmcod_v20"
...
type p_ok from w_a_reg_m`p_ok within b0w_reg_connection_tmcod_v20
integer x = 2098
integer y = 52
end type

type p_close from w_a_reg_m`p_close within b0w_reg_connection_tmcod_v20
integer x = 2400
integer y = 52
end type

type gb_cond from w_a_reg_m`gb_cond within b0w_reg_connection_tmcod_v20
integer x = 23
integer width = 1989
integer height = 284
end type

type p_delete from w_a_reg_m`p_delete within b0w_reg_connection_tmcod_v20
integer x = 315
integer y = 1652
end type

type p_insert from w_a_reg_m`p_insert within b0w_reg_connection_tmcod_v20
integer x = 23
integer y = 1652
end type

type p_save from w_a_reg_m`p_save within b0w_reg_connection_tmcod_v20
integer x = 613
integer y = 1652
end type

type dw_detail from w_a_reg_m`dw_detail within b0w_reg_connection_tmcod_v20
integer x = 23
integer y = 296
integer width = 2725
integer height = 1296
...
type p_reset from w_a_reg_m`p_reset within b0w_reg_connection_tmcod_v20
integer x = 1134
integer y = 1652
end type
