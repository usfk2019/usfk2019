$PBExportHeader$b0w_reg_connection_zone_1_v20.srw
$PBExportComments$[ssong] 접속료 발생 대역등록
forward
global type b0w_reg_connection_zone_1_v20 from w_a_reg_m
end type
end forward
...
global b0w_reg_connection_zone_1_v20 b0w_reg_connection_zone_1_v20

type variables
String is_customer_type, is_carrier_type
end variables

on b0w_reg_connection_zone_1_v20.create
call super::create
end on

on b0w_reg_connection_zone_1_v20.destroy
call super::destroy
end on
...
type dw_cond from w_a_reg_m`dw_cond within b0w_reg_connection_zone_1_v20
integer x = 37
integer y = 44
integer width = 1349
integer height = 140
string dataobject = "b0dw_reg_cnd_connection_zone_1_v20"
boolean vscrollbar = false
end type

type p_ok from w_a_reg_m`p_ok within b0w_reg_connection_zone_1_v20
integer x = 1509
integer y = 32
end type

type p_close from w_a_reg_m`p_close within b0w_reg_connection_zone_1_v20
integer x = 1801
integer y = 32
boolean originalsize = false
end type

type gb_cond from w_a_reg_m`gb_cond within b0w_reg_connection_zone_1_v20
integer x = 23
integer width = 1376
integer height = 196
end type

type p_delete from w_a_reg_m`p_delete within b0w_reg_connection_zone_1_v20
integer x = 315
integer y = 1664
end type

type p_insert from w_a_reg_m`p_insert within b0w_reg_connection_zone_1_v20
integer x = 23
integer y = 1664
end type

type p_save from w_a_reg_m`p_save within b0w_reg_connection_zone_1_v20
integer x = 608
integer y = 1664
end type

type dw_detail from w_a_reg_m`dw_detail within b0w_reg_connection_zone_1_v20
integer x = 23
integer y = 212
integer width = 2194
integer height = 1412
...
type p_reset from w_a_reg_m`p_reset within b0w_reg_connection_zone_1_v20
integer y = 1664
end type
