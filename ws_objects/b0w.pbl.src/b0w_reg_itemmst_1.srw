$PBExportHeader$b0w_reg_itemmst_1.srw
$PBExportComments$[parkkh] 품목마스터등록(할부적용안된것)
forward
global type b0w_reg_itemmst_1 from w_a_reg_m
end type
end forward
...
global b0w_reg_itemmst_1 b0w_reg_itemmst_1

type variables
string is_select_cod
end variables

on b0w_reg_itemmst_1.create
call super::create
end on

on b0w_reg_itemmst_1.destroy
call super::destroy
end on
...
type dw_cond from w_a_reg_m`dw_cond within b0w_reg_itemmst_1
integer x = 32
integer y = 44
integer width = 2304
string dataobject = "b0dw_cnd_reg_itemmst_1"
...
type p_ok from w_a_reg_m`p_ok within b0w_reg_itemmst_1
integer x = 2491
end type

type p_close from w_a_reg_m`p_close within b0w_reg_itemmst_1
integer x = 2793
boolean originalsize = false
end type

type gb_cond from w_a_reg_m`gb_cond within b0w_reg_itemmst_1
integer x = 23
end type

type p_delete from w_a_reg_m`p_delete within b0w_reg_itemmst_1
integer x = 315
integer y = 1628
end type

type p_insert from w_a_reg_m`p_insert within b0w_reg_itemmst_1
integer x = 23
integer y = 1628
end type

type p_save from w_a_reg_m`p_save within b0w_reg_itemmst_1
integer x = 608
integer y = 1628
end type

type dw_detail from w_a_reg_m`dw_detail within b0w_reg_itemmst_1
integer x = 23
integer y = 304
integer width = 3264
integer height = 1272
string dataobject = "b0dw_reg_itemmst_1"
end type
...
type p_reset from w_a_reg_m`p_reset within b0w_reg_itemmst_1
integer x = 1166
integer y = 1628
end type
