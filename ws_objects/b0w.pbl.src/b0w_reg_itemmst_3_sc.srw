$PBExportHeader$b0w_reg_itemmst_3_sc.srw
$PBExportComments$[kem] 품목 마스터 등록(선납품목포함)
forward
global type b0w_reg_itemmst_3_sc from w_a_reg_m
end type
end forward
...
global b0w_reg_itemmst_3_sc b0w_reg_itemmst_3_sc

type variables
string is_select_cod
end variables

on b0w_reg_itemmst_3_sc.create
call super::create
end on

on b0w_reg_itemmst_3_sc.destroy
call super::destroy
end on
...
String ls_item_code, ls_name, ls_category, ls_svcode, ls_trcode, ls_pricetable
...
For i=1 To ll_row
	...
	ls_category = Trim(dw_detail.object.itemmst_category[i])		//품목소분류
...
//	End If
	If ls_category = "" Then
		f_msg_usr_err(200, Title, "품목분류")
		dw_detail.SetRow(i)
		dw_detail.ScrollToRow(i)
		dw_detail.SetColumn('itemmst_category')
		Return -1
	End If
...
type dw_cond from w_a_reg_m`dw_cond within b0w_reg_itemmst_3_sc
integer x = 37
integer y = 40
integer width = 1481
integer height = 168
string dataobject = "b0dw_cnd_reg_itemmst_sc"
...
type p_ok from w_a_reg_m`p_ok within b0w_reg_itemmst_3_sc
integer x = 2555
end type

type p_close from w_a_reg_m`p_close within b0w_reg_itemmst_3_sc
integer x = 2857
boolean originalsize = false
end type

type gb_cond from w_a_reg_m`gb_cond within b0w_reg_itemmst_3_sc
integer x = 23
integer width = 1554
integer height = 220
end type

type p_delete from w_a_reg_m`p_delete within b0w_reg_itemmst_3_sc
integer x = 315
integer y = 1628
end type

type p_insert from w_a_reg_m`p_insert within b0w_reg_itemmst_3_sc
integer x = 23
integer y = 1628
end type

type p_save from w_a_reg_m`p_save within b0w_reg_itemmst_3_sc
integer x = 608
integer y = 1628
end type

type dw_detail from w_a_reg_m`dw_detail within b0w_reg_itemmst_3_sc
integer x = 23
integer y = 260
integer width = 3264
integer height = 1316
string dataobject = "b0dw_reg_itemmst_3_sc"
end type
...
type p_reset from w_a_reg_m`p_reset within b0w_reg_itemmst_3_sc
integer x = 1166
integer y = 1628
end type
