$PBExportHeader$b0w_reg_itemmst_3_v20_sams.srw
$PBExportComments$[1hera] 품목 마스터 등록(선납품목포함)
forward
global type b0w_reg_itemmst_3_v20_sams from w_a_reg_m
end type
end forward
...
global b0w_reg_itemmst_3_v20_sams b0w_reg_itemmst_3_v20_sams

type variables
string is_select_cod
end variables

on b0w_reg_itemmst_3_v20_sams.create
call super::create
end on

on b0w_reg_itemmst_3_v20_sams.destroy
call super::destroy
end on
...
type dw_cond from w_a_reg_m`dw_cond within b0w_reg_itemmst_3_v20_sams
integer x = 59
integer width = 2200
integer height = 224
string dataobject = "b0dw_cnd_reg_itemmst_sams"
...
type p_ok from w_a_reg_m`p_ok within b0w_reg_itemmst_3_v20_sams
integer x = 2309
end type

type p_close from w_a_reg_m`p_close within b0w_reg_itemmst_3_v20_sams
integer x = 2610
boolean originalsize = false
end type

type gb_cond from w_a_reg_m`gb_cond within b0w_reg_itemmst_3_v20_sams
integer x = 23
integer width = 2250
end type

type p_delete from w_a_reg_m`p_delete within b0w_reg_itemmst_3_v20_sams
integer x = 315
integer y = 1628
end type

type p_insert from w_a_reg_m`p_insert within b0w_reg_itemmst_3_v20_sams
integer x = 23
integer y = 1628
end type

type p_save from w_a_reg_m`p_save within b0w_reg_itemmst_3_v20_sams
integer x = 608
integer y = 1628
end type

type dw_detail from w_a_reg_m`dw_detail within b0w_reg_itemmst_3_v20_sams
integer x = 23
integer y = 304
integer width = 3264
integer height = 1272
string dataobject = "b0dw_reg_itemmst_3_v20_sams"
end type
...
type p_reset from w_a_reg_m`p_reset within b0w_reg_itemmst_3_v20_sams
integer x = 1166
integer y = 1628
end type
