$PBExportHeader$b0w_reg_itemmst_isp.srw
$PBExportComments$[parkkh] 품목 마스터 등록
forward
global type b0w_reg_itemmst_isp from w_a_reg_m
end type
end forward
...
global b0w_reg_itemmst_isp b0w_reg_itemmst_isp

type variables
string is_select_cod
end variables

on b0w_reg_itemmst_isp.create
call super::create
end on

on b0w_reg_itemmst_isp.destroy
call super::destroy
end on
...
For i=1 To ll_row
	...
	ls_itemcnt = String(dw_detail.object.itemmst_itemcnt[i]) 	//회선수
	...
	If IsNull(ls_itemcnt) Then ls_itemcnt =""
  ...
  If ls_trcode = "" Then
	...
	If ls_itemcnt = "" Then
		f_msg_usr_err(200, Title, "회선수")
		dw_detail.SetRow(i)
		dw_detail.ScrollToRow(i)
		dw_detail.SetColumn('itemmst_itemcnt')
		Return -1
	End If
...
type dw_cond from w_a_reg_m`dw_cond within b0w_reg_itemmst_isp
integer x = 37
integer y = 40
integer width = 2382
integer height = 224
...
type p_ok from w_a_reg_m`p_ok within b0w_reg_itemmst_isp
integer x = 2555
end type

type p_close from w_a_reg_m`p_close within b0w_reg_itemmst_isp
integer x = 2857
boolean originalsize = false
end type

type gb_cond from w_a_reg_m`gb_cond within b0w_reg_itemmst_isp
integer x = 23
integer width = 2409
end type

type p_delete from w_a_reg_m`p_delete within b0w_reg_itemmst_isp
integer x = 315
integer y = 1628
end type

type p_insert from w_a_reg_m`p_insert within b0w_reg_itemmst_isp
integer x = 23
integer y = 1628
end type

type p_save from w_a_reg_m`p_save within b0w_reg_itemmst_isp
integer x = 608
integer y = 1628
end type

type dw_detail from w_a_reg_m`dw_detail within b0w_reg_itemmst_isp
integer x = 23
integer y = 304
integer width = 3264
integer height = 1272
string dataobject = "b0dw_reg_itemmst_isp"
end type
...
type p_reset from w_a_reg_m`p_reset within b0w_reg_itemmst_isp
integer x = 1166
integer y = 1628
end type
