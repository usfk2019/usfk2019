$PBExportHeader$b0w_reg_particular_zoncst.srw
$PBExportComments$[kem] 개별 요율 등록
forward
global type b0w_reg_particular_zoncst from w_a_reg_m_m
end type
type p_new from u_p_new within b0w_reg_particular_zoncst
end type
end forward
...
global b0w_reg_particular_zoncst b0w_reg_particular_zoncst
...
on b0w_reg_particular_zoncst.create
int iCurrent
call super::create
...
on b0w_reg_particular_zoncst.destroy
call super::destroy
destroy(this.p_new)
end on
...
String ls_parttype, ls_partcod, ls_zoncod, ls_where, ls_partcod1
Long ll_row
...
//데이터 윈도우 바꾸기 
If ls_parttype = "S"  Then 
	dw_master.DataObject = "b0dw_cnd_reg_particular_zoncst1"
	dw_master.SetTransObject(SQLCA)
	dw_master.is_where = ls_where
ElseIf ls_parttype = "C" Then
	dw_master.DataObject = "b0dw_cnd_reg_particular_zoncst"
	dw_master.SetTransObject(SQLCA)
	dw_master.is_where = ls_where
ElseIf ls_parttype = "P" Then
	dw_master.DataObject = "b0dw_cnd_reg_particular_zoncst2"
	dw_master.SetTransObject(SQLCA)
	dw_master.is_where = ls_where
End If
...
event type integer ue_extra_insert(long al_insert_row);call super::ue_extra_insert;String ls_partcod
Long ll_row
...
type dw_cond from w_a_reg_m_m`dw_cond within b0w_reg_particular_zoncst
integer x = 37
integer y = 44
integer width = 1810
integer height = 224
string dataobject = "b0dw_cnd_particular_zoncst"
...
type p_ok from w_a_reg_m_m`p_ok within b0w_reg_particular_zoncst
integer x = 1984
integer y = 40
end type

type p_close from w_a_reg_m_m`p_close within b0w_reg_particular_zoncst
integer x = 2290
integer y = 40
end type

type gb_cond from w_a_reg_m_m`gb_cond within b0w_reg_particular_zoncst
integer x = 23
integer y = 4
integer width = 1851
integer height = 276
...
type dw_master from w_a_reg_m_m`dw_master within b0w_reg_particular_zoncst
integer x = 23
integer y = 296
integer height = 448
string dataobject = "b0dw_cnd_reg_particular_zoncst2"
end type
...
type dw_detail from w_a_reg_m_m`dw_detail within b0w_reg_particular_zoncst
integer x = 23
integer y = 784
integer height = 848
string dataobject = "b0dw_reg_particular_zoncst"
end type
...
type p_insert from w_a_reg_m_m`p_insert within b0w_reg_particular_zoncst
integer y = 1660
end type

type p_delete from w_a_reg_m_m`p_delete within b0w_reg_particular_zoncst
end type

type p_save from w_a_reg_m_m`p_save within b0w_reg_particular_zoncst
integer x = 617
end type

type p_reset from w_a_reg_m_m`p_reset within b0w_reg_particular_zoncst
integer x = 1353
end type

type st_horizontal from w_a_reg_m_m`st_horizontal within b0w_reg_particular_zoncst
integer y = 764
end type
