$PBExportHeader$b0w_reg_priceplanmst_v20_gt.srw
$PBExportComments$[parkkh] 가격정책등록
forward
global type b0w_reg_priceplanmst_v20_gt from w_a_reg_m_tm2
end type
end forward
...
global b0w_reg_priceplanmst_v20_gt b0w_reg_priceplanmst_v20_gt
...
on b0w_reg_priceplanmst_v20_gt.create
int iCurrent
call super::create
end on

on b0w_reg_priceplanmst_v20_gt.destroy
call super::destroy
end on
...
type dw_cond from w_a_reg_m_tm2`dw_cond within b0w_reg_priceplanmst_v20_gt
integer x = 55
integer width = 2624
integer height = 220
...
type p_ok from w_a_reg_m_tm2`p_ok within b0w_reg_priceplanmst_v20_gt
integer x = 2889
integer y = 56
end type

type p_close from w_a_reg_m_tm2`p_close within b0w_reg_priceplanmst_v20_gt
integer x = 3195
integer y = 56
boolean originalsize = false
end type

type gb_cond from w_a_reg_m_tm2`gb_cond within b0w_reg_priceplanmst_v20_gt
integer width = 2747
integer height = 292
end type

type dw_master from w_a_reg_m_tm2`dw_master within b0w_reg_priceplanmst_v20_gt
integer y = 320
integer width = 3470
integer height = 604
...
type p_insert from w_a_reg_m_tm2`p_insert within b0w_reg_priceplanmst_v20_gt
integer y = 1920
end type

type p_delete from w_a_reg_m_tm2`p_delete within b0w_reg_priceplanmst_v20_gt
integer y = 1920
end type

type p_save from w_a_reg_m_tm2`p_save within b0w_reg_priceplanmst_v20_gt
integer y = 1920
end type

type p_reset from w_a_reg_m_tm2`p_reset within b0w_reg_priceplanmst_v20_gt
integer y = 1920
end type

type tab_1 from w_a_reg_m_tm2`tab_1 within b0w_reg_priceplanmst_v20_gt
integer y = 964
integer width = 3461
integer height = 928
...
is_dwobject[1] = "b0dw_reg_priceplanmst_t1_v20_gt"
...
type st_horizontal from w_a_reg_m_tm2`st_horizontal within b0w_reg_priceplanmst_v20_gt
integer y = 928
end type
