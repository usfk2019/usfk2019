$PBExportHeader$b0w_reg_pricerate2_1_v20_sams.srw
$PBExportComments$[kem] 서비스별 요율등록 v20
forward
global type b0w_reg_pricerate2_1_v20_sams from w_a_reg_m_m
end type
end forward

global type b0w_reg_pricerate2_1_v20_sams from w_a_reg_m_m
end type
global b0w_reg_pricerate2_1_v20_sams b0w_reg_pricerate2_1_v20_sams
...
on b0w_reg_pricerate2_1_v20_sams.create
call super::create
end on

on b0w_reg_pricerate2_1_v20_sams.destroy
call super::destroy
end on
...
type dw_cond from w_a_reg_m_m`dw_cond within b0w_reg_pricerate2_1_v20_sams
integer x = 37
integer width = 1353
integer height = 156
string dataobject = "b0dw_cnd_reg_pricerate_v20_sams"
boolean hscrollbar = false
boolean vscrollbar = false
boolean livescroll = false
end type

type p_ok from w_a_reg_m_m`p_ok within b0w_reg_pricerate2_1_v20_sams
integer x = 1541
integer y = 40
end type

type p_close from w_a_reg_m_m`p_close within b0w_reg_pricerate2_1_v20_sams
integer x = 1847
integer y = 40
end type

type gb_cond from w_a_reg_m_m`gb_cond within b0w_reg_pricerate2_1_v20_sams
integer x = 23
integer y = 4
integer width = 1394
integer height = 220
...
type dw_master from w_a_reg_m_m`dw_master within b0w_reg_pricerate2_1_v20_sams
integer x = 23
integer y = 240
integer height = 464
string dataobject = "b0dw_cnd_pricerate_v20_sams"
end type
...
type dw_detail from w_a_reg_m_m`dw_detail within b0w_reg_pricerate2_1_v20_sams
integer x = 23
integer y = 740
integer height = 888
string dataobject = "b0dw_reg_pricerate_v20_sams"
end type
...
type p_insert from w_a_reg_m_m`p_insert within b0w_reg_pricerate2_1_v20_sams
end type

type p_delete from w_a_reg_m_m`p_delete within b0w_reg_pricerate2_1_v20_sams
end type

type p_save from w_a_reg_m_m`p_save within b0w_reg_pricerate2_1_v20_sams
end type

type p_reset from w_a_reg_m_m`p_reset within b0w_reg_pricerate2_1_v20_sams
integer x = 1353
end type

type st_horizontal from w_a_reg_m_m`st_horizontal within b0w_reg_pricerate2_1_v20_sams
integer y = 708
end type
