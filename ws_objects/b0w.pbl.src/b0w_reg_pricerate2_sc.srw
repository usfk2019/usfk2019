$PBExportHeader$b0w_reg_pricerate2_sc.srw
$PBExportComments$[kem] 서비스별 요율등록2
forward
global type b0w_reg_pricerate2_sc from w_a_reg_m_m
end type
end forward

global type b0w_reg_pricerate2_sc from w_a_reg_m_m
end type
global b0w_reg_pricerate2_sc b0w_reg_pricerate2_sc
...
DECLARE itemcod CURSOR FOR
				Select det.itemcod
			   From priceplan_det det, itemmst item
...
on b0w_reg_pricerate2_sc.create
call super::create
end on

on b0w_reg_pricerate2_sc.destroy
call super::destroy
end on
...
type dw_cond from w_a_reg_m_m`dw_cond within b0w_reg_pricerate2_sc
integer x = 37
integer width = 1353
integer height = 156
string dataobject = "b0dw_cnd_reg_pricerate1_sc"
boolean hscrollbar = false
boolean vscrollbar = false
boolean livescroll = false
end type

type p_ok from w_a_reg_m_m`p_ok within b0w_reg_pricerate2_sc
integer x = 1541
integer y = 40
end type

type p_close from w_a_reg_m_m`p_close within b0w_reg_pricerate2_sc
integer x = 1847
integer y = 40
end type

type gb_cond from w_a_reg_m_m`gb_cond within b0w_reg_pricerate2_sc
integer x = 23
integer y = 4
integer width = 1394
integer height = 220
...
type dw_master from w_a_reg_m_m`dw_master within b0w_reg_pricerate2_sc
integer x = 23
integer y = 240
integer height = 464
string dataobject = "b0dw_cnd_pricerate2_sc"
end type
...
type dw_detail from w_a_reg_m_m`dw_detail within b0w_reg_pricerate2_sc
integer x = 23
integer y = 740
integer height = 888
string dataobject = "b0dw_reg_pricerate2_1_sc"
end type
...
ls_filter = "det.priceplan = '" + is_priceplan + "' "
...
type p_insert from w_a_reg_m_m`p_insert within b0w_reg_pricerate2_sc
end type

type p_delete from w_a_reg_m_m`p_delete within b0w_reg_pricerate2_sc
end type

type p_save from w_a_reg_m_m`p_save within b0w_reg_pricerate2_sc
end type

type p_reset from w_a_reg_m_m`p_reset within b0w_reg_pricerate2_sc
integer x = 1353
end type

type st_horizontal from w_a_reg_m_m`st_horizontal within b0w_reg_pricerate2_sc
integer y = 708
end type
