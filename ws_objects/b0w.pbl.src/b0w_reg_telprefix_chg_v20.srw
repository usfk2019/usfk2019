$PBExportHeader$b0w_reg_telprefix_chg_v20.srw
$PBExportComments$[ohj] 서비스 코드별 번호 보정 등록
forward
global type b0w_reg_telprefix_chg_v20 from w_a_reg_m
end type
end forward
...
global b0w_reg_telprefix_chg_v20 b0w_reg_telprefix_chg_v20
...
on b0w_reg_telprefix_chg_v20.create
call super::create
end on

on b0w_reg_telprefix_chg_v20.destroy
call super::destroy
end on
...
Long		ll_rows
String	ls_telprefix,	 ls_type, ls_svccod
...
ll_rows = dw_detail.Retrieve(ls_svccod, ls_type)
...
event type integer ue_extra_insert(long al_insert_row);call super::ue_extra_insert;dw_detail.object.svccod[al_insert_row] = dw_cond.object.svccod[1]
...
type dw_cond from w_a_reg_m`dw_cond within b0w_reg_telprefix_chg_v20
integer x = 64
integer width = 1920
integer height = 220
integer taborder = 10
string dataobject = "b0dw_cnd_telprefix_chg_v20"
boolean vscrollbar = false
end type

type p_ok from w_a_reg_m`p_ok within b0w_reg_telprefix_chg_v20
integer x = 2149
integer y = 84
end type

type p_close from w_a_reg_m`p_close within b0w_reg_telprefix_chg_v20
integer x = 2455
integer y = 84
end type

type gb_cond from w_a_reg_m`gb_cond within b0w_reg_telprefix_chg_v20
integer width = 2007
integer height = 308
integer taborder = 30
end type

type p_delete from w_a_reg_m`p_delete within b0w_reg_telprefix_chg_v20
integer y = 1684
end type

type p_insert from w_a_reg_m`p_insert within b0w_reg_telprefix_chg_v20
integer y = 1684
end type

type p_save from w_a_reg_m`p_save within b0w_reg_telprefix_chg_v20
integer y = 1684
end type

type dw_detail from w_a_reg_m`dw_detail within b0w_reg_telprefix_chg_v20
integer y = 332
integer width = 3099
integer height = 1320
integer taborder = 20
string dataobject = "b0dw_reg_telprefix_chg_v20"
end type
...
type p_reset from w_a_reg_m`p_reset within b0w_reg_telprefix_chg_v20
integer y = 1684
end type
