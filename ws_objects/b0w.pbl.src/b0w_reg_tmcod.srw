$PBExportHeader$b0w_reg_tmcod.srw
$PBExportComments$[ceusee] 시간대 구성 등록
forward
global type b0w_reg_tmcod from w_a_reg_m
end type
end forward
...
global b0w_reg_tmcod b0w_reg_tmcod
...
on b0w_reg_tmcod.create
call super::create
end on

on b0w_reg_tmcod.destroy
call super::destroy
end on
...
String ls_priceplan,ls_where, ls_opendt
Long ll_row
...
ls_where += "pricecod = '" + ls_priceplan  + "' "
...
type dw_cond from w_a_reg_m`dw_cond within b0w_reg_tmcod
integer x = 41
integer y = 40
integer width = 1221
integer height = 208
string dataobject = "b0dw_cnd_reg_tmcod"
boolean hscrollbar = false
boolean vscrollbar = false
boolean livescroll = false
end type

type p_ok from w_a_reg_m`p_ok within b0w_reg_tmcod
integer x = 1390
integer y = 52
end type

type p_close from w_a_reg_m`p_close within b0w_reg_tmcod
integer x = 1691
integer y = 52
end type

type gb_cond from w_a_reg_m`gb_cond within b0w_reg_tmcod
integer x = 23
integer width = 1253
integer height = 264
end type

type p_delete from w_a_reg_m`p_delete within b0w_reg_tmcod
integer x = 315
integer y = 1652
end type

type p_insert from w_a_reg_m`p_insert within b0w_reg_tmcod
integer x = 23
integer y = 1652
end type

type p_save from w_a_reg_m`p_save within b0w_reg_tmcod
integer x = 613
integer y = 1652
end type

type dw_detail from w_a_reg_m`dw_detail within b0w_reg_tmcod
integer x = 23
integer y = 276
integer width = 2217
integer height = 1312
string dataobject = "b0dw_reg_tmcod"
end type
...
type p_reset from w_a_reg_m`p_reset within b0w_reg_tmcod
integer x = 1134
integer y = 1652
end type
