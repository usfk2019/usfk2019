$PBExportHeader$b0w_reg_zoncst3.srw
$PBExportComments$[kem] 대역별 요율 등록 - C&L
forward
global type b0w_reg_zoncst3 from w_a_reg_m
end type
type cb_load from commandbutton within b0w_reg_zoncst3
end type
type p_saveas from u_p_saveas within b0w_reg_zoncst3
end type
type p_fileread from u_p_fileread within b0w_reg_zoncst3
end type
end forward
...
global b0w_reg_zoncst3 b0w_reg_zoncst3
...
type dw_cond from w_a_reg_m`dw_cond within b0w_reg_zoncst3
integer x = 41
integer y = 40
integer width = 2464
integer height = 244
...
type p_ok from w_a_reg_m`p_ok within b0w_reg_zoncst3
integer x = 2670
integer y = 44
end type

type p_close from w_a_reg_m`p_close within b0w_reg_zoncst3
integer x = 2967
integer y = 44
end type

type gb_cond from w_a_reg_m`gb_cond within b0w_reg_zoncst3
integer x = 23
integer width = 2491
integer height = 304
end type

type p_delete from w_a_reg_m`p_delete within b0w_reg_zoncst3
integer y = 1600
end type

type p_insert from w_a_reg_m`p_insert within b0w_reg_zoncst3
integer y = 1600
end type

type p_save from w_a_reg_m`p_save within b0w_reg_zoncst3
integer y = 1600
end type

type dw_detail from w_a_reg_m`dw_detail within b0w_reg_zoncst3
integer x = 27
integer y = 312
integer width = 3237
integer height = 1248
string dataobject = "b0dw_reg_zoncst3"
end type
...
type p_reset from w_a_reg_m`p_reset within b0w_reg_zoncst3
integer x = 1097
integer y = 1600
end type
...
//Open
OpenWithParm(b0w_inq_zoncst3_popup, iu_cust_msg)  //청구 윈도우 연다.
