$PBExportHeader$b0w_reg_zoncst3_v20_temp.srw
$PBExportComments$[ohj] 대역별 요율 등록 v20
forward
global type b0w_reg_zoncst3_v20_temp from w_a_reg_m
end type
type cb_load from commandbutton within b0w_reg_zoncst3_v20_temp
end type
type p_saveas from u_p_saveas within b0w_reg_zoncst3_v20_temp
end type
type p_fileread from u_p_fileread within b0w_reg_zoncst3_v20_temp
end type
end forward
...
global b0w_reg_zoncst3_v20_temp b0w_reg_zoncst3_v20_temp
...
on b0w_reg_zoncst3_v20_temp.create
int iCurrent
call super::create
...
on b0w_reg_zoncst3_v20_temp.destroy
call super::destroy
...
type dw_cond from w_a_reg_m`dw_cond within b0w_reg_zoncst3_v20_temp
integer x = 41
integer y = 40
integer width = 2464
integer height = 244
...
type p_ok from w_a_reg_m`p_ok within b0w_reg_zoncst3_v20_temp
integer x = 2670
integer y = 44
end type

type p_close from w_a_reg_m`p_close within b0w_reg_zoncst3_v20_temp
integer x = 2967
integer y = 44
end type

type gb_cond from w_a_reg_m`gb_cond within b0w_reg_zoncst3_v20_temp
integer x = 23
integer width = 2491
integer height = 304
end type

type p_delete from w_a_reg_m`p_delete within b0w_reg_zoncst3_v20_temp
integer y = 1600
end type

type p_insert from w_a_reg_m`p_insert within b0w_reg_zoncst3_v20_temp
integer y = 1600
end type

type p_save from w_a_reg_m`p_save within b0w_reg_zoncst3_v20_temp
integer y = 1600
end type

type dw_detail from w_a_reg_m`dw_detail within b0w_reg_zoncst3_v20_temp
integer x = 27
integer y = 312
integer width = 3237
integer height = 1248
...
If is_svccod_control = 'Y' Then
	...
	//juede 2005.07.28 --start
	If ls_priceplan<>'' Then
		ls_filter = ls_filter +  " and priceplan = '" + ls_priceplan + "' "
	End If
	//juede 2005.07.28 ---end
...
type p_reset from w_a_reg_m`p_reset within b0w_reg_zoncst3_v20_temp
integer x = 1097
integer y = 1600
end type
