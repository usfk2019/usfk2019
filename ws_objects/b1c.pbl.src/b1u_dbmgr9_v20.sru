$PBExportHeader$b1u_dbmgr9_v20.sru
$PBExportComments$[kem] DB Manager/서비스신청(장비임대포함)
forward
global type b1u_dbmgr9_v20 from u_cust_a_db
end type
end forward

global type b1u_dbmgr9_v20 from u_cust_a_db
end type
global b1u_dbmgr9_v20 b1u_dbmgr9_v20
...
String ls_sale_flag_hw, ls_itemcod1, ls_status, ls_ref_desc, ls_adstatus, ls_act_status
Long   ll_hwseq, li_cnt, li_cnt1, ll_rows, i, ll_orderno, ll_contractseq


ii_rc = -1
Choose Case is_caller
	Case "b1w_reg_rental_pop_v20%getdata"
...
//		lu_dbmgr.is_data[2] = is_customerid
	...
	Case "b1w_reg_rental_pop_v20%hw_save"
...
on b1u_dbmgr9_v20.create
call super::create
end on

on b1u_dbmgr9_v20.destroy
call super::destroy
end on
