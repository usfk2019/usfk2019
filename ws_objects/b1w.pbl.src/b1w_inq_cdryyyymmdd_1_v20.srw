$PBExportHeader$b1w_inq_cdryyyymmdd_1_v20.srw
$PBExportComments$[ssong] 고객관리/일자별통화내역
forward
global type b1w_inq_cdryyyymmdd_1_v20 from w_a_inq_m
end type
type dw_tmp from u_d_base within b1w_inq_cdryyyymmdd_1_v20
end type
type p_1 from u_p_saveas within b1w_inq_cdryyyymmdd_1_v20
end type
end forward
...
global b1w_inq_cdryyyymmdd_1_v20 b1w_inq_cdryyyymmdd_1_v20
...
on b1w_inq_cdryyyymmdd_1_v20.create
int iCurrent
call super::create
...
on b1w_inq_cdryyyymmdd_1_v20.destroy
call super::destroy
destroy(this.dw_tmp)
destroy(this.p_1)
end on
...
type dw_cond from w_a_inq_m`dw_cond within b1w_inq_cdryyyymmdd_1_v20
integer x = 59
integer y = 52
integer width = 2862
integer height = 416
string dataobject = "b1dw_cnd_inq_cdryyyymmdd_1_v20"
...
type p_ok from w_a_inq_m`p_ok within b1w_inq_cdryyyymmdd_1_v20
integer x = 2967
integer y = 68
end type

type p_close from w_a_inq_m`p_close within b1w_inq_cdryyyymmdd_1_v20
integer x = 3561
integer y = 68
boolean originalsize = false
end type

type gb_cond from w_a_inq_m`gb_cond within b1w_inq_cdryyyymmdd_1_v20
integer width = 2912
integer height = 480
end type

type dw_detail from w_a_inq_m`dw_detail within b1w_inq_cdryyyymmdd_1_v20
integer y = 488
integer width = 3849
integer height = 1236
string dataobject = "b1dw_inq_cdryyyymmdd_1_v20"
end type
