$PBExportHeader$b1w_inq_cdryyyymmdd_2.srw
$PBExportComments$[parkkh] 고객관리/일자별통화내역(Timer체크)
forward
global type b1w_inq_cdryyyymmdd_2 from w_a_inq_m
end type
type dw_tmp from u_d_base within b1w_inq_cdryyyymmdd_2
end type
type p_1 from u_p_saveas within b1w_inq_cdryyyymmdd_2
end type
end forward
...
global b1w_inq_cdryyyymmdd_2 b1w_inq_cdryyyymmdd_2
...
on b1w_inq_cdryyyymmdd_2.create
int iCurrent
call super::create
...
on b1w_inq_cdryyyymmdd_2.destroy
call super::destroy
destroy(this.dw_tmp)
destroy(this.p_1)
end on
...
//Timer 값 가져오기
ll_time = Long(fs_get_control('00', 'Z999', ls_ref_desc))
Timer(ll_time)
end event
...
event timer;call super::timer;//Timer 체크 후 OK 버튼 click event 호출

//ii_cnt++
//messagebox('timer', ii_cnt)
p_ok.TriggerEvent(Clicked!)
end event

type dw_cond from w_a_inq_m`dw_cond within b1w_inq_cdryyyymmdd_2
integer x = 59
integer y = 52
integer width = 2807
integer height = 280
...
type p_ok from w_a_inq_m`p_ok within b1w_inq_cdryyyymmdd_2
integer x = 2939
integer y = 44
end type

type p_close from w_a_inq_m`p_close within b1w_inq_cdryyyymmdd_2
integer x = 3561
integer y = 44
boolean originalsize = false
end type

type gb_cond from w_a_inq_m`gb_cond within b1w_inq_cdryyyymmdd_2
integer width = 2866
integer height = 348
end type

type dw_detail from w_a_inq_m`dw_detail within b1w_inq_cdryyyymmdd_2
integer y = 368
integer width = 3849
integer height = 1356
