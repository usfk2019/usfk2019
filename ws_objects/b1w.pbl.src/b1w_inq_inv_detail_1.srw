$PBExportHeader$b1w_inq_inv_detail_1.srw
$PBExportComments$[ceusee] 청구및 상세내역 조회(전화사용제외)
forward
global type b1w_inq_inv_detail_1 from w_a_inq_m_tm
end type
type dw_cond2 from u_d_help within b1w_inq_inv_detail_1
end type
type p_find from u_p_find within b1w_inq_inv_detail_1
end type
end forward
...
global b1w_inq_inv_detail_1 b1w_inq_inv_detail_1
...
on b1w_inq_inv_detail_1.create
int iCurrent
call super::create
...
on b1w_inq_inv_detail_1.destroy
call super::destroy
...
If ls_value <> "" Then
	If ls_name <> "" Then
		...
		Choose Case ls_value
			...
			Case "locationnm"
				ls_where += "loc.locationnm like '%" + ls_name + "%' "
		End Choose		
   End If
End If
...
type dw_cond from w_a_inq_m_tm`dw_cond within b1w_inq_inv_detail_1
integer x = 37
integer y = 44
integer width = 2158
integer height = 132
...
type p_ok from w_a_inq_m_tm`p_ok within b1w_inq_inv_detail_1
integer x = 2341
integer y = 36
end type

type p_close from w_a_inq_m_tm`p_close within b1w_inq_inv_detail_1
integer x = 2638
integer y = 36
end type

type gb_cond from w_a_inq_m_tm`gb_cond within b1w_inq_inv_detail_1
integer x = 23
integer width = 2190
integer height = 192
end type

type dw_master from w_a_inq_m_tm`dw_master within b1w_inq_inv_detail_1
integer x = 23
integer y = 204
integer width = 3310
integer height = 604
string dataobject = "b1dw_inq_inv_detail_m_1"
end type
...
type tab_1 from w_a_inq_m_tm`tab_1 within b1w_inq_inv_detail_1
integer y = 844
integer width = 3314
integer height = 892
end type
...
//Tab Page에 들어갈 title
is_tab_title[1] = "Invoice List"
is_tab_title[2] = "Invoice History"
is_tab_title[3] = "Payment List"
is_tab_title[4] = "Sale List"
...
type st_horizontal from w_a_inq_m_tm`st_horizontal within b1w_inq_inv_detail_1
integer y = 808
integer height = 40
end type
