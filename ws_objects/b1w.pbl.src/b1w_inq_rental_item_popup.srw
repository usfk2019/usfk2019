$PBExportHeader$b1w_inq_rental_item_popup.srw
$PBExportComments$[kem] 임대품목 item popup
forward
global type b1w_inq_rental_item_popup from w_base
end type
type p_close from u_p_close within b1w_inq_rental_item_popup
end type
type dw_detail from u_d_sort within b1w_inq_rental_item_popup
end type
type ln_2 from line within b1w_inq_rental_item_popup
end type
end forward
...
global b1w_inq_rental_item_popup b1w_inq_rental_item_popup
...
on b1w_inq_rental_item_popup.create
int iCurrent
call super::create
...
on b1w_inq_rental_item_popup.destroy
call super::destroy
...
f_center_window(b1w_inq_rental_item_popup)
is_orderno = ""
