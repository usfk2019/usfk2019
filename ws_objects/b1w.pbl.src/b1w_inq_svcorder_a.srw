$PBExportHeader$b1w_inq_svcorder_a.srw
$PBExportComments$[chooys] 서비스 신청내역 조회/취소 Window
forward
global type b1w_inq_svcorder_a from w_a_inq_m_m
end type
type p_1 from u_p_reset within b1w_inq_svcorder_a
end type
type st_horizontal2 from st_horizontal within b1w_inq_svcorder_a
end type
end forward
...
global b1w_inq_svcorder_a b1w_inq_svcorder_a
...
type dw_cond from w_a_inq_m_m`dw_cond within b1w_inq_svcorder_a
integer x = 64
integer width = 2848
integer height = 632
...
type p_ok from w_a_inq_m_m`p_ok within b1w_inq_svcorder_a
integer x = 3026
integer y = 60
end type

type p_close from w_a_inq_m_m`p_close within b1w_inq_svcorder_a
integer x = 3639
integer y = 60
boolean originalsize = false
end type

type gb_cond from w_a_inq_m_m`gb_cond within b1w_inq_svcorder_a
integer x = 27
integer width = 2907
integer height = 688
end type

type dw_master from w_a_inq_m_m`dw_master within b1w_inq_svcorder_a
integer x = 27
integer y = 744
integer width = 3913
integer height = 1036
...
type dw_detail from w_a_inq_m_m`dw_detail within b1w_inq_svcorder_a
integer x = 27
integer y = 1376
integer width = 3566
integer height = 268
...
type st_horizontal from w_a_inq_m_m`st_horizontal within b1w_inq_svcorder_a
