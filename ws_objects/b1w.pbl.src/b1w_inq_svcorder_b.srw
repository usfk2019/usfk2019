$PBExportHeader$b1w_inq_svcorder_b.srw
$PBExportComments$[chooys] 서비스 신청내역 조회/취소 Window
forward
global type b1w_inq_svcorder_b from w_a_inq_m_m
end type
type p_1 from u_p_reset within b1w_inq_svcorder_b
end type
type st_horizontal2 from st_horizontal within b1w_inq_svcorder_b
end type
end forward
...
global b1w_inq_svcorder_b b1w_inq_svcorder_b
...
type dw_cond from w_a_inq_m_m`dw_cond within b1w_inq_svcorder_b
integer x = 64
integer width = 2848
integer height = 632
...
type p_ok from w_a_inq_m_m`p_ok within b1w_inq_svcorder_b
integer x = 3026
integer y = 60
end type

type p_close from w_a_inq_m_m`p_close within b1w_inq_svcorder_b
integer x = 3639
integer y = 60
boolean originalsize = false
end type

type gb_cond from w_a_inq_m_m`gb_cond within b1w_inq_svcorder_b
integer x = 27
integer width = 2907
integer height = 688
end type

type dw_master from w_a_inq_m_m`dw_master within b1w_inq_svcorder_b
integer x = 27
integer y = 744
integer width = 3913
integer height = 1036
string dataobject = "b1dw_inq_mst_inqorderbysvc_a"
end type
...
event dw_master::buttonclicked;call super::buttonclicked;long ll_master_row, ll_result
String ls_priceplan
...
Choose Case dwo.Name
	Case "svcorder_cancel" //신청내역취소버튼
		...
		ls_priceplan = Trim(dw_master.Object.svcorder_priceplan[row])
		
		//인증Key 관리 수정 - 2004.06.02
		ll_result = b1fi_validkeytype_check('서비스신청내역조회/취소', ls_priceplan, ii_cnt)
		...
		If(li_result = 1) Then
			...
			lu_dbmgr.is_caller = "b1w_inq_svcorder_b%cancel"
...
type dw_detail from w_a_inq_m_m`dw_detail within b1w_inq_svcorder_b
integer x = 27
integer y = 1376
integer width = 3566
integer height = 268
...
type st_horizontal from w_a_inq_m_m`st_horizontal within b1w_inq_svcorder_b
