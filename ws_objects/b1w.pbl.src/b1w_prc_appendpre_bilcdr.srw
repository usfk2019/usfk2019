$PBExportHeader$b1w_prc_appendpre_bilcdr.srw
$PBExportComments$[hhm] 일자별CDRyyyymmdd=>pre_bilcdr(선불제)
forward
global type b1w_prc_appendpre_bilcdr from w_a_prc
end type
end forward
...
global b1w_prc_appendpre_bilcdr b1w_prc_appendpre_bilcdr

type variables

end variables

on b1w_prc_appendpre_bilcdr.create
call super::create
end on

on b1w_prc_appendpre_bilcdr.destroy
call super::destroy
end on
...
setnull(ls_null )
//처리부분...
SQLCA.b1AppendPre_bilcdr(ls_yyyymmdd_to,'0',ls_null, ll_return, ls_errmsg, lb_count)
...
type p_ok from w_a_prc`p_ok within b1w_prc_appendpre_bilcdr
integer x = 1449
integer y = 36
end type

type dw_input from w_a_prc`dw_input within b1w_prc_appendpre_bilcdr
integer x = 64
integer y = 44
integer width = 1230
integer height = 148
string dataobject = "b1dw_cnd_prc_appendpre_bilcdr"
boolean hscrollbar = false
boolean vscrollbar = false
end type

type dw_msg_time from w_a_prc`dw_msg_time within b1w_prc_appendpre_bilcdr
integer y = 744
integer width = 1856
end type

type dw_msg_processing from w_a_prc`dw_msg_processing within b1w_prc_appendpre_bilcdr
integer y = 280
integer width = 1856
end type

type ln_up from w_a_prc`ln_up within b1w_prc_appendpre_bilcdr
integer beginy = 264
integer endx = 1838
integer endy = 264
end type

type ln_down from w_a_prc`ln_down within b1w_prc_appendpre_bilcdr
integer beginy = 1024
integer endx = 1838
integer endy = 1024
end type

type p_close from w_a_prc`p_close within b1w_prc_appendpre_bilcdr
integer x = 1449
integer y = 148
end type

type gb_cond from w_a_prc`gb_cond within b1w_prc_appendpre_bilcdr
integer width = 1307
integer height = 232
end type
