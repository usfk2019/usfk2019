$PBExportHeader$b1w_prc_reactive_prepaid.srw
$PBExportComments$[ohj]일시정지해제- 선불
forward
global type b1w_prc_reactive_prepaid from w_a_prc
end type
type st_1 from statictext within b1w_prc_reactive_prepaid
end type
end forward
...
global b1w_prc_reactive_prepaid b1w_prc_reactive_prepaid

type variables

end variables

on b1w_prc_reactive_prepaid.create
int iCurrent
call super::create
...
on b1w_prc_reactive_prepaid.destroy
call super::destroy
destroy(this.st_1)
end on
...
//setnull(ls_null )
//처리부분...
SQLCA.B1REACTIVE_PREPAYMENT('0', ll_return, ls_errmsg, lb_count)
...
type p_ok from w_a_prc`p_ok within b1w_prc_reactive_prepaid
integer x = 1449
integer y = 36
end type

type dw_input from w_a_prc`dw_input within b1w_prc_reactive_prepaid
...
type dw_msg_time from w_a_prc`dw_msg_time within b1w_prc_reactive_prepaid
integer y = 744
integer width = 1856
end type

type dw_msg_processing from w_a_prc`dw_msg_processing within b1w_prc_reactive_prepaid
integer y = 280
integer width = 1856
end type

type ln_up from w_a_prc`ln_up within b1w_prc_reactive_prepaid
integer beginy = 264
integer endx = 1838
integer endy = 264
end type

type ln_down from w_a_prc`ln_down within b1w_prc_reactive_prepaid
integer beginy = 1024
integer endx = 1838
integer endy = 1024
end type

type p_close from w_a_prc`p_close within b1w_prc_reactive_prepaid
integer x = 1449
integer y = 148
end type

type gb_cond from w_a_prc`gb_cond within b1w_prc_reactive_prepaid
integer width = 1307
integer height = 232
end type
...
string text = "Prepaid Reactive Process...."
