$PBExportHeader$b1w_prt_customer_bysvc_cv.srw
$PBExportComments$[parkkh] 서비스별 계약고객 리스트
forward
global type b1w_prt_customer_bysvc_cv from w_a_print
end type
end forward
...
global b1w_prt_customer_bysvc_cv b1w_prt_customer_bysvc_cv
...
on b1w_prt_customer_bysvc_cv.create
call super::create
end on

on b1w_prt_customer_bysvc_cv.destroy
call super::destroy
end on
...
String ls_ctype3, ls_regpart, ls_mainpart, ls_salepart, ls_activedt_fr, ls_activedt_to, ls_location
...
type dw_cond from w_a_print`dw_cond within b1w_prt_customer_bysvc_cv
integer x = 46
integer y = 36
integer width = 3849
integer height = 376
...
type p_ok from w_a_print`p_ok within b1w_prt_customer_bysvc_cv
integer x = 4018
integer y = 32
end type

type p_close from w_a_print`p_close within b1w_prt_customer_bysvc_cv
integer x = 4018
integer y = 144
end type

type dw_list from w_a_print`dw_list within b1w_prt_customer_bysvc_cv
integer x = 41
integer y = 476
integer width = 4315
integer height = 1060
string dataobject = "b1dw_prt_customer_bysvc_cv"
end type

type p_1 from w_a_print`p_1 within b1w_prt_customer_bysvc_cv
integer y = 1592
end type

type p_2 from w_a_print`p_2 within b1w_prt_customer_bysvc_cv
integer y = 1592
end type

type p_3 from w_a_print`p_3 within b1w_prt_customer_bysvc_cv
integer y = 1592
end type

type p_5 from w_a_print`p_5 within b1w_prt_customer_bysvc_cv
integer y = 1592
end type

type p_6 from w_a_print`p_6 within b1w_prt_customer_bysvc_cv
integer y = 1592
end type

type p_7 from w_a_print`p_7 within b1w_prt_customer_bysvc_cv
integer y = 1592
end type

type p_8 from w_a_print`p_8 within b1w_prt_customer_bysvc_cv
integer y = 1592
end type

type p_9 from w_a_print`p_9 within b1w_prt_customer_bysvc_cv
integer y = 1592
end type

type p_4 from w_a_print`p_4 within b1w_prt_customer_bysvc_cv
end type

type gb_1 from w_a_print`gb_1 within b1w_prt_customer_bysvc_cv
integer y = 1552
end type

type p_port from w_a_print`p_port within b1w_prt_customer_bysvc_cv
integer y = 1616
end type

type p_land from w_a_print`p_land within b1w_prt_customer_bysvc_cv
integer y = 1628
end type

type gb_cond from w_a_print`gb_cond within b1w_prt_customer_bysvc_cv
integer width = 3872
integer height = 440
end type

type p_saveas from w_a_print`p_saveas within b1w_prt_customer_bysvc_cv
integer y = 1592
end type
