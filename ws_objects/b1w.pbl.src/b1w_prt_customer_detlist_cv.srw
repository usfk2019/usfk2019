$PBExportHeader$b1w_prt_customer_detlist_cv.srw
$PBExportComments$[chooys] 고객 상세 리스트 - Window
forward
global type b1w_prt_customer_detlist_cv from w_a_print
end type
end forward
...
global b1w_prt_customer_detlist_cv b1w_prt_customer_detlist_cv

on b1w_prt_customer_detlist_cv.create
call super::create
end on

on b1w_prt_customer_detlist_cv.destroy
call super::destroy
end on
...
If( ls_buildingno <> "" ) Then
	If( ls_where <> "" ) Then ls_where += " AND "
	ls_where	+= "customerm_a.buildingno like '%"+ ls_buildingno +"'"
End If

If( ls_roomno <> "" ) Then
	If( ls_where <> "" ) Then ls_where += " AND "
	ls_where	+= "customerm_a.roomno like '%"+ ls_roomno +"'"
End If
...
type dw_cond from w_a_print`dw_cond within b1w_prt_customer_detlist_cv
integer x = 46
integer y = 40
integer width = 2679
integer height = 476
string dataobject = "b1dw_cnd_prtcustomerdetlist_cv"
boolean hscrollbar = false
boolean vscrollbar = false
end type

type p_ok from w_a_print`p_ok within b1w_prt_customer_detlist_cv
integer x = 2802
integer y = 56
end type

type p_close from w_a_print`p_close within b1w_prt_customer_detlist_cv
integer x = 3113
integer y = 56
end type

type dw_list from w_a_print`dw_list within b1w_prt_customer_detlist_cv
integer x = 32
integer y = 564
integer width = 3653
integer height = 996
string dataobject = "b1dw_prt_customerdetlist_cv"
end type

type p_1 from w_a_print`p_1 within b1w_prt_customer_detlist_cv
end type

type p_2 from w_a_print`p_2 within b1w_prt_customer_detlist_cv
end type

type p_3 from w_a_print`p_3 within b1w_prt_customer_detlist_cv
end type

type p_5 from w_a_print`p_5 within b1w_prt_customer_detlist_cv
end type

type p_6 from w_a_print`p_6 within b1w_prt_customer_detlist_cv
end type

type p_7 from w_a_print`p_7 within b1w_prt_customer_detlist_cv
end type

type p_8 from w_a_print`p_8 within b1w_prt_customer_detlist_cv
end type

type p_9 from w_a_print`p_9 within b1w_prt_customer_detlist_cv
end type

type p_4 from w_a_print`p_4 within b1w_prt_customer_detlist_cv
end type

type gb_1 from w_a_print`gb_1 within b1w_prt_customer_detlist_cv
end type

type p_port from w_a_print`p_port within b1w_prt_customer_detlist_cv
end type

type p_land from w_a_print`p_land within b1w_prt_customer_detlist_cv
end type

type gb_cond from w_a_print`gb_cond within b1w_prt_customer_detlist_cv
integer width = 2715
integer height = 532
end type

type p_saveas from w_a_print`p_saveas within b1w_prt_customer_detlist_cv
end type
