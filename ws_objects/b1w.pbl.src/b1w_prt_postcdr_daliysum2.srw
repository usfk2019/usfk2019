$PBExportHeader$b1w_prt_postcdr_daliysum2.srw
$PBExportComments$[kem] 후불일자별통화합계내역서(유형2)
forward
global type b1w_prt_postcdr_daliysum2 from w_a_print
end type
end forward
...
global b1w_prt_postcdr_daliysum2 b1w_prt_postcdr_daliysum2
...
event open;call super::open;/*------------------------------------------------------------------------
	Name	: b1w_prt_postcdr_daliysum2
	Desc.	: 후불일자별통화합계내역서(유형2)
	Ver.	: 1.0
	Date	: 2003.9.20
...
on b1w_prt_postcdr_daliysum2.create
call super::create
end on

on b1w_prt_postcdr_daliysum2.destroy
call super::destroy
end on
...
If ls_gubun = "0"  Then 
	dw_list.DataObject = "b1dw_prt_postcdr_daliysum2"
	dw_list.SetTransObject(SQLCA)
	dw_list.is_where = ls_where
	ll_row = dw_list.Retrieve()
ElseIf ls_gubun = "1" Then
	dw_list.DataObject = "b1dw_prt_postcdrh_daliysum2"
	dw_list.SetTransObject(SQLCA)
	dw_list.is_where = ls_where
	ll_row = dw_list.Retrieve()
End If
...
type dw_cond from w_a_print`dw_cond within b1w_prt_postcdr_daliysum2
integer y = 40
integer width = 1961
integer height = 300
...
type p_ok from w_a_print`p_ok within b1w_prt_postcdr_daliysum2
integer x = 2167
end type

type p_close from w_a_print`p_close within b1w_prt_postcdr_daliysum2
integer x = 2487
end type

type dw_list from w_a_print`dw_list within b1w_prt_postcdr_daliysum2
integer x = 23
integer y = 404
integer width = 2981
integer height = 1160
string dataobject = "b1dw_prt_postcdr_daliysum2"
end type

type p_1 from w_a_print`p_1 within b1w_prt_postcdr_daliysum2
integer y = 1636
end type

type p_2 from w_a_print`p_2 within b1w_prt_postcdr_daliysum2
integer y = 1636
end type

type p_3 from w_a_print`p_3 within b1w_prt_postcdr_daliysum2
integer y = 1636
end type

type p_5 from w_a_print`p_5 within b1w_prt_postcdr_daliysum2
integer y = 1636
end type

type p_6 from w_a_print`p_6 within b1w_prt_postcdr_daliysum2
integer y = 1636
end type

type p_7 from w_a_print`p_7 within b1w_prt_postcdr_daliysum2
integer y = 1636
end type

type p_8 from w_a_print`p_8 within b1w_prt_postcdr_daliysum2
integer y = 1636
end type

type p_9 from w_a_print`p_9 within b1w_prt_postcdr_daliysum2
integer y = 1636
end type

type p_4 from w_a_print`p_4 within b1w_prt_postcdr_daliysum2
end type

type gb_1 from w_a_print`gb_1 within b1w_prt_postcdr_daliysum2
integer y = 1596
end type

type p_port from w_a_print`p_port within b1w_prt_postcdr_daliysum2
integer y = 1660
end type

type p_land from w_a_print`p_land within b1w_prt_postcdr_daliysum2
integer y = 1672
end type

type gb_cond from w_a_print`gb_cond within b1w_prt_postcdr_daliysum2
integer width = 2025
integer height = 376
end type

type p_saveas from w_a_print`p_saveas within b1w_prt_postcdr_daliysum2
integer y = 1636
end type
