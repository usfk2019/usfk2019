$PBExportHeader$b1w_prt_validkey_list.srw
$PBExportComments$[jsha] 인증Key List
forward
global type b1w_prt_validkey_list from w_a_print
end type
end forward
...
global b1w_prt_validkey_list b1w_prt_validkey_list
...
on b1w_prt_validkey_list.create
call super::create
end on

on b1w_prt_validkey_list.destroy
call super::destroy
end on
...
type dw_cond from w_a_print`dw_cond within b1w_prt_validkey_list
integer x = 46
integer width = 2368
integer height = 240
string dataobject = "b1dw_cond_prt_validkey_list"
...
type p_ok from w_a_print`p_ok within b1w_prt_validkey_list
integer x = 2601
integer y = 60
end type

type p_close from w_a_print`p_close within b1w_prt_validkey_list
integer x = 2926
integer y = 60
end type

type dw_list from w_a_print`dw_list within b1w_prt_validkey_list
integer y = 320
integer height = 1260
string dataobject = "b1dw_prt_validkey_list"
end type

type p_1 from w_a_print`p_1 within b1w_prt_validkey_list
end type

type p_2 from w_a_print`p_2 within b1w_prt_validkey_list
end type

type p_3 from w_a_print`p_3 within b1w_prt_validkey_list
end type

type p_5 from w_a_print`p_5 within b1w_prt_validkey_list
end type

type p_6 from w_a_print`p_6 within b1w_prt_validkey_list
end type

type p_7 from w_a_print`p_7 within b1w_prt_validkey_list
end type

type p_8 from w_a_print`p_8 within b1w_prt_validkey_list
end type

type p_9 from w_a_print`p_9 within b1w_prt_validkey_list
end type

type p_4 from w_a_print`p_4 within b1w_prt_validkey_list
end type

type gb_1 from w_a_print`gb_1 within b1w_prt_validkey_list
end type

type p_port from w_a_print`p_port within b1w_prt_validkey_list
end type

type p_land from w_a_print`p_land within b1w_prt_validkey_list
end type

type gb_cond from w_a_print`gb_cond within b1w_prt_validkey_list
integer width = 2432
integer height = 300
end type

type p_saveas from w_a_print`p_saveas within b1w_prt_validkey_list
end type
