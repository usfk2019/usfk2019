$PBExportHeader$b1w_reg_chg_priceplan_1.srw
$PBExportComments$[ceusee] 서비스별 가격정책변경-후불
forward
global type b1w_reg_chg_priceplan_1 from w_a_reg_m_m3
end type
type dw_validkey from u_d_base within b1w_reg_chg_priceplan_1
end type
end forward
...
global b1w_reg_chg_priceplan_1 b1w_reg_chg_priceplan_1
...
on b1w_reg_chg_priceplan_1.create
int iCurrent
call super::create
...
on b1w_reg_chg_priceplan_1.destroy
call super::destroy
...
lu_dbmgr.is_caller = "b1w_reg_chg_priceplan_1%save"
...
type dw_cond from w_a_reg_m_m3`dw_cond within b1w_reg_chg_priceplan_1
integer x = 59
integer y = 56
integer width = 1527
integer height = 116
...
type p_ok from w_a_reg_m_m3`p_ok within b1w_reg_chg_priceplan_1
integer x = 1728
integer y = 40
end type

type p_close from w_a_reg_m_m3`p_close within b1w_reg_chg_priceplan_1
integer x = 2043
integer y = 40
boolean originalsize = false
end type

type gb_cond from w_a_reg_m_m3`gb_cond within b1w_reg_chg_priceplan_1
integer width = 1577
integer height = 212
end type

type dw_master from w_a_reg_m_m3`dw_master within b1w_reg_chg_priceplan_1
integer y = 224
integer width = 3081
integer height = 452
...
type dw_detail from w_a_reg_m_m3`dw_detail within b1w_reg_chg_priceplan_1
integer y = 1328
integer width = 3081
...
type p_insert from w_a_reg_m_m3`p_insert within b1w_reg_chg_priceplan_1
boolean visible = false
integer y = 1980
end type

type p_delete from w_a_reg_m_m3`p_delete within b1w_reg_chg_priceplan_1
boolean visible = false
integer y = 1980
end type

type p_save from w_a_reg_m_m3`p_save within b1w_reg_chg_priceplan_1
integer x = 59
integer y = 1952
end type

type p_reset from w_a_reg_m_m3`p_reset within b1w_reg_chg_priceplan_1
integer x = 361
integer y = 1952
end type

type dw_detail2 from w_a_reg_m_m3`dw_detail2 within b1w_reg_chg_priceplan_1
integer y = 708
integer width = 3077
integer height = 576
...
type st_horizontal2 from w_a_reg_m_m3`st_horizontal2 within b1w_reg_chg_priceplan_1
integer x = 27
integer y = 676
end type

type st_horizontal from w_a_reg_m_m3`st_horizontal within b1w_reg_chg_priceplan_1
integer x = 27
integer y = 1288
end type
