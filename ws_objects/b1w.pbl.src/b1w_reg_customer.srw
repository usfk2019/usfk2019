$PBExportHeader$b1w_reg_customer.srw
$PBExportComments$[ceusee] 고객정보 등록-후불
forward
global type b1w_reg_customer from w_a_reg_m_tm2
end type
type p_view from u_p_view within b1w_reg_customer
end type
end forward
...
global b1w_reg_customer b1w_reg_customer
...
String is_edi_drawingtype[]						 //은행신청유형(EDI)
...
If ls_temp = "" Then Return
fi_cut_string(ls_temp, ";", is_edi_drawingtype[])
...
type dw_cond from w_a_reg_m_tm2`dw_cond within b1w_reg_customer
integer y = 60
integer width = 2578
integer height = 200
...
type p_ok from w_a_reg_m_tm2`p_ok within b1w_reg_customer
integer x = 2779
integer y = 40
end type

type p_close from w_a_reg_m_tm2`p_close within b1w_reg_customer
integer x = 3081
integer y = 40
end type

type gb_cond from w_a_reg_m_tm2`gb_cond within b1w_reg_customer
integer x = 37
integer width = 2615
integer height = 280
end type

type dw_master from w_a_reg_m_tm2`dw_master within b1w_reg_customer
integer y = 296
integer width = 3534
integer height = 568
...
type p_insert from w_a_reg_m_tm2`p_insert within b1w_reg_customer
integer y = 2056
end type

type p_delete from w_a_reg_m_tm2`p_delete within b1w_reg_customer
integer y = 2056
end type

type p_save from w_a_reg_m_tm2`p_save within b1w_reg_customer
integer x = 622
integer y = 2056
end type

type p_reset from w_a_reg_m_tm2`p_reset within b1w_reg_customer
integer x = 1207
integer y = 2056
end type

type tab_1 from w_a_reg_m_tm2`tab_1 within b1w_reg_customer
integer y = 912
integer width = 3534
integer height = 1116
end type
...
type st_horizontal from w_a_reg_m_tm2`st_horizontal within b1w_reg_customer
integer y = 868
end type
