$PBExportHeader$b1w_reg_edit_contractmst_3.srw
$PBExportComments$[ohj] 계약내역조회/수정 - 기간만료일 추가
forward
global type b1w_reg_edit_contractmst_3 from w_a_reg_m_m
end type
end forward
...
global b1w_reg_edit_contractmst_3 b1w_reg_edit_contractmst_3
...
on b1w_reg_edit_contractmst_3.create
call super::create
end on

on b1w_reg_edit_contractmst_3.destroy
call super::destroy
end on
...
type dw_cond from w_a_reg_m_m`dw_cond within b1w_reg_edit_contractmst_3
integer x = 46
integer y = 44
integer width = 3616
integer height = 456
...
type p_ok from w_a_reg_m_m`p_ok within b1w_reg_edit_contractmst_3
integer x = 3758
integer y = 60
end type

type p_close from w_a_reg_m_m`p_close within b1w_reg_edit_contractmst_3
integer x = 4059
integer y = 60
boolean originalsize = false
end type

type gb_cond from w_a_reg_m_m`gb_cond within b1w_reg_edit_contractmst_3
integer x = 23
integer width = 3680
integer height = 516
end type

type dw_master from w_a_reg_m_m`dw_master within b1w_reg_edit_contractmst_3
integer x = 23
integer y = 532
integer width = 4293
integer height = 600
...
type dw_detail from w_a_reg_m_m`dw_detail within b1w_reg_edit_contractmst_3
integer x = 23
integer y = 1148
integer width = 4293
integer height = 728
...
type p_insert from w_a_reg_m_m`p_insert within b1w_reg_edit_contractmst_3
boolean visible = false
end type

type p_delete from w_a_reg_m_m`p_delete within b1w_reg_edit_contractmst_3
boolean visible = false
end type

type p_save from w_a_reg_m_m`p_save within b1w_reg_edit_contractmst_3
integer x = 41
integer y = 1896
end type

type p_reset from w_a_reg_m_m`p_reset within b1w_reg_edit_contractmst_3
integer x = 357
integer y = 1896
end type

type st_horizontal from w_a_reg_m_m`st_horizontal within b1w_reg_edit_contractmst_3
integer x = 14
integer y = 1132
end type
