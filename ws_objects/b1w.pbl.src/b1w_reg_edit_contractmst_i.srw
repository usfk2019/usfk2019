$PBExportHeader$b1w_reg_edit_contractmst_i.srw
$PBExportComments$[parkkh] 계약내역조회/수정 - its
forward
global type b1w_reg_edit_contractmst_i from w_a_reg_m_m
end type
end forward
...
global b1w_reg_edit_contractmst_i b1w_reg_edit_contractmst_i
...
on b1w_reg_edit_contractmst_i.create
call super::create
end on

on b1w_reg_edit_contractmst_i.destroy
call super::destroy
end on
...
type dw_cond from w_a_reg_m_m`dw_cond within b1w_reg_edit_contractmst_i
integer x = 55
integer width = 3616
integer height = 456
...
type p_ok from w_a_reg_m_m`p_ok within b1w_reg_edit_contractmst_i
integer x = 3749
integer y = 60
end type

type p_close from w_a_reg_m_m`p_close within b1w_reg_edit_contractmst_i
integer x = 4050
integer y = 60
boolean originalsize = false
end type

type gb_cond from w_a_reg_m_m`gb_cond within b1w_reg_edit_contractmst_i
integer width = 3657
integer height = 516
end type

type dw_master from w_a_reg_m_m`dw_master within b1w_reg_edit_contractmst_i
integer x = 23
integer y = 532
integer width = 4293
integer height = 636
...
If LeftA(ls_sysdate,6) = LeftA(ls_activedt,6) Then
...
type dw_detail from w_a_reg_m_m`dw_detail within b1w_reg_edit_contractmst_i
integer x = 23
integer y = 1196
integer width = 4288
integer height = 660
string dataobject = "b1dw_reg_edit_contractmst_i"
end type
...
type p_insert from w_a_reg_m_m`p_insert within b1w_reg_edit_contractmst_i
boolean visible = false
end type

type p_delete from w_a_reg_m_m`p_delete within b1w_reg_edit_contractmst_i
boolean visible = false
end type

type p_save from w_a_reg_m_m`p_save within b1w_reg_edit_contractmst_i
integer x = 41
integer y = 1896
end type

type p_reset from w_a_reg_m_m`p_reset within b1w_reg_edit_contractmst_i
integer x = 357
integer y = 1896
end type

type st_horizontal from w_a_reg_m_m`st_horizontal within b1w_reg_edit_contractmst_i
integer x = 14
integer y = 1164
end type
