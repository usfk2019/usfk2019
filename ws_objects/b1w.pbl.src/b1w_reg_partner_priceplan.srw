$PBExportHeader$b1w_reg_partner_priceplan.srw
$PBExportComments$[chooys]
forward
global type b1w_reg_partner_priceplan from w_a_reg_m_m
end type
end forward
...
global b1w_reg_partner_priceplan b1w_reg_partner_priceplan

on b1w_reg_partner_priceplan.create
call super::create
end on

on b1w_reg_partner_priceplan.destroy
call super::destroy
end on
...
type dw_cond from w_a_reg_m_m`dw_cond within b1w_reg_partner_priceplan
integer x = 41
integer width = 2345
integer height = 232
...
type p_ok from w_a_reg_m_m`p_ok within b1w_reg_partner_priceplan
integer x = 2464
end type

type p_close from w_a_reg_m_m`p_close within b1w_reg_partner_priceplan
integer x = 2770
end type

type gb_cond from w_a_reg_m_m`gb_cond within b1w_reg_partner_priceplan
integer width = 2386
integer height = 304
end type

type dw_master from w_a_reg_m_m`dw_master within b1w_reg_partner_priceplan
integer y = 336
integer height = 392
...
type dw_detail from w_a_reg_m_m`dw_detail within b1w_reg_partner_priceplan
integer x = 32
integer y = 768
...
type p_insert from w_a_reg_m_m`p_insert within b1w_reg_partner_priceplan
end type

type p_delete from w_a_reg_m_m`p_delete within b1w_reg_partner_priceplan
end type

type p_save from w_a_reg_m_m`p_save within b1w_reg_partner_priceplan
end type

type p_reset from w_a_reg_m_m`p_reset within b1w_reg_partner_priceplan
end type

type st_horizontal from w_a_reg_m_m`st_horizontal within b1w_reg_partner_priceplan
end type
