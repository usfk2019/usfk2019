$PBExportHeader$b1w_reg_prepayment_popup.srw
$PBExportComments$[ohj] 기간제선납상품-popup
forward
global type b1w_reg_prepayment_popup from w_base
end type
type p_create from u_p_create within b1w_reg_prepayment_popup
end type
type p_select from picture within b1w_reg_prepayment_popup
end type
type dw_check from u_d_base within b1w_reg_prepayment_popup
end type
type dw_cond from u_d_external within b1w_reg_prepayment_popup
end type
type p_close from u_p_close within b1w_reg_prepayment_popup
end type
type p_ok from u_p_ok within b1w_reg_prepayment_popup
end type
type gb_1 from groupbox within b1w_reg_prepayment_popup
end type
end forward
...
global b1w_reg_prepayment_popup b1w_reg_prepayment_popup
...
on b1w_reg_prepayment_popup.create
int iCurrent
call super::create
...
this.Control[iCurrent+3]=this.dw_check
...
on b1w_reg_prepayment_popup.destroy
call super::destroy
...
---------------------------------------------------------*/
Long   ll_row
String ls_itemcod, ls_ref_desc

iu_mdb_app = Create u_cust_db_app

f_center_window(b1w_reg_prepayment_popup)
...
dw_cond.object.contractseq[1] = iu_cust_msg.il_data[1]
...
integer height = 328
integer taborder = 10
string dataobject = "b1dw_cnd_prepayment_popup"
