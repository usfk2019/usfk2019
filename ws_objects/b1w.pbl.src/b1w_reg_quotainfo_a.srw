$PBExportHeader$b1w_reg_quotainfo_a.srw
$PBExportComments$[kem] 장비 할부내역 등록
forward
global type b1w_reg_quotainfo_a from w_a_reg_m_m
end type
end forward
...
global b1w_reg_quotainfo_a b1w_reg_quotainfo_a
...
on b1w_reg_quotainfo_a.create
call super::create
end on

on b1w_reg_quotainfo_a.destroy
call super::destroy
end on
...
type dw_cond from w_a_reg_m_m`dw_cond within b1w_reg_quotainfo_a
integer width = 1755
integer height = 276
...
type p_ok from w_a_reg_m_m`p_ok within b1w_reg_quotainfo_a
integer x = 1920
integer y = 48
end type

type p_close from w_a_reg_m_m`p_close within b1w_reg_quotainfo_a
integer x = 2226
integer y = 48
boolean originalsize = false
end type

type gb_cond from w_a_reg_m_m`gb_cond within b1w_reg_quotainfo_a
integer width = 1792
integer height = 340
end type

type dw_master from w_a_reg_m_m`dw_master within b1w_reg_quotainfo_a
integer x = 27
integer y = 360
integer width = 2629
integer height = 528
...
type dw_detail from w_a_reg_m_m`dw_detail within b1w_reg_quotainfo_a
integer x = 23
integer y = 944
integer width = 2638
integer height = 780
string dataobject = "b1dw_reg_quotainfo_a"
end type
...
Long ll_master_row, ll_orderno, ll_contractseq, ll_row, ll_rows, i
String ls_customerid, ls_itemcod, ls_itemnm, ls_priceplan, ls_quota_yn, ls_quota
Boolean lb_quota = False
...
If lb_quota = False Then
	f_msg_info(9000, Title, "할부인 품목이 없습니다.")
	Return -1
Else
...
type p_insert from w_a_reg_m_m`p_insert within b1w_reg_quotainfo_a
boolean visible = false
integer y = 1692
end type

type p_delete from w_a_reg_m_m`p_delete within b1w_reg_quotainfo_a
boolean visible = false
integer y = 1692
end type

type p_save from w_a_reg_m_m`p_save within b1w_reg_quotainfo_a
boolean visible = false
integer x = 69
integer y = 1696
end type

type p_reset from w_a_reg_m_m`p_reset within b1w_reg_quotainfo_a
integer x = 46
integer y = 1764
end type

type st_horizontal from w_a_reg_m_m`st_horizontal within b1w_reg_quotainfo_a
integer y = 892
integer height = 40
end type
