$PBExportHeader$b1w_reg_rental_pop_v20.srw
$PBExportComments$[kem] 서비스 신청시 장비임대 등록
forward
global type b1w_reg_rental_pop_v20 from w_a_reg_m
end type
end forward
...
global b1w_reg_rental_pop_v20 b1w_reg_rental_pop_v20
...
on b1w_reg_rental_pop_v20.create
call super::create
end on

on b1w_reg_rental_pop_v20.destroy
call super::destroy
end on
...
//window 중앙에
f_center_window(b1w_reg_rental_pop_v20)
...
lu_dbmgr = Create b1u_dbmgr9_v20
lu_dbmgr.is_caller = "b1w_reg_rental_pop_v20%hw_save"
lu_dbmgr.is_title = Title
lu_dbmgr.is_data[1]  = is_customerid
...
type dw_cond from w_a_reg_m`dw_cond within b1w_reg_rental_pop_v20
integer x = 46
integer y = 72
integer width = 2962
integer height = 364
...
type p_ok from w_a_reg_m`p_ok within b1w_reg_rental_pop_v20
...
type p_close from w_a_reg_m`p_close within b1w_reg_rental_pop_v20
integer x = 3058
integer y = 180
boolean originalsize = false
end type

type gb_cond from w_a_reg_m`gb_cond within b1w_reg_rental_pop_v20
integer width = 2994
integer height = 460
end type

type p_delete from w_a_reg_m`p_delete within b1w_reg_rental_pop_v20
boolean visible = false
integer x = 1010
integer y = 1888
end type

type p_insert from w_a_reg_m`p_insert within b1w_reg_rental_pop_v20
boolean visible = false
integer x = 709
integer y = 1888
end type

type p_save from w_a_reg_m`p_save within b1w_reg_rental_pop_v20
integer x = 50
integer y = 904
end type

type dw_detail from w_a_reg_m`dw_detail within b1w_reg_rental_pop_v20
integer x = 37
integer y = 488
integer width = 2990
integer height = 388
string dataobject = "b1dw_cnd_reg_quotainfo_pop_ad_v20"
end type
...
type p_reset from w_a_reg_m`p_reset within b1w_reg_rental_pop_v20
integer x = 352
integer y = 904
