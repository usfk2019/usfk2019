$PBExportHeader$b1w_reg_svc_actorder.srw
$PBExportComments$[ceusee]서비스신청/개통(할부가능)-후불
forward
global type b1w_reg_svc_actorder from w_a_reg_m_m3
end type
end forward
...
global b1w_reg_svc_actorder b1w_reg_svc_actorder
...
on b1w_reg_svc_actorder.create
call super::create
end on

on b1w_reg_svc_actorder.destroy
call super::destroy
end on
...
type dw_cond from w_a_reg_m_m3`dw_cond within b1w_reg_svc_actorder
integer x = 64
integer y = 52
integer width = 2574
integer height = 612
...
type p_ok from w_a_reg_m_m3`p_ok within b1w_reg_svc_actorder
integer x = 2688
integer y = 60
end type

type p_close from w_a_reg_m_m3`p_close within b1w_reg_svc_actorder
integer x = 2990
integer y = 60
boolean originalsize = false
end type

type gb_cond from w_a_reg_m_m3`gb_cond within b1w_reg_svc_actorder
integer x = 41
integer y = 4
integer width = 2624
integer height = 680
...
type dw_master from w_a_reg_m_m3`dw_master within b1w_reg_svc_actorder
...
type dw_detail from w_a_reg_m_m3`dw_detail within b1w_reg_svc_actorder
integer x = 37
integer y = 1392
integer width = 3186
integer height = 292
...
type p_insert from w_a_reg_m_m3`p_insert within b1w_reg_svc_actorder
integer x = 46
integer y = 1720
end type

type p_delete from w_a_reg_m_m3`p_delete within b1w_reg_svc_actorder
integer x = 338
integer y = 1720
end type

type p_save from w_a_reg_m_m3`p_save within b1w_reg_svc_actorder
integer x = 631
integer y = 1720
end type

type p_reset from w_a_reg_m_m3`p_reset within b1w_reg_svc_actorder
integer x = 1381
integer y = 1720
end type

type dw_detail2 from w_a_reg_m_m3`dw_detail2 within b1w_reg_svc_actorder
integer x = 37
integer y = 728
integer width = 3186
integer height = 624
...
type st_horizontal2 from w_a_reg_m_m3`st_horizontal2 within b1w_reg_svc_actorder
integer y = 688
integer height = 36
end type

type st_horizontal from w_a_reg_m_m3`st_horizontal within b1w_reg_svc_actorder
boolean visible = false
integer y = 1356
integer height = 36
end type
