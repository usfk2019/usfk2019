$PBExportHeader$b1w_reg_svc_actorder_2.srw
$PBExportComments$[ceusee] 서비스 신청/개통(할부불가)
forward
global type b1w_reg_svc_actorder_2 from w_a_reg_m_m3
end type
end forward
...
global b1w_reg_svc_actorder_2 b1w_reg_svc_actorder_2

type variables
Long il_orderno, il_validkey_cnt
String is_act_gu, is_cus_status, is_validkey_yn, is_svctype, is_svccode
String is_gkid, is_xener_svc, is_Xener_svccod[]
...
on b1w_reg_svc_actorder_2.create
call super::create
end on

on b1w_reg_svc_actorder_2.destroy
call super::destroy
end on
...
String ls_where, ls_contract_no, ls_gkid, ls_auth_method
String ls_ip_address, ls_h323id, ls_bil_fromdt, ls_sysdt
Long ll_row
...
type dw_cond from w_a_reg_m_m3`dw_cond within b1w_reg_svc_actorder_2
integer y = 56
integer width = 2578
integer height = 616
...
Choose Case dwo.name
	...
	Case "priceplan"
		...
		If SQLCA.SQLCode < 0 Then
			f_msg_sql_err(parent.title, "SELECT validkeycnt from priceplanmst")				
			Return 1
		End If	
...
type p_ok from w_a_reg_m_m3`p_ok within b1w_reg_svc_actorder_2
integer x = 2688
integer y = 60
end type

type p_close from w_a_reg_m_m3`p_close within b1w_reg_svc_actorder_2
integer x = 2990
integer y = 60
boolean originalsize = false
end type

type gb_cond from w_a_reg_m_m3`gb_cond within b1w_reg_svc_actorder_2
integer x = 41
integer y = 4
integer width = 2624
integer height = 692
...
type dw_master from w_a_reg_m_m3`dw_master within b1w_reg_svc_actorder_2
...
type dw_detail from w_a_reg_m_m3`dw_detail within b1w_reg_svc_actorder_2
integer x = 37
integer y = 1408
integer width = 3186
integer height = 280
...
type p_insert from w_a_reg_m_m3`p_insert within b1w_reg_svc_actorder_2
integer x = 46
integer y = 1716
end type

type p_delete from w_a_reg_m_m3`p_delete within b1w_reg_svc_actorder_2
integer x = 338
integer y = 1716
end type

type p_save from w_a_reg_m_m3`p_save within b1w_reg_svc_actorder_2
integer x = 631
integer y = 1716
end type

type p_reset from w_a_reg_m_m3`p_reset within b1w_reg_svc_actorder_2
integer x = 1381
integer y = 1716
end type

type dw_detail2 from w_a_reg_m_m3`dw_detail2 within b1w_reg_svc_actorder_2
integer x = 37
integer y = 744
integer width = 3186
integer height = 624
...
type st_horizontal2 from w_a_reg_m_m3`st_horizontal2 within b1w_reg_svc_actorder_2
integer y = 704
integer height = 36
end type

type st_horizontal from w_a_reg_m_m3`st_horizontal within b1w_reg_svc_actorder_2
boolean visible = false
integer y = 1372
integer height = 36
end type
