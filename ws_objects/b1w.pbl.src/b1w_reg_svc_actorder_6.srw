$PBExportHeader$b1w_reg_svc_actorder_6.srw
$PBExportComments$[kem] 서비스신청/개통(장비판매/임대가능)
forward
global type b1w_reg_svc_actorder_6 from w_a_reg_m_m3
end type
end forward
...
global b1w_reg_svc_actorder_6 b1w_reg_svc_actorder_6
...
on b1w_reg_svc_actorder_6.create
call super::create
end on

on b1w_reg_svc_actorder_6.destroy
call super::destroy
end on

event open;/*------------------------------------------------------------------------
	Name	:	b1w_reg_svc_actorder_4
	Desc	: 	서비스 신청
	Ver.	:	1.0
	Date	:   2004.05.
...
IF is_inout_svc_gu = 'N' Then
	dw_detail.dataObject = "b1dw_reg_svc_actorder_ipn_6"
    dw_detail.Trigger Event Constructor()
Elseif is_inout_svc_gu = 'Y' Then
	dw_detail.dataObject = "b1dw_reg_svc_actorder_ipn_5_1"
    dw_detail.Trigger Event Constructor()
End If
...
lu_dbmgr.is_caller   = "b1w_reg_svc_actorder_6%save"
...
Choose Case ii_cnt
	...
	Case 1
		...
		IF is_inout_svc_gu = 'N' Then
			dw_detail.is_help_win[1] = "b1w_hlp_validkeymst_2"
        ...
        Else 
			dw_detail.is_help_win[1] = "b1w_hlp_validkeymst_1"
			dw_detail.is_data[1] = "CloseWithReturn"
			dw_detail.is_data[2] = is_moveyn       //할당모듈 사용여부
			dw_detail.is_data[3] = ls_reg_partner  //유치처
			dw_detail.is_data[4] = ls_priceplan    //가격정책
...
type dw_cond from w_a_reg_m_m3`dw_cond within b1w_reg_svc_actorder_6
integer x = 64
integer y = 60
integer width = 3365
integer height = 1004
integer taborder = 40
string dataobject = "b1dw_cnd_reg_svc_actorder_5"
...
//		End If
		...
		//2004-008-26 parkkh modify start
...
type p_ok from w_a_reg_m_m3`p_ok within b1w_reg_svc_actorder_6
integer x = 3589
integer y = 56
end type

type p_close from w_a_reg_m_m3`p_close within b1w_reg_svc_actorder_6
integer x = 3589
integer y = 172
boolean originalsize = false
end type

type gb_cond from w_a_reg_m_m3`gb_cond within b1w_reg_svc_actorder_6
integer x = 41
integer y = 4
integer width = 3415
integer height = 1072
...
type dw_master from w_a_reg_m_m3`dw_master within b1w_reg_svc_actorder_6
...
type dw_detail from w_a_reg_m_m3`dw_detail within b1w_reg_svc_actorder_6
integer x = 46
integer y = 1816
integer width = 4064
integer height = 592
integer taborder = 30
string dataobject = "b1dw_reg_svc_actorder_ipn_6"
end type
...
type p_insert from w_a_reg_m_m3`p_insert within b1w_reg_svc_actorder_6
integer x = 55
integer y = 2468
end type

type p_delete from w_a_reg_m_m3`p_delete within b1w_reg_svc_actorder_6
integer x = 347
integer y = 2468
end type

type p_save from w_a_reg_m_m3`p_save within b1w_reg_svc_actorder_6
integer x = 640
integer y = 2468
end type

type p_reset from w_a_reg_m_m3`p_reset within b1w_reg_svc_actorder_6
integer x = 1390
integer y = 2468
end type

type dw_detail2 from w_a_reg_m_m3`dw_detail2 within b1w_reg_svc_actorder_6
integer x = 41
integer y = 1112
integer width = 4064
integer height = 664
integer taborder = 10
string dataobject = "b1dw_reg_svc_actorder_5"
end type
...
type st_horizontal2 from w_a_reg_m_m3`st_horizontal2 within b1w_reg_svc_actorder_6
integer x = 37
integer y = 1076
integer height = 36
end type
...
type st_horizontal from w_a_reg_m_m3`st_horizontal within b1w_reg_svc_actorder_6
boolean visible = false
integer x = 41
integer y = 1780
integer height = 36
