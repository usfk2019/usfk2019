$PBExportHeader$b1w_reg_svc_actorder_cl.srw
$PBExportComments$[kem] 서비스신청/개통(할부가능)-com&life
forward
global type b1w_reg_svc_actorder_cl from w_a_reg_m_m3
end type
end forward
...
global b1w_reg_svc_actorder_cl b1w_reg_svc_actorder_cl

type variables
Long il_orderno, il_validkey_cnt, il_contractseq
String is_act_gu, is_cus_status, is_validkey_yn, is_svctype, is_svccode, is_type, is_langtype
...
on b1w_reg_svc_actorder_cl.create
call super::create
end on

on b1w_reg_svc_actorder_cl.destroy
call super::destroy
end on

event open;/*------------------------------------------------------------------------
	Name	:	b1w_reg_svc_actorder_cl
	Desc	: 	서비스 신청
	Ver.	:	1.0
	Date	:   2003.10.09
...
ls_temp = fs_get_control("B1", "P203", ls_ref_desc)
//If ls_temp = "" Then Return
//fi_cut_string(ls_temp, ";" , is_auth_method[])   		//GateKeeper 연동 method
...
type dw_cond from w_a_reg_m_m3`dw_cond within b1w_reg_svc_actorder_cl
integer width = 3378
integer height = 1000
string dataobject = "b1dw_cnd_reg_svc_actorder_cl"
...
type p_ok from w_a_reg_m_m3`p_ok within b1w_reg_svc_actorder_cl
integer x = 3534
integer y = 60
end type

type p_close from w_a_reg_m_m3`p_close within b1w_reg_svc_actorder_cl
integer x = 3534
integer y = 168
boolean originalsize = false
end type

type gb_cond from w_a_reg_m_m3`gb_cond within b1w_reg_svc_actorder_cl
integer x = 41
integer y = 4
integer width = 3401
integer height = 1056
...
type dw_master from w_a_reg_m_m3`dw_master within b1w_reg_svc_actorder_cl
...
type dw_detail from w_a_reg_m_m3`dw_detail within b1w_reg_svc_actorder_cl
integer x = 41
integer y = 1660
integer width = 3817
integer height = 316
string dataobject = "b1dw_reg_svc_actorder_ipn_cl"
end type
...
type p_insert from w_a_reg_m_m3`p_insert within b1w_reg_svc_actorder_cl
integer x = 46
integer y = 1992
end type

type p_delete from w_a_reg_m_m3`p_delete within b1w_reg_svc_actorder_cl
integer x = 338
integer y = 1992
end type

type p_save from w_a_reg_m_m3`p_save within b1w_reg_svc_actorder_cl
integer x = 631
integer y = 1992
end type

type p_reset from w_a_reg_m_m3`p_reset within b1w_reg_svc_actorder_cl
integer x = 1381
integer y = 1992
end type

type dw_detail2 from w_a_reg_m_m3`dw_detail2 within b1w_reg_svc_actorder_cl
integer x = 41
integer y = 1096
integer width = 3817
integer height = 516
string dataobject = "b1dw_reg_svc_actorder_cl"
end type
...
type st_horizontal2 from w_a_reg_m_m3`st_horizontal2 within b1w_reg_svc_actorder_cl
integer x = 41
integer y = 1064
integer height = 36
end type

type st_horizontal from w_a_reg_m_m3`st_horizontal within b1w_reg_svc_actorder_cl
boolean visible = false
integer x = 41
integer y = 1616
integer height = 36
