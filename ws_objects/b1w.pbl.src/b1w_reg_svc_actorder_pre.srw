$PBExportHeader$b1w_reg_svc_actorder_pre.srw
$PBExportComments$[parkkh]서비스개통신청-선불제
forward
global type b1w_reg_svc_actorder_pre from w_a_reg_m_m3
end type
end forward
...
global b1w_reg_svc_actorder_pre b1w_reg_svc_actorder_pre
...
on b1w_reg_svc_actorder_pre.create
call super::create
end on

on b1w_reg_svc_actorder_pre.destroy
call super::destroy
end on
...
String ls_reg_partner, ls_sale_partner, ls_pricemodel
Long ll_row
...
type dw_cond from w_a_reg_m_m3`dw_cond within b1w_reg_svc_actorder_pre
integer y = 56
integer width = 2578
integer height = 992
string dataobject = "b1dw_cnd_reg_svc_actorder_pre"
...
type p_ok from w_a_reg_m_m3`p_ok within b1w_reg_svc_actorder_pre
integer x = 2734
integer y = 140
end type

type p_close from w_a_reg_m_m3`p_close within b1w_reg_svc_actorder_pre
integer x = 2734
integer y = 276
boolean originalsize = false
end type

type gb_cond from w_a_reg_m_m3`gb_cond within b1w_reg_svc_actorder_pre
integer x = 41
integer y = 4
integer width = 2624
integer height = 1060
...
type dw_master from w_a_reg_m_m3`dw_master within b1w_reg_svc_actorder_pre
...
type dw_detail from w_a_reg_m_m3`dw_detail within b1w_reg_svc_actorder_pre
integer y = 1712
integer width = 2633
integer height = 296
...
type p_insert from w_a_reg_m_m3`p_insert within b1w_reg_svc_actorder_pre
integer x = 46
integer y = 2056
end type

type p_delete from w_a_reg_m_m3`p_delete within b1w_reg_svc_actorder_pre
integer x = 379
integer y = 2056
end type

type p_save from w_a_reg_m_m3`p_save within b1w_reg_svc_actorder_pre
integer x = 713
integer y = 2056
end type

type p_reset from w_a_reg_m_m3`p_reset within b1w_reg_svc_actorder_pre
integer x = 1463
integer y = 2056
end type

type dw_detail2 from w_a_reg_m_m3`dw_detail2 within b1w_reg_svc_actorder_pre
integer x = 37
integer y = 1108
integer width = 2633
integer height = 576
...
type st_horizontal2 from w_a_reg_m_m3`st_horizontal2 within b1w_reg_svc_actorder_pre
integer y = 1068
integer height = 36
end type

type st_horizontal from w_a_reg_m_m3`st_horizontal within b1w_reg_svc_actorder_pre
boolean visible = false
integer x = 18
integer y = 1680
integer height = 36
