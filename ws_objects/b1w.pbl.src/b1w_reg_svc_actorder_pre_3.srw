$PBExportHeader$b1w_reg_svc_actorder_pre_3.srw
$PBExportComments$[kem]서비스개통신청-선불제(장비임대,선납포함)
forward
global type b1w_reg_svc_actorder_pre_3 from w_a_reg_m_m3
end type
end forward
...
global b1w_reg_svc_actorder_pre_3 b1w_reg_svc_actorder_pre_3
...
on b1w_reg_svc_actorder_pre_3.create
call super::create
end on

on b1w_reg_svc_actorder_pre_3.destroy
call super::destroy
end on
...
string ls_ref_desc, ls_temp, ls_result[], ls_direct_paytype
...
lu_dbmgr.is_caller = "b1w_reg_svc_actorder_pre_3%save"
...
type dw_cond from w_a_reg_m_m3`dw_cond within b1w_reg_svc_actorder_pre_3
integer x = 69
integer y = 52
integer width = 2578
integer height = 1140
integer taborder = 40
string dataobject = "b1dw_cnd_reg_svc_actorder_pre_3"
...
Long     li_exist, ll_i, li_return, ll_validity_term, ll_extdays, ll_endday, &
         ll_addunit, ll_use, li_return1, li_return2
...
type p_ok from w_a_reg_m_m3`p_ok within b1w_reg_svc_actorder_pre_3
integer x = 2766
integer y = 140
end type

type p_close from w_a_reg_m_m3`p_close within b1w_reg_svc_actorder_pre_3
integer x = 2766
integer y = 276
boolean originalsize = false
end type

type gb_cond from w_a_reg_m_m3`gb_cond within b1w_reg_svc_actorder_pre_3
integer x = 41
integer y = 4
integer width = 2624
integer height = 1204
...
type dw_master from w_a_reg_m_m3`dw_master within b1w_reg_svc_actorder_pre_3
...
type dw_detail from w_a_reg_m_m3`dw_detail within b1w_reg_svc_actorder_pre_3
integer y = 1688
integer width = 3045
integer height = 344
integer taborder = 30
...
type p_insert from w_a_reg_m_m3`p_insert within b1w_reg_svc_actorder_pre_3
integer x = 46
integer y = 2056
end type

type p_delete from w_a_reg_m_m3`p_delete within b1w_reg_svc_actorder_pre_3
integer x = 379
integer y = 2056
end type

type p_save from w_a_reg_m_m3`p_save within b1w_reg_svc_actorder_pre_3
integer x = 713
integer y = 2056
end type

type p_reset from w_a_reg_m_m3`p_reset within b1w_reg_svc_actorder_pre_3
integer x = 1463
integer y = 2056
end type

type dw_detail2 from w_a_reg_m_m3`dw_detail2 within b1w_reg_svc_actorder_pre_3
integer x = 37
integer y = 1252
integer width = 3040
integer height = 408
integer taborder = 10
string dataobject = "b1dw_reg_svc_actorder_det"
end type
...
type st_horizontal2 from w_a_reg_m_m3`st_horizontal2 within b1w_reg_svc_actorder_pre_3
integer y = 1208
integer height = 36
end type

type st_horizontal from w_a_reg_m_m3`st_horizontal within b1w_reg_svc_actorder_pre_3
boolean visible = false
integer y = 1620
integer height = 36
end type
