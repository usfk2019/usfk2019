$PBExportHeader$b1w_reg_svc_actorder_v20.srw
$PBExportComments$[parkkh]서비스후불개통신청(장비판매/임대)-인증KeyType, group
forward
global type b1w_reg_svc_actorder_v20 from w_a_reg_m_m3
end type
end forward
...
global b1w_reg_svc_actorder_v20 b1w_reg_svc_actorder_v20
...
public function integer wfi_get_customerid (string as_customerid);/*------------------------------------------------------------------------
	...
	Ver.	: 1.0
------------------------------------------------------------------------*/
String ls_customernm, ls_payid, ls_partner
...
on b1w_reg_svc_actorder_v20.create
call super::create
end on

on b1w_reg_svc_actorder_v20.destroy
call super::destroy
end on
...
type dw_cond from w_a_reg_m_m3`dw_cond within b1w_reg_svc_actorder_v20
integer x = 64
integer y = 60
integer width = 3365
integer height = 1004
...
type p_ok from w_a_reg_m_m3`p_ok within b1w_reg_svc_actorder_v20
integer x = 3589
integer y = 56
end type

type p_close from w_a_reg_m_m3`p_close within b1w_reg_svc_actorder_v20
integer x = 3589
integer y = 172
boolean originalsize = false
end type

type gb_cond from w_a_reg_m_m3`gb_cond within b1w_reg_svc_actorder_v20
integer x = 41
integer y = 4
integer width = 3415
integer height = 1072
...
type dw_master from w_a_reg_m_m3`dw_master within b1w_reg_svc_actorder_v20
...
type dw_detail from w_a_reg_m_m3`dw_detail within b1w_reg_svc_actorder_v20
integer x = 46
integer y = 1816
integer width = 4064
integer height = 592
...
type p_insert from w_a_reg_m_m3`p_insert within b1w_reg_svc_actorder_v20
integer x = 55
integer y = 2468
end type

type p_delete from w_a_reg_m_m3`p_delete within b1w_reg_svc_actorder_v20
integer x = 347
integer y = 2468
end type

type p_save from w_a_reg_m_m3`p_save within b1w_reg_svc_actorder_v20
integer x = 640
integer y = 2468
end type

type p_reset from w_a_reg_m_m3`p_reset within b1w_reg_svc_actorder_v20
integer x = 1390
integer y = 2468
end type

type dw_detail2 from w_a_reg_m_m3`dw_detail2 within b1w_reg_svc_actorder_v20
integer x = 41
integer y = 1112
integer width = 4064
integer height = 664
...
type st_horizontal2 from w_a_reg_m_m3`st_horizontal2 within b1w_reg_svc_actorder_v20
integer x = 37
integer y = 1076
integer height = 36
end type
...
type st_horizontal from w_a_reg_m_m3`st_horizontal within b1w_reg_svc_actorder_v20
boolean visible = false
integer x = 41
integer y = 1780
integer height = 36
