$PBExportHeader$b1w_reg_svc_actprc_pre.srw
$PBExportComments$[parkkh]서비스개통처리-선불제
forward
global type b1w_reg_svc_actprc_pre from w_a_reg_m_m
end type
end forward
...
global b1w_reg_svc_actprc_pre b1w_reg_svc_actprc_pre
...
on b1w_reg_svc_actprc_pre.create
call super::create
end on

on b1w_reg_svc_actprc_pre.destroy
call super::destroy
end on
...
lu_dbmgr2.is_caller = "b1w_reg_svc_actprc_pre%save"
lu_dbmgr2.is_title  = Title
lu_dbmgr2.idw_data[1] = dw_detail

lu_dbmgr2.uf_prc_db_04()
...
type dw_cond from w_a_reg_m_m`dw_cond within b1w_reg_svc_actprc_pre
integer x = 46
integer width = 2048
integer height = 192
...
type p_ok from w_a_reg_m_m`p_ok within b1w_reg_svc_actprc_pre
integer x = 2304
integer y = 40
end type

type p_close from w_a_reg_m_m`p_close within b1w_reg_svc_actprc_pre
integer x = 2606
integer y = 40
boolean originalsize = false
end type

type gb_cond from w_a_reg_m_m`gb_cond within b1w_reg_svc_actprc_pre
integer width = 2135
integer height = 276
end type

type dw_master from w_a_reg_m_m`dw_master within b1w_reg_svc_actprc_pre
integer x = 23
integer y = 296
integer width = 3118
integer height = 556
...
type dw_detail from w_a_reg_m_m`dw_detail within b1w_reg_svc_actprc_pre
integer x = 23
integer y = 880
integer width = 3118
integer height = 1044
...
type p_insert from w_a_reg_m_m`p_insert within b1w_reg_svc_actprc_pre
boolean visible = false
integer y = 1716
end type

type p_delete from w_a_reg_m_m`p_delete within b1w_reg_svc_actprc_pre
boolean visible = false
integer y = 1716
end type

type p_save from w_a_reg_m_m`p_save within b1w_reg_svc_actprc_pre
integer x = 46
integer y = 1948
end type

type p_reset from w_a_reg_m_m`p_reset within b1w_reg_svc_actprc_pre
integer x = 347
integer y = 1948
end type

type st_horizontal from w_a_reg_m_m`st_horizontal within b1w_reg_svc_actprc_pre
integer x = 23
integer y = 848
end type
