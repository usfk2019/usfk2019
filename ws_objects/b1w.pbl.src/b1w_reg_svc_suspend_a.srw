$PBExportHeader$b1w_reg_svc_suspend_a.srw
$PBExportComments$[ceusee] 일시정지처리-선불제&후불
forward
global type b1w_reg_svc_suspend_a from w_a_reg_m_m
end type
end forward
...
global b1w_reg_svc_suspend_a b1w_reg_svc_suspend_a
...
on b1w_reg_svc_suspend_a.create
call super::create
end on

on b1w_reg_svc_suspend_a.destroy
call super::destroy
end on
...
type dw_cond from w_a_reg_m_m`dw_cond within b1w_reg_svc_suspend_a
integer width = 1934
integer height = 208
...
type p_ok from w_a_reg_m_m`p_ok within b1w_reg_svc_suspend_a
integer x = 2085
integer y = 48
end type

type p_close from w_a_reg_m_m`p_close within b1w_reg_svc_suspend_a
integer x = 2386
integer y = 48
boolean originalsize = false
end type

type gb_cond from w_a_reg_m_m`gb_cond within b1w_reg_svc_suspend_a
integer width = 1966
integer height = 288
end type

type dw_master from w_a_reg_m_m`dw_master within b1w_reg_svc_suspend_a
integer x = 32
integer y = 308
integer height = 508
...
type dw_detail from w_a_reg_m_m`dw_detail within b1w_reg_svc_suspend_a
integer y = 848
integer height = 1000
string dataobject = "b1dw_reg_svc_suspend_a"
end type
...
type p_insert from w_a_reg_m_m`p_insert within b1w_reg_svc_suspend_a
boolean visible = false
integer y = 1740
end type

type p_delete from w_a_reg_m_m`p_delete within b1w_reg_svc_suspend_a
boolean visible = false
integer y = 1740
end type

type p_save from w_a_reg_m_m`p_save within b1w_reg_svc_suspend_a
integer x = 46
integer y = 1884
end type

type p_reset from w_a_reg_m_m`p_reset within b1w_reg_svc_suspend_a
integer x = 370
integer y = 1884
end type

type st_horizontal from w_a_reg_m_m`st_horizontal within b1w_reg_svc_suspend_a
integer y = 816
end type
