$PBExportHeader$b1w_reg_svc_suspendorder_cl.srw
$PBExportComments$[kem] 일시정지신청-선불제&후불- com&life
forward
global type b1w_reg_svc_suspendorder_cl from w_a_reg_m_m
end type
type dw_detail2 from u_d_base within b1w_reg_svc_suspendorder_cl
end type
type dw_detail3 from u_d_base within b1w_reg_svc_suspendorder_cl
end type
end forward
...
global b1w_reg_svc_suspendorder_cl b1w_reg_svc_suspendorder_cl
...
on b1w_reg_svc_suspendorder_cl.create
int iCurrent
call super::create
...
on b1w_reg_svc_suspendorder_cl.destroy
call super::destroy
...
type dw_cond from w_a_reg_m_m`dw_cond within b1w_reg_svc_suspendorder_cl
integer x = 46
integer y = 52
integer width = 2203
...
type p_ok from w_a_reg_m_m`p_ok within b1w_reg_svc_suspendorder_cl
integer x = 2382
integer y = 52
end type

type p_close from w_a_reg_m_m`p_close within b1w_reg_svc_suspendorder_cl
integer x = 2688
integer y = 52
end type

type gb_cond from w_a_reg_m_m`gb_cond within b1w_reg_svc_suspendorder_cl
integer width = 2231
end type

type dw_master from w_a_reg_m_m`dw_master within b1w_reg_svc_suspendorder_cl
integer x = 27
integer y = 328
integer width = 3081
integer height = 648
...
type dw_detail from w_a_reg_m_m`dw_detail within b1w_reg_svc_suspendorder_cl
integer x = 1449
integer y = 1008
integer width = 1659
integer height = 428
...
String ls_contractseq, ls_where, ls_type, ls_ref_desc, ls_svccod, ls_svctype
Long ll_row
...
type p_insert from w_a_reg_m_m`p_insert within b1w_reg_svc_suspendorder_cl
boolean visible = false
integer y = 1816
end type

type p_delete from w_a_reg_m_m`p_delete within b1w_reg_svc_suspendorder_cl
boolean visible = false
integer y = 1816
end type

type p_save from w_a_reg_m_m`p_save within b1w_reg_svc_suspendorder_cl
integer x = 59
integer y = 1764
end type

type p_reset from w_a_reg_m_m`p_reset within b1w_reg_svc_suspendorder_cl
integer x = 361
integer y = 1764
end type

type st_horizontal from w_a_reg_m_m`st_horizontal within b1w_reg_svc_suspendorder_cl
integer y = 976
end type
