$PBExportHeader$b1w_reg_svc_termorder.srw
$PBExportComments$[parkkh]서비스해지신청(위약금미포함)-후불제
forward
global type b1w_reg_svc_termorder from w_a_reg_m_m
end type
type dw_detail3 from u_d_base within b1w_reg_svc_termorder
end type
type dw_detail2 from u_d_base within b1w_reg_svc_termorder
end type
end forward
...
global b1w_reg_svc_termorder b1w_reg_svc_termorder
...
on b1w_reg_svc_termorder.create
int iCurrent
call super::create
...
on b1w_reg_svc_termorder.destroy
call super::destroy
...
type dw_cond from w_a_reg_m_m`dw_cond within b1w_reg_svc_termorder
integer x = 41
integer y = 52
integer width = 2437
integer height = 280
...
type p_ok from w_a_reg_m_m`p_ok within b1w_reg_svc_termorder
integer x = 2638
end type

type p_close from w_a_reg_m_m`p_close within b1w_reg_svc_termorder
integer x = 2944
boolean originalsize = false
end type

type gb_cond from w_a_reg_m_m`gb_cond within b1w_reg_svc_termorder
integer width = 2501
integer height = 360
end type

type dw_master from w_a_reg_m_m`dw_master within b1w_reg_svc_termorder
integer y = 396
integer width = 3237
integer height = 644
...
type dw_detail from w_a_reg_m_m`dw_detail within b1w_reg_svc_termorder
integer x = 1467
integer y = 1076
integer width = 1801
integer height = 624
...
type p_insert from w_a_reg_m_m`p_insert within b1w_reg_svc_termorder
boolean visible = false
integer y = 1716
end type

type p_delete from w_a_reg_m_m`p_delete within b1w_reg_svc_termorder
boolean visible = false
integer y = 1716
end type

type p_save from w_a_reg_m_m`p_save within b1w_reg_svc_termorder
integer x = 69
integer y = 2032
end type

type p_reset from w_a_reg_m_m`p_reset within b1w_reg_svc_termorder
integer x = 375
integer y = 2032
end type

type st_horizontal from w_a_reg_m_m`st_horizontal within b1w_reg_svc_termorder
integer y = 1040
integer height = 40
end type
