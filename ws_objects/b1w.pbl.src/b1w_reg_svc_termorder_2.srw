$PBExportHeader$b1w_reg_svc_termorder_2.srw
$PBExportComments$[kem] 해지신청/처리(위약금 포함) -선불제&후불제
forward
global type b1w_reg_svc_termorder_2 from w_a_reg_m_m
end type
type dw_detail3 from u_d_base within b1w_reg_svc_termorder_2
end type
type dw_detail2 from u_d_base within b1w_reg_svc_termorder_2
end type
end forward
...
global b1w_reg_svc_termorder_2 b1w_reg_svc_termorder_2
...
on b1w_reg_svc_termorder_2.create
int iCurrent
call super::create
...
on b1w_reg_svc_termorder_2.destroy
call super::destroy
...
String ls_act_status, ls_ref_desc, ls_customerid, ls_priceplan, ls_requestdt
Boolean lb_check
...
lu_dbmgr.is_caller = "b1w_reg_svc_termorder_2%save"
...
type dw_cond from w_a_reg_m_m`dw_cond within b1w_reg_svc_termorder_2
integer x = 41
integer y = 52
integer width = 2437
integer height = 280
...
type p_ok from w_a_reg_m_m`p_ok within b1w_reg_svc_termorder_2
integer x = 2638
end type

type p_close from w_a_reg_m_m`p_close within b1w_reg_svc_termorder_2
integer x = 2944
boolean originalsize = false
end type

type gb_cond from w_a_reg_m_m`gb_cond within b1w_reg_svc_termorder_2
integer width = 2501
integer height = 360
end type

type dw_master from w_a_reg_m_m`dw_master within b1w_reg_svc_termorder_2
integer y = 396
integer width = 3237
integer height = 644
string dataobject = "b1dw_reg_svc_termorder_m_a_1"
end type
...
type dw_detail from w_a_reg_m_m`dw_detail within b1w_reg_svc_termorder_2
integer x = 1467
integer y = 1076
integer width = 1801
integer height = 592
...
type p_insert from w_a_reg_m_m`p_insert within b1w_reg_svc_termorder_2
boolean visible = false
integer y = 1716
end type

type p_delete from w_a_reg_m_m`p_delete within b1w_reg_svc_termorder_2
boolean visible = false
integer y = 1716
end type

type p_save from w_a_reg_m_m`p_save within b1w_reg_svc_termorder_2
integer x = 69
integer y = 2004
end type

type p_reset from w_a_reg_m_m`p_reset within b1w_reg_svc_termorder_2
integer x = 375
integer y = 2004
end type

type st_horizontal from w_a_reg_m_m`st_horizontal within b1w_reg_svc_termorder_2
integer y = 1040
integer height = 40
end type
