$PBExportHeader$b1w_reg_svc_termorder_2_v20.srw
$PBExportComments$[ohj] 해지신청/처리(위약금 포함) -선불제&후불제
forward
global type b1w_reg_svc_termorder_2_v20 from w_a_reg_m_m
end type
type dw_detail3 from u_d_base within b1w_reg_svc_termorder_2_v20
end type
type dw_detail2 from u_d_base within b1w_reg_svc_termorder_2_v20
end type
end forward
...
global b1w_reg_svc_termorder_2_v20 b1w_reg_svc_termorder_2_v20
...
on b1w_reg_svc_termorder_2_v20.create
int iCurrent
call super::create
...
on b1w_reg_svc_termorder_2_v20.destroy
call super::destroy
...
String 	ls_where, 		ls_activedt_fr, 	ls_activedt_to, 	ls_temp, 	ls_result[],&
			ls_contractseq
...
//Null Check
If IsNull(ls_memberid) 		Then ls_customerid 	= ""
...
String ls_act_status, ls_ref_desc, ls_customerid, ls_priceplan, ls_requestdt, ls_svccod
Boolean lb_check
...
type dw_cond from w_a_reg_m_m`dw_cond within b1w_reg_svc_termorder_2_v20
integer x = 41
integer y = 52
integer width = 2469
integer height = 316
...
This.is_help_win[2] = "ssrt_hlp_customer"
...
type p_ok from w_a_reg_m_m`p_ok within b1w_reg_svc_termorder_2_v20
integer x = 2638
end type

type p_close from w_a_reg_m_m`p_close within b1w_reg_svc_termorder_2_v20
integer x = 2944
boolean originalsize = false
end type

type gb_cond from w_a_reg_m_m`gb_cond within b1w_reg_svc_termorder_2_v20
integer width = 2501
integer height = 376
end type

type dw_master from w_a_reg_m_m`dw_master within b1w_reg_svc_termorder_2_v20
integer x = 32
integer y = 396
integer width = 3323
integer height = 644
...
event dw_master::clicked;call super::clicked;String	ls_contractseq
Long		ll_count

ls_contractseq = String(this.object.contractmst_contractseq[row])

select Count(*) INTO :ll_count  from svcorder 
 where ref_contractseq = :ls_contractseq
   and Status IN ( is_termenable[1], is_termenable[2],is_termenable[3],is_termenable[4] ) ;

IF IsNull(ll_count) OR sqlca.sqlcode < 0 THEN ll_Count = 0
IF ll_Count > 0 then
	f_msg_info_app(9000, Title, "계약상태를 확인 하세요.")
	return
END IF
...
//click 할때마다....  이미 해지신청한 내용을 가져와서 보여주고.. save 버튼을 disable 하는 우선 작업 막음!!
...
type dw_detail from w_a_reg_m_m`dw_detail within b1w_reg_svc_termorder_2_v20
integer x = 1806
integer y = 1076
integer width = 1550
integer height = 592
...
type p_insert from w_a_reg_m_m`p_insert within b1w_reg_svc_termorder_2_v20
boolean visible = false
integer y = 1716
end type

type p_delete from w_a_reg_m_m`p_delete within b1w_reg_svc_termorder_2_v20
boolean visible = false
integer y = 1716
end type

type p_save from w_a_reg_m_m`p_save within b1w_reg_svc_termorder_2_v20
integer x = 69
integer y = 2004
end type

type p_reset from w_a_reg_m_m`p_reset within b1w_reg_svc_termorder_2_v20
integer x = 375
integer y = 2004
end type

type st_horizontal from w_a_reg_m_m`st_horizontal within b1w_reg_svc_termorder_2_v20
integer y = 1040
integer height = 40
end type
