$PBExportHeader$b1w_reg_svc_termorder_a.srw
$PBExportComments$[parkkh]서비스해지신청(위약금미포함)-선불제&후불제
forward
global type b1w_reg_svc_termorder_a from w_a_reg_m_m
end type
type dw_detail3 from u_d_base within b1w_reg_svc_termorder_a
end type
type dw_detail2 from u_d_base within b1w_reg_svc_termorder_a
end type
end forward
...
on b1w_reg_svc_termorder_a.create
int iCurrent
call super::create
...
on b1w_reg_svc_termorder_a.destroy
call super::destroy
...
//서비스type - 후불제
ls_ref_desc = ""
is_svctype_post = fs_get_control("B0", "P102", ls_ref_desc)
end event
...
String ls_act_status, ls_ref_desc, ls_customerid, ls_svctype
Boolean lb_check
...
ls_svctype = dw_detail.object.svcmst_svctype[1]
...
ElseIf ls_svctype = is_svctype_post Then
...
type dw_cond from w_a_reg_m_m`dw_cond within b1w_reg_svc_termorder_a
integer x = 41
integer y = 52
integer width = 2437
integer height = 280
...
type p_ok from w_a_reg_m_m`p_ok within b1w_reg_svc_termorder_a
integer x = 2638
end type

type p_close from w_a_reg_m_m`p_close within b1w_reg_svc_termorder_a
integer x = 2944
boolean originalsize = false
end type

type gb_cond from w_a_reg_m_m`gb_cond within b1w_reg_svc_termorder_a
integer width = 2501
integer height = 360
end type

type dw_master from w_a_reg_m_m`dw_master within b1w_reg_svc_termorder_a
integer y = 396
integer width = 3237
integer height = 644
string dataobject = "b1dw_reg_svc_termorder_m_a"
end type
...
type dw_detail from w_a_reg_m_m`dw_detail within b1w_reg_svc_termorder_a
integer x = 1467
integer y = 1076
integer width = 1801
integer height = 596
...
//		ls_paynm = Trim(This.object.customerm_customernm_1[row])
		...
		OpenWithParm(b1w_reg_termorder_pop, iu_cust_msg)
...
type p_insert from w_a_reg_m_m`p_insert within b1w_reg_svc_termorder_a
boolean visible = false
integer y = 1716
end type

type p_delete from w_a_reg_m_m`p_delete within b1w_reg_svc_termorder_a
boolean visible = false
integer y = 1716
end type

type p_save from w_a_reg_m_m`p_save within b1w_reg_svc_termorder_a
integer x = 69
integer y = 1972
end type

type p_reset from w_a_reg_m_m`p_reset within b1w_reg_svc_termorder_a
integer x = 375
integer y = 1972
end type

type st_horizontal from w_a_reg_m_m`st_horizontal within b1w_reg_svc_termorder_a
integer y = 1040
integer height = 40
end type
