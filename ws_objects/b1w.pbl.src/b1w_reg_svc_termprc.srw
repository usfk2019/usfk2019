$PBExportHeader$b1w_reg_svc_termprc.srw
$PBExportComments$[ceusee] 서비스 해지 처리-후불
forward
global type b1w_reg_svc_termprc from w_a_reg_m_m
end type
end forward
...
global b1w_reg_svc_termprc b1w_reg_svc_termprc
...
on b1w_reg_svc_termprc.create
call super::create
end on

on b1w_reg_svc_termprc.destroy
call super::destroy
end on
...
type dw_cond from w_a_reg_m_m`dw_cond within b1w_reg_svc_termprc
integer width = 1952
integer height = 296
...
type p_ok from w_a_reg_m_m`p_ok within b1w_reg_svc_termprc
integer x = 2167
integer y = 48
end type

type p_close from w_a_reg_m_m`p_close within b1w_reg_svc_termprc
integer x = 2496
integer y = 48
boolean originalsize = false
end type

type gb_cond from w_a_reg_m_m`gb_cond within b1w_reg_svc_termprc
integer width = 2043
integer height = 356
end type

type dw_master from w_a_reg_m_m`dw_master within b1w_reg_svc_termprc
integer x = 32
integer y = 368
integer width = 3287
integer height = 532
...
type dw_detail from w_a_reg_m_m`dw_detail within b1w_reg_svc_termprc
integer y = 940
integer width = 3269
integer height = 856
string dataobject = "b1dw_reg_tremprc"
end type
...
type p_insert from w_a_reg_m_m`p_insert within b1w_reg_svc_termprc
boolean visible = false
integer y = 1876
end type

type p_delete from w_a_reg_m_m`p_delete within b1w_reg_svc_termprc
boolean visible = false
integer y = 1876
end type

type p_save from w_a_reg_m_m`p_save within b1w_reg_svc_termprc
integer x = 59
integer y = 1880
end type

type p_reset from w_a_reg_m_m`p_reset within b1w_reg_svc_termprc
integer x = 375
integer y = 1880
end type

type st_horizontal from w_a_reg_m_m`st_horizontal within b1w_reg_svc_termprc
integer y = 908
end type
