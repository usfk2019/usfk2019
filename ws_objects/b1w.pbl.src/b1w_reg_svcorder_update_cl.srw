$PBExportHeader$b1w_reg_svcorder_update_cl.srw
$PBExportComments$[kem] 신청 내역 수정(All) - C&L
forward
global type b1w_reg_svcorder_update_cl from w_a_reg_s
end type
end forward
...
global b1w_reg_svcorder_update_cl b1w_reg_svcorder_update_cl

type variables
String is_actorder, is_date_check, is_cancel
end variables

on b1w_reg_svcorder_update_cl.create
call super::create
end on

on b1w_reg_svcorder_update_cl.destroy
call super::destroy
end on

event open;call super::open;f_center_window(b1w_reg_svcorder_update_cl)
...
type dw_cond from w_a_reg_s`dw_cond within b1w_reg_svcorder_update_cl
boolean visible = false
end type

type p_ok from w_a_reg_s`p_ok within b1w_reg_svcorder_update_cl
boolean visible = false
end type

type p_close from w_a_reg_s`p_close within b1w_reg_svcorder_update_cl
integer x = 2437
integer y = 800
end type

type gb_cond from w_a_reg_s`gb_cond within b1w_reg_svcorder_update_cl
boolean visible = false
end type

type dw_detail from w_a_reg_s`dw_detail within b1w_reg_svcorder_update_cl
integer y = 32
integer width = 2711
integer height = 732
string dataobject = "b1dw_reg_svcorder_update_cl"
...
type p_delete from w_a_reg_s`p_delete within b1w_reg_svcorder_update_cl
boolean visible = false
integer y = 744
end type

type p_insert from w_a_reg_s`p_insert within b1w_reg_svcorder_update_cl
boolean visible = false
integer y = 744
end type

type p_save from w_a_reg_s`p_save within b1w_reg_svcorder_update_cl
integer x = 2126
integer y = 800
end type

type p_reset from w_a_reg_s`p_reset within b1w_reg_svcorder_update_cl
boolean visible = false
integer y = 744
end type
