$PBExportHeader$b1w_reg_svcorder_validinfo_pop_v20.srw
$PBExportComments$[parkkh]서비스개통신청인증정보등록/조회
forward
global type b1w_reg_svcorder_validinfo_pop_v20 from w_a_reg_m
end type
type p_cancel from u_p_cancel within b1w_reg_svcorder_validinfo_pop_v20
end type
type cb_callingnum from commandbutton within b1w_reg_svcorder_validinfo_pop_v20
end type
end forward
...
global b1w_reg_svcorder_validinfo_pop_v20 b1w_reg_svcorder_validinfo_pop_v20
...
on b1w_reg_svcorder_validinfo_pop_v20.create
int iCurrent
call super::create
...
on b1w_reg_svcorder_validinfo_pop_v20.destroy
call super::destroy
...
//window 중앙에
f_center_window(b1w_reg_svcorder_validinfo_pop_v20)
...
type dw_cond from w_a_reg_m`dw_cond within b1w_reg_svcorder_validinfo_pop_v20
...
type p_ok from w_a_reg_m`p_ok within b1w_reg_svcorder_validinfo_pop_v20
boolean visible = false
integer x = 585
integer y = 1228
end type

type p_close from w_a_reg_m`p_close within b1w_reg_svcorder_validinfo_pop_v20
boolean visible = false
integer x = 2021
integer y = 684
...
type gb_cond from w_a_reg_m`gb_cond within b1w_reg_svcorder_validinfo_pop_v20
boolean visible = false
end type

type p_delete from w_a_reg_m`p_delete within b1w_reg_svcorder_validinfo_pop_v20
boolean visible = false
integer x = 50
integer y = 1432
end type

type p_insert from w_a_reg_m`p_insert within b1w_reg_svcorder_validinfo_pop_v20
boolean visible = false
end type

type p_save from w_a_reg_m`p_save within b1w_reg_svcorder_validinfo_pop_v20
integer x = 2816
integer y = 796
...
type dw_detail from w_a_reg_m`dw_detail within b1w_reg_svcorder_validinfo_pop_v20
integer y = 52
integer width = 3072
integer height = 668
integer taborder = 20
...
type p_reset from w_a_reg_m`p_reset within b1w_reg_svcorder_validinfo_pop_v20
boolean visible = false
integer x = 270
integer y = 1224
boolean enabled = true
