$PBExportHeader$b1w_reg_termorder_pop.srw
$PBExportComments$[parkkh] 납입고객 전체고객 해지신청(위약금미포함)
forward
global type b1w_reg_termorder_pop from w_a_reg_m
end type
type p_termorder from commandbutton within b1w_reg_termorder_pop
end type
end forward
...
global b1w_reg_termorder_pop b1w_reg_termorder_pop
...
String ls_status, ls_requestactive, ls_ref_desc, ls_termstatus, ls_customerid_1, ls_remark
Datetime ldt_crtdt
...
//	END If		
	...
	If is_act_gu = 'Y' Then 
		...
		End If	
			...
			//인증 정보 Update
		   Update validinfo
			Set todt = to_date(:is_enddt, 'yyyy-mm-dd'),
				status = :ls_status,
				use_yn = 'N',
				updt_user = :gs_user_id,
				updtdt = sysdate,
...
on b1w_reg_termorder_pop.create
int iCurrent
call super::create
...
on b1w_reg_termorder_pop.destroy
call super::destroy
...
//window 중앙에
f_center_window(b1w_reg_termorder_pop)
...
type dw_cond from w_a_reg_m`dw_cond within b1w_reg_termorder_pop
integer x = 41
integer y = 44
integer width = 3232
integer height = 324
...
type p_ok from w_a_reg_m`p_ok within b1w_reg_termorder_pop
integer x = 3328
integer y = 64
end type

type p_close from w_a_reg_m`p_close within b1w_reg_termorder_pop
integer x = 3634
integer y = 64
boolean originalsize = false
end type

type gb_cond from w_a_reg_m`gb_cond within b1w_reg_termorder_pop
integer width = 3255
integer height = 380
end type

type p_delete from w_a_reg_m`p_delete within b1w_reg_termorder_pop
boolean visible = false
integer x = 50
integer y = 1432
end type

type p_insert from w_a_reg_m`p_insert within b1w_reg_termorder_pop
boolean visible = false
end type

type p_save from w_a_reg_m`p_save within b1w_reg_termorder_pop
boolean visible = false
integer x = 2482
integer y = 132
integer height = 168
...
type dw_detail from w_a_reg_m`dw_detail within b1w_reg_termorder_pop
integer y = 396
integer width = 3904
integer height = 1000
integer taborder = 20
...
type p_reset from w_a_reg_m`p_reset within b1w_reg_termorder_pop
boolean visible = false
integer x = 2757
integer y = 124
