$PBExportHeader$b1w_reg_validinfo_popup_update.srw
$PBExportComments$[parkkh] 인증정보 update popup window(tab3)
forward
global type b1w_reg_validinfo_popup_update from w_a_reg_m
end type
end forward
...
global b1w_reg_validinfo_popup_update b1w_reg_validinfo_popup_update
...
on b1w_reg_validinfo_popup_update.create
call super::create
end on

on b1w_reg_validinfo_popup_update.destroy
call super::destroy
end on
...
-------------------------------------------------------------------------*/
Long ll_row
String ls_where, ls_ref_desc

is_cusid = ""
is_cusnm = ""

//window 중앙에
f_center_window(b1w_reg_validinfo_popup_update)
...
type dw_cond from w_a_reg_m`dw_cond within b1w_reg_validinfo_popup_update
...
type p_ok from w_a_reg_m`p_ok within b1w_reg_validinfo_popup_update
boolean visible = false
integer x = 585
integer y = 1228
end type

type p_close from w_a_reg_m`p_close within b1w_reg_validinfo_popup_update
integer x = 366
integer y = 868
end type

type gb_cond from w_a_reg_m`gb_cond within b1w_reg_validinfo_popup_update
boolean visible = false
end type

type p_delete from w_a_reg_m`p_delete within b1w_reg_validinfo_popup_update
boolean visible = false
integer x = 50
integer y = 1432
end type

type p_insert from w_a_reg_m`p_insert within b1w_reg_validinfo_popup_update
boolean visible = false
end type

type p_save from w_a_reg_m`p_save within b1w_reg_validinfo_popup_update
integer x = 55
integer y = 868
boolean enabled = true
end type

type dw_detail from w_a_reg_m`dw_detail within b1w_reg_validinfo_popup_update
integer y = 52
integer width = 3058
integer height = 772
integer taborder = 20
string dataobject = "b1dw_reg_validinfo_popup_update_1"
end type
...
type p_reset from w_a_reg_m`p_reset within b1w_reg_validinfo_popup_update
boolean visible = false
integer x = 270
integer y = 1224
boolean enabled = true
