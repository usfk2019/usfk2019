$PBExportHeader$b1w_reg_validinfo_popup_update_cl_v20.srw
$PBExportComments$[kem] 인증정보 update popup window(tab3)
forward
global type b1w_reg_validinfo_popup_update_cl_v20 from w_a_reg_m
end type
end forward
...
global b1w_reg_validinfo_popup_update_cl_v20 b1w_reg_validinfo_popup_update_cl_v20
...
on b1w_reg_validinfo_popup_update_cl_v20.create
call super::create
end on

on b1w_reg_validinfo_popup_update_cl_v20.destroy
call super::destroy
end on
...
//window 중앙에
f_center_window(b1w_reg_validinfo_popup_update_cl_v20)
...
//해당 svccod의 언어맨트만 가져오게
ll_row = dw_detail.GetChild("langtype", ldc)
...
type dw_cond from w_a_reg_m`dw_cond within b1w_reg_validinfo_popup_update_cl_v20
...
type p_ok from w_a_reg_m`p_ok within b1w_reg_validinfo_popup_update_cl_v20
boolean visible = false
integer x = 585
integer y = 1228
end type

type p_close from w_a_reg_m`p_close within b1w_reg_validinfo_popup_update_cl_v20
integer x = 2967
integer y = 932
end type

type gb_cond from w_a_reg_m`gb_cond within b1w_reg_validinfo_popup_update_cl_v20
boolean visible = false
end type

type p_delete from w_a_reg_m`p_delete within b1w_reg_validinfo_popup_update_cl_v20
boolean visible = false
integer x = 50
integer y = 1432
end type

type p_insert from w_a_reg_m`p_insert within b1w_reg_validinfo_popup_update_cl_v20
boolean visible = false
end type

type p_save from w_a_reg_m`p_save within b1w_reg_validinfo_popup_update_cl_v20
integer x = 2656
integer y = 932
boolean enabled = true
end type

type dw_detail from w_a_reg_m`dw_detail within b1w_reg_validinfo_popup_update_cl_v20
integer y = 52
integer width = 3301
integer height = 812
integer taborder = 20
string dataobject = "b1dw_reg_validinfo_popup_update_cl_v20"
end type
...
event dw_detail::retrieveend;call super::retrieveend;string  ls_svccod, ls_origin_type
long ll_i
...
//Error
If SQLCA.SQLCode < 0 Then
	f_msg_sql_err("서비스 타입", "Select sacmst Table")
	Return 0
End If


If ls_origin_type ='L' Then
	...
	This.Object.Validkey_loc_t.visible=true
Else
	...
	This.Object.Validkey_loc_t.visible=false	
End If	
end event

type p_reset from w_a_reg_m`p_reset within b1w_reg_validinfo_popup_update_cl_v20
boolean visible = false
integer x = 270
integer y = 1224
boolean enabled = true
