$PBExportHeader$b1w_reg_validinfoserver_mod.srw
$PBExportComments$[parkkh] validinfoserver 재처리
forward
global type b1w_reg_validinfoserver_mod from w_a_reg_m
end type
end forward
...
global b1w_reg_validinfoserver_mod b1w_reg_validinfoserver_mod
...
on b1w_reg_validinfoserver_mod.create
call super::create
end on

on b1w_reg_validinfoserver_mod.destroy
call super::destroy
end on
...
String ls_h323id, ls_coid, ls_gkid, ls_check_yn
Double lb_payamt
Long ll_row
Integer li_rc
b1u_dbmgr4 	lu_dbmgr
...
type dw_cond from w_a_reg_m`dw_cond within b1w_reg_validinfoserver_mod
integer x = 59
integer y = 60
integer width = 1472
integer height = 308
string dataobject = "b1dw_cnd_reg_validinfoserver_mod"
boolean hscrollbar = false
boolean vscrollbar = false
boolean livescroll = false
end type

type p_ok from w_a_reg_m`p_ok within b1w_reg_validinfoserver_mod
integer x = 1765
integer y = 68
end type

type p_close from w_a_reg_m`p_close within b1w_reg_validinfoserver_mod
integer x = 2080
integer y = 68
boolean originalsize = false
end type

type gb_cond from w_a_reg_m`gb_cond within b1w_reg_validinfoserver_mod
integer width = 1577
integer height = 400
end type

type p_delete from w_a_reg_m`p_delete within b1w_reg_validinfoserver_mod
boolean visible = false
end type

type p_insert from w_a_reg_m`p_insert within b1w_reg_validinfoserver_mod
boolean visible = false
end type

type p_save from w_a_reg_m`p_save within b1w_reg_validinfoserver_mod
integer x = 91
integer y = 1636
end type

type dw_detail from w_a_reg_m`dw_detail within b1w_reg_validinfoserver_mod
integer y = 432
integer width = 3209
integer height = 1152
string dataobject = "b1dw_reg_validinfoserver_mod"
end type

event dw_detail::constructor;call super::constructor;SetRowFocusIndicator(off!)
end event

type p_reset from w_a_reg_m`p_reset within b1w_reg_validinfoserver_mod
integer x = 425
integer y = 1636
end type
