$PBExportHeader$b1w_reg_validkey_update.srw
$PBExportComments$[parkkh] 인증key 변경/추가
forward
global type b1w_reg_validkey_update from w_a_reg_m
end type
type p_change from u_p_change within b1w_reg_validkey_update
end type
type p_add from u_p_add within b1w_reg_validkey_update
end type
type p_1 from u_p_term within b1w_reg_validkey_update
end type
end forward
...
global b1w_reg_validkey_update b1w_reg_validkey_update
...
String ls_where, ls_validkey, ls_svctype, ls_contractseq
Long ll_row, ll_cnt
...
iu_check.is_data[1] = ls_validkey     
...
OpenWithParm(b1w_validkey_update_popup_1, iu_cust_msg)
...
Long ll_row, ll_cnt, ll_validkeycnt, ll_
...
OpenWithParm(b1w_validkey_update_popup_2, iu_cust_msg)
...
iu_check.is_data[1] = ls_validkey     
//is_data[2] = is_fromdt
iu_check.is_data[3] = ls_contractseq    
...
OpenWithParm(b1w_validkey_update_popup_3, iu_cust_msg)


end event

on b1w_reg_validkey_update.create
int iCurrent
call super::create
...
on b1w_reg_validkey_update.destroy
call super::destroy
...
type dw_cond from w_a_reg_m`dw_cond within b1w_reg_validkey_update
integer x = 41
integer y = 40
integer width = 914
integer taborder = 10
...
type p_ok from w_a_reg_m`p_ok within b1w_reg_validkey_update
...
type p_close from w_a_reg_m`p_close within b1w_reg_validkey_update
integer x = 2034
integer y = 52
boolean originalsize = false
end type

type gb_cond from w_a_reg_m`gb_cond within b1w_reg_validkey_update
integer width = 1033
end type

type p_delete from w_a_reg_m`p_delete within b1w_reg_validkey_update
boolean visible = false
integer x = 50
integer y = 1432
end type

type p_insert from w_a_reg_m`p_insert within b1w_reg_validkey_update
boolean visible = false
end type

type p_save from w_a_reg_m`p_save within b1w_reg_validkey_update
boolean visible = false
integer x = 1330
integer y = 84
integer height = 168
...
type dw_detail from w_a_reg_m`dw_detail within b1w_reg_validkey_update
boolean visible = false
integer y = 52
integer width = 1257
integer height = 280
...
type p_reset from w_a_reg_m`p_reset within b1w_reg_validkey_update
boolean visible = false
integer x = 270
integer y = 1224
