$PBExportHeader$b1w_reg_validkey_update_cl.srw
$PBExportComments$[kem] 인증key 변경/추가-제너
forward
global type b1w_reg_validkey_update_cl from w_a_reg_m
end type
type p_change from u_p_change within b1w_reg_validkey_update_cl
end type
type p_add from u_p_add within b1w_reg_validkey_update_cl
end type
type p_term from u_p_term within b1w_reg_validkey_update_cl
end type
end forward
...
global b1w_reg_validkey_update_cl b1w_reg_validkey_update_cl
...
OpenWithParm(b1w_validkey_update_popup_1_cl, iu_cust_msg)
...
OpenWithParm(b1w_validkey_update_popup_2_cl, iu_cust_msg)
...
OpenWithParm(b1w_validkey_update_popup_3_cl, iu_cust_msg)


end event

on b1w_reg_validkey_update_cl.create
int iCurrent
call super::create
...
on b1w_reg_validkey_update_cl.destroy
call super::destroy
...
type dw_cond from w_a_reg_m`dw_cond within b1w_reg_validkey_update_cl
integer x = 41
integer y = 40
integer width = 1047
integer taborder = 10
...
type p_ok from w_a_reg_m`p_ok within b1w_reg_validkey_update_cl
...
type p_close from w_a_reg_m`p_close within b1w_reg_validkey_update_cl
integer x = 2139
boolean originalsize = false
end type

type gb_cond from w_a_reg_m`gb_cond within b1w_reg_validkey_update_cl
integer width = 1129
end type

type p_delete from w_a_reg_m`p_delete within b1w_reg_validkey_update_cl
boolean visible = false
integer x = 50
integer y = 1432
end type

type p_insert from w_a_reg_m`p_insert within b1w_reg_validkey_update_cl
boolean visible = false
end type

type p_save from w_a_reg_m`p_save within b1w_reg_validkey_update_cl
boolean visible = false
integer x = 1330
integer y = 84
integer height = 168
...
type dw_detail from w_a_reg_m`dw_detail within b1w_reg_validkey_update_cl
boolean visible = false
integer y = 52
integer width = 1257
integer height = 280
...
type p_reset from w_a_reg_m`p_reset within b1w_reg_validkey_update_cl
boolean visible = false
integer x = 270
integer y = 1224
