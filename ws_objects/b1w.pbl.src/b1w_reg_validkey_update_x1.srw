$PBExportHeader$b1w_reg_validkey_update_x1.srw
$PBExportComments$[parkkh] 인증key 변경/추가-제너
forward
global type b1w_reg_validkey_update_x1 from w_a_reg_m
end type
type p_change from u_p_change within b1w_reg_validkey_update_x1
end type
type p_add from u_p_add within b1w_reg_validkey_update_x1
end type
type p_term from u_p_term within b1w_reg_validkey_update_x1
end type
end forward
...
global b1w_reg_validkey_update_x1 b1w_reg_validkey_update_x1
...
iu_check.is_data[7] = ls_contractseq  //계약 Sequence
...
OpenWithParm(b1w_validkey_update_popup_1_x1, iu_cust_msg)
...
OpenWithParm(b1w_validkey_update_popup_2_x1, iu_cust_msg)
...
iu_check.is_data[1] = ls_validkey        //인증KEY
//is_data[2] = is_fromdt
iu_check.is_data[3] = ls_contractseq     //계약 Sequence
...
If (iu_check.is_data[4] = is_svctype_post) or (iu_check.is_data[4] = is_svctype_pre) Then
Else
	f_msg_info(9000, Title, "후불/선불제서비스 인증Key만 변경가능!!")
	dw_cond.SetFocus()
	dw_cond.SetColumn("validkey")
...
iu_cust_msg.is_data[5] = iu_check.is_data[4]      //svctype

OpenWithParm(b1w_validkey_update_popup_3_x1, iu_cust_msg)


end event

on b1w_reg_validkey_update_x1.create
int iCurrent
call super::create
...
on b1w_reg_validkey_update_x1.destroy
call super::destroy
...
type dw_cond from w_a_reg_m`dw_cond within b1w_reg_validkey_update_x1
integer x = 41
integer y = 40
integer width = 1047
integer taborder = 10
string dataobject = "b1dw_cnd_reg_validkey_update"
...
type p_ok from w_a_reg_m`p_ok within b1w_reg_validkey_update_x1
...
type p_close from w_a_reg_m`p_close within b1w_reg_validkey_update_x1
integer x = 2139
integer y = 92
boolean originalsize = false
end type

type gb_cond from w_a_reg_m`gb_cond within b1w_reg_validkey_update_x1
integer width = 1129
end type

type p_delete from w_a_reg_m`p_delete within b1w_reg_validkey_update_x1
boolean visible = false
integer x = 50
integer y = 1432
end type

type p_insert from w_a_reg_m`p_insert within b1w_reg_validkey_update_x1
boolean visible = false
end type

type p_save from w_a_reg_m`p_save within b1w_reg_validkey_update_x1
boolean visible = false
integer x = 1330
integer y = 84
integer height = 168
...
type dw_detail from w_a_reg_m`dw_detail within b1w_reg_validkey_update_x1
boolean visible = false
integer y = 52
integer width = 1257
integer height = 280
...
type p_reset from w_a_reg_m`p_reset within b1w_reg_validkey_update_x1
boolean visible = false
integer x = 270
integer y = 1224
