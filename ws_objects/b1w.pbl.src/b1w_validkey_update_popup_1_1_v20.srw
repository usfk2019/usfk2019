$PBExportHeader$b1w_validkey_update_popup_1_1_v20.srw
$PBExportComments$[ohj] 인증 Key 변경 v20
forward
global type b1w_validkey_update_popup_1_1_v20 from w_base
end type
type cb_callingnum from commandbutton within b1w_validkey_update_popup_1_1_v20
end type
type dw_detail from u_d_help within b1w_validkey_update_popup_1_1_v20
end type
type p_save from u_p_save within b1w_validkey_update_popup_1_1_v20
end type
type p_close from u_p_close within b1w_validkey_update_popup_1_1_v20
end type
type ln_2 from line within b1w_validkey_update_popup_1_1_v20
end type
end forward
...
global b1w_validkey_update_popup_1_1_v20 b1w_validkey_update_popup_1_1_v20
...
String is_req_yn, is_used_level, is_reg_partner, is_in_svctype, is_out_svctype
...
event ue_extra_save;String ls_validkey, ls_vpassword, ls_svccod, ls_priceplan, ls_svctype, ls_gkid
String ls_cid, ls_auth_method, ls_ip_address, ls_h323id, ls_pricemodel, ls_pid
String ls_validkey_type, ls_validkey_loc
Long ll_row, ll_cnt
String ls_callforwardno,ls_password,ls_callingnum_all,ls_fromdt
integer li_ing_validkey
...
ls_fromdt        = string(dw_detail.object.new_fromdt[1],'yyyymmdd')

//변경후 번호가 이미신청중인지 체크 Start by HMK
...
if li_ing_validkey > 0 then
		f_msg_info(9000, Title, ls_validkey + " 은 이미 적용시작일 이후의 날짜로 번호변경 신청중인 번호입니다.")
		dw_detail.SetRow(1)
...
on b1w_validkey_update_popup_1_1_v20.create
int iCurrent
call super::create
...
on b1w_validkey_update_popup_1_1_v20.destroy
call super::destroy
...
f_center_window(b1w_validkey_update_popup_1_1_v20)
is_validkey = ""
is_fromdt = ""
...
IF is_svctype = is_svctype_post Then
	dw_detail.dataObject = "b1dw_validkey_update_popup_1_1_v20"
    dw_detail.Trigger Event Constructor()
//	dw_detail.SetTransObject(SQLCA)
Elseif is_svctype = is_svctype_pre Then
	dw_detail.dataObject = "b1dw_validkey_update_popup_1_pre_1_v20"
    dw_detail.Trigger Event Constructor()
//	dw_detail.SetTransObject(SQLCA)	
End If
...
integer height = 1604
integer taborder = 10
string dataobject = "b1dw_validkey_update_popup_1_1_v20"
