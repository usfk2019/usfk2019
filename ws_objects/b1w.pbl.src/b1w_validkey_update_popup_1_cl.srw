$PBExportHeader$b1w_validkey_update_popup_1_cl.srw
$PBExportComments$[kem] 후불인증 Key 변경(제너)
forward
global type b1w_validkey_update_popup_1_cl from w_base
end type
type p_save from u_p_save within b1w_validkey_update_popup_1_cl
end type
type p_close from u_p_close within b1w_validkey_update_popup_1_cl
end type
type dw_detail from u_d_sort within b1w_validkey_update_popup_1_cl
end type
type ln_2 from line within b1w_validkey_update_popup_1_cl
end type
end forward
...
global b1w_validkey_update_popup_1_cl b1w_validkey_update_popup_1_cl
...
on b1w_validkey_update_popup_1_cl.create
int iCurrent
call super::create
...
on b1w_validkey_update_popup_1_cl.destroy
call super::destroy
destroy(this.p_save)
...
f_center_window(b1w_validkey_update_popup_1_cl)
is_validkey = ""
is_fromdt = ""
...
integer height = 1428
integer taborder = 10
string dataobject = "b1dw_validkey_update_popup_1_cl"
