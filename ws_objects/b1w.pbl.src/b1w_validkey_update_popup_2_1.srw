$PBExportHeader$b1w_validkey_update_popup_2_1.srw
$PBExportComments$[kem] 인증 Key 추가(제너)
forward
global type b1w_validkey_update_popup_2_1 from w_base
end type
type dw_detail from u_d_help within b1w_validkey_update_popup_2_1
end type
type p_save from u_p_save within b1w_validkey_update_popup_2_1
end type
type p_close from u_p_close within b1w_validkey_update_popup_2_1
end type
type ln_2 from line within b1w_validkey_update_popup_2_1
end type
end forward
...
global b1w_validkey_update_popup_2_1 b1w_validkey_update_popup_2_1

type variables
String  is_pgm_id, is_contractseq, is_itemcod, is_svctype, is_status
String is_svccod, is_Xener_svccod[], is_xener_svc
String is_svctype_post, is_svctype_pre, is_req_yn
...
on b1w_validkey_update_popup_2_1.create
int iCurrent
call super::create
...
on b1w_validkey_update_popup_2_1.destroy
call super::destroy
...
event open;call super::open;/*------------------------------------------------------------------------
	Nmae	: b1w_validkey_update_popup_2_1
	Desc	: 인증KEY 추가
	Ver	: 	2.0
	Date	: 	2004.06.03
...
f_center_window(b1w_validkey_update_popup_2_1)
...
IF is_svctype = is_svctype_post Then
	dw_detail.dataObject = "b1dw_validkey_update_popup_2_1"
    dw_detail.Trigger Event Constructor()
//	dw_detail.SetTransObject(SQLCA)
Elseif is_svctype = is_svctype_pre Then
	dw_detail.dataObject = "b1dw_validkey_update_popup_2_pre_1"
    dw_detail.Trigger Event Constructor()	
//	dw_detail.SetTransObject(SQLCA)	
End If
...
integer height = 984
integer taborder = 10
string dataobject = "b1dw_validkey_update_popup_2_1"
