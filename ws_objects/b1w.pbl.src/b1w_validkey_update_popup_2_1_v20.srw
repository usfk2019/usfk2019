$PBExportHeader$b1w_validkey_update_popup_2_1_v20.srw
$PBExportComments$[ohj] 인증 Key 추가 v20
forward
global type b1w_validkey_update_popup_2_1_v20 from w_base
end type
type cb_callingnum from commandbutton within b1w_validkey_update_popup_2_1_v20
end type
type dw_detail from u_d_help within b1w_validkey_update_popup_2_1_v20
end type
type p_save from u_p_save within b1w_validkey_update_popup_2_1_v20
end type
type p_close from u_p_close within b1w_validkey_update_popup_2_1_v20
end type
type ln_2 from line within b1w_validkey_update_popup_2_1_v20
end type
end forward
...
global b1w_validkey_update_popup_2_1_v20 b1w_validkey_update_popup_2_1_v20
...
on b1w_validkey_update_popup_2_1_v20.create
int iCurrent
call super::create
...
on b1w_validkey_update_popup_2_1_v20.destroy
call super::destroy
...
f_center_window(b1w_validkey_update_popup_2_1_v20)
...
IF is_svctype = is_svctype_post Then
	dw_detail.dataObject = "b1dw_validkey_update_popup_2_1_v20"
    dw_detail.Trigger Event Constructor()
Elseif is_svctype = is_svctype_pre Then
	dw_detail.dataObject = "b1dw_validkey_update_popup_2_pre_1_v20"
    dw_detail.Trigger Event Constructor()	
End If
...
integer height = 1108
integer taborder = 10
string dataobject = "b1dw_validkey_update_popup_2_pre_1_v20"
