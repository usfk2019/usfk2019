$PBExportHeader$b1w_validkey_update_popup_2_cl.srw
$PBExportComments$[kem] 인증 Key 추가(제너)
forward
global type b1w_validkey_update_popup_2_cl from w_base
end type
type p_save from u_p_save within b1w_validkey_update_popup_2_cl
end type
type p_close from u_p_close within b1w_validkey_update_popup_2_cl
end type
type dw_detail from u_d_sort within b1w_validkey_update_popup_2_cl
end type
type ln_2 from line within b1w_validkey_update_popup_2_cl
end type
end forward
...
global b1w_validkey_update_popup_2_cl b1w_validkey_update_popup_2_cl
...
on b1w_validkey_update_popup_2_cl.create
int iCurrent
call super::create
...
on b1w_validkey_update_popup_2_cl.destroy
call super::destroy
destroy(this.p_save)
...
f_center_window(b1w_validkey_update_popup_2_cl)
...
integer height = 968
integer taborder = 10
string dataobject = "b1dw_validkey_update_popup_2_cl"
boolean hscrollbar = false
borderstyle borderstyle = stylebox!
boolean ib_sort_use = false
end type

event retrieveend;call super::retrieveend;String ls_gkid, ls_auth_method, ls_ip_address, ls_h323id

Select gkid, auth_method, validitem2, validitem3
  Into :ls_gkid, :ls_auth_method, :ls_ip_address, :ls_h323id
  From validinfo
