$PBExportHeader$b1w_validkey_update_popup_3_1_v20.srw
$PBExportComments$[ohj] 인증 Key 해지 v20
forward
global type b1w_validkey_update_popup_3_1_v20 from w_base
end type
type p_save from u_p_save within b1w_validkey_update_popup_3_1_v20
end type
type p_close from u_p_close within b1w_validkey_update_popup_3_1_v20
end type
type dw_detail from u_d_sort within b1w_validkey_update_popup_3_1_v20
end type
type ln_2 from line within b1w_validkey_update_popup_3_1_v20
end type
end forward
...
global b1w_validkey_update_popup_3_1_v20 b1w_validkey_update_popup_3_1_v20
...
String ls_sysdt, ls_fromdt, ls_svccod, ls_priceplan, ls_date_allow_yn
Integer li_rc
...
//2005-12-23 khpark 개통일 check 여부  start
ls_svccod = dw_detail.object.svccod[1]
ls_priceplan = dw_detail.object.priceplan[1]
IF b1fi_date_allow_chk_yn_v20(This.title,ls_svccod,ls_priceplan,ls_date_allow_yn) < 0 Then
	 return -1
End IF	

//해당 서비스 가격정책에 개통일/해지일 허용여부가 'N'일경우 check
If ls_date_allow_yn = 'N' Then
	//오늘 날짜 이상부터 해지가 가능하다.
	...
	End If
End IF
//2005-12-23 khpark 개통일 check 여부  end
...
IF ii_validkeytype_cnt > 0 Then
	...
	lu_dbmgr.is_caller = "b1w_validkey_update_popup_3_1_v20%ue_save"
...
on b1w_validkey_update_popup_3_1_v20.create
int iCurrent
call super::create
...
on b1w_validkey_update_popup_3_1_v20.destroy
call super::destroy
destroy(this.p_save)
...
f_center_window(b1w_validkey_update_popup_3_1_v20)
is_validkey = ""
is_fromdt = ""
...
integer height = 888
integer taborder = 10
string dataobject = "b1dw_validkey_update_popup_3_1_v20"
