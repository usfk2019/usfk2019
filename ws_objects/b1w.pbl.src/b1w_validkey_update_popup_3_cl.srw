$PBExportHeader$b1w_validkey_update_popup_3_cl.srw
$PBExportComments$[ceusee] 인증 Key 해지(X1)
forward
global type b1w_validkey_update_popup_3_cl from w_base
end type
type p_save from u_p_save within b1w_validkey_update_popup_3_cl
end type
type p_close from u_p_close within b1w_validkey_update_popup_3_cl
end type
type dw_detail from u_d_sort within b1w_validkey_update_popup_3_cl
end type
type ln_2 from line within b1w_validkey_update_popup_3_cl
end type
end forward
...
global b1w_validkey_update_popup_3_cl b1w_validkey_update_popup_3_cl
...
on b1w_validkey_update_popup_3_cl.create
int iCurrent
call super::create
...
on b1w_validkey_update_popup_3_cl.destroy
call super::destroy
destroy(this.p_save)
...
f_center_window(b1w_validkey_update_popup_3_cl)
is_validkey = ""
is_fromdt = ""
...
integer height = 844
integer taborder = 10
string dataobject = "b1dw_validkey_update_popup_3_cl"
...
event retrieveend;call super::retrieveend;dw_detail.object.todt[1] = fd_date_next(Date(fdt_get_dbserver_now()), + 1)
Return 0
end event
