$PBExportHeader$b1w_validkey_update_popup_3_x1.srw
$PBExportComments$[ceusee] 인증 Key 해지(X1)
forward
global type b1w_validkey_update_popup_3_x1 from w_base
end type
type p_save from u_p_save within b1w_validkey_update_popup_3_x1
end type
type p_close from u_p_close within b1w_validkey_update_popup_3_x1
end type
type dw_detail from u_d_sort within b1w_validkey_update_popup_3_x1
end type
type ln_2 from line within b1w_validkey_update_popup_3_x1
end type
end forward
...
global b1w_validkey_update_popup_3_x1 b1w_validkey_update_popup_3_x1
...
on b1w_validkey_update_popup_3_x1.create
int iCurrent
call super::create
...
on b1w_validkey_update_popup_3_x1.destroy
call super::destroy
destroy(this.p_save)
...
f_center_window(b1w_validkey_update_popup_3_x1)
is_validkey = ""
is_fromdt = ""
...
integer height = 856
integer taborder = 10
string dataobject = "b1dw_validkey_update_popup_3_x1"
