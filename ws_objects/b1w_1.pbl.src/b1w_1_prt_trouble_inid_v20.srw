$PBExportHeader$b1w_1_prt_trouble_inid_v20.srw
$PBExportComments$[jsha] IN Route별 장애보고서
forward
global type b1w_1_prt_trouble_inid_v20 from w_a_print
end type
end forward
...
global b1w_1_prt_trouble_inid_v20 b1w_1_prt_trouble_inid_v20

on b1w_1_prt_trouble_inid_v20.create
call super::create
end on

on b1w_1_prt_trouble_inid_v20.destroy
call super::destroy
end on
...
type dw_cond from w_a_print`dw_cond within b1w_1_prt_trouble_inid_v20
integer width = 2414
integer height = 336
...
type p_ok from w_a_print`p_ok within b1w_1_prt_trouble_inid_v20
integer x = 2633
end type

type p_close from w_a_print`p_close within b1w_1_prt_trouble_inid_v20
integer x = 2935
end type

type dw_list from w_a_print`dw_list within b1w_1_prt_trouble_inid_v20
integer x = 69
integer y = 428
string dataobject = "b1dw_1_prt_trouble_inid_v20"
end type

type p_1 from w_a_print`p_1 within b1w_1_prt_trouble_inid_v20
integer y = 1764
end type

type p_2 from w_a_print`p_2 within b1w_1_prt_trouble_inid_v20
integer y = 1764
end type

type p_3 from w_a_print`p_3 within b1w_1_prt_trouble_inid_v20
integer y = 1764
end type

type p_5 from w_a_print`p_5 within b1w_1_prt_trouble_inid_v20
integer y = 1764
end type

type p_6 from w_a_print`p_6 within b1w_1_prt_trouble_inid_v20
integer y = 1764
end type

type p_7 from w_a_print`p_7 within b1w_1_prt_trouble_inid_v20
integer y = 1764
end type

type p_8 from w_a_print`p_8 within b1w_1_prt_trouble_inid_v20
integer y = 1764
end type

type p_9 from w_a_print`p_9 within b1w_1_prt_trouble_inid_v20
integer y = 1764
end type

type p_4 from w_a_print`p_4 within b1w_1_prt_trouble_inid_v20
end type

type gb_1 from w_a_print`gb_1 within b1w_1_prt_trouble_inid_v20
integer y = 1724
end type

type p_port from w_a_print`p_port within b1w_1_prt_trouble_inid_v20
integer y = 1788
end type

type p_land from w_a_print`p_land within b1w_1_prt_trouble_inid_v20
integer y = 1800
end type

type gb_cond from w_a_print`gb_cond within b1w_1_prt_trouble_inid_v20
integer width = 2487
integer height = 396
end type

type p_saveas from w_a_print`p_saveas within b1w_1_prt_trouble_inid_v20
integer y = 1764
end type
