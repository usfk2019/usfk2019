$PBExportHeader$b1w_1_prt_trouble_sacnum_v20.srw
$PBExportComments$[jsha] 접속번호별 장애보고서
forward
global type b1w_1_prt_trouble_sacnum_v20 from w_a_print
end type
end forward
...
global b1w_1_prt_trouble_sacnum_v20 b1w_1_prt_trouble_sacnum_v20

on b1w_1_prt_trouble_sacnum_v20.create
call super::create
end on

on b1w_1_prt_trouble_sacnum_v20.destroy
call super::destroy
end on
...
type dw_cond from w_a_print`dw_cond within b1w_1_prt_trouble_sacnum_v20
integer width = 2423
integer height = 332
...
type p_ok from w_a_print`p_ok within b1w_1_prt_trouble_sacnum_v20
integer x = 2624
end type

type p_close from w_a_print`p_close within b1w_1_prt_trouble_sacnum_v20
integer x = 2926
end type

type dw_list from w_a_print`dw_list within b1w_1_prt_trouble_sacnum_v20
integer y = 412
string dataobject = "b1dw_1_prt_trouble_sacnum_v20"
end type

type p_1 from w_a_print`p_1 within b1w_1_prt_trouble_sacnum_v20
integer y = 1744
end type

type p_2 from w_a_print`p_2 within b1w_1_prt_trouble_sacnum_v20
integer y = 1744
end type

type p_3 from w_a_print`p_3 within b1w_1_prt_trouble_sacnum_v20
integer y = 1744
end type

type p_5 from w_a_print`p_5 within b1w_1_prt_trouble_sacnum_v20
integer y = 1744
end type

type p_6 from w_a_print`p_6 within b1w_1_prt_trouble_sacnum_v20
integer y = 1744
end type

type p_7 from w_a_print`p_7 within b1w_1_prt_trouble_sacnum_v20
integer y = 1744
end type

type p_8 from w_a_print`p_8 within b1w_1_prt_trouble_sacnum_v20
integer y = 1744
end type

type p_9 from w_a_print`p_9 within b1w_1_prt_trouble_sacnum_v20
integer y = 1744
end type

type p_4 from w_a_print`p_4 within b1w_1_prt_trouble_sacnum_v20
end type

type gb_1 from w_a_print`gb_1 within b1w_1_prt_trouble_sacnum_v20
integer y = 1704
end type

type p_port from w_a_print`p_port within b1w_1_prt_trouble_sacnum_v20
integer y = 1768
end type

type p_land from w_a_print`p_land within b1w_1_prt_trouble_sacnum_v20
integer y = 1780
end type

type gb_cond from w_a_print`gb_cond within b1w_1_prt_trouble_sacnum_v20
integer x = 27
integer width = 2482
integer height = 392
end type

type p_saveas from w_a_print`p_saveas within b1w_1_prt_trouble_sacnum_v20
integer y = 1744
end type
