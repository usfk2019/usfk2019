$PBExportHeader$b1w_hlp_contractmst.srw
$PBExportComments$[parkkh] Help 계약SEQ
forward
global type b1w_hlp_contractmst from w_a_hlp
end type
end forward
...
global b1w_hlp_contractmst b1w_hlp_contractmst

type variables
String is_status
end variables

on b1w_hlp_contractmst.create
call super::create
end on

on b1w_hlp_contractmst.destroy
call super::destroy
end on
...
iu_cust_help.is_data[1] = string(dw_hlp.Object.contractseq[al_selrow])		//ID

end event

type p_1 from w_a_hlp`p_1 within b1w_hlp_contractmst
integer x = 1385
integer y = 44
end type

type dw_cond from w_a_hlp`dw_cond within b1w_hlp_contractmst
integer x = 46
integer y = 44
integer width = 1221
integer height = 300
...
type p_ok from w_a_hlp`p_ok within b1w_hlp_contractmst
integer x = 1682
integer y = 44
end type

type p_close from w_a_hlp`p_close within b1w_hlp_contractmst
integer x = 1979
integer y = 44
end type

type gb_cond from w_a_hlp`gb_cond within b1w_hlp_contractmst
integer width = 1248
integer height = 352
end type

type dw_hlp from w_a_hlp`dw_hlp within b1w_hlp_contractmst
integer x = 27
integer y = 372
integer width = 3424
integer height = 1188
string dataobject = "b1dw_hlp_contractmst"
boolean livescroll = false
end type
