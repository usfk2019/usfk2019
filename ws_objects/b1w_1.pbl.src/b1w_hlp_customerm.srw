$PBExportHeader$b1w_hlp_customerm.srw
$PBExportComments$[ceusee] Help : 사용자 ID
forward
global type b1w_hlp_customerm from w_a_hlp
end type
end forward
...
global b1w_hlp_customerm b1w_hlp_customerm

on b1w_hlp_customerm.create
call super::create
end on

on b1w_hlp_customerm.destroy
call super::destroy
end on
...
type p_1 from w_a_hlp`p_1 within b1w_hlp_customerm
integer x = 2011
integer y = 52
end type

type dw_cond from w_a_hlp`dw_cond within b1w_hlp_customerm
integer x = 41
integer y = 44
integer width = 1847
integer height = 188
...
type p_ok from w_a_hlp`p_ok within b1w_hlp_customerm
integer x = 2313
integer y = 52
boolean originalsize = false
end type

type p_close from w_a_hlp`p_close within b1w_hlp_customerm
integer x = 2610
integer y = 52
end type

type gb_cond from w_a_hlp`gb_cond within b1w_hlp_customerm
integer x = 14
integer width = 1893
integer height = 248
end type

type dw_hlp from w_a_hlp`dw_hlp within b1w_hlp_customerm
integer x = 18
integer y = 276
integer width = 3017
integer height = 1476
string dataobject = "b1dw_hlp_customerm"
