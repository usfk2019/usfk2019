$PBExportHeader$b1w_hlp_logid.srw
$PBExportComments$[ceusee] LogID Check
forward
global type b1w_hlp_logid from w_a_hlp
end type
end forward
...
global b1w_hlp_logid b1w_hlp_logid

type variables

end variables

on b1w_hlp_logid.create
call super::create
end on

on b1w_hlp_logid.destroy
call super::destroy
end on
...
type p_1 from w_a_hlp`p_1 within b1w_hlp_logid
integer x = 562
integer y = 468
end type

type dw_cond from w_a_hlp`dw_cond within b1w_hlp_logid
integer x = 41
integer width = 1298
integer height = 132
...
type p_ok from w_a_hlp`p_ok within b1w_hlp_logid
integer x = 864
integer y = 472
end type

type p_close from w_a_hlp`p_close within b1w_hlp_logid
integer x = 1170
integer y = 472
end type

type gb_cond from w_a_hlp`gb_cond within b1w_hlp_logid
integer x = 23
integer width = 1344
integer height = 200
end type

type dw_hlp from w_a_hlp`dw_hlp within b1w_hlp_logid
integer x = 23
integer y = 232
integer width = 1454
integer height = 212
string dataobject = "b1dw_cnd_logid"
