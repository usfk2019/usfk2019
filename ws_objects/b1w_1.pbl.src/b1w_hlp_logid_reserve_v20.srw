$PBExportHeader$b1w_hlp_logid_reserve_v20.srw
$PBExportComments$[ohj] logid 중복체크 v20
forward
global type b1w_hlp_logid_reserve_v20 from w_a_hlp
end type
end forward
...
global b1w_hlp_logid_reserve_v20 b1w_hlp_logid_reserve_v20

type variables

end variables

on b1w_hlp_logid_reserve_v20.create
call super::create
end on

on b1w_hlp_logid_reserve_v20.destroy
call super::destroy
end on
...
type p_1 from w_a_hlp`p_1 within b1w_hlp_logid_reserve_v20
integer x = 562
integer y = 468
end type

type dw_cond from w_a_hlp`dw_cond within b1w_hlp_logid_reserve_v20
integer x = 41
integer width = 1298
integer height = 132
string dataobject = "b1dw_cnd_reg_logid_reserve_v20"
boolean livescroll = false
end type

type p_ok from w_a_hlp`p_ok within b1w_hlp_logid_reserve_v20
integer x = 864
integer y = 472
end type

type p_close from w_a_hlp`p_close within b1w_hlp_logid_reserve_v20
integer x = 1170
integer y = 472
end type

type gb_cond from w_a_hlp`gb_cond within b1w_hlp_logid_reserve_v20
integer x = 23
integer width = 1344
integer height = 200
end type

type dw_hlp from w_a_hlp`dw_hlp within b1w_hlp_logid_reserve_v20
integer x = 23
integer y = 232
integer width = 1454
integer height = 212
string dataobject = "b1dw_cnd_logid_reserve_v20"
