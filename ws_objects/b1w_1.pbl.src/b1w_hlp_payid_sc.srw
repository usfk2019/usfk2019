$PBExportHeader$b1w_hlp_payid_sc.srw
$PBExportComments$[parkkh] Help 납입자 ID
forward
global type b1w_hlp_payid_sc from w_a_hlp
end type
end forward
...
global b1w_hlp_payid_sc b1w_hlp_payid_sc

on b1w_hlp_payid_sc.create
call super::create
end on

on b1w_hlp_payid_sc.destroy
call super::destroy
end on
...
type p_1 from w_a_hlp`p_1 within b1w_hlp_payid_sc
integer x = 2007
integer y = 52
boolean originalsize = false
end type

type dw_cond from w_a_hlp`dw_cond within b1w_hlp_payid_sc
integer x = 32
integer y = 60
integer width = 1847
integer height = 208
string dataobject = "b1dw_cnd_hlp_payid_sc"
boolean livescroll = false
end type

type p_ok from w_a_hlp`p_ok within b1w_hlp_payid_sc
integer x = 2304
integer y = 52
boolean originalsize = false
end type

type p_close from w_a_hlp`p_close within b1w_hlp_payid_sc
integer x = 2597
integer y = 52
end type

type gb_cond from w_a_hlp`gb_cond within b1w_hlp_payid_sc
integer x = 18
integer width = 1883
integer height = 296
end type

type dw_hlp from w_a_hlp`dw_hlp within b1w_hlp_payid_sc
integer x = 23
integer y = 308
integer width = 3003
integer height = 1448
string dataobject = "b1dw_hlp_payid_sc"
boolean livescroll = false
end type
