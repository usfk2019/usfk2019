$PBExportHeader$b1w_hlp_validkeymst.srw
$PBExportComments$[parkkh] Help 인증MST
forward
global type b1w_hlp_validkeymst from w_a_hlp
end type
end forward
...
global b1w_hlp_validkeymst b1w_hlp_validkeymst

type variables
String is_bonsa_partner, is_validkey_gubun
end variables

on b1w_hlp_validkeymst.create
call super::create
end on

on b1w_hlp_validkeymst.destroy
call super::destroy
end on
...
//2005.03.17 파라미터값이  Y일때 유치처가 가지고 있는 인증key만 조회 하여 개통신청할 수 있다.
If is_validkey_gubun = 'Y' Then
...
Else
	...
	IF is_data[3] <> is_bonsa_partner Then
		If is_data[2] = "Y" and is_data[3] <> "" Then
...
type p_1 from w_a_hlp`p_1 within b1w_hlp_validkeymst
integer x = 1563
integer y = 44
end type

type dw_cond from w_a_hlp`dw_cond within b1w_hlp_validkeymst
integer y = 56
integer width = 1262
integer height = 280
string dataobject = "b1dw_cnd_hlp_validkeymst"
boolean livescroll = false
end type

type p_ok from w_a_hlp`p_ok within b1w_hlp_validkeymst
integer x = 1861
integer y = 44
end type

type p_close from w_a_hlp`p_close within b1w_hlp_validkeymst
integer x = 2158
integer y = 44
end type

type gb_cond from w_a_hlp`gb_cond within b1w_hlp_validkeymst
integer width = 1326
integer height = 352
end type

type dw_hlp from w_a_hlp`dw_hlp within b1w_hlp_validkeymst
integer x = 27
integer y = 372
integer width = 3424
integer height = 1188
string dataobject = "b1dw_hlp_validkeymst"
boolean livescroll = false
end type
