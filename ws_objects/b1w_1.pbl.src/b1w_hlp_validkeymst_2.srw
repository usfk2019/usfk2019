$PBExportHeader$b1w_hlp_validkeymst_2.srw
$PBExportComments$[parkkh] Help 인증MST
forward
global type b1w_hlp_validkeymst_2 from w_a_hlp
end type
end forward
...
global b1w_hlp_validkeymst_2 b1w_hlp_validkeymst_2

type variables
String is_bonsa_partner, is_validkey_gubun
end variables

on b1w_hlp_validkeymst_2.create
call super::create
end on

on b1w_hlp_validkeymst_2.destroy
call super::destroy
end on
...
type p_1 from w_a_hlp`p_1 within b1w_hlp_validkeymst_2
integer x = 1563
integer y = 44
end type

type dw_cond from w_a_hlp`dw_cond within b1w_hlp_validkeymst_2
integer y = 56
integer width = 1262
integer height = 280
...
type p_ok from w_a_hlp`p_ok within b1w_hlp_validkeymst_2
integer x = 1861
integer y = 44
end type

type p_close from w_a_hlp`p_close within b1w_hlp_validkeymst_2
integer x = 2158
integer y = 44
end type

type gb_cond from w_a_hlp`gb_cond within b1w_hlp_validkeymst_2
integer width = 1326
integer height = 352
end type

type dw_hlp from w_a_hlp`dw_hlp within b1w_hlp_validkeymst_2
integer x = 27
integer y = 372
integer width = 3424
integer height = 1188
