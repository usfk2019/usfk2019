$PBExportHeader$b1w_inq_cdryyyymmdd_1_v20_1.srw
$PBExportComments$[ssong] 고객관리/일자별통화내역
forward
global type b1w_inq_cdryyyymmdd_1_v20_1 from w_a_inq_m
end type
type dw_tmp from u_d_base within b1w_inq_cdryyyymmdd_1_v20_1
end type
type p_1 from u_p_saveas within b1w_inq_cdryyyymmdd_1_v20_1
end type
end forward
...
global b1w_inq_cdryyyymmdd_1_v20_1 b1w_inq_cdryyyymmdd_1_v20_1
...
on b1w_inq_cdryyyymmdd_1_v20_1.create
int iCurrent
call super::create
...
on b1w_inq_cdryyyymmdd_1_v20_1.destroy
call super::destroy
destroy(this.dw_tmp)
destroy(this.p_1)
end on
...
String ls_stime_fr, ls_stime_to, ls_pbxno, ls_inid, ls_outid
...
ls_inid = Trim(dw_cond.object.inid[1])
ls_outid = Trim(dw_cond.object.outid[1])
is_table = Trim(dw_cond.object.table[1])
...
If Isnull(ls_inid) Then ls_inid = ""
If Isnull(ls_outid) Then ls_outid = ""
If Isnull(is_table) Then is_table = ""

//2005.12.07 table추가 svctype선택 
If is_table = "" Then
	f_msg_info(200, Title, "Table 구분")
	dw_cond.SetFocus()
	dw_cond.setColumn("table")
	Return 
End If
...
If ls_stime_to <> "" Then
		If ls_stime_fr <> "" Then
			If ls_stime_fr > ls_stime_to Then
				f_msg_info(200, Title, "통화일자(From) <= 통화일자(To)")
				Return
			End If
		End If
	End If
...
type dw_cond from w_a_inq_m`dw_cond within b1w_inq_cdryyyymmdd_1_v20_1
integer x = 59
integer y = 60
integer width = 3022
integer height = 420
string dataobject = "b1dw_cnd_inq_cdryyyymmdd_1_v20_1"
...
type p_ok from w_a_inq_m`p_ok within b1w_inq_cdryyyymmdd_1_v20_1
integer x = 3154
integer y = 68
end type

type p_close from w_a_inq_m`p_close within b1w_inq_cdryyyymmdd_1_v20_1
integer x = 3456
integer y = 68
boolean originalsize = false
end type

type gb_cond from w_a_inq_m`gb_cond within b1w_inq_cdryyyymmdd_1_v20_1
integer width = 3058
integer height = 496
end type

type dw_detail from w_a_inq_m`dw_detail within b1w_inq_cdryyyymmdd_1_v20_1
integer y = 536
integer width = 3991
integer height = 1388
string dataobject = "b1dw_inq_cdryyyymmdd_1_v20_1"
end type
