$PBExportHeader$b1w_inq_inv_detail_vtel.srw
$PBExportComments$[parkkh] 청구 및 사용내역 상세 조회
forward
global type b1w_inq_inv_detail_vtel from w_a_inq_m_tm
end type
type dw_cond2 from u_d_help within b1w_inq_inv_detail_vtel
end type
type p_find from u_p_find within b1w_inq_inv_detail_vtel
end type
type p_saveas from u_p_saveas within b1w_inq_inv_detail_vtel
end type
end forward
...
global b1w_inq_inv_detail_vtel b1w_inq_inv_detail_vtel
...
on b1w_inq_inv_detail_vtel.create
int iCurrent
call super::create
...
on b1w_inq_inv_detail_vtel.destroy
call super::destroy
...
type dw_cond from w_a_inq_m_tm`dw_cond within b1w_inq_inv_detail_vtel
integer x = 37
integer y = 44
integer width = 2158
integer height = 132
...
type p_ok from w_a_inq_m_tm`p_ok within b1w_inq_inv_detail_vtel
integer x = 2341
integer y = 36
end type

type p_close from w_a_inq_m_tm`p_close within b1w_inq_inv_detail_vtel
integer x = 2638
integer y = 36
end type

type gb_cond from w_a_inq_m_tm`gb_cond within b1w_inq_inv_detail_vtel
integer x = 23
integer width = 2190
integer height = 192
end type

type dw_master from w_a_inq_m_tm`dw_master within b1w_inq_inv_detail_vtel
integer x = 23
integer y = 204
integer width = 3310
integer height = 604
...
type tab_1 from w_a_inq_m_tm`tab_1 within b1w_inq_inv_detail_vtel
integer y = 844
integer width = 3314
integer height = 892
end type
...
Choose Case ai_select_tabpage
	Case 1, 2																//Tab 1, Tab 2
		...
		lu_dbmgr2 = CREATE b1u_dbmgr2_vtel
		
		lu_dbmgr2.is_caller = "b1dw_inq_inv_detail_t1_vtel%tabpage_retrieve"
...
type st_horizontal from w_a_inq_m_tm`st_horizontal within b1w_inq_inv_detail_vtel
integer y = 808
integer height = 40
end type
