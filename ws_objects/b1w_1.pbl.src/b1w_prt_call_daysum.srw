$PBExportHeader$b1w_prt_call_daysum.srw
$PBExportComments$[kem] 사업자정산이용요금일자별합계조회
forward
global type b1w_prt_call_daysum from w_a_print
end type
type dw_tmp from u_d_base within b1w_prt_call_daysum
end type
end forward
...
global b1w_prt_call_daysum b1w_prt_call_daysum
...
on b1w_prt_call_daysum.destroy
call super::destroy
destroy(this.dw_tmp)
end on
...
type dw_cond from w_a_print`dw_cond within b1w_prt_call_daysum
event ue_saveas_int ( )
integer y = 48
integer width = 2734
integer height = 376
string dataobject = "b1dw_cnd_prt_call_daysum"
...
type p_ok from w_a_print`p_ok within b1w_prt_call_daysum
integer x = 2949
integer y = 64
end type

type p_close from w_a_print`p_close within b1w_prt_call_daysum
integer x = 2949
integer y = 176
end type

type dw_list from w_a_print`dw_list within b1w_prt_call_daysum
integer y = 472
integer width = 3241
integer height = 1156
string dataobject = "b1dw_prt_call_daysum"
end type

type p_1 from w_a_print`p_1 within b1w_prt_call_daysum
end type

type p_2 from w_a_print`p_2 within b1w_prt_call_daysum
end type

type p_3 from w_a_print`p_3 within b1w_prt_call_daysum
end type

type p_5 from w_a_print`p_5 within b1w_prt_call_daysum
end type

type p_6 from w_a_print`p_6 within b1w_prt_call_daysum
end type

type p_7 from w_a_print`p_7 within b1w_prt_call_daysum
end type

type p_8 from w_a_print`p_8 within b1w_prt_call_daysum
end type

type p_9 from w_a_print`p_9 within b1w_prt_call_daysum
end type

type p_4 from w_a_print`p_4 within b1w_prt_call_daysum
end type

type gb_1 from w_a_print`gb_1 within b1w_prt_call_daysum
end type

type p_port from w_a_print`p_port within b1w_prt_call_daysum
end type

type p_land from w_a_print`p_land within b1w_prt_call_daysum
end type

type gb_cond from w_a_print`gb_cond within b1w_prt_call_daysum
integer width = 2793
integer height = 444
end type

type p_saveas from w_a_print`p_saveas within b1w_prt_call_daysum
end type
