$PBExportHeader$b1w_reg_customer_d_v20_sams.srw
$PBExportComments$[1hera] 고객정보 등록 v20
forward
global type b1w_reg_customer_d_v20_sams from w_a_reg_m_tm2
end type
type p_view from u_p_view within b1w_reg_customer_d_v20_sams
end type
end forward
...
global b1w_reg_customer_d_v20_sams b1w_reg_customer_d_v20_sams
...
on b1w_reg_customer_d_v20_sams.create
int iCurrent
call super::create
...
on b1w_reg_customer_d_v20_sams.destroy
call super::destroy
destroy(this.p_view)
end on
...
Else
	...
	If ( ls_value   = ""  Or ls_name     = "" ) And &
	   ( ls_value_1 = ""  Or ls_location = "" ) Then
	...
	If ls_value <> "" Then
		...
		Choose Case ls_value
			...
			Case "ssno"
				ls_where += "cus.socialsecurity like '" + ls_name + "%' "
			Case "corpnm"
				ls_where += "cus.corpnm like '" + ls_name + "%' "
			Case "phone1"
				ls_where += "cus.homephone like '" + ls_name + "%' "
			Case "key"
...
Choose Case li_tab
	Case 1		//Tab 1 고객정보
		If ib_new = True Then
			...
			tab_1.idw_tabpage[li_tab].object.partner[li_tab] 				= is_bonsa
...
String 	ls_firstnm, ls_lastnm, ls_midnm
...
Choose Case li_tab
	Case 1
		...
		lu_check.is_caller 	= "b1w_reg_customer_c_v20%save_tab1"
		lu_check.is_title 	= Title
		lu_check.ii_data[1] 	= li_tab
...
type dw_cond from w_a_reg_m_tm2`dw_cond within b1w_reg_customer_d_v20_sams
integer x = 82
integer y = 52
integer width = 2373
integer height = 200
string dataobject = "b1dw_1_cnd_reg_customer_sams"
end type
...
type p_ok from w_a_reg_m_tm2`p_ok within b1w_reg_customer_d_v20_sams
integer x = 2779
integer y = 40
end type

event p_ok::clicked;call super::clicked;messagebox("bb", 'bb')
end event

type p_close from w_a_reg_m_tm2`p_close within b1w_reg_customer_d_v20_sams
integer x = 3081
integer y = 40
end type

type gb_cond from w_a_reg_m_tm2`gb_cond within b1w_reg_customer_d_v20_sams
integer x = 37
integer width = 2478
integer height = 280
end type

type dw_master from w_a_reg_m_tm2`dw_master within b1w_reg_customer_d_v20_sams
integer y = 296
integer width = 3534
integer height = 568
string dataobject = "b1dw_1_inq_customer_sams"
end type
...
type p_insert from w_a_reg_m_tm2`p_insert within b1w_reg_customer_d_v20_sams
integer y = 2056
end type

type p_delete from w_a_reg_m_tm2`p_delete within b1w_reg_customer_d_v20_sams
integer y = 2056
end type

type p_save from w_a_reg_m_tm2`p_save within b1w_reg_customer_d_v20_sams
integer x = 622
integer y = 2056
end type

type p_reset from w_a_reg_m_tm2`p_reset within b1w_reg_customer_d_v20_sams
integer x = 1207
integer y = 2056
end type

type tab_1 from w_a_reg_m_tm2`tab_1 within b1w_reg_customer_d_v20_sams
integer y = 912
integer width = 3534
integer height = 1116
...
//is_tab_title[12] = "선납판매정보"
//is_tab_title[13] = "민원접수내역"
//is_tab_title[14] = "단축Key정보조회"
//
//Tab에 해당하는 dw
//is_dwObject[1] = "b1dw_reg_customer_t1_v20"	//고객관리대리점 추가 ohj 0707
//is_dwObject[2] = "b1dw_reg_customer_t2_1_v20"
//is_dwObject[3] = "b1dw_reg_customer_t3_v20"  //2005.0707 ohj언어 맨트수정
//is_dwObject[4] = "b1dw_reg_customer_t4"
//is_dwObject[5] = "b1dw_reg_customer_t5"
//is_dwObject[6] = "b1dw_reg_customer_t6_1"
...
//is_dwObject[10] = "b1dw_reg_particular_zoncst_v20"  //"b1dw_reg_customer_t11_1"
//is_dwObject[11] = "b0dw_reg_blacklist_a"  //"b1dw_reg_customer_t12"
//is_dwObject[12] = "b1dw_reg_customer_t14"
//is_dwObject[13] = "b1dw_reg_customer_t13_v20"
//is_dwObject[14] = "b1dw_reg_customer_t15_v20"
...
type st_horizontal from w_a_reg_m_tm2`st_horizontal within b1w_reg_customer_d_v20_sams
integer y = 868
end type
