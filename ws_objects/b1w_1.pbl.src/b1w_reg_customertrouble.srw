$PBExportHeader$b1w_reg_customertrouble.srw
$PBExportComments$[parkkh] 고객 민원접수 및 처리
forward
global type b1w_reg_customertrouble from w_a_reg_m_tm2
end type
end forward
...
global b1w_reg_customertrouble b1w_reg_customertrouble
...
on b1w_reg_customertrouble.create
int iCurrent
call super::create
end on

on b1w_reg_customertrouble.destroy
call super::destroy
end on
...
lu_check.is_caller = "b1w_reg_customermtrouble%extra_save"
...
type dw_cond from w_a_reg_m_tm2`dw_cond within b1w_reg_customertrouble
integer x = 41
integer y = 44
integer width = 2523
integer height = 268
string dataobject = "b1dw_cnd_reg_customeridtrouble"
...
type p_ok from w_a_reg_m_tm2`p_ok within b1w_reg_customertrouble
integer x = 2693
end type

type p_close from w_a_reg_m_tm2`p_close within b1w_reg_customertrouble
integer x = 2994
boolean originalsize = false
end type

type gb_cond from w_a_reg_m_tm2`gb_cond within b1w_reg_customertrouble
integer width = 2551
integer height = 348
end type

type dw_master from w_a_reg_m_tm2`dw_master within b1w_reg_customertrouble
integer y = 364
integer width = 3250
integer height = 592
string dataobject = "b1dw_reg_customeridtrouble_m"
end type
...
type p_insert from w_a_reg_m_tm2`p_insert within b1w_reg_customertrouble
integer y = 1916
end type

type p_delete from w_a_reg_m_tm2`p_delete within b1w_reg_customertrouble
integer y = 1916
end type

type p_save from w_a_reg_m_tm2`p_save within b1w_reg_customertrouble
integer y = 1916
end type

type p_reset from w_a_reg_m_tm2`p_reset within b1w_reg_customertrouble
integer y = 1916
end type

type tab_1 from w_a_reg_m_tm2`tab_1 within b1w_reg_customertrouble
integer y = 996
integer width = 3209
...
is_dwobject[1] = "b1dw_reg_customertrouble_t1"
...
type st_horizontal from w_a_reg_m_tm2`st_horizontal within b1w_reg_customertrouble
integer y = 964
end type
