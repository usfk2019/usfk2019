$PBExportHeader$b1w_reg_customertrouble_2.srw
$PBExportComments$[ceusee] 민원 등록 2
forward
global type b1w_reg_customertrouble_2 from w_a_reg_m_tm2
end type
end forward
...
global b1w_reg_customertrouble_2 b1w_reg_customertrouble_2
...
on b1w_reg_customertrouble_2.create
int iCurrent
call super::create
end on

on b1w_reg_customertrouble_2.destroy
call super::destroy
end on
...
lu_check.is_caller = "b1w_reg_customermtrouble_2%extra_save"
...
If li_tab_index = 2 Then //2번째 Tab이면
...
type dw_cond from w_a_reg_m_tm2`dw_cond within b1w_reg_customertrouble_2
integer x = 41
integer y = 44
integer width = 2523
integer height = 356
string dataobject = "b1dw_cnd_reg_customeridtrouble_2"
...
type p_ok from w_a_reg_m_tm2`p_ok within b1w_reg_customertrouble_2
integer x = 2693
end type

type p_close from w_a_reg_m_tm2`p_close within b1w_reg_customertrouble_2
integer x = 2994
boolean originalsize = false
end type

type gb_cond from w_a_reg_m_tm2`gb_cond within b1w_reg_customertrouble_2
integer width = 2551
integer height = 436
end type

type dw_master from w_a_reg_m_tm2`dw_master within b1w_reg_customertrouble_2
integer y = 448
integer width = 3237
integer height = 644
string dataobject = "b1dw_reg_customeridtrouble_m_2"
end type
...
type p_insert from w_a_reg_m_tm2`p_insert within b1w_reg_customertrouble_2
integer y = 2068
end type

type p_delete from w_a_reg_m_tm2`p_delete within b1w_reg_customertrouble_2
integer y = 2068
end type

type p_save from w_a_reg_m_tm2`p_save within b1w_reg_customertrouble_2
integer y = 2068
end type

type p_reset from w_a_reg_m_tm2`p_reset within b1w_reg_customertrouble_2
integer y = 2068
end type

type tab_1 from w_a_reg_m_tm2`tab_1 within b1w_reg_customertrouble_2
integer y = 1144
integer width = 3209
...
is_dwobject[1] = "b1dw_reg_customertrouble_t1_2"
is_dwobject[2] = "b1dw_reg_customertrouble_t2_2"
...
li_seltab = tab_1.SelectedTab
Long ll_row, i
String ls_filter, ls_itemcod, ls_admodel_yn
DataWindowChild ldc, ldwc_troubletype
...
String ls_where, ls_admodel_yn, ls_troubletype, ls_troubletypea, ls_troubletypeb, ls_troubletypec
String ls_filter
Long ll_row, i
Dec lc_troubleno
Int li_rc
...
Choose Case ai_select_tabpage
	Case 1								//Tab 1
	   ...
	   ls_filter = "troubletypea = '" + ls_troubletypea + "' "
		...
		//색깔 Setting
      Select admodel_yn into :ls_admodel_yn from troubletypemst where troubletype = :ls_troubletype;
	...
	Case 2								//Tab 2
	  ...
	  Next
		...
		Else
			...
			idw_tabpage[ai_select_tabpage].object.troubl_response_response_note2.Protect = 0
			idw_tabpage[ai_select_tabpage].object.troubl_response_trouble_status.Protect = 0
			idw_tabpage[ai_select_tabpage].object.close_yn.Protect = 0
				idw_tabpage[ai_select_tabpage].object.partner.Protect = 0
			...
			idw_tabpage[ai_select_tabpage].object.troubl_response_response_note.Color = RGB(0,0,0)
			idw_tabpage[ai_select_tabpage].object.troubl_response_response_note.BackGround.Color = RGB(255,255,255)
			idw_tabpage[ai_select_tabpage].object.troubl_response_response_note2.Color = RGB(0,0,0)
			idw_tabpage[ai_select_tabpage].object.troubl_response_response_note2.BackGround.Color = RGB(255,255,255)
			idw_tabpage[ai_select_tabpage].object.troubl_response_trouble_status.Color = RGB(255,255,255)
			idw_tabpage[ai_select_tabpage].object.troubl_response_trouble_status.BackGround.Color = RGB(108,147,137)
			idw_tabpage[ai_select_tabpage].object.close_yn.Color = RGB(0,0,0)
			idw_tabpage[ai_select_tabpage].object.close_yn.BackGround.Color = RGB(255,255,255)
			idw_tabpage[ai_select_tabpage].object.partner.Color = RGB(0,0,0)
			idw_tabpage[ai_select_tabpage].object.partner.BackGround.Color = RGB(255,255,255)
		End If
...
type st_horizontal from w_a_reg_m_tm2`st_horizontal within b1w_reg_customertrouble_2
integer y = 1100
end type
