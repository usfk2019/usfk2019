$PBExportHeader$b1w_reg_customertrouble_v20.srw
$PBExportComments$[jwlee] 민원 등록 V20
forward
global type b1w_reg_customertrouble_v20 from w_a_reg_m_tm2
end type
type uo_1 from u_calendar_sams within b1w_reg_customertrouble_v20
end type
end forward
...
global b1w_reg_customertrouble_v20 b1w_reg_customertrouble_v20
...
on b1w_reg_customertrouble_v20.create
int iCurrent
call super::create
...
on b1w_reg_customertrouble_v20.destroy
call super::destroy
destroy(this.uo_1)
end on
...
type dw_cond from w_a_reg_m_tm2`dw_cond within b1w_reg_customertrouble_v20
integer x = 96
integer y = 44
integer width = 2720
integer height = 448
string dataobject = "b1dw_cnd_reg_customeridtrouble_v20"
...
type p_ok from w_a_reg_m_tm2`p_ok within b1w_reg_customertrouble_v20
integer x = 2949
integer y = 56
end type

type p_close from w_a_reg_m_tm2`p_close within b1w_reg_customertrouble_v20
integer x = 1207
integer y = 2400
boolean originalsize = false
end type

type gb_cond from w_a_reg_m_tm2`gb_cond within b1w_reg_customertrouble_v20
integer width = 3237
integer height = 500
end type

type dw_master from w_a_reg_m_tm2`dw_master within b1w_reg_customertrouble_v20
integer y = 532
integer width = 3237
integer height = 1024
string dataobject = "b1dw_reg_customeridtrouble_m_v20"
end type
...
STRING	ls_result[],		ls_closeyn,			ls_status,			ls_user
...
type p_insert from w_a_reg_m_tm2`p_insert within b1w_reg_customertrouble_v20
integer y = 2400
end type

type p_delete from w_a_reg_m_tm2`p_delete within b1w_reg_customertrouble_v20
integer y = 2400
end type

type p_save from w_a_reg_m_tm2`p_save within b1w_reg_customertrouble_v20
integer x = 622
integer y = 2400
end type

type p_reset from w_a_reg_m_tm2`p_reset within b1w_reg_customertrouble_v20
integer x = 914
integer y = 2400
end type

type tab_1 from w_a_reg_m_tm2`tab_1 within b1w_reg_customertrouble_v20
integer y = 1592
integer width = 3209
integer height = 772
integer weight = 700
...
is_dwobject[1] = "b1dw_reg_customertrouble_t1_v20"
is_dwobject[2] = "b1dw_reg_customertrouble_t2_v20"
is_dwobject[3] = "b1dw_reg_customertrouble_t3_v20"
end event
...
event type long tab_1::ue_dw_doubleclicked(integer ai_tabpage, integer ai_xpos, integer ai_ypos, long al_row, dwobject adwo_dwo);call super::ue_dw_doubleclicked;String ls_customerid, ls_filter, ls_sql
Long   ll_cnt
...
String ls_filter, ls_prefixno, ls_status, ls_receipt_user, ls_EMP_GROUP, ls_customerid, ls_sql
...
int li_i, ll_cnt
dec lc_troubleno
String ls_closeyn, ls_status, ls_user
...
type st_horizontal from w_a_reg_m_tm2`st_horizontal within b1w_reg_customertrouble_v20
integer y = 1556
end type
