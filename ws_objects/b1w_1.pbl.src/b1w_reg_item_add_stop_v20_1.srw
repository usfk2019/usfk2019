$PBExportHeader$b1w_reg_item_add_stop_v20_1.srw
$PBExportComments$[ohj] 푸목추가사용 및 사용중지 v20
forward
global type b1w_reg_item_add_stop_v20_1 from w_a_reg_m
end type
end forward
...
global b1w_reg_item_add_stop_v20_1 b1w_reg_item_add_stop_v20_1
...
on b1w_reg_item_add_stop_v20_1.create
call super::create
end on

on b1w_reg_item_add_stop_v20_1.destroy
call super::destroy
end on
...
type dw_cond from w_a_reg_m`dw_cond within b1w_reg_item_add_stop_v20_1
integer x = 59
integer y = 80
integer width = 827
integer height = 116
...
type p_ok from w_a_reg_m`p_ok within b1w_reg_item_add_stop_v20_1
integer x = 1577
end type

type p_close from w_a_reg_m`p_close within b1w_reg_item_add_stop_v20_1
integer x = 1883
end type

type gb_cond from w_a_reg_m`gb_cond within b1w_reg_item_add_stop_v20_1
integer x = 37
integer y = 4
integer width = 1335
integer height = 224
...
type p_delete from w_a_reg_m`p_delete within b1w_reg_item_add_stop_v20_1
end type

type p_insert from w_a_reg_m`p_insert within b1w_reg_item_add_stop_v20_1
end type

type p_save from w_a_reg_m`p_save within b1w_reg_item_add_stop_v20_1
end type

type dw_detail from w_a_reg_m`dw_detail within b1w_reg_item_add_stop_v20_1
integer x = 37
integer y = 252
integer width = 2391
integer height = 1316
...
type p_reset from w_a_reg_m`p_reset within b1w_reg_item_add_stop_v20_1
end type
