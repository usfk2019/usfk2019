$PBExportHeader$b1w_reg_itemchange_popup_v20.srw
$PBExportComments$[ohj] 품목사용 popup v20
forward
global type b1w_reg_itemchange_popup_v20 from w_a_reg_m
end type
type gb_1 from gb_cond within b1w_reg_itemchange_popup_v20
end type
end forward
...
global b1w_reg_itemchange_popup_v20 b1w_reg_itemchange_popup_v20
...
on b1w_reg_itemchange_popup_v20.create
int iCurrent
call super::create
...
on b1w_reg_itemchange_popup_v20.destroy
call super::destroy
destroy(this.gb_1)
end on
...
integer  li_return, li_exist
String   ls_where, ls_ref_desc, ls_temp, ls_requestdt, ls_method, ls_bilfromdt, &
         ls_cu_date, ls_bil_todt, ls_filter
Date   ldt_bilfromdt, ldt_date_next, ldt_date_next_1, ld_frdt, ld_todt, ld_currdate
DataWindowChild ldc_itemcod

//window 중앙에
f_center_window(b1w_reg_itemchange_popup_v20)
...
ld_currdate    = iu_cust_msg.id_data[6]
...
dw_detail.Object.itemcod_old[1] = is_itemcod
dw_detail.Object.bil_fromdt[1]  = ld_frdt

li_exist = dw_detail.GetChild("itemcod", ldc_itemcod)		//DDDW 구함목
If li_exist = -1 Then f_msg_usr_err(2100, Title, "GetChild() : 품목")
ls_filter = "a.priceplan = '" + is_priceplan  + "' And a.grouptype = 0 "
...
event type integer ue_extra_save();Long    ll_row, ll_cnt, ll_type, i, ll_type_1
String ls_itemcod
...
ls_itemcod = fs_snvl(dw_detail.object.itemcod[1], '')

If ls_itemcod  = '' Then
	f_msg_usr_err(210, Title, "변경할 품목을 선택하세요")
	dw_detail.SetColumn("itemcod")
	return -1
End If

If ls_itemcod = is_itemcod Then
	f_msg_usr_err(210, Title, "변경할 품목을 다시 선택 하세요")
	dw_detail.SetColumn("itemcod")
	return -1
End If
...
type dw_cond from w_a_reg_m`dw_cond within b1w_reg_itemchange_popup_v20
...
type p_ok from w_a_reg_m`p_ok within b1w_reg_itemchange_popup_v20
boolean visible = false
integer x = 585
integer y = 1228
end type

type p_close from w_a_reg_m`p_close within b1w_reg_itemchange_popup_v20
integer x = 859
integer y = 428
boolean originalsize = false
end type

type gb_cond from w_a_reg_m`gb_cond within b1w_reg_itemchange_popup_v20
boolean visible = false
integer x = 14
integer y = 552
end type

type p_delete from w_a_reg_m`p_delete within b1w_reg_itemchange_popup_v20
boolean visible = false
integer x = 50
integer y = 1432
end type

type p_insert from w_a_reg_m`p_insert within b1w_reg_itemchange_popup_v20
boolean visible = false
end type

type p_save from w_a_reg_m`p_save within b1w_reg_itemchange_popup_v20
integer x = 553
integer y = 428
boolean enabled = true
end type

type dw_detail from w_a_reg_m`dw_detail within b1w_reg_itemchange_popup_v20
integer x = 64
integer y = 60
integer width = 1152
integer height = 276
integer taborder = 20
string dataobject = "b1dw_reg_itemchange_v20"
boolean hscrollbar = false
boolean vscrollbar = false
...
type p_reset from w_a_reg_m`p_reset within b1w_reg_itemchange_popup_v20
boolean visible = false
integer x = 270
integer y = 1224
boolean enabled = true
