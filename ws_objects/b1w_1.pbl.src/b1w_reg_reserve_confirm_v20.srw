$PBExportHeader$b1w_reg_reserve_confirm_v20.srw
$PBExportComments$[ohj] 서비스 가입예약확정처리 v20
forward
global type b1w_reg_reserve_confirm_v20 from w_a_reg_m
end type
type bt_detail from commandbutton within b1w_reg_reserve_confirm_v20
end type
type bt_customer from commandbutton within b1w_reg_reserve_confirm_v20
end type
type bt_active from commandbutton within b1w_reg_reserve_confirm_v20
end type
type gb_1 from groupbox within b1w_reg_reserve_confirm_v20
end type
end forward
...
global b1w_reg_reserve_confirm_v20 b1w_reg_reserve_confirm_v20
...
on b1w_reg_reserve_confirm_v20.create
int iCurrent
call super::create
...
on b1w_reg_reserve_confirm_v20.destroy
call super::destroy
...
type dw_cond from w_a_reg_m`dw_cond within b1w_reg_reserve_confirm_v20
integer y = 60
integer width = 2491
integer height = 252
...
type p_ok from w_a_reg_m`p_ok within b1w_reg_reserve_confirm_v20
integer x = 2693
end type

type p_close from w_a_reg_m`p_close within b1w_reg_reserve_confirm_v20
integer x = 2999
end type

type gb_cond from w_a_reg_m`gb_cond within b1w_reg_reserve_confirm_v20
integer width = 2546
integer height = 328
end type

type p_delete from w_a_reg_m`p_delete within b1w_reg_reserve_confirm_v20
end type

type p_insert from w_a_reg_m`p_insert within b1w_reg_reserve_confirm_v20
end type

type p_save from w_a_reg_m`p_save within b1w_reg_reserve_confirm_v20
end type

type dw_detail from w_a_reg_m`dw_detail within b1w_reg_reserve_confirm_v20
integer x = 50
integer y = 476
integer width = 3227
integer height = 1064
...
type p_reset from w_a_reg_m`p_reset within b1w_reg_reserve_confirm_v20
end type
...
If ls_svctype = ls_svctype_cu Then
	OpenSheetWithParm(b1w_reg_svc_actorder_pre_reserve_v20, iu_cust_msg, w_mdi_main, 1, Layered!)  

ElseIf ls_svctype_1 = ls_svctype_cu Then
	OpenSheetWithParm(b1w_reg_svc_actorder_reserve_v20, iu_cust_msg, w_mdi_main, 1, Layered!)  
