$PBExportHeader$b1w_reg_svc_actorder_pre_3_v20_mh.srw
$PBExportComments$[ohj]서비스개통신청-선불제 v20
forward
global type b1w_reg_svc_actorder_pre_3_v20_mh from w_a_reg_m_m3
end type
end forward
...
global b1w_reg_svc_actorder_pre_3_v20_mh b1w_reg_svc_actorder_pre_3_v20_mh
...
String  is_reg_partner, is_customerid, is_in_svctype
String   is_out_svctype, is_inout_svc_gu, is_validkey_type
string is_callforward_type, is_callforward_code[], is_addition_itemcod
end variables
...
on b1w_reg_svc_actorder_pre_3_v20_mh.create
call super::create
end on

on b1w_reg_svc_actorder_pre_3_v20_mh.destroy
call super::destroy
end on

event open;/*------------------------------------------------------------------------
	Name	:	b1w_reg_svc_actorder_pre_3_v20_mh
	Desc	: 	서비스 신청
	Ver.	:	1.0
	Date	:   2004.05.21
...
string ls_ref_desc, ls_temp, ls_result[], ls_direct_paytype, ls_method_code[]
...
Long ll_row, ll_result//, ll_endday
...
lu_dbmgr.is_caller = "b1w_reg_svc_actorder_pre_3_v20_moohan%save"
...
lu_dbmgr.il_data[1] = 1                          // return  값때문에....
...
//IF is_inout_svc_gu = 'N' Then    //입출중계서비스가 아닐 경우
	OpenWithParm(b1w_reg_svcorder_validinfo_pop_v20_mh, iu_cust_msg)
//Else                             //입출중계서비스일 경우
...
type dw_cond from w_a_reg_m_m3`dw_cond within b1w_reg_svc_actorder_pre_3_v20_mh
integer x = 69
integer y = 52
integer width = 2578
integer height = 1004
...
Choose Case dwo.name
	Case "customerid" 		
   		wfi_get_customerid(data)		
			...
			If ls_customernm <>"" Then dw_cond.object.svccod.Protect = 0
...
//		dw_cond.Object.endday[1] = ll_endday
	...
	Case "pricemodel"
		...
		//ls_prebil_yn = dw_cond.Object.prebil_yn[1]
		...
		If fs_snvl(ls_prebil_yn, 'N') = 'N' Then   //기간제 선납상품이 아니면... ohj 2005.06.27
			If ls_enddt = "" Then
	//   		2005.06.27  ohj 주석처리....
				SELECT EXTDAYS
				  INTO :ll_extdays
...
//		
//		If fs_snvl(ls_prebil_yn, 'N') = 'Y' Then   //기간제 선납상품이면... ohj 2005.06.27
//					
...
type p_ok from w_a_reg_m_m3`p_ok within b1w_reg_svc_actorder_pre_3_v20_mh
integer x = 2766
integer y = 140
end type

type p_close from w_a_reg_m_m3`p_close within b1w_reg_svc_actorder_pre_3_v20_mh
integer x = 2766
integer y = 276
boolean originalsize = false
end type

type gb_cond from w_a_reg_m_m3`gb_cond within b1w_reg_svc_actorder_pre_3_v20_mh
integer x = 41
integer y = 4
integer width = 2624
integer height = 1068
...
type dw_master from w_a_reg_m_m3`dw_master within b1w_reg_svc_actorder_pre_3_v20_mh
...
type dw_detail from w_a_reg_m_m3`dw_detail within b1w_reg_svc_actorder_pre_3_v20_mh
integer y = 1700
integer width = 3045
integer height = 344
integer taborder = 30
...
type p_insert from w_a_reg_m_m3`p_insert within b1w_reg_svc_actorder_pre_3_v20_mh
integer x = 46
integer y = 2064
end type

type p_delete from w_a_reg_m_m3`p_delete within b1w_reg_svc_actorder_pre_3_v20_mh
integer x = 379
integer y = 2064
end type

type p_save from w_a_reg_m_m3`p_save within b1w_reg_svc_actorder_pre_3_v20_mh
integer x = 713
integer y = 2064
end type

type p_reset from w_a_reg_m_m3`p_reset within b1w_reg_svc_actorder_pre_3_v20_mh
integer x = 1463
integer y = 2064
end type

type dw_detail2 from w_a_reg_m_m3`dw_detail2 within b1w_reg_svc_actorder_pre_3_v20_mh
integer x = 37
integer y = 1124
integer width = 3040
integer height = 528
...
type st_horizontal2 from w_a_reg_m_m3`st_horizontal2 within b1w_reg_svc_actorder_pre_3_v20_mh
integer y = 1080
integer height = 36
end type

type st_horizontal from w_a_reg_m_m3`st_horizontal within b1w_reg_svc_actorder_pre_3_v20_mh
boolean visible = false
integer y = 1660
integer height = 36
end type
