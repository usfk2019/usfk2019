$PBExportHeader$b1w_reg_svc_actorder_reserve_v20_1.srw
$PBExportComments$[ohj]서비스후불개통신청, 예약개통확정처리
forward
global type b1w_reg_svc_actorder_reserve_v20_1 from w_a_reg_m_m3
end type
end forward
...
global b1w_reg_svc_actorder_reserve_v20_1 b1w_reg_svc_actorder_reserve_v20_1
...
on b1w_reg_svc_actorder_reserve_v20_1.create
call super::create
end on

on b1w_reg_svc_actorder_reserve_v20_1.destroy
call super::destroy
end on
...
String ls_svccod, ls_priceplan, ls_customerid, ls_validtype, ls_currency_type, &
       ls_filter, ls_partner1
Long   li_exist
...
ls_customerid = iu_cust_msg.is_data[4]
ls_validtype  = iu_cust_msg.is_data[3]

dw_cond.object.svccod[1]        = ls_svccod
dw_cond.object.priceplan[1]     = ls_priceplan
dw_cond.object.customerid[1]    = ls_customerid
dw_cond.object.validkey_type[1] = ls_validtype

wfi_get_customerid(ls_customerid)
dw_cond.object.svccod.Protect     = 1
dw_cond.object.priceplan.Protect  = 1
...
ls_filter = "a.priceplan = '" + ls_priceplan  + "'  " 
...
String ls_langtype, ls_ref_desc, ls_temp, ls_result[]
...
type dw_cond from w_a_reg_m_m3`dw_cond within b1w_reg_svc_actorder_reserve_v20_1
integer x = 64
integer y = 60
integer width = 3365
integer height = 1004
integer taborder = 40
string dataobject = "b1dw_cnd_reg_svc_actorder_v20"
boolean hscrollbar = false
boolean vscrollbar = false
boolean livescroll = false
end type

event dw_cond::itemchanged;call super::itemchanged;DataWindowChild ldc_priceplan, ldc_svcpromise, ldc_svccod, ldc_vprice, ldc_validkey_type
...
type p_ok from w_a_reg_m_m3`p_ok within b1w_reg_svc_actorder_reserve_v20_1
integer x = 3589
integer y = 56
end type

type p_close from w_a_reg_m_m3`p_close within b1w_reg_svc_actorder_reserve_v20_1
integer x = 3589
integer y = 172
boolean originalsize = false
end type

type gb_cond from w_a_reg_m_m3`gb_cond within b1w_reg_svc_actorder_reserve_v20_1
integer x = 41
integer y = 4
integer width = 3415
integer height = 1072
...
type dw_master from w_a_reg_m_m3`dw_master within b1w_reg_svc_actorder_reserve_v20_1
...
type dw_detail from w_a_reg_m_m3`dw_detail within b1w_reg_svc_actorder_reserve_v20_1
integer x = 46
integer y = 1816
integer width = 4064
integer height = 592
...
event dw_detail::doubleclicked;call super::doubleclicked;This.accepttext()
...
type p_insert from w_a_reg_m_m3`p_insert within b1w_reg_svc_actorder_reserve_v20_1
integer x = 55
integer y = 2468
end type

type p_delete from w_a_reg_m_m3`p_delete within b1w_reg_svc_actorder_reserve_v20_1
integer x = 347
integer y = 2468
end type

type p_save from w_a_reg_m_m3`p_save within b1w_reg_svc_actorder_reserve_v20_1
integer x = 640
integer y = 2468
end type

type p_reset from w_a_reg_m_m3`p_reset within b1w_reg_svc_actorder_reserve_v20_1
integer x = 1390
integer y = 2468
end type

type dw_detail2 from w_a_reg_m_m3`dw_detail2 within b1w_reg_svc_actorder_reserve_v20_1
integer x = 41
integer y = 1112
integer width = 4064
integer height = 664
...
//				ll_groupno_1   = This.object.groupno[i]
				...
				If ll_grouptype = ll_grouptype_1  Then
					This.object.chk[i] = "N"
				End If
...
type st_horizontal2 from w_a_reg_m_m3`st_horizontal2 within b1w_reg_svc_actorder_reserve_v20_1
integer x = 37
integer y = 1076
integer height = 36
end type
...
type st_horizontal from w_a_reg_m_m3`st_horizontal within b1w_reg_svc_actorder_reserve_v20_1
boolean visible = false
integer x = 41
integer y = 1780
integer height = 36
