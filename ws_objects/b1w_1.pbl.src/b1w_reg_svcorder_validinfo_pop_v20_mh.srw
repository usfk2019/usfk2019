$PBExportHeader$b1w_reg_svcorder_validinfo_pop_v20_mh.srw
$PBExportComments$[parkkh]서비스개통신청인증정보등록/조회
forward
global type b1w_reg_svcorder_validinfo_pop_v20_mh from w_a_reg_m
end type
type p_cancel from u_p_cancel within b1w_reg_svcorder_validinfo_pop_v20_mh
end type
type cb_callingnum from commandbutton within b1w_reg_svcorder_validinfo_pop_v20_mh
end type
end forward
...
global b1w_reg_svcorder_validinfo_pop_v20_mh b1w_reg_svcorder_validinfo_pop_v20_mh
...
on b1w_reg_svcorder_validinfo_pop_v20_mh.create
int iCurrent
call super::create
...
on b1w_reg_svcorder_validinfo_pop_v20_mh.destroy
call super::destroy
...
//window 중앙에
f_center_window(b1w_reg_svcorder_validinfo_pop_v20_mh)
...
type dw_cond from w_a_reg_m`dw_cond within b1w_reg_svcorder_validinfo_pop_v20_mh
...
type p_ok from w_a_reg_m`p_ok within b1w_reg_svcorder_validinfo_pop_v20_mh
boolean visible = false
integer x = 585
integer y = 1228
end type

type p_close from w_a_reg_m`p_close within b1w_reg_svcorder_validinfo_pop_v20_mh
boolean visible = false
integer x = 2021
integer y = 684
...
type gb_cond from w_a_reg_m`gb_cond within b1w_reg_svcorder_validinfo_pop_v20_mh
boolean visible = false
end type

type p_delete from w_a_reg_m`p_delete within b1w_reg_svcorder_validinfo_pop_v20_mh
boolean visible = false
integer x = 50
integer y = 1432
end type

type p_insert from w_a_reg_m`p_insert within b1w_reg_svcorder_validinfo_pop_v20_mh
boolean visible = false
end type

type p_save from w_a_reg_m`p_save within b1w_reg_svcorder_validinfo_pop_v20_mh
integer x = 2816
integer y = 952
...
type dw_detail from w_a_reg_m`dw_detail within b1w_reg_svcorder_validinfo_pop_v20_mh
integer y = 52
integer width = 3072
integer height = 804
integer taborder = 20
...
type p_reset from w_a_reg_m`p_reset within b1w_reg_svcorder_validinfo_pop_v20_mh
boolean visible = false
integer x = 270
integer y = 1224
boolean enabled = true
