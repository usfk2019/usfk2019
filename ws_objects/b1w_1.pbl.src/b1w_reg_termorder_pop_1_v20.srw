$PBExportHeader$b1w_reg_termorder_pop_1_v20.srw
$PBExportComments$[parkkh] 납입고객 전체고객 해지신청(위약그포함)
forward
global type b1w_reg_termorder_pop_1_v20 from w_a_reg_m
end type
type p_termorder from commandbutton within b1w_reg_termorder_pop_1_v20
end type
end forward
...
global b1w_reg_termorder_pop_1_v20 b1w_reg_termorder_pop_1_v20
...
string ls_temp, ls_result_code[],ls_validkeystatus,ls_validkeystatus1
Datetime ldt_crtdt
...
//		End If		 
	...
	If is_act_gu = 'Y' Then 
		...
		End If	
			...
			UPDATE CONTRACTDET
			   SET BIL_TODT = DECODE(NVL(BIL_TODT, ''), '', to_date(:is_enddt, 'yyyy-mm-dd')
				  , (DECODE(sign(BIL_TODT - to_date(:is_enddt, 'yyyy-mm-dd'))
				  , -1, BIL_TODT
				  ,  1, to_date(:is_enddt, 'yyyy-mm-dd')
				  ,  0, BIL_TODT                                            )))
			 WHERE to_char(contractseq) = :ls_contractseq;
...
on b1w_reg_termorder_pop_1_v20.create
int iCurrent
call super::create
...
on b1w_reg_termorder_pop_1_v20.destroy
call super::destroy
...
//window 중앙에
f_center_window(b1w_reg_termorder_pop_1_v20)
...
ls_customernm = iu_cust_msg.is_data[12]  	//고객명

dw_cond.object.payid[1] = is_payid
dw_cond.object.paynm[1] = ls_customernm
...
type dw_cond from w_a_reg_m`dw_cond within b1w_reg_termorder_pop_1_v20
integer x = 41
integer y = 44
integer width = 3218
integer height = 316
integer taborder = 10
string dataobject = "b1dw_cnd_reg_termorder_pop_v20"
boolean hscrollbar = false
boolean vscrollbar = false
boolean livescroll = false
end type

event dw_cond::itemchanged;call super::itemchanged;String ls_act_gu
date ldt_date
...
Choose Case dwo.name
	Case "termdt" 
		...
		If ls_act_gu = 'Y' Then
			This.object.enddt[row] = relativedate(This.object.termdt[row], -1)
		End If
...
type p_ok from w_a_reg_m`p_ok within b1w_reg_termorder_pop_1_v20
integer x = 3328
integer y = 64
end type

type p_close from w_a_reg_m`p_close within b1w_reg_termorder_pop_1_v20
integer x = 3634
integer y = 64
boolean originalsize = false
end type

type gb_cond from w_a_reg_m`gb_cond within b1w_reg_termorder_pop_1_v20
integer width = 3246
integer height = 380
end type

type p_delete from w_a_reg_m`p_delete within b1w_reg_termorder_pop_1_v20
boolean visible = false
integer x = 50
integer y = 1432
end type

type p_insert from w_a_reg_m`p_insert within b1w_reg_termorder_pop_1_v20
boolean visible = false
end type

type p_save from w_a_reg_m`p_save within b1w_reg_termorder_pop_1_v20
boolean visible = false
integer x = 2482
integer y = 132
integer height = 168
...
type dw_detail from w_a_reg_m`dw_detail within b1w_reg_termorder_pop_1_v20
integer y = 388
integer width = 3904
integer height = 1000
integer taborder = 20
string dataobject = "b1dw_reg_termorder_pop_v20"
end type

event dw_detail::constructor;call super::constructor;dw_detail.SetRowFocusIndicator(off!)
end event

type p_reset from w_a_reg_m`p_reset within b1w_reg_termorder_pop_1_v20
boolean visible = false
integer x = 2757
integer y = 124
