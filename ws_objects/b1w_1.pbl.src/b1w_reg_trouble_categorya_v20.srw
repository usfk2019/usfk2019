$PBExportHeader$b1w_reg_trouble_categorya_v20.srw
$PBExportComments$[chooys] 민원유형 소분류등록
forward
global type b1w_reg_trouble_categorya_v20 from w_a_reg_m
end type
end forward
...
global b1w_reg_trouble_categorya_v20 b1w_reg_trouble_categorya_v20

on b1w_reg_trouble_categorya_v20.create
call super::create
end on

on b1w_reg_trouble_categorya_v20.destroy
call super::destroy
end on
...
type dw_cond from w_a_reg_m`dw_cond within b1w_reg_trouble_categorya_v20
integer x = 41
integer y = 64
integer width = 2377
integer height = 144
...
type p_ok from w_a_reg_m`p_ok within b1w_reg_trouble_categorya_v20
integer x = 2583
integer y = 44
boolean originalsize = false
end type

type p_close from w_a_reg_m`p_close within b1w_reg_trouble_categorya_v20
integer x = 2889
integer y = 44
boolean originalsize = false
end type

type gb_cond from w_a_reg_m`gb_cond within b1w_reg_trouble_categorya_v20
integer y = 4
integer width = 2409
integer height = 240
end type

type p_delete from w_a_reg_m`p_delete within b1w_reg_trouble_categorya_v20
integer x = 334
integer y = 1736
end type

type p_insert from w_a_reg_m`p_insert within b1w_reg_trouble_categorya_v20
integer y = 1736
end type

type p_save from w_a_reg_m`p_save within b1w_reg_trouble_categorya_v20
integer x = 635
integer y = 1736
end type

type dw_detail from w_a_reg_m`dw_detail within b1w_reg_trouble_categorya_v20
integer y = 272
integer width = 3227
integer height = 1408
string dataobject = "b1dw_reg_trouble_categorya_v20"
end type

event dw_detail::itemchanged;call super::itemchanged;String ls_category_c, ls_svccod

//품목중분류 선택시 품목대분류 자동 뿌려줌!!
Choose Case dwo.Name
	Case "troubletypea_troubletypeb"
		SELECT troubletypec, svccod
		INTO :ls_category_c, :ls_svccod
		FROM troubletypeb
...
type p_reset from w_a_reg_m`p_reset within b1w_reg_trouble_categorya_v20
integer x = 1193
integer y = 1736
end type
