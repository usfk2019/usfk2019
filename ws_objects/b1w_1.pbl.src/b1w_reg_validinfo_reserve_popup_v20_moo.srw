$PBExportHeader$b1w_reg_validinfo_reserve_popup_v20_moo.srw
$PBExportComments$[kem]서비스개통신청인증정보등록/조회 예약 - moohan
forward
global type b1w_reg_validinfo_reserve_popup_v20_moo from w_a_reg_m
end type
type p_cancel from u_p_cancel within b1w_reg_validinfo_reserve_popup_v20_moo
end type
type cb_callingnum from commandbutton within b1w_reg_validinfo_reserve_popup_v20_moo
end type
end forward
...
global b1w_reg_validinfo_reserve_popup_v20_moo b1w_reg_validinfo_reserve_popup_v20_moo
...
String is_close_gu, is_validitem_yn, is_used_level, is_used_level_h, is_gubun
Long il_row
datawindow idw_data
...
If is_validkey_type <> "" Then
	...
	//예약 개통처리시... type 수정 안되게...
	If is_gubun = '1' Then
		dw_detail.object.validkey_type.Protect = 1
	End If
...
on b1w_reg_validinfo_reserve_popup_v20_moo.create
int iCurrent
call super::create
...
on b1w_reg_validinfo_reserve_popup_v20_moo.destroy
call super::destroy
...
event open;call super::open;/*------------------------------------------------------------------------
	Name	:	b1w_reg_validinfo_reserve_popup_v20
...
//window 중앙에
f_center_window(b1w_reg_validinfo_reserve_popup_v20_moo)
...
is_gubun = iu_cust_msg.is_data[9]             //예약관련 구분... 인증key type protect
...
type dw_cond from w_a_reg_m`dw_cond within b1w_reg_validinfo_reserve_popup_v20_moo
...
type p_ok from w_a_reg_m`p_ok within b1w_reg_validinfo_reserve_popup_v20_moo
boolean visible = false
integer x = 585
integer y = 1228
end type

type p_close from w_a_reg_m`p_close within b1w_reg_validinfo_reserve_popup_v20_moo
boolean visible = false
integer x = 1961
integer y = 736
end type

type gb_cond from w_a_reg_m`gb_cond within b1w_reg_validinfo_reserve_popup_v20_moo
boolean visible = false
end type

type p_delete from w_a_reg_m`p_delete within b1w_reg_validinfo_reserve_popup_v20_moo
boolean visible = false
integer x = 50
integer y = 1432
end type

type p_insert from w_a_reg_m`p_insert within b1w_reg_validinfo_reserve_popup_v20_moo
boolean visible = false
end type

type p_save from w_a_reg_m`p_save within b1w_reg_validinfo_reserve_popup_v20_moo
integer x = 2798
integer y = 924
...
type dw_detail from w_a_reg_m`dw_detail within b1w_reg_validinfo_reserve_popup_v20_moo
integer y = 52
integer width = 3072
integer height = 800
integer taborder = 20
string dataobject = "b1dw_reg_svcorder_validinfo_pop_v20_mh"
end type
...
type p_reset from w_a_reg_m`p_reset within b1w_reg_validinfo_reserve_popup_v20_moo
boolean visible = false
integer x = 270
integer y = 1224
boolean enabled = true
