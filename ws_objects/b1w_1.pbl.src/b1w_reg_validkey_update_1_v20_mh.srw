$PBExportHeader$b1w_reg_validkey_update_1_v20_mh.srw
$PBExportComments$[ohj] 인증key 변경/추가/해지 v20
forward
global type b1w_reg_validkey_update_1_v20_mh from w_a_reg_m
end type
type p_change from u_p_change within b1w_reg_validkey_update_1_v20_mh
end type
type p_add from u_p_add within b1w_reg_validkey_update_1_v20_mh
end type
type p_term from u_p_term within b1w_reg_validkey_update_1_v20_mh
end type
end forward
...
global b1w_reg_validkey_update_1_v20_mh b1w_reg_validkey_update_1_v20_mh

type variables
String is_fromdt, is_validkey, is_status
String is_svctype_post, is_svctype_pre 
b1u_dbmgr4_v20 iu_check
...
iu_check = Create b1u_dbmgr4_v20
iu_check.is_caller = "b1w_reg_validkey_update_1_v20_moohan%ue_change"
...
OpenWithParm(b1w_validkey_update_popup_1_1_v20_mh, iu_cust_msg)
...
iu_check = Create b1u_dbmgr4_v20
iu_check.is_caller = "b1w_reg_validkey_update_1_v20_moohan%ue_add"
iu_check.is_title = This.Title
iu_check.idw_data[1] = dw_cond
...
OpenWithParm(b1w_validkey_update_popup_2_1_v20_mh, iu_cust_msg)
...
//인증Key 후불서비스인지
iu_check = Create b1u_dbmgr4_v20
iu_check.is_caller = "b1w_reg_validkey_update_1_v20_moohan%ue_term"
iu_check.is_title = This.Title
iu_check.idw_data[1] = dw_cond
iu_check.is_data[1] = ls_validkey     //인증KEY
//is_data[2] = is_fromdt
...
OpenWithParm(b1w_validkey_update_popup_3_1_v20_mh, iu_cust_msg)


end event

on b1w_reg_validkey_update_1_v20_mh.create
int iCurrent
call super::create
...
on b1w_reg_validkey_update_1_v20_mh.destroy
call super::destroy
...
type dw_cond from w_a_reg_m`dw_cond within b1w_reg_validkey_update_1_v20_mh
integer x = 41
integer y = 56
integer width = 1047
integer height = 216
...
type p_ok from w_a_reg_m`p_ok within b1w_reg_validkey_update_1_v20_mh
...
type p_close from w_a_reg_m`p_close within b1w_reg_validkey_update_1_v20_mh
integer x = 2139
boolean originalsize = false
end type

type gb_cond from w_a_reg_m`gb_cond within b1w_reg_validkey_update_1_v20_mh
integer width = 1129
end type

type p_delete from w_a_reg_m`p_delete within b1w_reg_validkey_update_1_v20_mh
boolean visible = false
integer x = 50
integer y = 1432
end type

type p_insert from w_a_reg_m`p_insert within b1w_reg_validkey_update_1_v20_mh
boolean visible = false
end type

type p_save from w_a_reg_m`p_save within b1w_reg_validkey_update_1_v20_mh
boolean visible = false
integer x = 1330
integer y = 84
integer height = 168
...
type dw_detail from w_a_reg_m`dw_detail within b1w_reg_validkey_update_1_v20_mh
boolean visible = false
integer y = 52
integer width = 1257
integer height = 280
...
type p_reset from w_a_reg_m`p_reset within b1w_reg_validkey_update_1_v20_mh
boolean visible = false
integer x = 270
integer y = 1224
