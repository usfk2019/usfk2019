$PBExportHeader$b1w_validkey_update_popup_2_1_v20_mh.srw
$PBExportComments$[ohj] 인증 Key 추가 v20
forward
global type b1w_validkey_update_popup_2_1_v20_mh from w_base
end type
type cb_callingnum from commandbutton within b1w_validkey_update_popup_2_1_v20_mh
end type
type dw_detail from u_d_help within b1w_validkey_update_popup_2_1_v20_mh
end type
type p_save from u_p_save within b1w_validkey_update_popup_2_1_v20_mh
end type
type p_close from u_p_close within b1w_validkey_update_popup_2_1_v20_mh
end type
type ln_2 from line within b1w_validkey_update_popup_2_1_v20_mh
end type
end forward
...
global b1w_validkey_update_popup_2_1_v20_mh b1w_validkey_update_popup_2_1_v20_mh

type variables
String  is_contractseq, is_itemcod, is_svctype, is_status
...
string is_addition_itemcod,is_addition_code,is_callforward_yn
...
lu_dbmgr.is_caller = "b1w_validkey_update_popup_2_1_v20_moohan%ue_save"
...
on b1w_validkey_update_popup_2_1_v20_mh.create
int iCurrent
call super::create
...
on b1w_validkey_update_popup_2_1_v20_mh.destroy
call super::destroy
...
event open;call super::open;/*------------------------------------------------------------------------
	Nmae	: b1w_validkey_update_popup_2_1_v20
	Desc	: 인증KEY 추가
	Ver	: 	2.0
	Date	: 	2005.05.04
	Programer : ohj
	            Modify kem 2005.11.09
-------------------------------------------------------------------------*/
String ls_customerid, ls_customernm, ls_ref_desc, ls_temp, ls_result[]
Long ll_i

f_center_window(b1w_validkey_update_popup_2_1_v20_mh)
...
IF is_svctype = is_svctype_post Then
	dw_detail.dataObject = "b1dw_validkey_update_popup_2_1_v20_mh"
    dw_detail.Trigger Event Constructor()
Elseif is_svctype = is_svctype_pre Then
	dw_detail.dataObject = "b1dw_validkey_update_popup_2_pre_v20_mh"
    dw_detail.Trigger Event Constructor()	
End If
...
integer height = 1272
integer taborder = 10
string dataobject = "b1dw_validkey_update_popup_2_pre_v20_mh"
