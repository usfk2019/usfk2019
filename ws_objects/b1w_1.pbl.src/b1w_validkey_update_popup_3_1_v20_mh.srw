$PBExportHeader$b1w_validkey_update_popup_3_1_v20_mh.srw
$PBExportComments$[ohj] 인증 Key 해지 v20
forward
global type b1w_validkey_update_popup_3_1_v20_mh from w_base
end type
type p_save from u_p_save within b1w_validkey_update_popup_3_1_v20_mh
end type
type p_close from u_p_close within b1w_validkey_update_popup_3_1_v20_mh
end type
type dw_detail from u_d_sort within b1w_validkey_update_popup_3_1_v20_mh
end type
type ln_2 from line within b1w_validkey_update_popup_3_1_v20_mh
end type
end forward
...
global b1w_validkey_update_popup_3_1_v20_mh b1w_validkey_update_popup_3_1_v20_mh
...
IF ii_validkeytype_cnt > 0 Then
	...
	lu_dbmgr.is_caller = "b1w_validkey_update_popup_3_1_v20_moohan%ue_save"
...
on b1w_validkey_update_popup_3_1_v20_mh.create
int iCurrent
call super::create
...
on b1w_validkey_update_popup_3_1_v20_mh.destroy
call super::destroy
destroy(this.p_save)
...
f_center_window(b1w_validkey_update_popup_3_1_v20_mh)
is_validkey = ""
is_fromdt = ""
...
integer height = 968
integer taborder = 10
string dataobject = "b1dw_validkey_update_popup_3_1_v20_mh"
