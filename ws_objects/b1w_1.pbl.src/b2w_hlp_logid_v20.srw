$PBExportHeader$b2w_hlp_logid_v20.srw
$PBExportComments$[jsha] LogID Check
forward
global type b2w_hlp_logid_v20 from w_a_hlp
end type
end forward
...
global b2w_hlp_logid_v20 b2w_hlp_logid_v20

type variables

end variables

on b2w_hlp_logid_v20.create
call super::create
end on

on b2w_hlp_logid_v20.destroy
call super::destroy
end on
...
type p_1 from w_a_hlp`p_1 within b2w_hlp_logid_v20
integer x = 567
integer y = 488
end type

type dw_cond from w_a_hlp`dw_cond within b2w_hlp_logid_v20
integer x = 27
integer width = 1230
integer height = 184
...
type p_ok from w_a_hlp`p_ok within b2w_hlp_logid_v20
integer x = 869
integer y = 488
end type

type p_close from w_a_hlp`p_close within b2w_hlp_logid_v20
integer x = 1170
integer y = 488
end type

type gb_cond from w_a_hlp`gb_cond within b2w_hlp_logid_v20
integer x = 23
integer width = 1266
integer height = 240
end type

type dw_hlp from w_a_hlp`dw_hlp within b2w_hlp_logid_v20
integer x = 23
integer y = 252
integer width = 1454
integer height = 216
string dataobject = "b2dw_cnd_logid_v20"
