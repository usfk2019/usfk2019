$PBExportHeader$b2w_reg_partnermst_v20.srw
$PBExportComments$[kem] 대리점정보등록(com&life)
forward
global type b2w_reg_partnermst_v20 from w_a_reg_m_tm2
end type
end forward
...
global b2w_reg_partnermst_v20 b2w_reg_partnermst_v20

type variables
Boolean ib_new			//신규 등록  True
String is_check, is_root
Long		il_oldnum, il_newnum
...
on b2w_reg_partnermst_v20.create
int iCurrent
call super::create
end on

on b2w_reg_partnermst_v20.destroy
call super::destroy
end on
...
Choose Case ai_selected_tab
	...
	Case 4
		ls_partner = dw_master.object.partner[ll_master_row]
		tab_1.idw_tabpage[ai_selected_tab].object.shopid[al_insert_row]  	= ls_partner
		tab_1.idw_tabpage[ai_selected_tab].object.crtdt[al_insert_row]    = fdt_get_dbserver_now()
		tab_1.idw_tabpage[ai_selected_tab].object.crt_user[al_insert_row] = gs_user_id
	Case 5 // ADD 2006-12-07
		ls_partner = dw_master.object.partner[ll_master_row]
		tab_1.idw_tabpage[ai_selected_tab].object.partner[al_insert_row]   	= ls_partner
		tab_1.idw_tabpage[ai_selected_tab].object.fromdt[al_insert_row]    	= fdt_get_dbserver_now()
		tab_1.idw_tabpage[ai_selected_tab].object.crt_dt[al_insert_row]     	= fdt_get_dbserver_now()
		tab_1.idw_tabpage[ai_selected_tab].object.crt_user[al_insert_row]  	= gs_user_id
		tab_1.idw_tabpage[ai_selected_tab].object.updt_dt[al_insert_row]    	= fdt_get_dbserver_now()		//등록일자
		tab_1.idw_tabpage[ai_selected_tab].object.updt_user[al_insert_row] 	= gs_user_id
		tab_1.idw_tabpage[ai_selected_tab].object.pgm_id[al_insert_row]    	= gs_pgm_id[gi_open_win_no]
	Case 6
		ls_partner = dw_master.object.partner[ll_master_row]
...
String ls_groupid,	ls_regtype,	 ls_keynum
...
Choose Case ai_select_tab
	Case 1
		...
		ls_groupid 		= Trim(tab_1.idw_tabpage[ai_select_tab].object.group_id[ll_row])
		...
		// ADD 2007-1-10 -- Start
		If IsNull(ls_groupid) 	Then ls_groupid = ""
		If ls_groupid = "" Then
			f_msg_usr_err(200, title, "Shop Group")
			tab_1.idw_tabpage[ai_select_tab].SetFocus()
			tab_1.idw_tabpage[ai_select_tab].SetColumn("group_id")
			Return -2
		End If
		// Add END..
	...
	Case 6
		...
		tab_1.idw_tabpage[ai_select_tab].AcceptText()
		//필수 Check
		ls_partner 		= Trim(tab_1.idw_tabpage[ai_select_tab].object.shopid[ll_row])
		ls_regtype  	= Trim(tab_1.idw_tabpage[ai_select_tab].object.regtype[ll_row])
		ls_keynum	 	= Trim(tab_1.idw_tabpage[ai_select_tab].object.keynum[ll_row])

		If IsNull(ls_partner) 	Then ls_partner 	= ""
		If IsNull(ls_regtype)	Then ls_regtype	= ""
		If IsNull(ls_keynum) 	Then ls_keynum 	= ""

		If ls_partner = "" Then
			f_msg_usr_err(200, title, "Shop ID")
			tab_1.idw_tabpage[ai_select_tab].SetFocus()
			tab_1.idw_tabpage[ai_select_tab].SetColumn("regtype")
			Return -2
		End If
		...
		If ls_keynum = "" Then
			f_msg_usr_err(200, title, "Shop Key")
			tab_1.idw_tabpage[ai_select_tab].SetFocus()
			tab_1.idw_tabpage[ai_select_tab].SetColumn("keynum")
			Return -2
		End If
...
type dw_cond from w_a_reg_m_tm2`dw_cond within b2w_reg_partnermst_v20
integer x = 55
integer y = 40
integer width = 2665
integer height = 240
...
type p_ok from w_a_reg_m_tm2`p_ok within b2w_reg_partnermst_v20
integer x = 2889
integer y = 56
end type

type p_close from w_a_reg_m_tm2`p_close within b2w_reg_partnermst_v20
integer x = 3195
integer y = 56
boolean originalsize = false
end type

type gb_cond from w_a_reg_m_tm2`gb_cond within b2w_reg_partnermst_v20
integer width = 2747
integer height = 292
end type

type dw_master from w_a_reg_m_tm2`dw_master within b2w_reg_partnermst_v20
integer y = 320
integer width = 3470
integer height = 604
...
type p_insert from w_a_reg_m_tm2`p_insert within b2w_reg_partnermst_v20
integer y = 1920
end type

type p_delete from w_a_reg_m_tm2`p_delete within b2w_reg_partnermst_v20
integer y = 1920
end type

type p_save from w_a_reg_m_tm2`p_save within b2w_reg_partnermst_v20
integer y = 1920
end type

type p_reset from w_a_reg_m_tm2`p_reset within b2w_reg_partnermst_v20
integer y = 1920
end type

type tab_1 from w_a_reg_m_tm2`tab_1 within b2w_reg_partnermst_v20
integer y = 964
integer width = 3461
integer height = 928
...
//is_tab_title[12] = "Facillity Index"
//is_tab_title[13] = "Schedule"
//
//
//is_dwobject[1] = "b2dw_reg_partnermst_t1_v20"
...
//is_dwobject[12]= "b2dw_reg_partnermst_t12"
//is_dwobject[13]= "b2dw_reg_partnermst_t13_ssrt"
//

is_tab_title[1] = "기초정보"
is_tab_title[2] = "WebID관리"
is_tab_title[3] = "가격정책"
is_tab_title[4] = "Facillity Index"
is_tab_title[5] = "Schedule"
is_tab_title[6] = "Shop Key"


is_dwobject[1] = "b2dw_reg_partnermst_t1_v20"
is_dwobject[2] = "b2dw_reg_partnermst_t7_v20"
is_dwobject[3] = "b2dw_reg_partnermst_t6"
is_dwobject[4] = "b2dw_reg_partnermst_t12"
is_dwobject[5] = "b2dw_reg_partnermst_t13_ssrt"
is_dwobject[6] = "b2dw_reg_partnermst_t14"
end event
...
event tab_1::selectionchanging;//1  Prevent the selection from changing
String ls_credit_yn, ls_partner
Long ll_master_row
...
type st_horizontal from w_a_reg_m_tm2`st_horizontal within b2w_reg_partnermst_v20
integer y = 924
end type
