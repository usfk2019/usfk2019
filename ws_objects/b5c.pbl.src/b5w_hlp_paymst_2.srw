$PBExportHeader$b5w_hlp_paymst_2.srw
$PBExportComments$[kwon] Help : 납입자 번호/명
forward
global type b5w_hlp_paymst_2 from w_a_hlp
end type
end forward
...
global b5w_hlp_paymst_2 b5w_hlp_paymst_2

on b5w_hlp_paymst_2.create
call super::create
end on

on b5w_hlp_paymst_2.destroy
call super::destroy
end on
...
String ls_paytypenm
String ls_trdt, ls_marknm 
Long   ll_row

dw_cond.object.value[1] = "customerid" //Customerid를 조건으로 찾는다.
dw_cond.object.name[1] = is_data[3]

//
If iu_cust_help.is_data[3] <> "" Then
	Post Event ue_find()
//	Parent.TriggerEvent('ue_find')
End If

//ll_row = dw_detail.Retrieve(as_payid)
//If ll_row < 0 Then
...
type p_1 from w_a_hlp`p_1 within b5w_hlp_paymst_2
integer x = 2021
integer y = 44
boolean originalsize = false
end type

type dw_cond from w_a_hlp`dw_cond within b5w_hlp_paymst_2
integer x = 50
integer y = 56
integer width = 1861
integer height = 184
string dataobject = "b5d_cnd_hlp_paymst_2"
end type

type p_ok from w_a_hlp`p_ok within b5w_hlp_paymst_2
integer x = 2322
integer y = 44
boolean originalsize = false
end type

type p_close from w_a_hlp`p_close within b5w_hlp_paymst_2
integer x = 2624
integer y = 44
end type

type gb_cond from w_a_hlp`gb_cond within b5w_hlp_paymst_2
integer x = 23
integer y = 4
integer width = 1902
integer height = 256
...
type dw_hlp from w_a_hlp`dw_hlp within b5w_hlp_paymst_2
integer x = 23
integer y = 284
integer width = 3026
integer height = 1476
string dataobject = "b5d_hlp_paymst_2"
end type
