$PBExportHeader$b5w_hlp_paymst_hotbill.srw
$PBExportComments$[ceusee] Hotbill 처리된 납입자
forward
global type b5w_hlp_paymst_hotbill from w_a_hlp
end type
end forward
...
global b5w_hlp_paymst_hotbill b5w_hlp_paymst_hotbill

on b5w_hlp_paymst_hotbill.create
call super::create
end on

on b5w_hlp_paymst_hotbill.destroy
call super::destroy
end on
...
type p_1 from w_a_hlp`p_1 within b5w_hlp_paymst_hotbill
integer x = 2021
integer y = 52
integer height = 92
...
type dw_cond from w_a_hlp`dw_cond within b5w_hlp_paymst_hotbill
integer x = 46
integer y = 60
integer width = 1847
integer height = 200
...
type p_ok from w_a_hlp`p_ok within b5w_hlp_paymst_hotbill
integer x = 2318
integer y = 52
boolean originalsize = false
end type

type p_close from w_a_hlp`p_close within b5w_hlp_paymst_hotbill
integer x = 2619
integer y = 52
end type

type gb_cond from w_a_hlp`gb_cond within b5w_hlp_paymst_hotbill
integer x = 32
integer y = 4
integer width = 1874
integer height = 280
...
type dw_hlp from w_a_hlp`dw_hlp within b5w_hlp_paymst_hotbill
integer x = 27
integer y = 292
integer width = 3017
integer height = 1476
string dataobject = "b5d_hlp_paymst_hotbill"
