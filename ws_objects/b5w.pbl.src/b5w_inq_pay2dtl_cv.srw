$PBExportHeader$b5w_inq_pay2dtl_cv.srw
$PBExportComments$[kwon] 입금상세내역조회
forward
global type b5w_inq_pay2dtl_cv from w_a_inq_m_m
end type
end forward
...
global b5w_inq_pay2dtl_cv b5w_inq_pay2dtl_cv
...
type dw_cond from w_a_inq_m_m`dw_cond within b5w_inq_pay2dtl_cv
integer x = 64
integer y = 56
integer width = 2441
integer height = 308
...
type p_ok from w_a_inq_m_m`p_ok within b5w_inq_pay2dtl_cv
integer x = 2615
end type

type p_close from w_a_inq_m_m`p_close within b5w_inq_pay2dtl_cv
integer x = 2912
boolean originalsize = false
end type

type gb_cond from w_a_inq_m_m`gb_cond within b5w_inq_pay2dtl_cv
integer width = 2510
integer height = 392
end type

type dw_master from w_a_inq_m_m`dw_master within b5w_inq_pay2dtl_cv
integer x = 27
integer y = 420
integer width = 3410
integer height = 1004
string dataobject = "b5dw_inq_pay2dtl_cv"
end type

event dw_master::ue_init();call super::ue_init;dwObject ldwo_SORT

ldwo_SORT = Object.reqpay_payid_t
uf_init(ldwo_SORT)

end event

type dw_detail from w_a_inq_m_m`dw_detail within b5w_inq_pay2dtl_cv
integer x = 32
integer y = 1472
integer width = 3410
integer height = 536
...
type st_horizontal from w_a_inq_m_m`st_horizontal within b5w_inq_pay2dtl_cv
integer y = 1428
integer height = 36
end type
