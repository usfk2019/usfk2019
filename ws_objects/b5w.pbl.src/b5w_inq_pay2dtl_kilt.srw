$PBExportHeader$b5w_inq_pay2dtl_kilt.srw
$PBExportComments$[kwon] 입금상세내역조회
forward
global type b5w_inq_pay2dtl_kilt from w_a_inq_m_m
end type
end forward
...
global b5w_inq_pay2dtl_kilt b5w_inq_pay2dtl_kilt
...
on b5w_inq_pay2dtl_kilt.create
call super::create
end on

on b5w_inq_pay2dtl_kilt.destroy
call super::destroy
end on
...
type dw_cond from w_a_inq_m_m`dw_cond within b5w_inq_pay2dtl_kilt
integer x = 64
integer y = 56
integer width = 2414
integer height = 308
...
type p_ok from w_a_inq_m_m`p_ok within b5w_inq_pay2dtl_kilt
integer x = 2565
end type

type p_close from w_a_inq_m_m`p_close within b5w_inq_pay2dtl_kilt
integer x = 2862
boolean originalsize = false
end type

type gb_cond from w_a_inq_m_m`gb_cond within b5w_inq_pay2dtl_kilt
integer width = 2482
integer height = 392
end type

type dw_master from w_a_inq_m_m`dw_master within b5w_inq_pay2dtl_kilt
integer x = 27
integer y = 420
integer width = 3410
integer height = 1004
string dataobject = "b5dw_inq_pay2dtl_kilt"
end type
...
type dw_detail from w_a_inq_m_m`dw_detail within b5w_inq_pay2dtl_kilt
integer x = 32
integer y = 1472
integer width = 3410
integer height = 536
...
type st_horizontal from w_a_inq_m_m`st_horizontal within b5w_inq_pay2dtl_kilt
integer y = 1428
integer height = 36
end type
