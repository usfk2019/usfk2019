$PBExportHeader$b5w_inq_reqinfo_bill_1.srw
$PBExportComments$[juede] 청구서내역조회 - 20개 라인으로 수정
forward
global type b5w_inq_reqinfo_bill_1 from w_a_inq_m_m
end type
end forward
...
global b5w_inq_reqinfo_bill_1 b5w_inq_reqinfo_bill_1
...
on b5w_inq_reqinfo_bill_1.create
call super::create
end on

on b5w_inq_reqinfo_bill_1.destroy
call super::destroy
end on
...
type dw_cond from w_a_inq_m_m`dw_cond within b5w_inq_reqinfo_bill_1
integer x = 55
integer y = 64
integer width = 1349
integer height = 148
...
type p_ok from w_a_inq_m_m`p_ok within b5w_inq_reqinfo_bill_1
integer x = 1490
end type

type p_close from w_a_inq_m_m`p_close within b5w_inq_reqinfo_bill_1
integer x = 1801
boolean originalsize = false
end type

type gb_cond from w_a_inq_m_m`gb_cond within b5w_inq_reqinfo_bill_1
integer width = 1385
integer height = 256
end type

type dw_master from w_a_inq_m_m`dw_master within b5w_inq_reqinfo_bill_1
integer y = 284
integer width = 2021
integer height = 448
...
type dw_detail from w_a_inq_m_m`dw_detail within b5w_inq_reqinfo_bill_1
integer x = 32
integer y = 784
integer width = 2021
integer height = 1356
string dataobject = "b5d_inq_detail_reqinfo_bill_1"
...
type st_horizontal from w_a_inq_m_m`st_horizontal within b5w_inq_reqinfo_bill_1
integer x = 23
integer y = 740
integer height = 36
end type
