$PBExportHeader$b5w_inq_reqinfo_bill_vtel.srw
$PBExportComments$[kwon-backgu] 청구서내역조회
forward
global type b5w_inq_reqinfo_bill_vtel from w_a_inq_m_m
end type
end forward
...
global b5w_inq_reqinfo_bill_vtel b5w_inq_reqinfo_bill_vtel
...
If ls_payid = "" Then
	f_msg_usr_err(200, Title, "납입고객번호")
...
on b5w_inq_reqinfo_bill_vtel.create
call super::create
end on

on b5w_inq_reqinfo_bill_vtel.destroy
call super::destroy
end on
...
type dw_cond from w_a_inq_m_m`dw_cond within b5w_inq_reqinfo_bill_vtel
integer x = 55
integer y = 64
integer width = 1349
integer height = 148
...
type p_ok from w_a_inq_m_m`p_ok within b5w_inq_reqinfo_bill_vtel
integer x = 1490
end type

type p_close from w_a_inq_m_m`p_close within b5w_inq_reqinfo_bill_vtel
integer x = 1801
boolean originalsize = false
end type

type gb_cond from w_a_inq_m_m`gb_cond within b5w_inq_reqinfo_bill_vtel
integer width = 1385
integer height = 256
end type

type dw_master from w_a_inq_m_m`dw_master within b5w_inq_reqinfo_bill_vtel
integer y = 284
integer width = 2021
integer height = 448
...
type dw_detail from w_a_inq_m_m`dw_detail within b5w_inq_reqinfo_bill_vtel
integer x = 32
integer y = 784
integer width = 2021
integer height = 1356
string dataobject = "b5d_inq_detail_reqinfo_bill_vtel"
...
event type integer dw_detail::ue_retrieve(long al_select_row);String	ls_where, ls_reqdt, ls_reqterm
Integer li_rc
...
lu_dbmgr = CREATE b5u_dbmgr
lu_dbmgr.is_caller = "REQAMTINFO BILL 2"
...
ls_reqterm = b5fs_reqterm("", lu_dbmgr.is_data[2])
This.Modify("t_opendt.text= '" + String(Mid(ls_reqterm, 1, 8), "@@@@-@@-@@") + "'" )
This.Modify("t_enddt.text= '" + String(Mid(ls_reqterm, 9, 8), "@@@@-@@-@@") + "'" )
...
this.Object.amtnm_16[1] ="당월요금계" 
this.Object.amtnm_17[1] ="전월미납금" 
this.Object.amtnm_18[1] = "청구금액"	
...
type st_horizontal from w_a_inq_m_m`st_horizontal within b5w_inq_reqinfo_bill_vtel
integer x = 23
integer y = 740
integer height = 36
end type
