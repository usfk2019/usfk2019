$PBExportHeader$b5w_pay_acclist2_cv.srw
$PBExportComments$[chooys] 입금정산보고서2 Window
forward
global type b5w_pay_acclist2_cv from w_a_print
end type
type dw_hidden from datawindow within b5w_pay_acclist2_cv
end type
end forward
...
global b5w_pay_acclist2_cv b5w_pay_acclist2_cv
...
on b5w_pay_acclist2_cv.destroy
call super::destroy
...
//Retrieve
ll_rows = dw_list.Retrieve(is_chk, ls_trdtfr, ls_trdtto, is_currency)
If ll_rows < 0 Then
...
type dw_cond from w_a_print`dw_cond within b5w_pay_acclist2_cv
integer width = 878
integer height = 164
...
type p_ok from w_a_print`p_ok within b5w_pay_acclist2_cv
integer x = 997
integer y = 48
end type

type p_close from w_a_print`p_close within b5w_pay_acclist2_cv
integer x = 1298
integer y = 48
end type

type dw_list from w_a_print`dw_list within b5w_pay_acclist2_cv
integer y = 248
integer height = 1372
string dataobject = "b5dw_prt_pay_acclist2_cv"
end type

type p_1 from w_a_print`p_1 within b5w_pay_acclist2_cv
end type

type p_2 from w_a_print`p_2 within b5w_pay_acclist2_cv
end type

type p_3 from w_a_print`p_3 within b5w_pay_acclist2_cv
end type

type p_5 from w_a_print`p_5 within b5w_pay_acclist2_cv
end type

type p_6 from w_a_print`p_6 within b5w_pay_acclist2_cv
end type

type p_7 from w_a_print`p_7 within b5w_pay_acclist2_cv
end type

type p_8 from w_a_print`p_8 within b5w_pay_acclist2_cv
end type

type p_9 from w_a_print`p_9 within b5w_pay_acclist2_cv
end type

type p_4 from w_a_print`p_4 within b5w_pay_acclist2_cv
end type

type gb_1 from w_a_print`gb_1 within b5w_pay_acclist2_cv
end type

type p_port from w_a_print`p_port within b5w_pay_acclist2_cv
end type

type p_land from w_a_print`p_land within b5w_pay_acclist2_cv
end type

type gb_cond from w_a_print`gb_cond within b5w_pay_acclist2_cv
integer width = 910
integer height = 220
end type

type p_saveas from w_a_print`p_saveas within b5w_pay_acclist2_cv
end type
