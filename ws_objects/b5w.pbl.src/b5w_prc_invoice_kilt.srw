$PBExportHeader$b5w_prc_invoice_kilt.srw
$PBExportComments$[islim] 청구서 대행 발송
forward
global type b5w_prc_invoice_kilt from w_a_prc
end type
end forward
...
global b5w_prc_invoice_kilt b5w_prc_invoice_kilt
...
on b5w_prc_invoice_kilt.create
call super::create
end on

on b5w_prc_invoice_kilt.destroy
call super::destroy
end on
...
lu_dbmgr.is_caller = "Create Invoice Kilt"
...
type p_ok from w_a_prc`p_ok within b5w_prc_invoice_kilt
integer x = 1417
integer y = 72
boolean originalsize = false
end type

type dw_input from w_a_prc`dw_input within b5w_prc_invoice_kilt
integer y = 44
integer width = 1262
integer height = 292
string dataobject = "b5dw_cnd_prc_invoice_kilt"
...
type dw_msg_time from w_a_prc`dw_msg_time within b5w_prc_invoice_kilt
integer y = 848
end type

type dw_msg_processing from w_a_prc`dw_msg_processing within b5w_prc_invoice_kilt
integer y = 384
end type

type ln_up from w_a_prc`ln_up within b5w_prc_invoice_kilt
integer beginy = 364
integer endy = 364
end type

type ln_down from w_a_prc`ln_down within b5w_prc_invoice_kilt
integer beginy = 1136
integer endy = 1136
end type

type p_close from w_a_prc`p_close within b5w_prc_invoice_kilt
integer x = 1417
integer y = 180
end type

type gb_cond from w_a_prc`gb_cond within b5w_prc_invoice_kilt
integer width = 1312
integer height = 344
end type
