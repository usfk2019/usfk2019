$PBExportHeader$b5w_prc_itemsale_m.srw
$PBExportComments$[hhm]월판매액생성
forward
global type b5w_prc_itemsale_m from b5w_a_prc_reqpgm
end type
end forward
...
global b5w_prc_itemsale_m b5w_prc_itemsale_m
...
on b5w_prc_itemsale_m.create
call super::create
end on

on b5w_prc_itemsale_m.destroy
call super::destroy
end on
...
type p_ok from b5w_a_prc_reqpgm`p_ok within b5w_prc_itemsale_m
integer x = 1472
integer y = 60
end type

type dw_input from b5w_a_prc_reqpgm`dw_input within b5w_prc_itemsale_m
integer x = 46
integer y = 68
integer width = 1198
integer height = 244
...
type dw_msg_time from b5w_a_prc_reqpgm`dw_msg_time within b5w_prc_itemsale_m
integer y = 844
end type

type dw_msg_processing from b5w_a_prc_reqpgm`dw_msg_processing within b5w_prc_itemsale_m
integer y = 380
end type

type ln_up from b5w_a_prc_reqpgm`ln_up within b5w_prc_itemsale_m
integer beginy = 364
integer endx = 1897
integer endy = 364
end type

type ln_down from b5w_a_prc_reqpgm`ln_down within b5w_prc_itemsale_m
integer beginy = 1124
integer endx = 1897
integer endy = 1124
end type

type p_close from b5w_a_prc_reqpgm`p_close within b5w_prc_itemsale_m
integer x = 1472
integer y = 168
end type

type gb_cond from b5w_a_prc_reqpgm`gb_cond within b5w_prc_itemsale_m
integer y = 8
integer width = 1330
integer height = 336
end type
