$PBExportHeader$b5w_prc_reactive_post.srw
$PBExportComments$[ohj]일시정지해제- 후불
forward
global type b5w_prc_reactive_post from w_a_prc
end type
type st_1 from statictext within b5w_prc_reactive_post
end type
end forward
...
global b5w_prc_reactive_post b5w_prc_reactive_post

type variables

end variables

on b5w_prc_reactive_post.create
int iCurrent
call super::create
...
on b5w_prc_reactive_post.destroy
call super::destroy
destroy(this.st_1)
end on
...
//setnull(ls_null )
//처리부분...
SQLCA.B1REACTIVE_PREPAYMENT('1', ll_return, ls_errmsg, lb_count)
...
type p_ok from w_a_prc`p_ok within b5w_prc_reactive_post
integer x = 1449
integer y = 36
end type

type dw_input from w_a_prc`dw_input within b5w_prc_reactive_post
...
type dw_msg_time from w_a_prc`dw_msg_time within b5w_prc_reactive_post
integer y = 744
integer width = 1856
end type

type dw_msg_processing from w_a_prc`dw_msg_processing within b5w_prc_reactive_post
integer y = 280
integer width = 1856
end type

type ln_up from w_a_prc`ln_up within b5w_prc_reactive_post
integer beginy = 264
integer endx = 1838
integer endy = 264
end type

type ln_down from w_a_prc`ln_down within b5w_prc_reactive_post
integer beginy = 1024
integer endx = 1838
integer endy = 1024
end type

type p_close from w_a_prc`p_close within b5w_prc_reactive_post
integer x = 1449
integer y = 148
end type

type gb_cond from w_a_prc`gb_cond within b5w_prc_reactive_post
integer width = 1307
integer height = 232
end type
...
string text = "Postpaid Reactive Process..."
