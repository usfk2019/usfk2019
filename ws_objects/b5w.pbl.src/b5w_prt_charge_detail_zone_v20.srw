$PBExportHeader$b5w_prt_charge_detail_zone_v20.srw
$PBExportComments$[ssong] 요금상세 내역서
forward
global type b5w_prt_charge_detail_zone_v20 from w_a_print
end type
end forward
...
global b5w_prt_charge_detail_zone_v20 b5w_prt_charge_detail_zone_v20

type variables
String is_format
end variables

on b5w_prt_charge_detail_zone_v20.create
call super::create
end on

on b5w_prt_charge_detail_zone_v20.destroy
call super::destroy
end on
...
//Messagebox('',ls_workdt_fr)
//Messagebox('',ls_workdt_to)
...
If ls_choice = "1" Then //청구전
	dw_list.DataObject = "b5dw_prt_det_charge_detail_a"
...
ElseIf ls_choice = "2" Then //청구후
	dw_list.DataObject = "b5dw_prt_det_charge_detail_b"
...
type dw_cond from w_a_print`dw_cond within b5w_prt_charge_detail_zone_v20
integer y = 68
integer width = 2578
integer height = 208
string dataobject = "b5dw_prt_cnd_charge_detail"
boolean hscrollbar = false
boolean vscrollbar = false
boolean livescroll = false
end type

type p_ok from w_a_print`p_ok within b5w_prt_charge_detail_zone_v20
integer x = 2743
integer y = 60
end type

type p_close from w_a_print`p_close within b5w_prt_charge_detail_zone_v20
integer x = 3045
integer y = 60
end type

type dw_list from w_a_print`dw_list within b5w_prt_charge_detail_zone_v20
integer y = 312
integer width = 3378
integer height = 1644
string dataobject = "b5dw_prt_det_charge_detail_a"
end type

type p_1 from w_a_print`p_1 within b5w_prt_charge_detail_zone_v20
integer x = 2898
integer y = 1996
end type

type p_2 from w_a_print`p_2 within b5w_prt_charge_detail_zone_v20
integer x = 695
integer y = 1996
end type

type p_3 from w_a_print`p_3 within b5w_prt_charge_detail_zone_v20
integer x = 2574
integer y = 1996
end type

type p_5 from w_a_print`p_5 within b5w_prt_charge_detail_zone_v20
integer x = 1385
integer y = 1996
end type

type p_6 from w_a_print`p_6 within b5w_prt_charge_detail_zone_v20
integer x = 1961
integer y = 1996
end type

type p_7 from w_a_print`p_7 within b5w_prt_charge_detail_zone_v20
integer x = 1769
integer y = 1996
end type

type p_8 from w_a_print`p_8 within b5w_prt_charge_detail_zone_v20
integer x = 1577
integer y = 1996
end type

type p_9 from w_a_print`p_9 within b5w_prt_charge_detail_zone_v20
integer x = 1010
integer y = 1996
end type

type p_4 from w_a_print`p_4 within b5w_prt_charge_detail_zone_v20
end type

type gb_1 from w_a_print`gb_1 within b5w_prt_charge_detail_zone_v20
integer x = 55
integer y = 1968
end type

type p_port from w_a_print`p_port within b5w_prt_charge_detail_zone_v20
integer x = 105
integer y = 2024
end type

type p_land from w_a_print`p_land within b5w_prt_charge_detail_zone_v20
integer x = 265
integer y = 2036
end type

type gb_cond from w_a_print`gb_cond within b5w_prt_charge_detail_zone_v20
integer y = 8
integer width = 2629
integer height = 296
end type

type p_saveas from w_a_print`p_saveas within b5w_prt_charge_detail_zone_v20
integer x = 2249
integer y = 1996
end type
