$PBExportHeader$b5w_reg_mtr_req.srw
$PBExportComments$[kwon] 거래수동거래등록
forward
global type b5w_reg_mtr_req from w_a_reg_m_sql
end type
end forward
...
global b5w_reg_mtr_req b5w_reg_mtr_req
...
Date ldate_trdt
Dec{0} lc0_pre_balance, lc0_cur_balance
...
public function integer wfi_chk_data ();String 	ls_payid, 		ls_customerid, ls_trcod
...
on b5w_reg_mtr_req.create
call super::create
end on

on b5w_reg_mtr_req.destroy
call super::destroy
end on
...
type dw_cond from w_a_reg_m_sql`dw_cond within b5w_reg_mtr_req
integer y = 52
integer width = 2770
integer height = 536
string dataobject = "b5d_cnd_reg_mtr_req"
...
type p_ok from w_a_reg_m_sql`p_ok within b5w_reg_mtr_req
integer x = 2862
integer y = 76
end type

type p_close from w_a_reg_m_sql`p_close within b5w_reg_mtr_req
integer x = 2862
integer y = 300
end type

type gb_cond from w_a_reg_m_sql`gb_cond within b5w_reg_mtr_req
integer x = 23
integer width = 2811
integer height = 656
end type

type p_save from w_a_reg_m_sql`p_save within b5w_reg_mtr_req
integer x = 2862
integer y = 188
end type

type dw_detail from w_a_reg_m_sql`dw_detail within b5w_reg_mtr_req
integer x = 23
integer y = 672
integer width = 2802
integer height = 1184
