$PBExportHeader$b5w_reg_reqconf.srw
$PBExportComments$*[kwon] 청구주기 Control
forward
global type b5w_reg_reqconf from w_a_reg_m
end type
end forward
...
global b5w_reg_reqconf b5w_reg_reqconf
...
on b5w_reg_reqconf.create
call super::create
end on

on b5w_reg_reqconf.destroy
call super::destroy
end on
...
For li_cnt = 1 to ll_rows
	...
	If ls_inputclosedt = "" Then
		f_msg_usr_err(200, Title, "[청구주기]전월입금마감일자")
		dw_detail.SetRow(li_cnt)
...
type dw_cond from w_a_reg_m`dw_cond within b5w_reg_reqconf
...
type p_ok from w_a_reg_m`p_ok within b5w_reg_reqconf
boolean visible = false
integer x = 1280
integer y = 32
...
type p_close from w_a_reg_m`p_close within b5w_reg_reqconf
integer x = 1207
integer y = 916
boolean originalsize = false
end type

type gb_cond from w_a_reg_m`gb_cond within b5w_reg_reqconf
boolean visible = false
integer x = 503
integer y = 1036
integer height = 152
...
type p_delete from w_a_reg_m`p_delete within b5w_reg_reqconf
integer x = 384
integer y = 916
end type

type p_insert from w_a_reg_m`p_insert within b5w_reg_reqconf
integer x = 64
integer y = 916
end type

type p_save from w_a_reg_m`p_save within b5w_reg_reqconf
integer x = 704
integer y = 916
end type

type dw_detail from w_a_reg_m`dw_detail within b5w_reg_reqconf
integer x = 50
integer y = 52
integer width = 3186
integer height = 820
...
type p_reset from w_a_reg_m`p_reset within b5w_reg_reqconf
boolean visible = false
integer y = 876
end type
