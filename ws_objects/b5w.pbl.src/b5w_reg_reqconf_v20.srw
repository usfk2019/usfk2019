$PBExportHeader$b5w_reg_reqconf_v20.srw
$PBExportComments$[parkkh] 청구주기v20-청구주기단위/주기수추가
forward
global type b5w_reg_reqconf_v20 from w_a_reg_m
end type
end forward
...
global b5w_reg_reqconf_v20 b5w_reg_reqconf_v20
...
on b5w_reg_reqconf_v20.create
call super::create
end on

on b5w_reg_reqconf_v20.destroy
call super::destroy
end on
...
type dw_cond from w_a_reg_m`dw_cond within b5w_reg_reqconf_v20
...
type p_ok from w_a_reg_m`p_ok within b5w_reg_reqconf_v20
boolean visible = false
integer x = 1280
integer y = 32
...
type p_close from w_a_reg_m`p_close within b5w_reg_reqconf_v20
integer x = 1207
integer y = 916
boolean originalsize = false
end type

type gb_cond from w_a_reg_m`gb_cond within b5w_reg_reqconf_v20
boolean visible = false
integer x = 503
integer y = 1036
integer height = 152
...
type p_delete from w_a_reg_m`p_delete within b5w_reg_reqconf_v20
integer x = 384
integer y = 916
end type

type p_insert from w_a_reg_m`p_insert within b5w_reg_reqconf_v20
integer x = 64
integer y = 916
end type

type p_save from w_a_reg_m`p_save within b5w_reg_reqconf_v20
integer x = 704
integer y = 916
end type

type dw_detail from w_a_reg_m`dw_detail within b5w_reg_reqconf_v20
integer x = 50
integer y = 52
integer width = 3186
integer height = 820
string dataobject = "b5d_reg_reqconf_v20"
boolean vscrollbar = false
end type
...
type p_reset from w_a_reg_m`p_reset within b5w_reg_reqconf_v20
boolean visible = false
integer y = 876
end type
