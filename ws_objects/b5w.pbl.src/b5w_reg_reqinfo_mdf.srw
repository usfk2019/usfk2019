$PBExportHeader$b5w_reg_reqinfo_mdf.srw
$PBExportComments$[backgu-2002/09-26] 월별 고객 정보 History
forward
global type b5w_reg_reqinfo_mdf from w_a_reg_m
end type
end forward
...
global b5w_reg_reqinfo_mdf b5w_reg_reqinfo_mdf
...
String ls_cregno
String ls_chargedt , ls_inv_yn    , ls_inv_method  , ls_pay_method
...
String ls_card_ssno, ls_card_expdt, ls_card_group1 , ls_card_authyn
Long   ll_row
Boolean lb_check
...
on b5w_reg_reqinfo_mdf.create
call super::create
end on

on b5w_reg_reqinfo_mdf.destroy
call super::destroy
end on
...
type dw_cond from w_a_reg_m`dw_cond within b5w_reg_reqinfo_mdf
integer x = 55
integer y = 44
integer width = 2112
integer height = 244
...
type p_ok from w_a_reg_m`p_ok within b5w_reg_reqinfo_mdf
integer x = 2377
end type

type p_close from w_a_reg_m`p_close within b5w_reg_reqinfo_mdf
integer x = 2683
boolean originalsize = false
end type

type gb_cond from w_a_reg_m`gb_cond within b5w_reg_reqinfo_mdf
integer width = 2231
end type

type p_delete from w_a_reg_m`p_delete within b5w_reg_reqinfo_mdf
boolean visible = false
integer y = 1664
end type

type p_insert from w_a_reg_m`p_insert within b5w_reg_reqinfo_mdf
boolean visible = false
integer y = 1664
end type

type p_save from w_a_reg_m`p_save within b5w_reg_reqinfo_mdf
integer x = 69
integer y = 1664
end type

type dw_detail from w_a_reg_m`dw_detail within b5w_reg_reqinfo_mdf
integer y = 324
integer width = 3337
integer height = 1288
string dataobject = "b5d_reg_reqinfo_mdf"
end type
...
type p_reset from w_a_reg_m`p_reset within b5w_reg_reqinfo_mdf
integer x = 402
integer y = 1664
end type
