$PBExportHeader$b5w_reg_sendemail_v20.srw
$PBExportComments$[jsha] email청구서발송
forward
global type b5w_reg_sendemail_v20 from w_a_reg_m_m
end type
type p_send from u_p_send within b5w_reg_sendemail_v20
end type
type gb_master from groupbox within b5w_reg_sendemail_v20
end type
end forward
...
global b5w_reg_sendemail_v20 b5w_reg_sendemail_v20
...
on b5w_reg_sendemail_v20.create
int iCurrent
call super::create
...
on b5w_reg_sendemail_v20.destroy
call super::destroy
destroy(this.p_send)
...
ls_status1 = '90'  //Constrained Termination
...
IF ls_where <> "" THEN ls_where += " AND "
	ls_where += " cus.status <> '" + ls_status1 + "' "
...
type dw_cond from w_a_reg_m_m`dw_cond within b5w_reg_sendemail_v20
integer x = 55
integer y = 44
integer width = 2158
integer height = 424
...
type p_ok from w_a_reg_m_m`p_ok within b5w_reg_sendemail_v20
integer x = 2565
integer y = 40
end type

type p_close from w_a_reg_m_m`p_close within b5w_reg_sendemail_v20
integer x = 2565
integer y = 156
boolean originalsize = false
end type

type gb_cond from w_a_reg_m_m`gb_cond within b5w_reg_sendemail_v20
integer x = 27
integer width = 2491
integer height = 500
end type

type dw_master from w_a_reg_m_m`dw_master within b5w_reg_sendemail_v20
integer x = 64
integer y = 536
integer width = 2437
integer height = 288
...
type dw_detail from w_a_reg_m_m`dw_detail within b5w_reg_sendemail_v20
integer y = 892
integer width = 2638
integer height = 636
...
type p_insert from w_a_reg_m_m`p_insert within b5w_reg_sendemail_v20
boolean visible = false
end type

type p_delete from w_a_reg_m_m`p_delete within b5w_reg_sendemail_v20
boolean visible = false
end type

type p_save from w_a_reg_m_m`p_save within b5w_reg_sendemail_v20
boolean visible = false
end type

type p_reset from w_a_reg_m_m`p_reset within b5w_reg_sendemail_v20
integer x = 416
integer y = 1680
end type

type st_horizontal from w_a_reg_m_m`st_horizontal within b5w_reg_sendemail_v20
integer y = 844
end type
