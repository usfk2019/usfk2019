$PBExportHeader$b5w_reg_trcode_2.srw
$PBExportComments$[kwon-backgu] 거래유형
forward
global type b5w_reg_trcode_2 from w_a_reg_m
end type
end forward
...
global b5w_reg_trcode_2 b5w_reg_trcode_2

on b5w_reg_trcode_2.create
call super::create
end on

on b5w_reg_trcode_2.destroy
call super::destroy
end on
...
type dw_cond from w_a_reg_m`dw_cond within b5w_reg_trcode_2
integer x = 64
integer y = 60
integer width = 1778
integer height = 204
...
type p_ok from w_a_reg_m`p_ok within b5w_reg_trcode_2
integer x = 2121
integer y = 52
end type

type p_close from w_a_reg_m`p_close within b5w_reg_trcode_2
integer x = 2432
integer y = 52
boolean originalsize = false
end type

type gb_cond from w_a_reg_m`gb_cond within b5w_reg_trcode_2
integer x = 37
integer width = 1947
integer height = 284
end type

type p_delete from w_a_reg_m`p_delete within b5w_reg_trcode_2
integer x = 334
integer y = 1744
end type

type p_insert from w_a_reg_m`p_insert within b5w_reg_trcode_2
integer x = 37
integer y = 1744
end type

type p_save from w_a_reg_m`p_save within b5w_reg_trcode_2
integer x = 635
integer y = 1744
end type

type dw_detail from w_a_reg_m`dw_detail within b5w_reg_trcode_2
integer x = 37
integer y = 300
integer width = 2866
integer height = 1404
string dataobject = "b5dw_reg_trcode_2"
end type
...
type p_reset from w_a_reg_m`p_reset within b5w_reg_trcode_2
integer x = 1097
integer y = 1744
end type
