$PBExportHeader$b5w_reg_billfile_create_v20.srw
$PBExportComments$[ohj] 청구file 생성
forward
global type b5w_reg_billfile_create_v20 from w_a_inq_m
end type
type cb_1 from commandbutton within b5w_reg_billfile_create_v20
end type
end forward
...
global b5w_reg_billfile_create_v20 b5w_reg_billfile_create_v20

on b5w_reg_billfile_create_v20.create
int iCurrent
call super::create
...
on b5w_reg_billfile_create_v20.destroy
call super::destroy
destroy(this.cb_1)
end on
...
type dw_cond from w_a_inq_m`dw_cond within b5w_reg_billfile_create_v20
boolean visible = false
end type

type p_ok from w_a_inq_m`p_ok within b5w_reg_billfile_create_v20
integer x = 1760
integer y = 36
end type

type p_close from w_a_inq_m`p_close within b5w_reg_billfile_create_v20
integer x = 2062
integer y = 36
end type

type gb_cond from w_a_inq_m`gb_cond within b5w_reg_billfile_create_v20
boolean visible = false
end type

type dw_detail from w_a_inq_m`dw_detail within b5w_reg_billfile_create_v20
integer y = 160
...
OpenWithParm(b5w_inq_billfile_create_popup_v20, iu_cust_msg)
