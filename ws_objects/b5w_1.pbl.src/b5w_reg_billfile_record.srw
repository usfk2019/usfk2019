$PBExportHeader$b5w_reg_billfile_record.srw
$PBExportComments$[ohj] 청구file record 구성
forward
global type b5w_reg_billfile_record from w_a_reg_m
end type
end forward

global type b5w_reg_billfile_record from w_a_reg_m
end type
global b5w_reg_billfile_record b5w_reg_billfile_record
...
on b5w_reg_billfile_record.create
call super::create
end on

on b5w_reg_billfile_record.destroy
call super::destroy
end on
...
type dw_cond from w_a_reg_m`dw_cond within b5w_reg_billfile_record
integer x = 59
integer y = 76
integer width = 1623
integer height = 112
...
type p_ok from w_a_reg_m`p_ok within b5w_reg_billfile_record
integer x = 1920
integer y = 80
end type

type p_close from w_a_reg_m`p_close within b5w_reg_billfile_record
integer x = 2226
integer y = 80
end type

type gb_cond from w_a_reg_m`gb_cond within b5w_reg_billfile_record
integer y = 8
integer width = 1765
integer height = 228
end type

type p_delete from w_a_reg_m`p_delete within b5w_reg_billfile_record
end type

type p_insert from w_a_reg_m`p_insert within b5w_reg_billfile_record
end type

type p_save from w_a_reg_m`p_save within b5w_reg_billfile_record
end type

type dw_detail from w_a_reg_m`dw_detail within b5w_reg_billfile_record
integer y = 292
integer height = 1256
string dataobject = "b5dw_cnd_reg_billfile_record"
end type
...
type p_reset from w_a_reg_m`p_reset within b5w_reg_billfile_record
end type
