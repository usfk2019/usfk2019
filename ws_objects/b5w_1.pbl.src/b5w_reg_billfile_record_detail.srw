$PBExportHeader$b5w_reg_billfile_record_detail.srw
$PBExportComments$[ohj] 청구file record 상세구성
forward
global type b5w_reg_billfile_record_detail from w_a_reg_m_m
end type
type p_new from u_p_new within b5w_reg_billfile_record_detail
end type
type p_select from u_p_select within b5w_reg_billfile_record_detail
end type
end forward
...
global b5w_reg_billfile_record_detail b5w_reg_billfile_record_detail
...
on b5w_reg_billfile_record_detail.create
int iCurrent
call super::create
...
on b5w_reg_billfile_record_detail.destroy
call super::destroy
destroy(this.p_new)
...
type dw_cond from w_a_reg_m_m`dw_cond within b5w_reg_billfile_record_detail
integer x = 59
integer y = 60
integer width = 1746
integer height = 128
...
type p_ok from w_a_reg_m_m`p_ok within b5w_reg_billfile_record_detail
integer x = 2057
integer y = 52
boolean originalsize = false
end type

type p_close from w_a_reg_m_m`p_close within b5w_reg_billfile_record_detail
integer x = 2363
integer y = 52
end type

type gb_cond from w_a_reg_m_m`gb_cond within b5w_reg_billfile_record_detail
integer x = 23
integer y = 4
integer width = 1934
integer height = 212
...
type dw_master from w_a_reg_m_m`dw_master within b5w_reg_billfile_record_detail
integer x = 23
integer y = 256
integer height = 448
...
type dw_detail from w_a_reg_m_m`dw_detail within b5w_reg_billfile_record_detail
integer x = 23
integer y = 736
integer height = 900
...
type p_insert from w_a_reg_m_m`p_insert within b5w_reg_billfile_record_detail
integer x = 334
integer y = 1660
end type

type p_delete from w_a_reg_m_m`p_delete within b5w_reg_billfile_record_detail
integer x = 626
end type

type p_save from w_a_reg_m_m`p_save within b5w_reg_billfile_record_detail
integer x = 919
end type

type p_reset from w_a_reg_m_m`p_reset within b5w_reg_billfile_record_detail
integer x = 1655
end type

type st_horizontal from w_a_reg_m_m`st_horizontal within b5w_reg_billfile_record_detail
integer y = 704
integer height = 36
end type
