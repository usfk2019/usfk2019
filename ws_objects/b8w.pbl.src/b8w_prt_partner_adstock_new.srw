$PBExportHeader$b8w_prt_partner_adstock_new.srw
$PBExportComments$[parkkh] 대리점별재고현황
forward
global type b8w_prt_partner_adstock_new from w_a_print
end type
end forward
...
global b8w_prt_partner_adstock_new b8w_prt_partner_adstock_new
...
on b8w_prt_partner_adstock_new.create
call super::create
end on

on b8w_prt_partner_adstock_new.destroy
call super::destroy
end on
...
type dw_cond from w_a_print`dw_cond within b8w_prt_partner_adstock_new
integer width = 2222
integer height = 160
string dataobject = "b8dw_cnd_prt_partner_adstock_new"
...
type p_ok from w_a_print`p_ok within b8w_prt_partner_adstock_new
integer x = 2441
end type

type p_close from w_a_print`p_close within b8w_prt_partner_adstock_new
integer x = 2757
end type

type dw_list from w_a_print`dw_list within b8w_prt_partner_adstock_new
integer x = 23
integer y = 256
integer width = 4315
integer height = 1348
string dataobject = "b8dw_prt_partner_adstock_new"
end type
...
type p_1 from w_a_print`p_1 within b8w_prt_partner_adstock_new
end type

type p_2 from w_a_print`p_2 within b8w_prt_partner_adstock_new
end type

type p_3 from w_a_print`p_3 within b8w_prt_partner_adstock_new
end type

type p_5 from w_a_print`p_5 within b8w_prt_partner_adstock_new
end type

type p_6 from w_a_print`p_6 within b8w_prt_partner_adstock_new
end type

type p_7 from w_a_print`p_7 within b8w_prt_partner_adstock_new
end type

type p_8 from w_a_print`p_8 within b8w_prt_partner_adstock_new
end type

type p_9 from w_a_print`p_9 within b8w_prt_partner_adstock_new
end type

type p_4 from w_a_print`p_4 within b8w_prt_partner_adstock_new
end type

type gb_1 from w_a_print`gb_1 within b8w_prt_partner_adstock_new
end type

type p_port from w_a_print`p_port within b8w_prt_partner_adstock_new
end type

type p_land from w_a_print`p_land within b8w_prt_partner_adstock_new
end type

type gb_cond from w_a_print`gb_cond within b8w_prt_partner_adstock_new
integer width = 2286
integer height = 232
end type

type p_saveas from w_a_print`p_saveas within b8w_prt_partner_adstock_new
end type
