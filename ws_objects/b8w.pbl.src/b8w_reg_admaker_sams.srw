$PBExportHeader$b8w_reg_admaker_sams.srw
$PBExportComments$[chooys] 제조사 등록 Window
forward
global type b8w_reg_admaker_sams from w_a_reg_m_m
end type
end forward
...
global b8w_reg_admaker_sams b8w_reg_admaker_sams
...
on b8w_reg_admaker_sams.create
call super::create
end on

on b8w_reg_admaker_sams.destroy
call super::destroy
end on
...
type dw_cond from w_a_reg_m_m`dw_cond within b8w_reg_admaker_sams
integer x = 55
integer y = 40
integer width = 1833
integer height = 116
string dataobject = "b8dw_cnd_regadmaker_sams"
boolean hscrollbar = false
boolean vscrollbar = false
boolean livescroll = false
end type

type p_ok from w_a_reg_m_m`p_ok within b8w_reg_admaker_sams
integer x = 1943
end type

type p_close from w_a_reg_m_m`p_close within b8w_reg_admaker_sams
integer x = 2245
end type

type gb_cond from w_a_reg_m_m`gb_cond within b8w_reg_admaker_sams
integer width = 1874
integer height = 204
end type

type dw_master from w_a_reg_m_m`dw_master within b8w_reg_admaker_sams
integer y = 232
integer width = 2432
integer height = 684
string dataobject = "b8dw_inq_regadmaker_sams"
end type
...
type dw_detail from w_a_reg_m_m`dw_detail within b8w_reg_admaker_sams
integer x = 37
integer y = 956
integer width = 2432
integer height = 668
...
type p_insert from w_a_reg_m_m`p_insert within b8w_reg_admaker_sams
integer x = 37
end type

type p_delete from w_a_reg_m_m`p_delete within b8w_reg_admaker_sams
integer x = 329
integer y = 1656
end type

type p_save from w_a_reg_m_m`p_save within b8w_reg_admaker_sams
integer x = 626
integer y = 1656
end type

type p_reset from w_a_reg_m_m`p_reset within b8w_reg_admaker_sams
integer x = 1353
integer y = 1656
end type

type st_horizontal from w_a_reg_m_m`st_horizontal within b8w_reg_admaker_sams
integer x = 0
integer y = 924
end type
