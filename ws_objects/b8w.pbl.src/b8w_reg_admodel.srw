$PBExportHeader$b8w_reg_admodel.srw
$PBExportComments$[kem] 장비모델 관리 Window
forward
global type b8w_reg_admodel from w_a_reg_m_tm2
end type
end forward
...
global b8w_reg_admodel b8w_reg_admodel
...
on b8w_reg_admodel.create
int iCurrent
call super::create
end on

on b8w_reg_admodel.destroy
call super::destroy
end on
...
event ue_extra_insert;call super::ue_extra_insert;String ls_modelno
Long   ll_row
...
type dw_cond from w_a_reg_m_tm2`dw_cond within b8w_reg_admodel
integer x = 46
integer width = 2203
integer height = 112
string dataobject = "b8dw_cnd_regadmodel"
end type

type p_ok from w_a_reg_m_tm2`p_ok within b8w_reg_admodel
integer x = 2341
integer y = 44
end type

type p_close from w_a_reg_m_tm2`p_close within b8w_reg_admodel
integer x = 2647
integer y = 44
end type

type gb_cond from w_a_reg_m_tm2`gb_cond within b8w_reg_admodel
integer x = 37
integer width = 2254
integer height = 188
end type

type dw_master from w_a_reg_m_tm2`dw_master within b8w_reg_admodel
integer x = 23
integer y = 224
integer width = 2903
integer height = 428
string dataobject = "b8dw_inq_reqadmodel"
end type
...
type p_insert from w_a_reg_m_tm2`p_insert within b8w_reg_admodel
end type

type p_delete from w_a_reg_m_tm2`p_delete within b8w_reg_admodel
end type

type p_save from w_a_reg_m_tm2`p_save within b8w_reg_admodel
end type

type p_reset from w_a_reg_m_tm2`p_reset within b8w_reg_admodel
end type

type tab_1 from w_a_reg_m_tm2`tab_1 within b8w_reg_admodel
integer x = 23
integer y = 700
integer width = 2903
integer height = 956
...
//Tab에 해당하는 dw
is_dwObject[1] = "b8dw_reg_admodel_t1"
is_dwObject[2] = "b8dw_reg_admodel_t3"
is_dwObject[3] = "b8dw_reg_admodel_t2"
...
type st_horizontal from w_a_reg_m_tm2`st_horizontal within b8w_reg_admodel
integer y = 660
end type
