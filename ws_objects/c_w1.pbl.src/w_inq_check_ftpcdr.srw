$PBExportHeader$w_inq_check_ftpcdr.srw
$PBExportComments$[ssong]시스템 점검관리 윈도우
forward
global type w_inq_check_ftpcdr from w_a_inq_m
end type
end forward

global type w_inq_check_ftpcdr from w_a_inq_m
end type
global w_inq_check_ftpcdr w_inq_check_ftpcdr
...
on w_inq_check_ftpcdr.create
call super::create
end on

on w_inq_check_ftpcdr.destroy
call super::destroy
end on
...
type dw_cond from w_a_inq_m`dw_cond within w_inq_check_ftpcdr
integer x = 41
integer y = 52
integer width = 1582
integer height = 268
...
type p_ok from w_a_inq_m`p_ok within w_inq_check_ftpcdr
integer x = 1765
integer y = 96
end type

type p_close from w_a_inq_m`p_close within w_inq_check_ftpcdr
integer x = 2066
integer y = 96
end type

type gb_cond from w_a_inq_m`gb_cond within w_inq_check_ftpcdr
integer x = 9
integer width = 1646
integer height = 340
end type

type dw_detail from w_a_inq_m`dw_detail within w_inq_check_ftpcdr
integer y = 372
integer height = 1332
string dataobject = "d_inq_check_ftpcdr"
