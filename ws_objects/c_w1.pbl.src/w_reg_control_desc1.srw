$PBExportHeader$w_reg_control_desc1.srw
$PBExportComments$[ceusee] 시스템 파라미터 등록(log 등록부분 수정)
forward
global type w_reg_control_desc1 from w_a_reg_m
end type
end forward
...
global w_reg_control_desc1 w_reg_control_desc1

type variables
String is_pgmid
end variables

on w_reg_control_desc1.create
call super::create
end on

on w_reg_control_desc1.destroy
call super::destroy
end on
...
//		dw_detail.Object.reg_dt[ll_mrow_cnt] = ld_now
		...
		//2004.04.23 by c.bora
		li_return = fi_set_systemlog1(ls_pgm_id, ls_pgm_item, '04', ls_chg_item, 'SYSCTL1T',ls_old, ls_new)
...
type dw_cond from w_a_reg_m`dw_cond within w_reg_control_desc1
integer x = 46
integer y = 52
integer width = 1984
integer height = 208
...
type p_ok from w_a_reg_m`p_ok within w_reg_control_desc1
integer x = 2231
integer y = 44
end type

type p_close from w_a_reg_m`p_close within w_reg_control_desc1
integer x = 2533
integer y = 44
end type

type gb_cond from w_a_reg_m`gb_cond within w_reg_control_desc1
integer width = 2080
integer height = 272
end type

type p_delete from w_a_reg_m`p_delete within w_reg_control_desc1
integer x = 338
integer y = 1676
end type

type p_insert from w_a_reg_m`p_insert within w_reg_control_desc1
integer x = 46
integer y = 1672
end type

type p_save from w_a_reg_m`p_save within w_reg_control_desc1
integer x = 635
integer y = 1676
end type

type dw_detail from w_a_reg_m`dw_detail within w_reg_control_desc1
integer y = 288
integer width = 2999
integer height = 1356
...
type p_reset from w_a_reg_m`p_reset within w_reg_control_desc1
integer x = 1152
integer y = 1676
end type
