$PBExportHeader$w_reg_grp_auth_asp.srw
$PBExportComments$Reg : Group authority(from w_a_reg_m_m)
forward
global type w_reg_grp_auth_asp from w_a_reg_m_m
end type
end forward
...
global w_reg_grp_auth_asp w_reg_grp_auth_asp
...
on w_reg_grp_auth_asp.create
call super::create
end on

on w_reg_grp_auth_asp.destroy
call super::destroy
end on
...
type dw_cond from w_a_reg_m_m`dw_cond within w_reg_grp_auth_asp
integer y = 40
integer width = 1463
integer height = 200
...
type p_ok from w_a_reg_m_m`p_ok within w_reg_grp_auth_asp
integer x = 1641
integer y = 44
end type

type p_close from w_a_reg_m_m`p_close within w_reg_grp_auth_asp
integer x = 1947
integer y = 44
end type

type gb_cond from w_a_reg_m_m`gb_cond within w_reg_grp_auth_asp
integer width = 1504
integer height = 248
end type

type dw_master from w_a_reg_m_m`dw_master within w_reg_grp_auth_asp
integer y = 268
integer height = 544
...
type dw_detail from w_a_reg_m_m`dw_detail within w_reg_grp_auth_asp
integer y = 864
...
type p_insert from w_a_reg_m_m`p_insert within w_reg_grp_auth_asp
integer y = 1756
end type

type p_delete from w_a_reg_m_m`p_delete within w_reg_grp_auth_asp
integer y = 1760
end type

type p_save from w_a_reg_m_m`p_save within w_reg_grp_auth_asp
integer y = 1760
end type

type p_reset from w_a_reg_m_m`p_reset within w_reg_grp_auth_asp
integer y = 1760
end type

type st_horizontal from w_a_reg_m_m`st_horizontal within w_reg_grp_auth_asp
integer x = 32
integer y = 820
end type
