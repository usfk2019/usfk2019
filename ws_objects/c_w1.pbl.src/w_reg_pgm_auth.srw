$PBExportHeader$w_reg_pgm_auth.srw
$PBExportComments$Reg : Program authority(from w_a_reg_m_m)
forward
global type w_reg_pgm_auth from w_a_reg_m_m
end type
end forward
...
global w_reg_pgm_auth w_reg_pgm_auth
...
on w_reg_pgm_auth.create
call super::create
end on

on w_reg_pgm_auth.destroy
call super::destroy
end on
...
type dw_cond from w_a_reg_m_m`dw_cond within w_reg_pgm_auth
integer width = 1307
integer height = 188
...
type p_ok from w_a_reg_m_m`p_ok within w_reg_pgm_auth
integer x = 1719
integer y = 48
end type

type p_close from w_a_reg_m_m`p_close within w_reg_pgm_auth
integer x = 2030
integer y = 48
end type

type gb_cond from w_a_reg_m_m`gb_cond within w_reg_pgm_auth
integer width = 1563
integer height = 256
end type

type dw_master from w_a_reg_m_m`dw_master within w_reg_pgm_auth
integer y = 268
integer height = 544
...
type dw_detail from w_a_reg_m_m`dw_detail within w_reg_pgm_auth
integer y = 848
...
type p_insert from w_a_reg_m_m`p_insert within w_reg_pgm_auth
integer y = 1732
end type

type p_delete from w_a_reg_m_m`p_delete within w_reg_pgm_auth
integer y = 1736
end type

type p_save from w_a_reg_m_m`p_save within w_reg_pgm_auth
integer y = 1736
end type

type p_reset from w_a_reg_m_m`p_reset within w_reg_pgm_auth
integer y = 1736
end type

type st_horizontal from w_a_reg_m_m`st_horizontal within w_reg_pgm_auth
integer x = 32
integer y = 816
end type
