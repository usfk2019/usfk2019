$PBExportHeader$w_reg_userid_asp.srw
$PBExportComments$[cuesee]Reg : User ID(from w_a_reg_m) 암호화 적용
forward
global type w_reg_userid_asp from w_a_reg_m
end type
end forward
...
global w_reg_userid_asp w_reg_userid_asp

on w_reg_userid_asp.create
call super::create
end on

on w_reg_userid_asp.destroy
call super::destroy
end on
...
type dw_cond from w_a_reg_m`dw_cond within w_reg_userid_asp
integer y = 64
integer width = 1330
integer height = 212
...
type p_ok from w_a_reg_m`p_ok within w_reg_userid_asp
integer x = 1563
integer y = 44
end type

type p_close from w_a_reg_m`p_close within w_reg_userid_asp
integer x = 1870
integer y = 44
end type

type gb_cond from w_a_reg_m`gb_cond within w_reg_userid_asp
integer width = 1422
end type

type p_delete from w_a_reg_m`p_delete within w_reg_userid_asp
integer y = 1692
end type

type p_insert from w_a_reg_m`p_insert within w_reg_userid_asp
integer y = 1692
end type

type p_save from w_a_reg_m`p_save within w_reg_userid_asp
integer y = 1692
end type

type dw_detail from w_a_reg_m`dw_detail within w_reg_userid_asp
integer y = 304
integer width = 3401
integer height = 1364
...
type p_reset from w_a_reg_m`p_reset within w_reg_userid_asp
integer y = 1692
end type
