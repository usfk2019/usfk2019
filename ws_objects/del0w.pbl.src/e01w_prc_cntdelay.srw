$PBExportHeader$e01w_prc_cntdelay.srw
$PBExportComments$[parkkh] 연체개월수 계산
forward
global type e01w_prc_cntdelay from w_a_prc
end type
end forward
...
global e01w_prc_cntdelay e01w_prc_cntdelay

type variables
String is_stddt
end variables

on e01w_prc_cntdelay.create
call super::create
end on

on e01w_prc_cntdelay.destroy
call super::destroy
end on
...
type p_ok from w_a_prc`p_ok within e01w_prc_cntdelay
integer x = 1326
integer y = 48
end type

type dw_input from w_a_prc`dw_input within e01w_prc_cntdelay
integer x = 69
integer width = 1038
integer height = 168
...
type dw_msg_time from w_a_prc`dw_msg_time within e01w_prc_cntdelay
integer y = 744
integer width = 1856
end type

type dw_msg_processing from w_a_prc`dw_msg_processing within e01w_prc_cntdelay
integer y = 280
integer width = 1856
end type

type ln_up from w_a_prc`ln_up within e01w_prc_cntdelay
integer beginy = 264
integer endx = 1838
integer endy = 264
end type

type ln_down from w_a_prc`ln_down within e01w_prc_cntdelay
integer beginy = 1024
integer endx = 1838
integer endy = 1024
end type

type p_close from w_a_prc`p_close within e01w_prc_cntdelay
integer x = 1641
integer y = 48
end type

type gb_cond from w_a_prc`gb_cond within e01w_prc_cntdelay
integer width = 1266
integer height = 240
end type
