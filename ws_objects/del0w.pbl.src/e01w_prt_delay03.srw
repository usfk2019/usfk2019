$PBExportHeader$e01w_prt_delay03.srw
$PBExportComments$[parkkh] 연체자 리스트
forward
global type e01w_prt_delay03 from w_a_print
end type
type dw_saveas from datawindow within e01w_prt_delay03
end type
type hpb_1 from hprogressbar within e01w_prt_delay03
end type
type gb_2 from groupbox within e01w_prt_delay03
end type
end forward
...
global e01w_prt_delay03 e01w_prt_delay03
...
String 	ls_where, 			ls_temp, 			ls_module, ls_ref_no, 	ls_ref_desc, &
			...
			ls_base,				ls_customerid,		ls_service
...
If isnull( li_from ) Then			li_from	=	0
...
If ls_base <> "" Then
	If ls_where <> "" Then ls_where += " AND "
	ls_where += " cus.basecod = '" + ls_base + "' "
End If
If ls_customerid <> "" Then
	If ls_where <> "" Then ls_where += " AND "
	ls_where += " DLYMST.PAYID = '" + ls_customerid + "' "
End If
If ls_service <> "" Then
	If ls_where <> "" Then ls_where += " AND "
...
event ue_saveas();Long	lp, ll_row,	ll_cnt, jj, ll_rowcnt
DEC{2} ldc_amt
...
type dw_cond from w_a_print`dw_cond within e01w_prt_delay03
integer x = 50
integer y = 36
integer width = 1742
integer height = 380
...
type p_ok from w_a_print`p_ok within e01w_prt_delay03
integer x = 1879
integer y = 36
end type

type p_close from w_a_print`p_close within e01w_prt_delay03
integer x = 2190
integer y = 36
end type

type dw_list from w_a_print`dw_list within e01w_prt_delay03
integer x = 23
integer y = 432
integer height = 1236
string dataobject = "e01d_prt_delay03"
end type
...
type p_1 from w_a_print`p_1 within e01w_prt_delay03
end type

type p_2 from w_a_print`p_2 within e01w_prt_delay03
end type

type p_3 from w_a_print`p_3 within e01w_prt_delay03
end type

type p_5 from w_a_print`p_5 within e01w_prt_delay03
end type

type p_6 from w_a_print`p_6 within e01w_prt_delay03
end type

type p_7 from w_a_print`p_7 within e01w_prt_delay03
end type

type p_8 from w_a_print`p_8 within e01w_prt_delay03
end type

type p_9 from w_a_print`p_9 within e01w_prt_delay03
end type

type p_4 from w_a_print`p_4 within e01w_prt_delay03
end type

type gb_1 from w_a_print`gb_1 within e01w_prt_delay03
end type

type p_port from w_a_print`p_port within e01w_prt_delay03
end type

type p_land from w_a_print`p_land within e01w_prt_delay03
end type

type gb_cond from w_a_print`gb_cond within e01w_prt_delay03
integer width = 1801
integer height = 428
end type

type p_saveas from w_a_print`p_saveas within e01w_prt_delay03
end type
