$PBExportHeader$e01w_reg_del_last_set.srw
$PBExportComments$[parkkh] 연체자 조치사항 등록
forward
global type e01w_reg_del_last_set from w_a_reg_m_sql
end type
type dw_term from u_d_base within e01w_reg_del_last_set
end type
end forward
...
global e01w_reg_del_last_set e01w_reg_del_last_set
...
on e01w_reg_del_last_set.create
int iCurrent
call super::create
...
on e01w_reg_del_last_set.destroy
call super::destroy
...
type dw_cond from w_a_reg_m_sql`dw_cond within e01w_reg_del_last_set
integer x = 41
integer y = 40
integer width = 1614
integer height = 340
string dataobject = "e01d_cnd_del_last"
boolean hscrollbar = false
boolean vscrollbar = false
boolean livescroll = false
end type

type p_ok from w_a_reg_m_sql`p_ok within e01w_reg_del_last_set
integer x = 1742
integer y = 48
end type

type p_close from w_a_reg_m_sql`p_close within e01w_reg_del_last_set
integer x = 2350
integer y = 48
end type

type gb_cond from w_a_reg_m_sql`gb_cond within e01w_reg_del_last_set
integer width = 1669
integer height = 404
end type

type p_save from w_a_reg_m_sql`p_save within e01w_reg_del_last_set
integer x = 2043
integer y = 48
end type

type dw_detail from w_a_reg_m_sql`dw_detail within e01w_reg_del_last_set
integer x = 23
integer y = 424
integer width = 2702
integer height = 908
