$PBExportHeader$e01w_reg_select_dly_new.srw
$PBExportComments$[parkkh] 연체대상자추출
forward
global type e01w_reg_select_dly_new from w_a_reg_m_sql
end type
end forward
...
global e01w_reg_select_dly_new e01w_reg_select_dly_new

type variables

end variables

on e01w_reg_select_dly_new.create
call super::create
end on

on e01w_reg_select_dly_new.destroy
call super::destroy
end on
...
event ue_save_sql;Integer li_return
...
SQLCA.e01_select_dly_bysvc(ll_dly_mfr, ll_dly_mto, gs_pgm_id[gi_open_win_no], gs_user_id,ls_stddt, ll_return, ls_errmsg, lb_count)
...
type dw_cond from w_a_reg_m_sql`dw_cond within e01w_reg_select_dly_new
integer x = 41
integer width = 1010
integer height = 224
...
type p_ok from w_a_reg_m_sql`p_ok within e01w_reg_select_dly_new
integer x = 1097
integer y = 44
end type

type p_close from w_a_reg_m_sql`p_close within e01w_reg_select_dly_new
integer x = 1691
integer y = 44
end type

type gb_cond from w_a_reg_m_sql`gb_cond within e01w_reg_select_dly_new
integer width = 1033
integer height = 280
end type

type p_save from w_a_reg_m_sql`p_save within e01w_reg_select_dly_new
integer x = 1394
integer y = 44
end type

type dw_detail from w_a_reg_m_sql`dw_detail within e01w_reg_select_dly_new
integer y = 292
integer width = 1943
integer height = 984
