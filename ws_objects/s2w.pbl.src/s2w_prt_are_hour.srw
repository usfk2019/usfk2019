$PBExportHeader$s2w_prt_are_hour.srw
$PBExportComments$[ceusee] 지역별 시간대 통계 보고서
forward
global type s2w_prt_are_hour from w_a_print
end type
end forward

global type s2w_prt_are_hour from w_a_print
end type
global s2w_prt_are_hour s2w_prt_are_hour

on s2w_prt_are_hour.create
call super::create
end on

on s2w_prt_are_hour.destroy
call super::destroy
end on
...
event open;call super::open;/*------------------------------------------------------------------------
	Name	:	s1w_prt_are_hour
	Desc.	: 	지역별 시간대별 통계 리스트 
	Ver.	:	1.0
	Date	:	2003.01.13
...
type dw_cond from w_a_print`dw_cond within s2w_prt_are_hour
integer width = 1691
integer height = 348
string dataobject = "s2dw_cnd_reg_are_hour"
boolean hscrollbar = false
boolean vscrollbar = false
boolean livescroll = false
end type

type p_ok from w_a_print`p_ok within s2w_prt_are_hour
integer x = 2117
integer y = 60
end type

type p_close from w_a_print`p_close within s2w_prt_are_hour
integer x = 2427
integer y = 60
end type

type dw_list from w_a_print`dw_list within s2w_prt_are_hour
integer y = 452
integer height = 1168
string dataobject = "s2dw_prt_are_hour"
end type

type p_1 from w_a_print`p_1 within s2w_prt_are_hour
end type

type p_2 from w_a_print`p_2 within s2w_prt_are_hour
end type

type p_3 from w_a_print`p_3 within s2w_prt_are_hour
end type

type p_5 from w_a_print`p_5 within s2w_prt_are_hour
end type

type p_6 from w_a_print`p_6 within s2w_prt_are_hour
end type

type p_7 from w_a_print`p_7 within s2w_prt_are_hour
end type

type p_8 from w_a_print`p_8 within s2w_prt_are_hour
end type

type p_9 from w_a_print`p_9 within s2w_prt_are_hour
end type

type p_4 from w_a_print`p_4 within s2w_prt_are_hour
end type

type gb_1 from w_a_print`gb_1 within s2w_prt_are_hour
end type

type p_port from w_a_print`p_port within s2w_prt_are_hour
end type

type p_land from w_a_print`p_land within s2w_prt_are_hour
end type

type gb_cond from w_a_print`gb_cond within s2w_prt_are_hour
integer width = 1746
integer height = 428
end type

type p_saveas from w_a_print`p_saveas within s2w_prt_are_hour
end type
