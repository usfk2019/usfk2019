$PBExportHeader$s2w_prt_are_week.srw
$PBExportComments$[ceusee] 지역별 요일 통계 보고서
forward
global type s2w_prt_are_week from w_a_print
end type
end forward

global type s2w_prt_are_week from w_a_print
end type
global s2w_prt_are_week s2w_prt_are_week

on s2w_prt_are_week.create
call super::create
end on

on s2w_prt_are_week.destroy
call super::destroy
end on
...
type dw_cond from w_a_print`dw_cond within s2w_prt_are_week
integer y = 40
integer width = 1737
integer height = 340
...
type p_ok from w_a_print`p_ok within s2w_prt_are_week
integer x = 1961
integer y = 56
end type

type p_close from w_a_print`p_close within s2w_prt_are_week
integer x = 2277
integer y = 56
end type

type dw_list from w_a_print`dw_list within s2w_prt_are_week
integer y = 436
integer height = 1184
string dataobject = "s2dw_prt_are_week"
end type

type p_1 from w_a_print`p_1 within s2w_prt_are_week
end type

type p_2 from w_a_print`p_2 within s2w_prt_are_week
end type

type p_3 from w_a_print`p_3 within s2w_prt_are_week
end type

type p_5 from w_a_print`p_5 within s2w_prt_are_week
end type

type p_6 from w_a_print`p_6 within s2w_prt_are_week
end type

type p_7 from w_a_print`p_7 within s2w_prt_are_week
end type

type p_8 from w_a_print`p_8 within s2w_prt_are_week
end type

type p_9 from w_a_print`p_9 within s2w_prt_are_week
end type

type p_4 from w_a_print`p_4 within s2w_prt_are_week
end type

type gb_1 from w_a_print`gb_1 within s2w_prt_are_week
end type

type p_port from w_a_print`p_port within s2w_prt_are_week
end type

type p_land from w_a_print`p_land within s2w_prt_are_week
end type

type gb_cond from w_a_print`gb_cond within s2w_prt_are_week
integer width = 1774
integer height = 404
end type

type p_saveas from w_a_print`p_saveas within s2w_prt_are_week
end type
