$PBExportHeader$s2w_prt_hour_graph.srw
$PBExportComments$[kem] 시간대 통계 그래프
forward
global type s2w_prt_hour_graph from w_a_print
end type
end forward

global type s2w_prt_hour_graph from w_a_print
end type
global s2w_prt_hour_graph s2w_prt_hour_graph

on s2w_prt_hour_graph.create
call super::create
end on

on s2w_prt_hour_graph.destroy
call super::destroy
end on
...
//데이터 윈도우 바꾸기 
If ls_type = "1"  Then 
	dw_list.DataObject = "s2dw_prt_hour_graph"
	dw_list.SetTransObject(SQLCA)
	dw_list.is_where = ls_where
ElseIf ls_type = "2" Then
	dw_list.DataObject = "s2dw_prt_hour_graphpie"
	dw_list.SetTransObject(SQLCA)
	dw_list.is_where = ls_where
End If
...
type dw_cond from w_a_print`dw_cond within s2w_prt_hour_graph
integer width = 1330
string dataobject = "s2dw_cnd_reg_hour_graph"
boolean hscrollbar = false
boolean vscrollbar = false
boolean livescroll = false
end type

type p_ok from w_a_print`p_ok within s2w_prt_hour_graph
integer x = 1550
end type

type p_close from w_a_print`p_close within s2w_prt_hour_graph
integer x = 1851
end type

type dw_list from w_a_print`dw_list within s2w_prt_hour_graph
string dataobject = "s2dw_prt_hour_graph"
end type

type p_1 from w_a_print`p_1 within s2w_prt_hour_graph
end type

type p_2 from w_a_print`p_2 within s2w_prt_hour_graph
end type

type p_3 from w_a_print`p_3 within s2w_prt_hour_graph
end type

type p_5 from w_a_print`p_5 within s2w_prt_hour_graph
end type

type p_6 from w_a_print`p_6 within s2w_prt_hour_graph
end type

type p_7 from w_a_print`p_7 within s2w_prt_hour_graph
end type

type p_8 from w_a_print`p_8 within s2w_prt_hour_graph
end type

type p_9 from w_a_print`p_9 within s2w_prt_hour_graph
end type

type p_4 from w_a_print`p_4 within s2w_prt_hour_graph
end type

type gb_1 from w_a_print`gb_1 within s2w_prt_hour_graph
end type

type p_port from w_a_print`p_port within s2w_prt_hour_graph
end type

type p_land from w_a_print`p_land within s2w_prt_hour_graph
end type

type gb_cond from w_a_print`gb_cond within s2w_prt_hour_graph
integer width = 1413
end type

type p_saveas from w_a_print`p_saveas within s2w_prt_hour_graph
end type
