$PBExportHeader$s2w_prt_priceplan.srw
$PBExportComments$[cusee] 상품별일일통계보고서
forward
global type s2w_prt_priceplan from w_a_print
end type
end forward

global type s2w_prt_priceplan from w_a_print
end type
global s2w_prt_priceplan s2w_prt_priceplan

on s2w_prt_priceplan.create
call super::create
end on

on s2w_prt_priceplan.destroy
call super::destroy
end on
...
lu_dbmgr.is_caller = "s2w_prt_priceplan%ok"
...
If ls_format = "1" Then
	...
	dw_list.object.sub_amt.Format = "#,##0.0"
...
type dw_cond from w_a_print`dw_cond within s2w_prt_priceplan
integer width = 1678
integer height = 300
string dataobject = "s2dw_cnd_reg_priceplan"
boolean hscrollbar = false
boolean vscrollbar = false
boolean livescroll = false
end type

type p_ok from w_a_print`p_ok within s2w_prt_priceplan
integer x = 1865
end type

type p_close from w_a_print`p_close within s2w_prt_priceplan
integer x = 2167
end type

type dw_list from w_a_print`dw_list within s2w_prt_priceplan
integer y = 372
integer height = 1248
string dataobject = "s2dw_prt_priceplan"
end type

type p_1 from w_a_print`p_1 within s2w_prt_priceplan
end type

type p_2 from w_a_print`p_2 within s2w_prt_priceplan
end type

type p_3 from w_a_print`p_3 within s2w_prt_priceplan
end type

type p_5 from w_a_print`p_5 within s2w_prt_priceplan
end type

type p_6 from w_a_print`p_6 within s2w_prt_priceplan
end type

type p_7 from w_a_print`p_7 within s2w_prt_priceplan
end type

type p_8 from w_a_print`p_8 within s2w_prt_priceplan
end type

type p_9 from w_a_print`p_9 within s2w_prt_priceplan
end type

type p_4 from w_a_print`p_4 within s2w_prt_priceplan
end type

type gb_1 from w_a_print`gb_1 within s2w_prt_priceplan
end type

type p_port from w_a_print`p_port within s2w_prt_priceplan
end type

type p_land from w_a_print`p_land within s2w_prt_priceplan
end type

type gb_cond from w_a_print`gb_cond within s2w_prt_priceplan
integer width = 1723
integer height = 364
end type

type p_saveas from w_a_print`p_saveas within s2w_prt_priceplan
end type
