$PBExportHeader$u_calendar_sams2.sru
$PBExportComments$Drop-down calendar
forward
global type u_calendar_sams2 from userobject
end type
type pb_monprev from picturebutton within u_calendar_sams2
end type
type pb_monnext from picturebutton within u_calendar_sams2
end type
type pb_yrprev from picturebutton within u_calendar_sams2
end type
type pb_yrnext from picturebutton within u_calendar_sams2
end type
type dw_cal from datawindow within u_calendar_sams2
end type
end forward
...
global u_calendar_sams2 u_calendar_sams2
