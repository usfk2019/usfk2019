$PBExportHeader$b1w_1_hlp_customerm_sams.srw
$PBExportComments$Help : 사용자 ID
forward
global type b1w_1_hlp_customerm_sams from w_a_hlp
end type
end forward
...
global b1w_1_hlp_customerm_sams b1w_1_hlp_customerm_sams

on b1w_1_hlp_customerm_sams.create
call super::create
end on

on b1w_1_hlp_customerm_sams.destroy
call super::destroy
end on
...
type p_1 from w_a_hlp`p_1 within b1w_1_hlp_customerm_sams
integer x = 2011
integer y = 52
integer taborder = 1
end type

type dw_cond from w_a_hlp`dw_cond within b1w_1_hlp_customerm_sams
integer x = 41
integer y = 44
integer width = 1847
integer height = 188
integer taborder = 0
string dataobject = "b1dw_1_cnd_hlp_customerm_sams"
end type

type p_ok from w_a_hlp`p_ok within b1w_1_hlp_customerm_sams
integer x = 2313
integer y = 52
boolean originalsize = false
end type

type p_close from w_a_hlp`p_close within b1w_1_hlp_customerm_sams
integer x = 2610
integer y = 52
end type

type gb_cond from w_a_hlp`gb_cond within b1w_1_hlp_customerm_sams
integer x = 14
integer width = 1893
integer height = 248
integer taborder = 0
...
type dw_hlp from w_a_hlp`dw_hlp within b1w_1_hlp_customerm_sams
integer x = 18
integer y = 276
integer width = 3017
integer height = 1476
string dataobject = "b1dw_1_hlp_customerm_sams"
