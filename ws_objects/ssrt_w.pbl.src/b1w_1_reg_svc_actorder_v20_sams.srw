$PBExportHeader$b1w_1_reg_svc_actorder_v20_sams.srw
$PBExportComments$Service Request
forward
global type b1w_1_reg_svc_actorder_v20_sams from w_a_reg_m_m3
end type
type uo_1 from u_calendar_sams within b1w_1_reg_svc_actorder_v20_sams
end type
end forward
...
global b1w_1_reg_svc_actorder_v20_sams b1w_1_reg_svc_actorder_v20_sams
...
on b1w_1_reg_svc_actorder_v20_sams.create
int iCurrent
call super::create
...
on b1w_1_reg_svc_actorder_v20_sams.destroy
call super::destroy
destroy(this.uo_1)
end on

event open;call w_a_condition::open
...
IF dw_cond.object.related_order.visible AND ls_related_orderno = "" THEN
...
type dw_cond from w_a_reg_m_m3`dw_cond within b1w_1_reg_svc_actorder_v20_sams
integer x = 32
integer y = 60
integer width = 2674
integer height = 692
integer taborder = 10
string dataobject = "b1dw_1_cnd_reg_svc_actorder_v20_sams"
...
type p_ok from w_a_reg_m_m3`p_ok within b1w_1_reg_svc_actorder_v20_sams
integer x = 3662
end type

type p_close from w_a_reg_m_m3`p_close within b1w_1_reg_svc_actorder_v20_sams
integer x = 3662
integer y = 164
boolean originalsize = false
end type

type gb_cond from w_a_reg_m_m3`gb_cond within b1w_1_reg_svc_actorder_v20_sams
integer x = 23
integer width = 2697
integer height = 772
integer taborder = 0
...
type dw_master from w_a_reg_m_m3`dw_master within b1w_1_reg_svc_actorder_v20_sams
...
type dw_detail from w_a_reg_m_m3`dw_detail within b1w_1_reg_svc_actorder_v20_sams
integer x = 23
integer y = 1460
integer width = 3611
integer height = 356
...
type p_insert from w_a_reg_m_m3`p_insert within b1w_1_reg_svc_actorder_v20_sams
integer x = 55
integer y = 1828
end type

type p_delete from w_a_reg_m_m3`p_delete within b1w_1_reg_svc_actorder_v20_sams
integer x = 347
integer y = 1828
end type

type p_save from w_a_reg_m_m3`p_save within b1w_1_reg_svc_actorder_v20_sams
integer x = 640
integer y = 1828
end type

type p_reset from w_a_reg_m_m3`p_reset within b1w_1_reg_svc_actorder_v20_sams
integer x = 1390
integer y = 1828
end type

type dw_detail2 from w_a_reg_m_m3`dw_detail2 within b1w_1_reg_svc_actorder_v20_sams
integer x = 23
integer y = 820
integer width = 3616
integer height = 592
...
type st_horizontal2 from w_a_reg_m_m3`st_horizontal2 within b1w_1_reg_svc_actorder_v20_sams
integer x = 18
integer y = 776
integer height = 36
end type
...
type st_horizontal from w_a_reg_m_m3`st_horizontal within b1w_1_reg_svc_actorder_v20_sams
boolean visible = false
integer x = 23
integer y = 1420
integer height = 36
...
iu_cust_msg.is_data[9] = gs_shopid
