$PBExportHeader$b1w_hlp_validkeymst_v20_sams.srw
$PBExportComments$Help 인증MST-인증Key
forward
global type b1w_hlp_validkeymst_v20_sams from w_a_hlp
end type
end forward
...
global b1w_hlp_validkeymst_v20_sams b1w_hlp_validkeymst_v20_sams

type variables
String is_bonsa_partner, is_used_level, is_used_level_code[], is_partner
end variables

on b1w_hlp_validkeymst_v20_sams.create
call super::create
end on

on b1w_hlp_validkeymst_v20_sams.destroy
call super::destroy
end on
...
type p_1 from w_a_hlp`p_1 within b1w_hlp_validkeymst_v20_sams
integer x = 1691
integer y = 44
end type

type dw_cond from w_a_hlp`dw_cond within b1w_hlp_validkeymst_v20_sams
integer x = 69
integer y = 56
integer width = 1376
integer height = 280
...
type p_ok from w_a_hlp`p_ok within b1w_hlp_validkeymst_v20_sams
integer x = 1989
integer y = 44
end type

type p_close from w_a_hlp`p_close within b1w_hlp_validkeymst_v20_sams
integer x = 2286
integer y = 44
end type

type gb_cond from w_a_hlp`gb_cond within b1w_hlp_validkeymst_v20_sams
integer width = 1445
integer height = 360
end type

type dw_hlp from w_a_hlp`dw_hlp within b1w_hlp_validkeymst_v20_sams
integer x = 27
integer y = 372
integer width = 3424
integer height = 1188
string dataobject = "b1dw_hlp_validkeymst_v20_sams"
boolean livescroll = false
end type
