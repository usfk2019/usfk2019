$PBExportHeader$b5w_reg_hotreqdtl_ssrt.srw
$PBExportComments$Hot Bill 계산
forward
global type b5w_reg_hotreqdtl_ssrt from w_a_reg_s
end type
type p_cancel from u_p_cancel within b5w_reg_hotreqdtl_ssrt
end type
type cb_hotbill from commandbutton within b5w_reg_hotreqdtl_ssrt
end type
type dw_split from datawindow within b5w_reg_hotreqdtl_ssrt
end type
type hpb_1 from hprogressbar within b5w_reg_hotreqdtl_ssrt
end type
type gb_3 from groupbox within b5w_reg_hotreqdtl_ssrt
end type
end forward
...
global b5w_reg_hotreqdtl_ssrt b5w_reg_hotreqdtl_ssrt
...
on b5w_reg_hotreqdtl_ssrt.create
int iCurrent
call super::create
...
on b5w_reg_hotreqdtl_ssrt.destroy
call super::destroy
...
type dw_cond from w_a_reg_s`dw_cond within b5w_reg_hotreqdtl_ssrt
integer width = 2455
integer height = 536
...
type p_ok from w_a_reg_s`p_ok within b5w_reg_hotreqdtl_ssrt
boolean visible = false
integer x = 2619
integer y = 252
end type

type p_close from w_a_reg_s`p_close within b5w_reg_hotreqdtl_ssrt
integer x = 2619
integer y = 28
boolean originalsize = false
end type

type gb_cond from w_a_reg_s`gb_cond within b5w_reg_hotreqdtl_ssrt
integer width = 2478
integer height = 588
end type

type dw_detail from w_a_reg_s`dw_detail within b5w_reg_hotreqdtl_ssrt
integer x = 50
integer y = 608
integer width = 2455
integer height = 1204
...
type p_delete from w_a_reg_s`p_delete within b5w_reg_hotreqdtl_ssrt
boolean visible = false
integer x = 416
integer y = 1848
end type

type p_insert from w_a_reg_s`p_insert within b5w_reg_hotreqdtl_ssrt
boolean visible = false
integer x = 123
integer y = 1848
end type

type p_save from w_a_reg_s`p_save within b5w_reg_hotreqdtl_ssrt
integer x = 137
integer y = 1848
end type

type p_reset from w_a_reg_s`p_reset within b5w_reg_hotreqdtl_ssrt
integer x = 782
integer y = 1848
end type
...
Else
   ...
   End IF                // 2005.01.10.  khpark modify end 청구내역자료collection에 return = 2 추가        
	...
	Insert Into Hotreqdtl (
						reqnum, 		seq, 				payid, 		customerid,          trdt, 			
						paydt,											transdt,		
						trcod, 											tramt, 					adjamt, remark,
						crtdt, 		crt_user, 		pgm_id)
	   Values(	:is_reqnum, :ll_max_seq, 	:is_payid, 		:is_payid, 				to_date(:ls_trdt, 'yyyymmdd'), 
//						to_date(:ls_paydt, 'yyyymmdd'),			to_date(:ls_paydt, 'yyyymmdd'), 
                  sysdate,                               sysdate,
						:ls_refund[2], 								:ldc_refund,			0, :is_termdt,
				  		sysdate, 	:gs_user_id,	:gs_pgm_id[gi_open_win_no]);
