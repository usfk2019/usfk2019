$PBExportHeader$b5w_reg_hotreqdtl_ssrt_new.srw
$PBExportComments$Hot Bill 계산
forward
global type b5w_reg_hotreqdtl_ssrt_new from w_a_reg_s
end type
type p_cancel from u_p_cancel within b5w_reg_hotreqdtl_ssrt_new
end type
type cb_hotbill from commandbutton within b5w_reg_hotreqdtl_ssrt_new
end type
type dw_split from datawindow within b5w_reg_hotreqdtl_ssrt_new
end type
type hpb_1 from hprogressbar within b5w_reg_hotreqdtl_ssrt_new
end type
type cb_1 from commandbutton within b5w_reg_hotreqdtl_ssrt_new
end type
type gb_3 from groupbox within b5w_reg_hotreqdtl_ssrt_new
end type
end forward
...
global b5w_reg_hotreqdtl_ssrt_new b5w_reg_hotreqdtl_ssrt_new
...
Long		ll_row,			ll_max_seq,		ll_count = 0
...
on b5w_reg_hotreqdtl_ssrt_new.create
int iCurrent
call super::create
...
on b5w_reg_hotreqdtl_ssrt_new.destroy
call super::destroy
...
type dw_cond from w_a_reg_s`dw_cond within b5w_reg_hotreqdtl_ssrt_new
integer width = 2455
integer height = 536
...
type p_ok from w_a_reg_s`p_ok within b5w_reg_hotreqdtl_ssrt_new
boolean visible = false
integer x = 2619
integer y = 252
end type

type p_close from w_a_reg_s`p_close within b5w_reg_hotreqdtl_ssrt_new
integer x = 969
integer y = 1848
boolean originalsize = false
end type

type gb_cond from w_a_reg_s`gb_cond within b5w_reg_hotreqdtl_ssrt_new
integer width = 2478
integer height = 588
end type

type dw_detail from w_a_reg_s`dw_detail within b5w_reg_hotreqdtl_ssrt_new
integer x = 50
integer y = 608
integer width = 2455
integer height = 1204
...
type p_delete from w_a_reg_s`p_delete within b5w_reg_hotreqdtl_ssrt_new
boolean visible = false
integer x = 416
integer y = 1848
end type

type p_insert from w_a_reg_s`p_insert within b5w_reg_hotreqdtl_ssrt_new
boolean visible = false
integer x = 123
integer y = 1848
end type

type p_save from w_a_reg_s`p_save within b5w_reg_hotreqdtl_ssrt_new
integer x = 50
integer y = 1848
end type

type p_reset from w_a_reg_s`p_reset within b5w_reg_hotreqdtl_ssrt_new
integer x = 663
integer y = 1848
end type
