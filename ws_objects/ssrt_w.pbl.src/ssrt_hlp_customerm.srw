$PBExportHeader$ssrt_hlp_customerm.srw
$PBExportComments$[1hera] Help : Customer INFO
forward
global type ssrt_hlp_customerm from w_a_hlp
end type
end forward
...
global ssrt_hlp_customerm ssrt_hlp_customerm

on ssrt_hlp_customerm.create
call super::create
end on

on ssrt_hlp_customerm.destroy
call super::destroy
end on
...
event open;call super::open;This.Title = "Help - Customer Info"
//is_default = "ue_find"
end event
...
type p_1 from w_a_hlp`p_1 within ssrt_hlp_customerm
integer x = 2011
integer y = 52
integer taborder = 1
end type

type dw_cond from w_a_hlp`dw_cond within ssrt_hlp_customerm
integer x = 41
integer y = 44
integer width = 1847
integer height = 188
...
type p_ok from w_a_hlp`p_ok within ssrt_hlp_customerm
integer x = 2313
integer y = 52
boolean originalsize = false
end type

type p_close from w_a_hlp`p_close within ssrt_hlp_customerm
integer x = 2610
integer y = 52
end type

type gb_cond from w_a_hlp`gb_cond within ssrt_hlp_customerm
integer x = 14
integer width = 1893
integer height = 248
integer taborder = 0
...
type dw_hlp from w_a_hlp`dw_hlp within ssrt_hlp_customerm
integer x = 18
integer y = 276
integer width = 3017
integer height = 1476
