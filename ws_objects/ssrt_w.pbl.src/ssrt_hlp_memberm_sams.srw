$PBExportHeader$ssrt_hlp_memberm_sams.srw
$PBExportComments$[1hera] Help : 멤버 ID
forward
global type ssrt_hlp_memberm_sams from w_a_hlp
end type
end forward
...
global ssrt_hlp_memberm_sams ssrt_hlp_memberm_sams

on ssrt_hlp_memberm_sams.create
call super::create
end on

on ssrt_hlp_memberm_sams.destroy
call super::destroy
end on
...
event open;call super::open;This.Title = "Help - 사용자 Member ID"
end event
...
iu_cust_help.is_data[1] = Trim(dw_hlp.Object.memberid[al_selrow])
iu_cust_help.is_data[2] = Trim(dw_hlp.Object.customernm[al_selrow])
iu_cust_help.is_data[3] = Trim(dw_hlp.Object.status[al_selrow])

end event

type p_1 from w_a_hlp`p_1 within ssrt_hlp_memberm_sams
integer x = 2011
integer y = 52
end type

type dw_cond from w_a_hlp`dw_cond within ssrt_hlp_memberm_sams
integer x = 41
integer y = 44
integer width = 1847
integer height = 188
string dataobject = "ssrt_cnd_hlp_memberm_sams"
end type

type p_ok from w_a_hlp`p_ok within ssrt_hlp_memberm_sams
integer x = 2313
integer y = 52
boolean originalsize = false
end type

type p_close from w_a_hlp`p_close within ssrt_hlp_memberm_sams
integer x = 2610
integer y = 52
end type

type gb_cond from w_a_hlp`gb_cond within ssrt_hlp_memberm_sams
integer x = 14
integer width = 1893
integer height = 248
end type

type dw_hlp from w_a_hlp`dw_hlp within ssrt_hlp_memberm_sams
integer x = 18
integer y = 276
integer width = 3017
integer height = 1476
