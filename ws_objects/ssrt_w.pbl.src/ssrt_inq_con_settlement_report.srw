$PBExportHeader$ssrt_inq_con_settlement_report.srw
$PBExportComments$[kem] aafes settlement report
forward
global type ssrt_inq_con_settlement_report from w_a_inq_m
end type
type cb_dr from commandbutton within ssrt_inq_con_settlement_report
end type
type dw_regcod from datawindow within ssrt_inq_con_settlement_report
end type
type p_1 from u_p_saveas within ssrt_inq_con_settlement_report
end type
end forward
...
global ssrt_inq_con_settlement_report ssrt_inq_con_settlement_report
...
on ssrt_inq_con_settlement_report.create
int iCurrent
call super::create
...
on ssrt_inq_con_settlement_report.destroy
call super::destroy
destroy(this.cb_dr)
...
type dw_cond from w_a_inq_m`dw_cond within ssrt_inq_con_settlement_report
integer x = 55
integer y = 60
integer width = 2167
integer height = 284
...
type p_ok from w_a_inq_m`p_ok within ssrt_inq_con_settlement_report
integer x = 2290
end type

type p_close from w_a_inq_m`p_close within ssrt_inq_con_settlement_report
integer x = 2885
boolean originalsize = false
end type

type gb_cond from w_a_inq_m`gb_cond within ssrt_inq_con_settlement_report
integer width = 2213
integer height = 380
end type

type dw_detail from w_a_inq_m`dw_detail within ssrt_inq_con_settlement_report
integer x = 32
integer y = 400
integer width = 3150
integer height = 1372
...
OpenWithParm(ssrt_prt_con_settlement_report, iu_cust_msg)
