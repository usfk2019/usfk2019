$PBExportHeader$ssrt_inq_report_sams_new_vat.srw
$PBExportComments$보고서-SAMS
forward
global type ssrt_inq_report_sams_new_vat from w_a_inq_m
end type
type cb_dr from commandbutton within ssrt_inq_report_sams_new_vat
end type
type cb_xr from commandbutton within ssrt_inq_report_sams_new_vat
end type
type dw_regcod from datawindow within ssrt_inq_report_sams_new_vat
end type
type p_1 from u_p_saveas within ssrt_inq_report_sams_new_vat
end type
type cb_zr from commandbutton within ssrt_inq_report_sams_new_vat
end type
end forward
...
global ssrt_inq_report_sams_new_vat ssrt_inq_report_sams_new_vat
...
on ssrt_inq_report_sams_new_vat.create
int iCurrent
call super::create
...
on ssrt_inq_report_sams_new_vat.destroy
call super::destroy
destroy(this.cb_dr)
destroy(this.cb_xr)
...
type dw_cond from w_a_inq_m`dw_cond within ssrt_inq_report_sams_new_vat
integer x = 55
integer y = 44
integer width = 2167
integer height = 424
...
type p_ok from w_a_inq_m`p_ok within ssrt_inq_report_sams_new_vat
integer x = 2272
integer y = 36
end type

type p_close from w_a_inq_m`p_close within ssrt_inq_report_sams_new_vat
integer x = 2592
integer y = 36
boolean originalsize = false
end type

type gb_cond from w_a_inq_m`gb_cond within ssrt_inq_report_sams_new_vat
integer width = 2213
integer height = 504
end type

type dw_detail from w_a_inq_m`dw_detail within ssrt_inq_report_sams_new_vat
integer x = 32
integer y = 512
integer height = 1260
string dataobject = "ssrt_inq_report_daily_new_vat"
end type
...
dec{2}	ldec_payamt, 	ldec_totpayamt_d, 	ldec_totpayamt_c, ldec_total, &
			...
			ldec_payamt2,	ldc_payamt,				ldc_in2
DEC	 	ldc_shopCount
