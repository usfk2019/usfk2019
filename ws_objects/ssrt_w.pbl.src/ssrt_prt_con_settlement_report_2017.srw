$PBExportHeader$ssrt_prt_con_settlement_report_2017.srw
$PBExportComments$[kem] AAFES settlement report 출력물
forward
global type ssrt_prt_con_settlement_report_2017 from w_a_print
end type
end forward
...
global ssrt_prt_con_settlement_report_2017 ssrt_prt_con_settlement_report_2017
...
on ssrt_prt_con_settlement_report_2017.create
call super::create
end on

on ssrt_prt_con_settlement_report_2017.destroy
call super::destroy
end on
...
type dw_cond from w_a_print`dw_cond within ssrt_prt_con_settlement_report_2017
...
type p_ok from w_a_print`p_ok within ssrt_prt_con_settlement_report_2017
boolean visible = false
integer x = 2318
integer y = 60
end type

type p_close from w_a_print`p_close within ssrt_prt_con_settlement_report_2017
integer x = 2619
integer y = 60
end type

type dw_list from w_a_print`dw_list within ssrt_prt_con_settlement_report_2017
integer y = 260
integer width = 3232
integer height = 1348
...
type p_1 from w_a_print`p_1 within ssrt_prt_con_settlement_report_2017
end type

type p_2 from w_a_print`p_2 within ssrt_prt_con_settlement_report_2017
end type

type p_3 from w_a_print`p_3 within ssrt_prt_con_settlement_report_2017
end type

type p_5 from w_a_print`p_5 within ssrt_prt_con_settlement_report_2017
end type

type p_6 from w_a_print`p_6 within ssrt_prt_con_settlement_report_2017
end type

type p_7 from w_a_print`p_7 within ssrt_prt_con_settlement_report_2017
end type

type p_8 from w_a_print`p_8 within ssrt_prt_con_settlement_report_2017
end type

type p_9 from w_a_print`p_9 within ssrt_prt_con_settlement_report_2017
end type

type p_4 from w_a_print`p_4 within ssrt_prt_con_settlement_report_2017
end type

type gb_1 from w_a_print`gb_1 within ssrt_prt_con_settlement_report_2017
end type

type p_port from w_a_print`p_port within ssrt_prt_con_settlement_report_2017
end type

type p_land from w_a_print`p_land within ssrt_prt_con_settlement_report_2017
end type

type gb_cond from w_a_print`gb_cond within ssrt_prt_con_settlement_report_2017
boolean visible = false
integer width = 2254
integer height = 240
end type

type p_saveas from w_a_print`p_saveas within ssrt_prt_con_settlement_report_2017
end type
