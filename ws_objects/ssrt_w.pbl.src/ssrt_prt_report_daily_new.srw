$PBExportHeader$ssrt_prt_report_daily_new.srw
$PBExportComments$[1hera]ssrt Daily Report
forward
global type ssrt_prt_report_daily_new from w_a_print
end type
end forward
...
global ssrt_prt_report_daily_new ssrt_prt_report_daily_new
...
on ssrt_prt_report_daily_new.create
call super::create
end on

on ssrt_prt_report_daily_new.destroy
call super::destroy
end on
...
IF ldc_payamt <> 0 THEN
	wf_cut(ldc_payamt)
	dw_list.object.t_op_1.Text = is_fm1
	dw_list.object.t_op_2.Text = is_fm2
	dw_list.object.t_op_3.Text = is_fm3
END IF
...
FOR ll = 3  to 6
	...
	IF ldc_payamt <> 0 THEN
		...
		case 6
				dw_list.object.t_f41.Text = is_fm1
				dw_list.object.t_f42.Text = is_fm2
				dw_list.object.t_f43.Text = is_fm3				
		end choose
	END IF
	...
	IF ldc_payamt <> 0 THEN
		...
		case 6
				dw_list.object.t_f44.Text = is_fm1
				dw_list.object.t_f45.Text = is_fm2
				dw_list.object.t_f46.Text = is_fm3				
		end choose
	END IF
NEXT
...
type dw_cond from w_a_print`dw_cond within ssrt_prt_report_daily_new
...
type p_ok from w_a_print`p_ok within ssrt_prt_report_daily_new
boolean visible = false
integer x = 2318
integer y = 60
end type

type p_close from w_a_print`p_close within ssrt_prt_report_daily_new
integer x = 2619
integer y = 60
end type

type dw_list from w_a_print`dw_list within ssrt_prt_report_daily_new
integer y = 260
integer width = 3232
integer height = 1348
string dataobject = "ssrt_prt_daily_report_ALL_1_new"
end type

type p_1 from w_a_print`p_1 within ssrt_prt_report_daily_new
end type

type p_2 from w_a_print`p_2 within ssrt_prt_report_daily_new
end type

type p_3 from w_a_print`p_3 within ssrt_prt_report_daily_new
end type

type p_5 from w_a_print`p_5 within ssrt_prt_report_daily_new
end type

type p_6 from w_a_print`p_6 within ssrt_prt_report_daily_new
end type

type p_7 from w_a_print`p_7 within ssrt_prt_report_daily_new
end type

type p_8 from w_a_print`p_8 within ssrt_prt_report_daily_new
end type

type p_9 from w_a_print`p_9 within ssrt_prt_report_daily_new
end type

type p_4 from w_a_print`p_4 within ssrt_prt_report_daily_new
end type

type gb_1 from w_a_print`gb_1 within ssrt_prt_report_daily_new
end type

type p_port from w_a_print`p_port within ssrt_prt_report_daily_new
end type

type p_land from w_a_print`p_land within ssrt_prt_report_daily_new
end type

type gb_cond from w_a_print`gb_cond within ssrt_prt_report_daily_new
boolean visible = false
integer width = 2254
integer height = 240
end type

type p_saveas from w_a_print`p_saveas within ssrt_prt_report_daily_new
end type
