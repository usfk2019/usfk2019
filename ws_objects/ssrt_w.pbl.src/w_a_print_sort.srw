$PBExportHeader$w_a_print_sort.srw
$PBExportComments$Print Ancestor(from w_base )
forward
global type w_a_print_sort from w_base
end type
type dw_list from u_d_sort within w_a_print_sort
end type
type dw_cond from u_d_external within w_a_print_sort
end type
type p_ok from u_p_ok within w_a_print_sort
end type
type p_close from u_p_close within w_a_print_sort
end type
type p_1 from u_p_psetup within w_a_print_sort
end type
type p_2 from u_p_zoom within w_a_print_sort
end type
type p_3 from u_p_print within w_a_print_sort
end type
type p_5 from u_p_pfirst within w_a_print_sort
end type
type p_6 from u_p_plast within w_a_print_sort
end type
type p_7 from u_p_pnext within w_a_print_sort
end type
type p_8 from u_p_pprev within w_a_print_sort
end type
type p_9 from u_p_reset within w_a_print_sort
end type
type p_4 from u_p_sort within w_a_print_sort
end type
type gb_1 from groupbox within w_a_print_sort
end type
type p_port from picture within w_a_print_sort
end type
type p_land from picture within w_a_print_sort
end type
type gb_cond from groupbox within w_a_print_sort
end type
end forward
...
global w_a_print_sort w_a_print_sort
...
event ue_pfirst();dw_list.ScrollToRow(1)
dw_list.SetFocus()
end event

event ue_sort();If dw_list.Rowcount() > 0 Then
	String ls_null
	SetNull( ls_null )
...
event ue_pnext();dw_list.ScrollNextPage()
dw_list.SetFocus()
end event

event ue_pprev();dw_list.ScrollPriorPage()
dw_list.SetFocus()
end event
