$PBExportHeader$b2w_inq_partnerused_limit_v20.srw
$PBExportComments$[ssong]대리점 사용한도조회
forward
global type b2w_inq_partnerused_limit_v20 from w_a_inq_m_m
end type
end forward
...
global b2w_inq_partnerused_limit_v20 b2w_inq_partnerused_limit_v20
...
on b2w_inq_partnerused_limit_v20.create
call super::create
end on

on b2w_inq_partnerused_limit_v20.destroy
call super::destroy
end on
...
type dw_cond from w_a_inq_m_m`dw_cond within b2w_inq_partnerused_limit_v20
integer width = 1984
integer height = 128
...
type p_ok from w_a_inq_m_m`p_ok within b2w_inq_partnerused_limit_v20
integer x = 2235
end type

type p_close from w_a_inq_m_m`p_close within b2w_inq_partnerused_limit_v20
integer x = 2546
end type

type gb_cond from w_a_inq_m_m`gb_cond within b2w_inq_partnerused_limit_v20
integer width = 2048
integer height = 212
end type

type dw_master from w_a_inq_m_m`dw_master within b2w_inq_partnerused_limit_v20
integer y = 244
integer height = 512
...
type dw_detail from w_a_inq_m_m`dw_detail within b2w_inq_partnerused_limit_v20
integer x = 32
integer y = 800
integer height = 920
...
type st_horizontal from w_a_inq_m_m`st_horizontal within b2w_inq_partnerused_limit_v20
integer x = 32
integer y = 764
end type
