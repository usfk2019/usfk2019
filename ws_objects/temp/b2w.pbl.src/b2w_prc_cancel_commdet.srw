$PBExportHeader$b2w_prc_cancel_commdet.srw
$PBExportComments$[y.k.min] 유치/매출수수료계산취소
forward
global type b2w_prc_cancel_commdet from w_a_prc
end type
end forward
...
global b2w_prc_cancel_commdet b2w_prc_cancel_commdet
...
on b2w_prc_cancel_commdet.create
call super::create
end on

on b2w_prc_cancel_commdet.destroy
call super::destroy
end on
...
lu_dbmgr.is_caller = "b2w_prc_cancel_commdet%ue_process"
lu_dbmgr.uf_prc_db()
...
type p_ok from w_a_prc`p_ok within b2w_prc_cancel_commdet
integer x = 1125
integer y = 44
boolean originalsize = false
end type

type dw_input from w_a_prc`dw_input within b2w_prc_cancel_commdet
integer x = 50
integer width = 942
integer height = 192
...
type dw_msg_time from w_a_prc`dw_msg_time within b2w_prc_cancel_commdet
integer x = 27
integer y = 768
integer width = 1797
end type

type dw_msg_processing from w_a_prc`dw_msg_processing within b2w_prc_cancel_commdet
integer x = 27
integer y = 292
integer width = 1797
end type

type ln_up from w_a_prc`ln_up within b2w_prc_cancel_commdet
integer beginy = 268
integer endy = 268
end type

type ln_down from w_a_prc`ln_down within b2w_prc_cancel_commdet
integer beginx = 27
integer beginy = 1056
integer endx = 1778
integer endy = 1056
...
type p_close from w_a_prc`p_close within b2w_prc_cancel_commdet
integer x = 1426
integer y = 44
end type

type gb_cond from w_a_prc`gb_cond within b2w_prc_cancel_commdet
integer width = 987
integer height = 244
end type
