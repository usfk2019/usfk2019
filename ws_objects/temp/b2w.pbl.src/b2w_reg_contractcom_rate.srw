$PBExportHeader$b2w_reg_contractcom_rate.srw
$PBExportComments$[ceusee] 유치/관리커미션 요율 등록
forward
global type b2w_reg_contractcom_rate from w_a_reg_m_tm2
end type
end forward
...
global b2w_reg_contractcom_rate b2w_reg_contractcom_rate

on b2w_reg_contractcom_rate.create
int iCurrent
call super::create
end on

on b2w_reg_contractcom_rate.destroy
call super::destroy
end on
...
event ue_ok();call super::ue_ok;String ls_partner, ls_partnernm, ls_levelcod, ls_where
Long ll_row
...
type dw_cond from w_a_reg_m_tm2`dw_cond within b2w_reg_contractcom_rate
integer width = 2299
integer height = 116
string dataobject = "b2dw_cnd_reg_contractcom_rate"
end type

type p_ok from w_a_reg_m_tm2`p_ok within b2w_reg_contractcom_rate
integer x = 2455
integer y = 48
end type

type p_close from w_a_reg_m_tm2`p_close within b2w_reg_contractcom_rate
integer x = 2761
integer y = 48
end type

type gb_cond from w_a_reg_m_tm2`gb_cond within b2w_reg_contractcom_rate
integer width = 2336
integer height = 204
end type

type dw_master from w_a_reg_m_tm2`dw_master within b2w_reg_contractcom_rate
integer x = 27
integer y = 236
integer height = 572
string dataobject = "b2dw_inq_contractcom_rate"
end type
...
type p_insert from w_a_reg_m_tm2`p_insert within b2w_reg_contractcom_rate
integer y = 1848
end type

type p_delete from w_a_reg_m_tm2`p_delete within b2w_reg_contractcom_rate
integer y = 1848
end type

type p_save from w_a_reg_m_tm2`p_save within b2w_reg_contractcom_rate
integer y = 1848
end type

type p_reset from w_a_reg_m_tm2`p_reset within b2w_reg_contractcom_rate
integer y = 1848
end type

type tab_1 from w_a_reg_m_tm2`tab_1 within b2w_reg_contractcom_rate
integer x = 23
integer y = 864
integer height = 952
end type
...
//Tab에 해당하는 dw
is_dwObject[1] = "b2dw_reg_contractcom_rate_t1"
is_dwObject[2] = "b2dw_reg_contractcom_rate_t2"
is_dwObject[3] = "b2dw_reg_contractcom_rate_t3"
...
type st_horizontal from w_a_reg_m_tm2`st_horizontal within b2w_reg_contractcom_rate
integer y = 820
end type
