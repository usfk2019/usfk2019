$PBExportHeader$b2w_reg_partnerbond_recv.srw
$PBExportComments$[y.k.min] 대리점한도회복
forward
global type b2w_reg_partnerbond_recv from w_a_reg_m_sql
end type
end forward
...
global b2w_reg_partnerbond_recv b2w_reg_partnerbond_recv

on b2w_reg_partnerbond_recv.create
call super::create
end on

on b2w_reg_partnerbond_recv.destroy
call super::destroy
end on
...
Choose Case li_return
	...
	Case -1
		...
		f_msg_info(3010, This.Title, "대리점한도회복처리")
	Case Is >= 0
		//COMMIT
		iu_mdb_app.is_title = This.Title
		...
		iu_mdb_app.uf_prc_db()
		If iu_mdb_app.ii_rc = -1 Then Return
		f_msg_info(3000, This.Title, "대리점한도회복관리 처리완료")
...
If lc_work_amt = 0 Then
	f_msg_usr_err(200, Title, "한도회복금액")
	dw_cond.SetFocus()
...
If lc_work_amt < 0 Then
	f_msg_usr_err(201, Title, "한도회복금액")
	dw_cond.SetFocus()
	dw_cond.SetColumn("work_amt")
	Return -2
End If
...
type dw_cond from w_a_reg_m_sql`dw_cond within b2w_reg_partnerbond_recv
integer width = 1792
integer height = 664
string dataobject = "b2dw_cnd_reg_partnerbond_recv"
boolean hscrollbar = false
boolean vscrollbar = false
boolean livescroll = false
end type

type p_ok from w_a_reg_m_sql`p_ok within b2w_reg_partnerbond_recv
integer x = 1984
end type

type p_close from w_a_reg_m_sql`p_close within b2w_reg_partnerbond_recv
integer y = 52
end type

type gb_cond from w_a_reg_m_sql`gb_cond within b2w_reg_partnerbond_recv
integer width = 1856
integer height = 744
end type

type p_save from w_a_reg_m_sql`p_save within b2w_reg_partnerbond_recv
integer x = 2286
integer y = 52
end type

type dw_detail from w_a_reg_m_sql`dw_detail within b2w_reg_partnerbond_recv
integer y = 784
string dataobject = "b2dw_reg_partnerbond_recv"
