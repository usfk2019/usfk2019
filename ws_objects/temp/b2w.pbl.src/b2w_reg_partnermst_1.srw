$PBExportHeader$b2w_reg_partnermst_1.srw
$PBExportComments$[kem] 대리점정보등록(com&life)
forward
global type b2w_reg_partnermst_1 from w_a_reg_m_tm2
end type
end forward
...
global b2w_reg_partnermst_1 b2w_reg_partnermst_1
...
on b2w_reg_partnermst_1.create
int iCurrent
call super::create
end on

on b2w_reg_partnermst_1.destroy
call super::destroy
end on
...
IF 	li_tab_index = 3 Then   //여신정보저장 시 partnermst의 tot_credit 계산을 다시한다.
...
type dw_cond from w_a_reg_m_tm2`dw_cond within b2w_reg_partnermst_1
integer x = 55
integer y = 40
integer width = 2665
integer height = 240
...
type p_ok from w_a_reg_m_tm2`p_ok within b2w_reg_partnermst_1
integer x = 2889
integer y = 56
end type

type p_close from w_a_reg_m_tm2`p_close within b2w_reg_partnermst_1
integer x = 3195
integer y = 56
boolean originalsize = false
end type

type gb_cond from w_a_reg_m_tm2`gb_cond within b2w_reg_partnermst_1
integer width = 2747
integer height = 292
end type

type dw_master from w_a_reg_m_tm2`dw_master within b2w_reg_partnermst_1
integer y = 320
integer width = 3470
integer height = 604
...
type p_insert from w_a_reg_m_tm2`p_insert within b2w_reg_partnermst_1
integer y = 1920
end type

type p_delete from w_a_reg_m_tm2`p_delete within b2w_reg_partnermst_1
integer y = 1920
end type

type p_save from w_a_reg_m_tm2`p_save within b2w_reg_partnermst_1
integer y = 1920
end type

type p_reset from w_a_reg_m_tm2`p_reset within b2w_reg_partnermst_1
integer y = 1920
end type

type tab_1 from w_a_reg_m_tm2`tab_1 within b2w_reg_partnermst_1
integer y = 964
integer width = 3461
integer height = 928
...
type st_horizontal from w_a_reg_m_tm2`st_horizontal within b2w_reg_partnermst_1
integer y = 924
end type
