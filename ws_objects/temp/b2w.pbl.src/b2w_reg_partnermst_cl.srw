$PBExportHeader$b2w_reg_partnermst_cl.srw
$PBExportComments$[kem] 대리점정보등록(com&life)
forward
global type b2w_reg_partnermst_cl from w_a_reg_m_tm2
end type
end forward
...
global b2w_reg_partnermst_cl b2w_reg_partnermst_cl
...
on b2w_reg_partnermst_cl.create
int iCurrent
call super::create
end on

on b2w_reg_partnermst_cl.destroy
call super::destroy
end on
...
String ls_type, ls_fromdt, ls_todt, ls_where, ls_new, ls_close, ls_prefix
...
Else
		...
		Else			
			IF ls_partner <> "" Then 
				...
				If ls_prefix <> '000' Then

					//ls_where += "   ( partner  = '" + ls_partner + "' " &
					ls_where += " prefixno like '" + ls_prefix  + "%' "
				Else 
		  			ls_where += " prefixno like '%'"
				End If
			End If
		End If
...
String ls_partner, ls_partnernm, ls_levelcod, ls_hpartner, ls_logid, ls_password, ls_emp_id, ls_todt, ls_enddt
...
type dw_cond from w_a_reg_m_tm2`dw_cond within b2w_reg_partnermst_cl
integer x = 55
integer y = 40
integer width = 2665
integer height = 240
...
type p_ok from w_a_reg_m_tm2`p_ok within b2w_reg_partnermst_cl
integer x = 2889
integer y = 56
end type

type p_close from w_a_reg_m_tm2`p_close within b2w_reg_partnermst_cl
integer x = 3195
integer y = 56
boolean originalsize = false
end type

type gb_cond from w_a_reg_m_tm2`gb_cond within b2w_reg_partnermst_cl
integer width = 2747
integer height = 292
end type

type dw_master from w_a_reg_m_tm2`dw_master within b2w_reg_partnermst_cl
integer y = 320
integer width = 3470
integer height = 604
...
type p_insert from w_a_reg_m_tm2`p_insert within b2w_reg_partnermst_cl
integer y = 1920
end type

type p_delete from w_a_reg_m_tm2`p_delete within b2w_reg_partnermst_cl
integer y = 1920
end type

type p_save from w_a_reg_m_tm2`p_save within b2w_reg_partnermst_cl
integer y = 1920
end type

type p_reset from w_a_reg_m_tm2`p_reset within b2w_reg_partnermst_cl
integer y = 1920
end type

type tab_1 from w_a_reg_m_tm2`tab_1 within b2w_reg_partnermst_cl
integer y = 964
integer width = 3461
integer height = 928
...
is_tab_title[3] = "여신정보"
is_tab_title[4] = "대역별요율"
is_tab_title[5] = "착신지제한번호"
is_tab_title[6] = "가격정책"

is_dwobject[1] = "b2dw_reg_partnermst_t1"
is_dwobject[2] = "b2dw_reg_partnermst_t2"
is_dwobject[3] = "b2dw_reg_partnermst_t3"
is_dwobject[4] = "b0dw_reg_particular_zoncst"  //"b2dw_reg_partnermst_t4_1"
is_dwobject[5] = "b0dw_reg_blacklist_a"  //"b2dw_reg_partnermst_t5"
is_dwobject[6] = "b2dw_reg_partnermst_t6"
end event
...
//		tab_1.idw_tabpage[ai_select_tabpage].idwo_help_col[1] = idw_tabpage[ai_select_tabpage].object.updt_user
	...
	Case 4
		...
		If ls_type = "0" Then
			tab_1.idw_tabpage[4].object.frpoint.Format = "#,##0"
			tab_1.idw_tabpage[4].object.confee.Format = "#,##0"
			tab_1.idw_tabpage[4].object.unitfee.Format = "#,##0"
			tab_1.idw_tabpage[4].object.unitfee1.Format = "#,##0"
			tab_1.idw_tabpage[4].object.unitfee2.Format = "#,##0"
			tab_1.idw_tabpage[4].object.unitfee3.Format = "#,##0"
			tab_1.idw_tabpage[4].object.unitfee4.Format = "#,##0"
			tab_1.idw_tabpage[4].object.unitfee5.Format = "#,##0"
			tab_1.idw_tabpage[4].object.munitfee.Format  = "#,##0"
			tab_1.idw_tabpage[4].object.munitfee1.Format = "#,##0"
			tab_1.idw_tabpage[4].object.munitfee2.Format = "#,##0"
			tab_1.idw_tabpage[4].object.munitfee3.Format = "#,##0"
			tab_1.idw_tabpage[4].object.munitfee4.Format = "#,##0"
			tab_1.idw_tabpage[4].object.munitfee5.Format = "#,##0"
		ElseIf ls_type = "1" Then
			tab_1.idw_tabpage[4].object.frpoint.Format = "#,##0.0"
			tab_1.idw_tabpage[4].object.confee.Format = "#,##0.0"
			tab_1.idw_tabpage[4].object.unitfee.Format = "#,##0.0"
			tab_1.idw_tabpage[4].object.unitfee1.Format = "#,##0.0"
			tab_1.idw_tabpage[4].object.unitfee2.Format = "#,##0.0"
			tab_1.idw_tabpage[4].object.unitfee3.Format = "#,##0.0"
			tab_1.idw_tabpage[4].object.unitfee4.Format = "#,##0.0"
			tab_1.idw_tabpage[4].object.unitfee5.Format = "#,##0.0"
			tab_1.idw_tabpage[4].object.munitfee.Format  = "#,##0.0"
			tab_1.idw_tabpage[4].object.munitfee1.Format = "#,##0.0"
			tab_1.idw_tabpage[4].object.munitfee2.Format = "#,##0.0"
			tab_1.idw_tabpage[4].object.munitfee3.Format = "#,##0.0"
			tab_1.idw_tabpage[4].object.munitfee4.Format = "#,##0.0"
			tab_1.idw_tabpage[4].object.munitfee5.Format = "#,##0.0"
		ElseIf ls_type = "2" Then
			tab_1.idw_tabpage[4].object.frpoint.Format = "#,##0.00"
			tab_1.idw_tabpage[4].object.confee.Format = "#,##0.00"
			tab_1.idw_tabpage[4].object.unitfee.Format = "#,##0.00"
			tab_1.idw_tabpage[4].object.unitfee1.Format = "#,##0.00"
			tab_1.idw_tabpage[4].object.unitfee2.Format = "#,##0.00"
			tab_1.idw_tabpage[4].object.unitfee3.Format = "#,##0.00"
			tab_1.idw_tabpage[4].object.unitfee4.Format = "#,##0.00"
			tab_1.idw_tabpage[4].object.unitfee5.Format = "#,##0.00"
			tab_1.idw_tabpage[4].object.munitfee.Format  = "#,##0.00"
			tab_1.idw_tabpage[4].object.munitfee1.Format = "#,##0.00"
			tab_1.idw_tabpage[4].object.munitfee2.Format = "#,##0.00"
			tab_1.idw_tabpage[4].object.munitfee3.Format = "#,##0.00"
			tab_1.idw_tabpage[4].object.munitfee4.Format = "#,##0.00"
			tab_1.idw_tabpage[4].object.munitfee5.Format = "#,##0.00"
		ElseIF ls_type = "3" Then
			tab_1.idw_tabpage[4].object.frpoint.Format = "#,##0.000"
			tab_1.idw_tabpage[4].object.confee.Format = "#,##0.000"
			tab_1.idw_tabpage[4].object.unitfee.Format = "#,##0.000"
			tab_1.idw_tabpage[4].object.unitfee1.Format = "#,##0.000"
			tab_1.idw_tabpage[4].object.unitfee2.Format = "#,##0.000"
			tab_1.idw_tabpage[4].object.unitfee3.Format = "#,##0.000"
			tab_1.idw_tabpage[4].object.unitfee4.Format = "#,##0.000"
			tab_1.idw_tabpage[4].object.unitfee5.Format = "#,##0.000"
			tab_1.idw_tabpage[4].object.munitfee.Format  = "#,##0.000"
			tab_1.idw_tabpage[4].object.munitfee1.Format = "#,##0.000"
			tab_1.idw_tabpage[4].object.munitfee2.Format = "#,##0.000"
			tab_1.idw_tabpage[4].object.munitfee3.Format = "#,##0.000"
			tab_1.idw_tabpage[4].object.munitfee4.Format = "#,##0.000"
			tab_1.idw_tabpage[4].object.munitfee5.Format = "#,##0.000"
		Else
			tab_1.idw_tabpage[4].object.frpoint.Format = "#,##0.0000"
			tab_1.idw_tabpage[4].object.confee.Format = "#,##0.0000"
			tab_1.idw_tabpage[4].object.unitfee.Format = "#,##0.0000"
			tab_1.idw_tabpage[4].object.unitfee1.Format = "#,##0.0000"
			tab_1.idw_tabpage[4].object.unitfee2.Format = "#,##0.0000"
			tab_1.idw_tabpage[4].object.unitfee3.Format = "#,##0.0000"
			tab_1.idw_tabpage[4].object.unitfee4.Format = "#,##0.0000"
			tab_1.idw_tabpage[4].object.unitfee5.Format = "#,##0.0000"
			tab_1.idw_tabpage[4].object.munitfee.Format  = "#,##0.0000"
			tab_1.idw_tabpage[4].object.munitfee1.Format = "#,##0.0000"
			tab_1.idw_tabpage[4].object.munitfee2.Format = "#,##0.0000"
			tab_1.idw_tabpage[4].object.munitfee3.Format = "#,##0.0000"
			tab_1.idw_tabpage[4].object.munitfee4.Format = "#,##0.0000"
			tab_1.idw_tabpage[4].object.munitfee5.Format = "#,##0.0000"
		End If
		
		For i =1 To tab_1.idw_tabpage[4].RowCount()
			lc_data = tab_1.idw_tabpage[4].object.unbilsec[i]
			If IsNull(lc_data) Then tab_1.idw_tabpage[4].object.unbilsec[i] = 0
			lc_data = tab_1.idw_tabpage[4].object.confee[i]
			If IsNull(lc_data) Then tab_1.idw_tabpage[4].object.confee[i] = 0
			lc_data = tab_1.idw_tabpage[4].object.unitfee1[i]
			If IsNull(lc_data) Then tab_1.idw_tabpage[4].object.unitfee1[i] = 0
			lc_data = tab_1.idw_tabpage[4].object.tmrange1[i]
			If IsNull(lc_data) Then tab_1.idw_tabpage[4].object.tmrange1[i] = 0
			lc_data = tab_1.idw_tabpage[4].object.unitsec1[i]
			If IsNull(lc_data) Then tab_1.idw_tabpage[4].object.unitsec1[i] = 0
			lc_data = tab_1.idw_tabpage[4].object.unitfee2[i]
			If IsNull(lc_data) Then tab_1.idw_tabpage[4].object.unitfee2[i] = 0
			lc_data = tab_1.idw_tabpage[4].object.tmrange2[i]
			If IsNull(lc_data) Then tab_1.idw_tabpage[4].object.tmrange2[i] = 0
			lc_data = tab_1.idw_tabpage[4].object.unitsec2[i]
			If IsNull(lc_data) Then tab_1.idw_tabpage[4].object.unitsec2[i] = 0
			lc_data = tab_1.idw_tabpage[4].object.unitfee3[i]
			If IsNull(lc_data) Then tab_1.idw_tabpage[4].object.unitfee3[i] = 0
			lc_data = tab_1.idw_tabpage[4].object.tmrange3[i]
			If IsNull(lc_data) Then tab_1.idw_tabpage[4].object.tmrange3[i] = 0
			lc_data = tab_1.idw_tabpage[4].object.unitsec3[i]
			If IsNull(lc_data) Then tab_1.idw_tabpage[4].object.unitsec3[i] = 0
			lc_data = tab_1.idw_tabpage[4].object.unitfee4[i]
			If IsNull(lc_data) Then tab_1.idw_tabpage[4].object.unitfee4[i] = 0
			lc_data = tab_1.idw_tabpage[4].object.tmrange4[i]
			If IsNull(lc_data) Then tab_1.idw_tabpage[4].object.tmrange4[i] = 0
			lc_data = tab_1.idw_tabpage[4].object.unitsec4[i]
			If IsNull(lc_data) Then tab_1.idw_tabpage[4].object.unitsec4[i] = 0
			lc_data = tab_1.idw_tabpage[4].object.unitfee5[i]
			If IsNull(lc_data) Then tab_1.idw_tabpage[4].object.unitfee5[i] = 0
			lc_data = tab_1.idw_tabpage[4].object.tmrange5[i]
			If IsNull(lc_data) Then tab_1.idw_tabpage[4].object.tmrange5[i] = 0
			lc_data = tab_1.idw_tabpage[4].object.unitsec5[i]
			If IsNull(lc_data) Then tab_1.idw_tabpage[4].object.unitsec5[i] = 0
			lc_data = tab_1.idw_tabpage[4].object.munitfee1[i]
			If IsNull(lc_data) Then tab_1.idw_tabpage[4].object.munitfee1[i] = 0
			lc_data = tab_1.idw_tabpage[4].object.mtmrange1[i]
			If IsNull(lc_data) Then tab_1.idw_tabpage[4].object.mtmrange1[i] = 0
			lc_data = tab_1.idw_tabpage[4].object.munitsec1[i]
			If IsNull(lc_data) Then tab_1.idw_tabpage[4].object.munitsec1[i] = 0
			lc_data = tab_1.idw_tabpage[4].object.munitfee2[i]
			If IsNull(lc_data) Then tab_1.idw_tabpage[4].object.munitfee2[i] = 0
			lc_data = tab_1.idw_tabpage[4].object.mtmrange2[i]
			If IsNull(lc_data) Then tab_1.idw_tabpage[4].object.mtmrange2[i] = 0
			lc_data = tab_1.idw_tabpage[4].object.munitsec2[i]
			If IsNull(lc_data) Then tab_1.idw_tabpage[4].object.munitsec2[i] = 0
			lc_data = tab_1.idw_tabpage[4].object.munitfee3[i]
			If IsNull(lc_data) Then tab_1.idw_tabpage[4].object.munitfee3[i] = 0
			lc_data = tab_1.idw_tabpage[4].object.mtmrange3[i]
			If IsNull(lc_data) Then tab_1.idw_tabpage[4].object.mtmrange3[i] = 0
			lc_data = tab_1.idw_tabpage[4].object.munitsec3[i]
			If IsNull(lc_data) Then tab_1.idw_tabpage[4].object.munitsec3[i] = 0
			lc_data = tab_1.idw_tabpage[4].object.munitfee4[i]
			If IsNull(lc_data) Then tab_1.idw_tabpage[4].object.munitfee4[i] = 0
			lc_data = tab_1.idw_tabpage[4].object.mtmrange4[i]
			If IsNull(lc_data) Then tab_1.idw_tabpage[4].object.mtmrange4[i] = 0
			lc_data = tab_1.idw_tabpage[4].object.munitsec4[i]
			If IsNull(lc_data) Then tab_1.idw_tabpage[4].object.munitsec4[i] = 0
			lc_data = tab_1.idw_tabpage[4].object.munitfee5[i]
			If IsNull(lc_data) Then tab_1.idw_tabpage[4].object.munitfee5[i] = 0
			lc_data = tab_1.idw_tabpage[4].object.mtmrange5[i]
			If IsNull(lc_data) Then tab_1.idw_tabpage[4].object.mtmrange5[i] = 0
			lc_data = tab_1.idw_tabpage[4].object.munitsec5[i]
			If IsNull(lc_data) Then tab_1.idw_tabpage[4].object.munitsec5[i] = 0

			tab_1.idw_tabpage[4].SetItemStatus(i, 0, Primary!, NotModified!)
		Next		
...
type st_horizontal from w_a_reg_m_tm2`st_horizontal within b2w_reg_partnermst_cl
integer y = 924
end type
