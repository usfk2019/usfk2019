$PBExportHeader$b2w_reg_partnerused_limit1_v20.srw
$PBExportComments$[ssong]대리점 사용한도 관리
forward
global type b2w_reg_partnerused_limit1_v20 from w_a_reg_m_m
end type
end forward
...
global b2w_reg_partnerused_limit1_v20 b2w_reg_partnerused_limit1_v20
...
on b2w_reg_partnerused_limit1_v20.create
call super::create
end on

on b2w_reg_partnerused_limit1_v20.destroy
call super::destroy
end on
...
if ll_cnt_2 = 0 then
	If ls_priceplan = 'ALL' then
		IF ll_cnt_3 >= 1 Then
			f_msg_usr_err(201, Title, "'사용한도(금액)' 등록되어 있어 ALL 가격정책을 등록할수 없습니다. ")
			dw_cond.SetFocus()
			dw_cond.SetColumn("priceplan")
			Return -2
		   End If
...
elseif ll_cnt_2 > 0 then
		f_msg_usr_err(201, Title, "'사용한도(금액)'에 ALL 가격정책이 등록되어 있어 가격정책을 등록할수 없습니다.")
...
is_limit_flag = fs_get_control("A1", "C722", ls_ref_desc)
...
type dw_cond from w_a_reg_m_m`dw_cond within b2w_reg_partnerused_limit1_v20
...
type p_ok from w_a_reg_m_m`p_ok within b2w_reg_partnerused_limit1_v20
integer x = 2011
integer y = 52
end type

type p_close from w_a_reg_m_m`p_close within b2w_reg_partnerused_limit1_v20
integer x = 2629
integer y = 52
boolean originalsize = false
end type

type gb_cond from w_a_reg_m_m`gb_cond within b2w_reg_partnerused_limit1_v20
integer width = 1883
integer height = 724
end type

type dw_master from w_a_reg_m_m`dw_master within b2w_reg_partnerused_limit1_v20
integer x = 9
integer y = 748
integer width = 3109
integer height = 492
...
type dw_detail from w_a_reg_m_m`dw_detail within b2w_reg_partnerused_limit1_v20
integer x = 9
integer y = 1284
integer width = 3109
integer height = 532
...
type p_insert from w_a_reg_m_m`p_insert within b2w_reg_partnerused_limit1_v20
boolean visible = false
integer x = 23
integer y = 1708
end type

type p_delete from w_a_reg_m_m`p_delete within b2w_reg_partnerused_limit1_v20
boolean visible = false
integer x = 315
integer y = 1708
end type

type p_save from w_a_reg_m_m`p_save within b2w_reg_partnerused_limit1_v20
integer x = 2322
integer y = 52
boolean enabled = true
end type

type p_reset from w_a_reg_m_m`p_reset within b2w_reg_partnerused_limit1_v20
boolean visible = false
integer x = 1339
integer y = 1708
boolean enabled = true
...
type st_horizontal from w_a_reg_m_m`st_horizontal within b2w_reg_partnerused_limit1_v20
integer x = 9
integer y = 1244
end type
