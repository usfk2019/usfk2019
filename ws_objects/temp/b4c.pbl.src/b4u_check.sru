$PBExportHeader$b4u_check.sru
$PBExportComments$[ssong]
forward
global type b4u_check from u_cust_a_check
end type
end forward

global type b4u_check from u_cust_a_check
end type
global b4u_check b4u_check
...
Choose Case is_caller
   ...
   Case "b1w_reg_deposit%save_tab2"
...
//			End If
	 ...
	 *  보증금 담당자 정보 등록
	 *******************************************************/
   Case "b1w_reg_deposit%save_tab3"
