$PBExportHeader$b4w_inq_penaltydet_1.srw
$PBExportComments$[chooys] 위약금내역조회 - Window
forward
global type b4w_inq_penaltydet_1 from w_a_inq_m_m
end type
type p_1 from u_p_reset within b4w_inq_penaltydet_1
end type
end forward
...
global b4w_inq_penaltydet_1 b4w_inq_penaltydet_1
...
on b4w_inq_penaltydet_1.create
int iCurrent
call super::create
this.p_1=create p_1
...
on b4w_inq_penaltydet_1.destroy
call super::destroy
destroy(this.p_1)
end on
...
type dw_cond from w_a_inq_m_m`dw_cond within b4w_inq_penaltydet_1
integer x = 55
integer y = 52
integer width = 2501
integer height = 208
...
type p_ok from w_a_inq_m_m`p_ok within b4w_inq_penaltydet_1
integer x = 2638
end type

type p_close from w_a_inq_m_m`p_close within b4w_inq_penaltydet_1
integer x = 3232
boolean originalsize = false
end type

type gb_cond from w_a_inq_m_m`gb_cond within b4w_inq_penaltydet_1
integer x = 18
integer width = 2551
end type

type dw_master from w_a_inq_m_m`dw_master within b4w_inq_penaltydet_1
integer x = 23
integer y = 304
integer width = 3511
integer height = 576
...
type dw_detail from w_a_inq_m_m`dw_detail within b4w_inq_penaltydet_1
integer x = 23
integer y = 912
integer width = 3511
integer height = 952
string dataobject = "b4dw_inq_detail_inqpenaltydet_1"
end type
...
type st_horizontal from w_a_inq_m_m`st_horizontal within b4w_inq_penaltydet_1
integer x = 14
integer y = 880
end type
