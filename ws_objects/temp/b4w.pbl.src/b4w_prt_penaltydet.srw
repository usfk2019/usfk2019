$PBExportHeader$b4w_prt_penaltydet.srw
$PBExportComments$[jykim] 위약금발생내역리스트
forward
global type b4w_prt_penaltydet from w_a_print
end type
end forward
...
global b4w_prt_penaltydet b4w_prt_penaltydet

on b4w_prt_penaltydet.create
call super::create
end on

on b4w_prt_penaltydet.destroy
call super::destroy
end on
...
type dw_cond from w_a_print`dw_cond within b4w_prt_penaltydet
integer width = 2469
integer height = 232
...
type p_ok from w_a_print`p_ok within b4w_prt_penaltydet
integer x = 2642
integer y = 56
end type

type p_close from w_a_print`p_close within b4w_prt_penaltydet
integer x = 2944
integer y = 56
end type

type dw_list from w_a_print`dw_list within b4w_prt_penaltydet
integer y = 304
integer width = 3182
integer height = 1316
string dataobject = "b4dw_prt_penaltydet"
end type
...
type p_1 from w_a_print`p_1 within b4w_prt_penaltydet
end type

type p_2 from w_a_print`p_2 within b4w_prt_penaltydet
end type

type p_3 from w_a_print`p_3 within b4w_prt_penaltydet
end type

type p_5 from w_a_print`p_5 within b4w_prt_penaltydet
end type

type p_6 from w_a_print`p_6 within b4w_prt_penaltydet
end type

type p_7 from w_a_print`p_7 within b4w_prt_penaltydet
end type

type p_8 from w_a_print`p_8 within b4w_prt_penaltydet
end type

type p_9 from w_a_print`p_9 within b4w_prt_penaltydet
end type

type p_4 from w_a_print`p_4 within b4w_prt_penaltydet
end type

type gb_1 from w_a_print`gb_1 within b4w_prt_penaltydet
end type

type p_port from w_a_print`p_port within b4w_prt_penaltydet
end type

type p_land from w_a_print`p_land within b4w_prt_penaltydet
end type

type gb_cond from w_a_print`gb_cond within b4w_prt_penaltydet
integer width = 2514
integer height = 288
integer taborder = 30
end type

type p_saveas from w_a_print`p_saveas within b4w_prt_penaltydet
end type
