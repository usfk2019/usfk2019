$PBExportHeader$b4w_reg_customer_usedamt_adj.srw
$PBExportComments$[juede] 고객별사용한도 관리
forward
global type b4w_reg_customer_usedamt_adj from w_a_reg_m_m
end type
end forward
...
global b4w_reg_customer_usedamt_adj b4w_reg_customer_usedamt_adj

type variables
String is_partner, is_partner_1, is_limit_flag
end variables

on b4w_reg_customer_usedamt_adj.create
call super::create
end on

on b4w_reg_customer_usedamt_adj.destroy
call super::destroy
end on
...
Choose Case li_return
	...
	Case -1
		...
		f_msg_info(3010, This.Title, "고객 사용금액 증감처리")
	Case Is >= 0
		//COMMIT
		iu_cust_db_app.is_title = This.Title
		...
		iu_cust_db_app.uf_prc_db()
		If iu_cust_db_app.ii_rc = -1 Then Return -1
		f_msg_info(3000, This.Title, "고객 사용금액 증감 처리완료")
...
type dw_cond from w_a_reg_m_m`dw_cond within b4w_reg_customer_usedamt_adj
event dropdownlist pbm_dwndropdown
integer y = 40
integer width = 1765
integer height = 668
string dataobject = "b4dw_cnd_reg_customer_usedamt_adj"
...
type p_ok from w_a_reg_m_m`p_ok within b4w_reg_customer_usedamt_adj
integer x = 2011
integer y = 52
end type

type p_close from w_a_reg_m_m`p_close within b4w_reg_customer_usedamt_adj
integer x = 2629
integer y = 52
boolean originalsize = false
end type

type gb_cond from w_a_reg_m_m`gb_cond within b4w_reg_customer_usedamt_adj
integer width = 1883
integer height = 724
integer taborder = 20
end type

type dw_master from w_a_reg_m_m`dw_master within b4w_reg_customer_usedamt_adj
integer x = 9
integer y = 748
integer width = 3109
integer height = 492
integer taborder = 30
string dataobject = "b4dw_reg_mst_customer_usedamt_adj"
end type
...
type dw_detail from w_a_reg_m_m`dw_detail within b4w_reg_customer_usedamt_adj
integer x = 9
integer y = 1284
integer width = 3109
integer height = 532
integer taborder = 40
string dataobject = "b4dw_reg_det_customer_usedamt_adj"
end type
...
type p_insert from w_a_reg_m_m`p_insert within b4w_reg_customer_usedamt_adj
boolean visible = false
integer x = 23
integer y = 1708
end type

type p_delete from w_a_reg_m_m`p_delete within b4w_reg_customer_usedamt_adj
boolean visible = false
integer x = 315
integer y = 1708
end type

type p_save from w_a_reg_m_m`p_save within b4w_reg_customer_usedamt_adj
integer x = 2322
integer y = 52
boolean enabled = true
end type

type p_reset from w_a_reg_m_m`p_reset within b4w_reg_customer_usedamt_adj
boolean visible = false
integer x = 1339
integer y = 1708
boolean enabled = true
...
type st_horizontal from w_a_reg_m_m`st_horizontal within b4w_reg_customer_usedamt_adj
integer x = 9
integer y = 1244
end type
