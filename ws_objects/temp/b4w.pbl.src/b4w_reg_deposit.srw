$PBExportHeader$b4w_reg_deposit.srw
$PBExportComments$[ssong]납입고객별 서비스별 보증금 관리
forward
global type b4w_reg_deposit from w_a_reg_m_tm2
end type
end forward
...
global b4w_reg_deposit b4w_reg_deposit
...
on b4w_reg_deposit.create
int iCurrent
call super::create
end on

on b4w_reg_deposit.destroy
call super::destroy
end on

event open;call super::open;/*-------------------------------------------------------------------------
	Name	:	b4w_reg_deposit
...
type dw_cond from w_a_reg_m_tm2`dw_cond within b4w_reg_deposit
integer width = 2446
integer height = 164
string dataobject = "b4dw_reg_cnd_deposit"
end type
...
type p_ok from w_a_reg_m_tm2`p_ok within b4w_reg_deposit
integer x = 2601
end type

type p_close from w_a_reg_m_tm2`p_close within b4w_reg_deposit
integer x = 2903
end type

type gb_cond from w_a_reg_m_tm2`gb_cond within b4w_reg_deposit
integer width = 2478
integer height = 256
end type

type dw_master from w_a_reg_m_tm2`dw_master within b4w_reg_deposit
integer y = 284
integer width = 3154
integer height = 592
string dataobject = "b4dw_reg_master_deposit"
end type
...
type p_insert from w_a_reg_m_tm2`p_insert within b4w_reg_deposit
end type

type p_delete from w_a_reg_m_tm2`p_delete within b4w_reg_deposit
end type

type p_save from w_a_reg_m_tm2`p_save within b4w_reg_deposit
end type

type p_reset from w_a_reg_m_tm2`p_reset within b4w_reg_deposit
end type

type tab_1 from w_a_reg_m_tm2`tab_1 within b4w_reg_deposit
integer width = 3159
end type
...
event tab_1::ue_init();call super::ue_init;ii_enable_max_tab = 3 //사용할 Tab Page의 갯수 (15 이하)
...
is_dwobject[1] = "b4dw_reg_deposit_t1"  //Tab Page에 해당되는  DataWindow 할당 
is_dwobject[2] = "b4dw_reg_deposit_t2"
is_dwobject[3] = "b4dw_reg_deposit_t3"
...
type st_horizontal from w_a_reg_m_tm2`st_horizontal within b4w_reg_deposit
end type
