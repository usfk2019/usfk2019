$PBExportHeader$b4w_reg_deposit_limitcontrol_v20.srw
$PBExportComments$[OHJ] 보증금 한도 control 관리  V20
forward
global type b4w_reg_deposit_limitcontrol_v20 from w_a_reg_m
end type
end forward

global type b4w_reg_deposit_limitcontrol_v20 from w_a_reg_m
end type
global b4w_reg_deposit_limitcontrol_v20 b4w_reg_deposit_limitcontrol_v20

on b4w_reg_deposit_limitcontrol_v20.create
call super::create
end on

on b4w_reg_deposit_limitcontrol_v20.destroy
call super::destroy
end on

event open;call super::open;/*------------------------------------------------------------------------
//	Name      :	b4w_reg_deposit_limitcontrol_V20
//	Desc.     : 보증금 한도 관리
//	Date      : 2004.08.25
//  Ver.      : 1.0
...
event type integer ue_extra_save();call super::ue_extra_save;String ls_svccod, ls_limit_control, ls_payid
...
type dw_cond from w_a_reg_m`dw_cond within b4w_reg_deposit_limitcontrol_v20
integer x = 41
integer y = 64
integer width = 1166
integer height = 144
...
type p_ok from w_a_reg_m`p_ok within b4w_reg_deposit_limitcontrol_v20
integer x = 1577
integer y = 76
end type

type p_close from w_a_reg_m`p_close within b4w_reg_deposit_limitcontrol_v20
integer x = 1883
integer y = 76
end type

type gb_cond from w_a_reg_m`gb_cond within b4w_reg_deposit_limitcontrol_v20
integer width = 1467
integer height = 276
end type

type p_delete from w_a_reg_m`p_delete within b4w_reg_deposit_limitcontrol_v20
end type

type p_insert from w_a_reg_m`p_insert within b4w_reg_deposit_limitcontrol_v20
end type

type p_save from w_a_reg_m`p_save within b4w_reg_deposit_limitcontrol_v20
end type

type dw_detail from w_a_reg_m`dw_detail within b4w_reg_deposit_limitcontrol_v20
string dataobject = "b4dw_reg_det_deposit_limitcontrol_v20"
end type
...
type p_reset from w_a_reg_m`p_reset within b4w_reg_deposit_limitcontrol_v20
end type
