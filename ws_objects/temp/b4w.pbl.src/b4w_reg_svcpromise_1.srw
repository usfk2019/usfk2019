$PBExportHeader$b4w_reg_svcpromise_1.srw
$PBExportComments$[parkkh] 약정유형등록
forward
global type b4w_reg_svcpromise_1 from w_a_reg_m
end type
end forward
...
global b4w_reg_svcpromise_1 b4w_reg_svcpromise_1

on b4w_reg_svcpromise_1.create
call super::create
end on

on b4w_reg_svcpromise_1.destroy
call super::destroy
end on
...
For i = 1 To ll_row
	...
	ld_prmbaseamt = dw_detail.object.prm_baseamt[i]
	If IsNull(ld_prmbaseamt) Then ld_prmbaseamt = -1
	If ld_prmbaseamt < 0 Then
		f_msg_usr_err(200, Title, "위약기본료")
		dw_detail.SetRow(i)
		dw_detail.ScrollToRow(i)
		dw_detail.SetColumn("prm_baseamt")
		Return -1
	End If
...
type dw_cond from w_a_reg_m`dw_cond within b4w_reg_svcpromise_1
integer x = 41
integer y = 60
integer width = 1317
integer height = 224
...
type p_ok from w_a_reg_m`p_ok within b4w_reg_svcpromise_1
integer x = 1504
integer y = 44
end type

type p_close from w_a_reg_m`p_close within b4w_reg_svcpromise_1
integer x = 1819
integer y = 44
boolean originalsize = false
end type

type gb_cond from w_a_reg_m`gb_cond within b4w_reg_svcpromise_1
integer width = 1367
end type

type p_delete from w_a_reg_m`p_delete within b4w_reg_svcpromise_1
integer y = 1632
end type

type p_insert from w_a_reg_m`p_insert within b4w_reg_svcpromise_1
integer y = 1632
end type

type p_save from w_a_reg_m`p_save within b4w_reg_svcpromise_1
integer y = 1632
end type

type dw_detail from w_a_reg_m`dw_detail within b4w_reg_svcpromise_1
integer x = 23
integer width = 3141
integer height = 1264
integer taborder = 20
string dataobject = "b4dw_reg_svcpromise_1"
end type
...
type p_reset from w_a_reg_m`p_reset within b4w_reg_svcpromise_1
integer y = 1632
end type
