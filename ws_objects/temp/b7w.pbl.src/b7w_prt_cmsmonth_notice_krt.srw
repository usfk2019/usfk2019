$PBExportHeader$b7w_prt_cmsmonth_notice_krt.srw
$PBExportComments$[islim] 자동납부 청구서(월별)
forward
global type b7w_prt_cmsmonth_notice_krt from w_a_print
end type
type cb_shift_r from commandbutton within b7w_prt_cmsmonth_notice_krt
end type
type cb_shift_l from commandbutton within b7w_prt_cmsmonth_notice_krt
end type
type dw_select2 from u_d_external within b7w_prt_cmsmonth_notice_krt
end type
type dw_select1 from u_d_sgl_sel within b7w_prt_cmsmonth_notice_krt
end type
type cb_shift_r_all from commandbutton within b7w_prt_cmsmonth_notice_krt
end type
type cb_shift_l_all from commandbutton within b7w_prt_cmsmonth_notice_krt
end type
end forward
...
global b7w_prt_cmsmonth_notice_krt b7w_prt_cmsmonth_notice_krt
...
on b7w_prt_cmsmonth_notice_krt.create
int iCurrent
call super::create
...
on b7w_prt_cmsmonth_notice_krt.destroy
call super::destroy
...
//ls_busyn = Trim(dw_cond.Object.bus_yn[1])
...
//If ls_kind = "1" Then
//	dw_list.DataObject = "b7dw_prt_cmsmonth_notice_v"
//Else
//	dw_list.DataObject = "b7dw_prt_cmsmonth_notice_rec_v"
//End If


If ls_pay_method = "1" Then
	dw_list.DataObject = "b7dw_prt_giromonth_notice_v"		
ElseIf ls_pay_method = "2" Then
	dw_list.DataObject = "b7dw_prt_cmsmonth_notice_v"
Else
	dw_list.DataObject = "b7dw_prt_ktmonth_notice_1_krt"
End If
...
If ls_pay_method = '1' Then  //지로
	...
	lu_dbmgr.is_caller = "b7w_prt_giro_notice_v%ue_ok"
...
ElseIf ls_pay_method = '2' Then	//자동이체
	lu_dbmgr.is_title = This.Title
	lu_dbmgr.is_caller = "b7w_prt_cms_notice_v%ue_ok"
	lu_dbmgr.is_data2[1] = ls_trdt
	lu_dbmgr.is_data2[2] = ls_usedt_fr
	lu_dbmgr.is_data2[3] = ls_usedt_to
	lu_dbmgr.is_data2[4] = ls_paydt
...
type dw_cond from w_a_print`dw_cond within b7w_prt_cmsmonth_notice_krt
integer x = 55
integer y = 36
integer width = 1408
integer height = 444
...
type p_ok from w_a_print`p_ok within b7w_prt_cmsmonth_notice_krt
integer x = 3314
integer y = 48
end type

type p_close from w_a_print`p_close within b7w_prt_cmsmonth_notice_krt
integer x = 3314
integer y = 244
end type

type dw_list from w_a_print`dw_list within b7w_prt_cmsmonth_notice_krt
integer x = 27
integer y = 532
integer width = 3488
integer height = 1296
string dataobject = "b7dw_prt_cmsmonth_notice_v"
end type

type p_1 from w_a_print`p_1 within b7w_prt_cmsmonth_notice_krt
integer y = 1880
end type

type p_2 from w_a_print`p_2 within b7w_prt_cmsmonth_notice_krt
integer y = 1872
end type

type p_3 from w_a_print`p_3 within b7w_prt_cmsmonth_notice_krt
integer y = 1880
end type

type p_5 from w_a_print`p_5 within b7w_prt_cmsmonth_notice_krt
integer y = 1880
end type

type p_6 from w_a_print`p_6 within b7w_prt_cmsmonth_notice_krt
integer y = 1880
end type

type p_7 from w_a_print`p_7 within b7w_prt_cmsmonth_notice_krt
integer y = 1880
end type

type p_8 from w_a_print`p_8 within b7w_prt_cmsmonth_notice_krt
integer y = 1880
end type

type p_9 from w_a_print`p_9 within b7w_prt_cmsmonth_notice_krt
integer y = 1872
end type

type p_4 from w_a_print`p_4 within b7w_prt_cmsmonth_notice_krt
integer y = 1872
end type

type gb_1 from w_a_print`gb_1 within b7w_prt_cmsmonth_notice_krt
integer y = 1836
end type

type p_port from w_a_print`p_port within b7w_prt_cmsmonth_notice_krt
integer y = 1892
end type

type p_land from w_a_print`p_land within b7w_prt_cmsmonth_notice_krt
integer y = 1904
end type

type gb_cond from w_a_print`gb_cond within b7w_prt_cmsmonth_notice_krt
integer width = 1440
integer height = 504
end type

type p_saveas from w_a_print`p_saveas within b7w_prt_cmsmonth_notice_krt
integer y = 1884
end type
