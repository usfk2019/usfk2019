$PBExportHeader$b7w_prt_cmsmonth_notice_v.srw
$PBExportComments$[islim] 청구서(월별)
forward
global type b7w_prt_cmsmonth_notice_v from w_a_print
end type
type cb_shift_r from commandbutton within b7w_prt_cmsmonth_notice_v
end type
type cb_shift_l from commandbutton within b7w_prt_cmsmonth_notice_v
end type
type dw_select2 from u_d_external within b7w_prt_cmsmonth_notice_v
end type
type dw_select1 from u_d_sgl_sel within b7w_prt_cmsmonth_notice_v
end type
type cb_shift_r_all from commandbutton within b7w_prt_cmsmonth_notice_v
end type
type cb_shift_l_all from commandbutton within b7w_prt_cmsmonth_notice_v
end type
end forward
...
global b7w_prt_cmsmonth_notice_v b7w_prt_cmsmonth_notice_v
...
on b7w_prt_cmsmonth_notice_v.create
int iCurrent
call super::create
...
on b7w_prt_cmsmonth_notice_v.destroy
call super::destroy
...
If ls_pay_method = '1' Then  //지로
	...
	lu_dbmgr.is_data2[7] = ls_chargedt	
...
ElseIf ls_pay_method = '2' Then	//자동이체
	...
	lu_dbmgr.is_data2[8] = ls_chargedt		
...
Else  //kt통합
	...
	lu_dbmgr.idw_data[1] = dw_list
	lu_dbmgr.idw_data[2] = dw_select2
	lu_dbmgr.is_data2[6] = ls_chargedt	
//	lu_dbmgr.is_data2[6] = is_manager_tel
...
type dw_cond from w_a_print`dw_cond within b7w_prt_cmsmonth_notice_v
integer x = 55
integer width = 1371
integer height = 448
...
type p_ok from w_a_print`p_ok within b7w_prt_cmsmonth_notice_v
integer x = 3314
integer y = 48
end type

type p_close from w_a_print`p_close within b7w_prt_cmsmonth_notice_v
integer x = 3314
integer y = 244
end type

type dw_list from w_a_print`dw_list within b7w_prt_cmsmonth_notice_v
integer x = 27
integer y = 532
integer width = 3488
integer height = 1296
...
type p_1 from w_a_print`p_1 within b7w_prt_cmsmonth_notice_v
integer y = 1880
end type

type p_2 from w_a_print`p_2 within b7w_prt_cmsmonth_notice_v
integer y = 1872
end type

type p_3 from w_a_print`p_3 within b7w_prt_cmsmonth_notice_v
integer y = 1880
end type

type p_5 from w_a_print`p_5 within b7w_prt_cmsmonth_notice_v
integer y = 1880
end type

type p_6 from w_a_print`p_6 within b7w_prt_cmsmonth_notice_v
integer y = 1880
end type

type p_7 from w_a_print`p_7 within b7w_prt_cmsmonth_notice_v
integer y = 1880
end type

type p_8 from w_a_print`p_8 within b7w_prt_cmsmonth_notice_v
integer y = 1880
end type

type p_9 from w_a_print`p_9 within b7w_prt_cmsmonth_notice_v
integer y = 1872
end type

type p_4 from w_a_print`p_4 within b7w_prt_cmsmonth_notice_v
integer y = 1872
end type

type gb_1 from w_a_print`gb_1 within b7w_prt_cmsmonth_notice_v
integer y = 1836
end type

type p_port from w_a_print`p_port within b7w_prt_cmsmonth_notice_v
integer y = 1892
end type

type p_land from w_a_print`p_land within b7w_prt_cmsmonth_notice_v
integer y = 1904
end type

type gb_cond from w_a_print`gb_cond within b7w_prt_cmsmonth_notice_v
integer width = 1422
integer height = 504
end type

type p_saveas from w_a_print`p_saveas within b7w_prt_cmsmonth_notice_v
integer y = 1884
end type
