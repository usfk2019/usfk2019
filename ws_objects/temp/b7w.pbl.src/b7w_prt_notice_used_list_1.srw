$PBExportHeader$b7w_prt_notice_used_list_1.srw
$PBExportComments$[islim] 청구서 삽지-전화사용내역(월별)
forward
global type b7w_prt_notice_used_list_1 from w_a_print
end type
type cb_shift_r from commandbutton within b7w_prt_notice_used_list_1
end type
type cb_shift_l from commandbutton within b7w_prt_notice_used_list_1
end type
type dw_select2 from u_d_external within b7w_prt_notice_used_list_1
end type
type dw_select1 from u_d_sgl_sel within b7w_prt_notice_used_list_1
end type
type cb_shift_r_all from commandbutton within b7w_prt_notice_used_list_1
end type
type cb_shift_l_all from commandbutton within b7w_prt_notice_used_list_1
end type
end forward
...
global b7w_prt_notice_used_list_1 b7w_prt_notice_used_list_1
...
on b7w_prt_notice_used_list_1.create
int iCurrent
call super::create
...
on b7w_prt_notice_used_list_1.destroy
call super::destroy
...
type dw_cond from w_a_print`dw_cond within b7w_prt_notice_used_list_1
integer x = 55
integer y = 36
integer width = 2519
integer height = 284
string dataobject = "b7dw_cnd_prt_notice_used_list"
...
//			If ls_where <> "" Then ls_where += " AND "
//			ls_where += "reqinfo.pay_method = ' "+ ls_paymethod + "' "
//		End If
//		
//		If ls_payid <> "" Then
//			If ls_where <> "" Then ls_where += " AND "
...
//		dw_select1.is_where = ls_where
      If ls_payid ="" Then
		...
		ll_rows = dw_select1.Retrieve(ls_trdt, ls_paymethod, ls_chargedt,ls_payid)
...
type p_ok from w_a_print`p_ok within b7w_prt_notice_used_list_1
integer x = 2679
integer y = 64
end type

type p_close from w_a_print`p_close within b7w_prt_notice_used_list_1
integer x = 2679
integer y = 200
end type

type dw_list from w_a_print`dw_list within b7w_prt_notice_used_list_1
integer x = 27
integer y = 824
integer width = 3488
integer height = 1004
string dataobject = "b7dw_prt_notice_used_list_vtel"
end type

type p_1 from w_a_print`p_1 within b7w_prt_notice_used_list_1
integer y = 1880
end type

type p_2 from w_a_print`p_2 within b7w_prt_notice_used_list_1
integer y = 1872
end type

type p_3 from w_a_print`p_3 within b7w_prt_notice_used_list_1
integer y = 1880
end type

type p_5 from w_a_print`p_5 within b7w_prt_notice_used_list_1
integer y = 1880
end type

type p_6 from w_a_print`p_6 within b7w_prt_notice_used_list_1
integer y = 1880
end type

type p_7 from w_a_print`p_7 within b7w_prt_notice_used_list_1
integer y = 1880
end type

type p_8 from w_a_print`p_8 within b7w_prt_notice_used_list_1
integer y = 1880
end type

type p_9 from w_a_print`p_9 within b7w_prt_notice_used_list_1
integer y = 1872
end type

type p_4 from w_a_print`p_4 within b7w_prt_notice_used_list_1
integer y = 1872
end type

type gb_1 from w_a_print`gb_1 within b7w_prt_notice_used_list_1
integer y = 1836
end type

type p_port from w_a_print`p_port within b7w_prt_notice_used_list_1
integer y = 1892
end type

type p_land from w_a_print`p_land within b7w_prt_notice_used_list_1
integer y = 1904
end type

type gb_cond from w_a_print`gb_cond within b7w_prt_notice_used_list_1
integer width = 2601
integer height = 348
end type

type p_saveas from w_a_print`p_saveas within b7w_prt_notice_used_list_1
integer y = 1884
end type
