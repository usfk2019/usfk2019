$PBExportHeader$b7w_reg_bankreq_gr20.srw
$PBExportComments$[ceusee]자동이체(EDI) 신청 응답
forward
global type b7w_reg_bankreq_gr20 from w_a_reg_m_sql
end type
type p_1 from u_p_fileread within b7w_reg_bankreq_gr20
end type
end forward
...
global b7w_reg_bankreq_gr20 b7w_reg_bankreq_gr20
...
on b7w_reg_bankreq_gr20.create
int iCurrent
call super::create
this.p_1=create p_1
...
on b7w_reg_bankreq_gr20.destroy
call super::destroy
destroy(this.p_1)
end on
...
type dw_cond from w_a_reg_m_sql`dw_cond within b7w_reg_bankreq_gr20
integer y = 56
integer width = 2469
integer height = 528
...
type p_ok from w_a_reg_m_sql`p_ok within b7w_reg_bankreq_gr20
integer x = 2642
integer y = 96
boolean originalsize = false
end type

type p_close from w_a_reg_m_sql`p_close within b7w_reg_bankreq_gr20
integer x = 2642
integer y = 224
end type

type gb_cond from w_a_reg_m_sql`gb_cond within b7w_reg_bankreq_gr20
integer y = 16
integer width = 2501
integer height = 600
end type

type p_save from w_a_reg_m_sql`p_save within b7w_reg_bankreq_gr20
boolean visible = false
integer x = 2830
integer y = 496
end type

type dw_detail from w_a_reg_m_sql`dw_detail within b7w_reg_bankreq_gr20
integer x = 37
integer y = 644
integer width = 3109
integer height = 1100
