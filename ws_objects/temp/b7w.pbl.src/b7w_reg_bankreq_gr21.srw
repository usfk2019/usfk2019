$PBExportHeader$b7w_reg_bankreq_gr21.srw
$PBExportComments$[ceusee] 자동이체(EDI) 은행신청 파일 반영
forward
global type b7w_reg_bankreq_gr21 from w_a_reg_m_sql
end type
type p_fileread from u_p_fileread within b7w_reg_bankreq_gr21
end type
end forward
...
global b7w_reg_bankreq_gr21 b7w_reg_bankreq_gr21
...
//		f_msg_usr_err(210, Title + "today:" + String(id_acpdt, 'yyyy-mm-dd'), "처리일자")
//	dw_cond.SetColumn("cmsacpdt")
//	dw_cond.SetFocus()
//	RETURN 
//END IF
...
//	f_msg_usr_err(200, Title, "접수일자는 일(토)요일,공휴일일 수 없습니다.")
//	dw_cond.SetColumn("cmsacpdt")
//	dw_cond.SetFocus()
//	RETURN 
//END IF
...
Choose Case lu_dbmgr.ii_rc
	...
	Case Else
		...
		dw_cond.object.filename[1] = lu_dbmgr.is_data[5] //GR22파일						
		dw_cond.object.bankreq_file_name[1] = lu_dbmgr.is_data[5] //GR22파일
		//이체연도
...
on b7w_reg_bankreq_gr21.create
int iCurrent
call super::create
...
on b7w_reg_bankreq_gr21.destroy
call super::destroy
...
type dw_cond from w_a_reg_m_sql`dw_cond within b7w_reg_bankreq_gr21
integer y = 56
integer width = 2121
integer height = 644
...
type p_ok from w_a_reg_m_sql`p_ok within b7w_reg_bankreq_gr21
integer x = 2299
integer y = 60
boolean originalsize = false
end type

type p_close from w_a_reg_m_sql`p_close within b7w_reg_bankreq_gr21
integer x = 2610
integer y = 60
end type

type gb_cond from w_a_reg_m_sql`gb_cond within b7w_reg_bankreq_gr21
integer y = 16
integer width = 2162
integer height = 700
end type

type p_save from w_a_reg_m_sql`p_save within b7w_reg_bankreq_gr21
boolean visible = false
integer x = 2830
integer y = 496
end type

type dw_detail from w_a_reg_m_sql`dw_detail within b7w_reg_bankreq_gr21
integer y = 748
integer width = 3136
integer height = 1396
