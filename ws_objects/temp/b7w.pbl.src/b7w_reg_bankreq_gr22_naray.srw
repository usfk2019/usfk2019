$PBExportHeader$b7w_reg_bankreq_gr22_naray.srw
$PBExportComments$[jwlee] 자동이체(EDI) 신청파일 작성(GR22)_naray용
forward
global type b7w_reg_bankreq_gr22_naray from w_a_reg_m_sql
end type
type p_2 from u_p_create within b7w_reg_bankreq_gr22_naray
end type
type hpb_1 from hprogressbar within b7w_reg_bankreq_gr22_naray
end type
type p_filewrite from u_p_filewrite within b7w_reg_bankreq_gr22_naray
end type
end forward
...
global b7w_reg_bankreq_gr22_naray b7w_reg_bankreq_gr22_naray
...
on b7w_reg_bankreq_gr22_naray.create
int iCurrent
call super::create
this.p_2=create p_2
...
on b7w_reg_bankreq_gr22_naray.destroy
call super::destroy
destroy(this.p_2)
destroy(this.hpb_1)
...
dw_cond.Object.browse[1] = is_filepath+is_filename[2]
is_filepath = is_filepath+is_filename[2]
...
//출금이체 신청결과(없음;미처리;처리중;처리성공;처리실패;0;1;2;S;F)
ls_ref_desc = ""
ls_temp = ""
...
type dw_cond from w_a_reg_m_sql`dw_cond within b7w_reg_bankreq_gr22_naray
integer x = 32
integer y = 40
integer width = 2062
integer height = 452
...
type p_ok from w_a_reg_m_sql`p_ok within b7w_reg_bankreq_gr22_naray
integer x = 2235
integer y = 56
boolean originalsize = false
end type

type p_close from w_a_reg_m_sql`p_close within b7w_reg_bankreq_gr22_naray
integer x = 2542
integer y = 56
end type

type gb_cond from w_a_reg_m_sql`gb_cond within b7w_reg_bankreq_gr22_naray
integer x = 18
integer width = 2094
integer height = 516
end type

type p_save from w_a_reg_m_sql`p_save within b7w_reg_bankreq_gr22_naray
integer x = 2235
integer y = 184
end type

type dw_detail from w_a_reg_m_sql`dw_detail within b7w_reg_bankreq_gr22_naray
integer x = 18
integer y = 536
integer width = 3150
integer height = 1320
string dataobject = "b7dw_inq_reg_bankreq_gr22_naray"
end type
