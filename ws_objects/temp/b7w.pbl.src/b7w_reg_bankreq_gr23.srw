$PBExportHeader$b7w_reg_bankreq_gr23.srw
$PBExportComments$[ceusee] 자동이체(EDI) 출금의뢰
forward
global type b7w_reg_bankreq_gr23 from w_a_reg_m_sql
end type
type p_2 from u_p_create within b7w_reg_bankreq_gr23
end type
type hpb_1 from hprogressbar within b7w_reg_bankreq_gr23
end type
type p_filewrite from u_p_filewrite within b7w_reg_bankreq_gr23
end type
end forward
...
global b7w_reg_bankreq_gr23 b7w_reg_bankreq_gr23
...
on b7w_reg_bankreq_gr23.create
int iCurrent
call super::create
this.p_2=create p_2
...
on b7w_reg_bankreq_gr23.destroy
call super::destroy
destroy(this.p_2)
destroy(this.hpb_1)
...
type dw_cond from w_a_reg_m_sql`dw_cond within b7w_reg_bankreq_gr23
integer x = 46
integer y = 60
integer width = 2249
integer height = 604
...
type p_ok from w_a_reg_m_sql`p_ok within b7w_reg_bankreq_gr23
integer x = 2405
integer y = 92
boolean originalsize = false
end type

type p_close from w_a_reg_m_sql`p_close within b7w_reg_bankreq_gr23
integer x = 2711
integer y = 92
end type

type gb_cond from w_a_reg_m_sql`gb_cond within b7w_reg_bankreq_gr23
integer x = 37
integer y = 8
integer width = 2281
integer height = 668
...
type p_save from w_a_reg_m_sql`p_save within b7w_reg_bankreq_gr23
integer x = 2405
integer y = 220
end type

type dw_detail from w_a_reg_m_sql`dw_detail within b7w_reg_bankreq_gr23
integer x = 37
integer y = 696
integer width = 2985
integer height = 1116
