$PBExportHeader$b7w_reg_bankreq_gr24.srw
$PBExportComments$[ceusee]자동이체(EDI) 신청 응답
forward
global type b7w_reg_bankreq_gr24 from w_a_reg_m_sql
end type
type p_1 from u_p_fileread within b7w_reg_bankreq_gr24
end type
type p_payment from u_p_payment within b7w_reg_bankreq_gr24
end type
end forward
...
global b7w_reg_bankreq_gr24 b7w_reg_bankreq_gr24
...
on b7w_reg_bankreq_gr24.create
int iCurrent
call super::create
this.p_1=create p_1
...
on b7w_reg_bankreq_gr24.destroy
call super::destroy
destroy(this.p_1)
...
type dw_cond from w_a_reg_m_sql`dw_cond within b7w_reg_bankreq_gr24
integer width = 2199
integer height = 576
...
type p_ok from w_a_reg_m_sql`p_ok within b7w_reg_bankreq_gr24
integer x = 2377
integer y = 64
boolean originalsize = false
end type

type p_close from w_a_reg_m_sql`p_close within b7w_reg_bankreq_gr24
integer x = 2688
integer y = 64
end type

type gb_cond from w_a_reg_m_sql`gb_cond within b7w_reg_bankreq_gr24
integer width = 2240
integer height = 648
end type

type p_save from w_a_reg_m_sql`p_save within b7w_reg_bankreq_gr24
boolean visible = false
end type

type dw_detail from w_a_reg_m_sql`dw_detail within b7w_reg_bankreq_gr24
integer y = 664
integer width = 3113
integer height = 1196
