$PBExportHeader$b7w_reg_bankreq_gr24_naray.srw
$PBExportComments$[jwlee]자동이체(EDI) 신청 응답_naray용
forward
global type b7w_reg_bankreq_gr24_naray from w_a_reg_m_sql
end type
type p_1 from u_p_fileread within b7w_reg_bankreq_gr24_naray
end type
type p_payment from u_p_payment within b7w_reg_bankreq_gr24_naray
end type
type p_2 from u_p_saveas within b7w_reg_bankreq_gr24_naray
end type
type cb_1 from commandbutton within b7w_reg_bankreq_gr24_naray
end type
end forward
...
global b7w_reg_bankreq_gr24_naray b7w_reg_bankreq_gr24_naray
...
Constant Integer GR24_SIZE = 150, li_MAX_DIR = 255, li_MAX_FILES = 4097
Boolean	lb_return
...
// file name
ls_temp = fs_get_control("B7", "A606", ls_ref_desc)
...
ls_filename = ""
ls_extension = ""
ls_filter = ls_filenames[2] + " Files (" + ls_filenames[2] + "*.*), " + ls_filenames[2] +  "*.*"
...
lu_dbmgr.is_caller = "GR24%FileRead"
lu_dbmgr.is_Title = This.Title
lu_dbmgr.is_data[1] = ls_pathname
lu_dbmgr.is_data[2] = ls_filename
lu_dbmgr.is_data[3] = ls_file_name
lu_dbmgr.is_data[4] = Trim(String(ld_outdt, 'yyyymmdd'))
...
String ls_temp, ls_ref_desc, ls_pay_type[], ls_filename
Double lb_count
Long  ll_return
Int    li_cnt
IF dw_cond.Accepttext() <> 1 Then Return

ls_filename = dw_cond.Object.s_file_name[1]
ls_errmsg   = space(256)
...
SQLCA.B7CMSREQPAY(ls_filename,gs_user_id,ls_pgm_id,ll_return,ls_errmsg,lb_count)
...
If ll_return <> 0 Then	//실패
	f_msg_info(3010, Title, "입금TR생성이 되지 않았습니다.")
	Return 
Else							//성공
	f_msg_info(3000, Title, "은행이체 입금 처리 반영( " + String(lb_count) + "건)")
	Return
End If
...
//
//Destroy lu_api
f_excel_ascii1(dw_detail,'b7w_reg_bankreq_gr24')
...
on b7w_reg_bankreq_gr24_naray.create
int iCurrent
call super::create
this.p_1=create p_1
...
on b7w_reg_bankreq_gr24_naray.destroy
call super::destroy
destroy(this.p_1)
...
type dw_cond from w_a_reg_m_sql`dw_cond within b7w_reg_bankreq_gr24_naray
integer width = 2199
integer height = 576
string dataobject = "b7dw_cnd_reg_bankreq_gr24"
...
type p_ok from w_a_reg_m_sql`p_ok within b7w_reg_bankreq_gr24_naray
integer x = 2377
integer y = 64
boolean originalsize = false
end type

type p_close from w_a_reg_m_sql`p_close within b7w_reg_bankreq_gr24_naray
integer x = 2688
integer y = 64
end type

type gb_cond from w_a_reg_m_sql`gb_cond within b7w_reg_bankreq_gr24_naray
integer width = 2240
integer height = 648
end type

type p_save from w_a_reg_m_sql`p_save within b7w_reg_bankreq_gr24_naray
boolean visible = false
end type

type dw_detail from w_a_reg_m_sql`dw_detail within b7w_reg_bankreq_gr24_naray
integer y = 664
integer width = 3113
integer height = 1196
string dataobject = "b7dw_reg_bankreq_gr24_m"
end type
...
event clicked;// EA22 File Search
Constant Integer GR24_SIZE = 150, li_MAX_DIR = 255, li_MAX_FILES = 4097
Boolean	lb_return
Integer	li_return, li_filenum
Integer	li_read_bytes
...
ls_prc_filename = ls_filenames[3] + ls_outdt_mmdd
...
lu_dbmgr.is_caller   = "GR25%FileRead"
