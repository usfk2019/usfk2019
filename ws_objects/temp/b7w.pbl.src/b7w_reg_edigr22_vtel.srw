$PBExportHeader$b7w_reg_edigr22_vtel.srw
$PBExportComments$[jsha] 출금의뢰응답
forward
global type b7w_reg_edigr22_vtel from w_a_reg_m_sql
end type
type p_1 from u_p_fileread within b7w_reg_edigr22_vtel
end type
type p_payment from u_p_payment within b7w_reg_edigr22_vtel
end type
end forward
...
global b7w_reg_edigr22_vtel b7w_reg_edigr22_vtel
...
on b7w_reg_edigr22_vtel.create
int iCurrent
call super::create
this.p_1=create p_1
...
on b7w_reg_edigr22_vtel.destroy
call super::destroy
destroy(this.p_1)
...
// Dynamic SQL
ls_where = "  banktext.payid = customerm.customerid  "
...
type dw_cond from w_a_reg_m_sql`dw_cond within b7w_reg_edigr22_vtel
integer width = 2094
integer height = 576
...
type p_ok from w_a_reg_m_sql`p_ok within b7w_reg_edigr22_vtel
integer x = 2309
integer y = 116
boolean originalsize = false
end type

type p_close from w_a_reg_m_sql`p_close within b7w_reg_edigr22_vtel
integer x = 2619
integer y = 116
end type

type gb_cond from w_a_reg_m_sql`gb_cond within b7w_reg_edigr22_vtel
integer width = 2149
integer height = 648
end type

type p_save from w_a_reg_m_sql`p_save within b7w_reg_edigr22_vtel
boolean visible = false
end type

type dw_detail from w_a_reg_m_sql`dw_detail within b7w_reg_edigr22_vtel
integer x = 37
integer y = 664
integer width = 3113
integer height = 1196
string dataobject = "b7dw_reg_edigr22_m_vtel"
end type
