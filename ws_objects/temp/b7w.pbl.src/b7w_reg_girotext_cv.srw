$PBExportHeader$b7w_reg_girotext_cv.srw
$PBExportComments$[chooys] 지로수납파일처리 CVNET
forward
global type b7w_reg_girotext_cv from w_a_reg_m_sql
end type
type p_1 from u_p_fileread within b7w_reg_girotext_cv
end type
type p_payment from u_p_payment within b7w_reg_girotext_cv
end type
end forward
...
global b7w_reg_girotext_cv b7w_reg_girotext_cv
...
lu_dbmgr2.is_caller = "b7w_reg_girotext_cv%ue_fileread"
...
on b7w_reg_girotext_cv.destroy
call super::destroy
destroy(this.p_1)
...
type dw_cond from w_a_reg_m_sql`dw_cond within b7w_reg_girotext_cv
integer width = 2094
integer height = 496
...
type p_ok from w_a_reg_m_sql`p_ok within b7w_reg_girotext_cv
integer x = 2309
integer y = 116
boolean originalsize = false
end type

type p_close from w_a_reg_m_sql`p_close within b7w_reg_girotext_cv
integer x = 2619
integer y = 116
end type

type gb_cond from w_a_reg_m_sql`gb_cond within b7w_reg_girotext_cv
integer width = 2149
integer height = 552
end type

type p_save from w_a_reg_m_sql`p_save within b7w_reg_girotext_cv
boolean visible = false
end type

type dw_detail from w_a_reg_m_sql`dw_detail within b7w_reg_girotext_cv
integer x = 37
integer y = 576
integer width = 3099
integer height = 1284
string dataobject = "b7dw_reg_girotext_mst_cv"
end type
