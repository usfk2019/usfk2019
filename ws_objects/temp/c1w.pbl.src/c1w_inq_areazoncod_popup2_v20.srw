$PBExportHeader$c1w_inq_areazoncod_popup2_v20.srw
$PBExportComments$[ohj] 홀세일 지역별대역정의 대역 copy Popup v20
forward
global type c1w_inq_areazoncod_popup2_v20 from w_base
end type
type p_close from u_p_close within c1w_inq_areazoncod_popup2_v20
end type
type p_ok from u_p_ok within c1w_inq_areazoncod_popup2_v20
end type
type dw_cond from u_d_external within c1w_inq_areazoncod_popup2_v20
end type
type gb_1 from groupbox within c1w_inq_areazoncod_popup2_v20
end type
type dw_check from u_d_base within c1w_inq_areazoncod_popup2_v20
end type
end forward
...
global c1w_inq_areazoncod_popup2_v20 c1w_inq_areazoncod_popup2_v20
...
on c1w_inq_areazoncod_popup2_v20.create
int iCurrent
call super::create
...
on c1w_inq_areazoncod_popup2_v20.destroy
call super::destroy
...
event open;call super::open;/*-------------------------------------------------------
	Name	: c1w_inq_areazoncod_popup2_v20
	Desc.	: 표준 대역 Load wholesale
	Ver.	: 1.0
	Date	: 2006.01.11
...
f_center_window(c1w_inq_areazoncod_popup2_v20)
...
If is_type = 'Y' Then
	dw_cond.dataObject = "c1dw_cnd_reg_standard_zone2_svc_v20"
	...
	End If			
Else
	dw_cond.dataObject = "c1dw_cnd_reg_standard_zone2_v20"
	dw_cond.SetTransObject(SQLCA)
	dw_cond.insertrow(0)
...
integer height = 188
integer taborder = 10
string dataobject = "c1dw_cnd_reg_standard_zone2_v20"
...
Choose Case dwo.Name
	Case "svccod"
		// dddw change
//		dw_cond.Modify("nodeno.dddw.name = 'c1dc_dddw_nodeno_v20'")
...
integer height = 508
integer taborder = 20
string dataobject = "c1dw_reg_areazoncod_check2_v20"
end type
