$PBExportHeader$c1w_prc_carrier_amount_pre.srw
$PBExportComments$[hhm] 사업자정산재계산
forward
global type c1w_prc_carrier_amount_pre from w_a_prc
end type
end forward
...
global c1w_prc_carrier_amount_pre c1w_prc_carrier_amount_pre

type variables

end variables

on c1w_prc_carrier_amount_pre.create
call super::create
end on

on c1w_prc_carrier_amount_pre.destroy
call super::destroy
end on
...
//처리부분...
SQLCA.c1Carrier_Amount_pre(ls_yyyymmdd_fr,ls_yyyymmdd_to,ls_calctype,ls_Carrierid, ll_return, ls_errmsg, lb_count)
...
type p_ok from w_a_prc`p_ok within c1w_prc_carrier_amount_pre
integer x = 1568
integer y = 56
end type

type dw_input from w_a_prc`dw_input within c1w_prc_carrier_amount_pre
integer y = 64
integer width = 1358
integer height = 220
...
type dw_msg_time from w_a_prc`dw_msg_time within c1w_prc_carrier_amount_pre
integer y = 804
integer width = 1856
end type

type dw_msg_processing from w_a_prc`dw_msg_processing within c1w_prc_carrier_amount_pre
integer y = 340
integer width = 1856
end type

type ln_up from w_a_prc`ln_up within c1w_prc_carrier_amount_pre
integer beginx = 18
integer beginy = 328
integer endx = 1824
integer endy = 328
...
type ln_down from w_a_prc`ln_down within c1w_prc_carrier_amount_pre
integer beginy = 1084
integer endx = 1838
integer endy = 1084
end type

type p_close from w_a_prc`p_close within c1w_prc_carrier_amount_pre
integer x = 1568
integer y = 176
end type

type gb_cond from w_a_prc`gb_cond within c1w_prc_carrier_amount_pre
integer width = 1426
integer height = 304
end type
