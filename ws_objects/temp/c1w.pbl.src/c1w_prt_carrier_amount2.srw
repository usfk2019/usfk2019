$PBExportHeader$c1w_prt_carrier_amount2.srw
$PBExportComments$[parkkh] 회선정산료레포트(합산)
forward
global type c1w_prt_carrier_amount2 from w_a_print
end type
end forward

global type c1w_prt_carrier_amount2 from w_a_print
end type
global c1w_prt_carrier_amount2 c1w_prt_carrier_amount2

type variables
String is_ratetype, is_flag
end variables

on c1w_prt_carrier_amount2.create
call super::create
end on

on c1w_prt_carrier_amount2.destroy
call super::destroy
end on
...
String ls_cdsaup, ls_dtfrom, ls_dtto, ls_nmsaup, ls_where
long ll_row
...
type dw_cond from w_a_print`dw_cond within c1w_prt_carrier_amount2
integer x = 55
integer y = 48
integer width = 1504
integer height = 260
string dataobject = "c1dw_cnd_reg_carrier_amount"
boolean hscrollbar = false
boolean vscrollbar = false
boolean livescroll = false
end type

type p_ok from w_a_print`p_ok within c1w_prt_carrier_amount2
integer x = 1728
integer y = 44
end type

type p_close from w_a_print`p_close within c1w_prt_carrier_amount2
integer x = 2043
integer y = 44
end type

type dw_list from w_a_print`dw_list within c1w_prt_carrier_amount2
integer y = 356
string dataobject = "c1dw_prt_reg_carrier_amount2"
end type

type p_1 from w_a_print`p_1 within c1w_prt_carrier_amount2
end type

type p_2 from w_a_print`p_2 within c1w_prt_carrier_amount2
end type

type p_3 from w_a_print`p_3 within c1w_prt_carrier_amount2
end type

type p_5 from w_a_print`p_5 within c1w_prt_carrier_amount2
end type

type p_6 from w_a_print`p_6 within c1w_prt_carrier_amount2
end type

type p_7 from w_a_print`p_7 within c1w_prt_carrier_amount2
end type

type p_8 from w_a_print`p_8 within c1w_prt_carrier_amount2
end type

type p_9 from w_a_print`p_9 within c1w_prt_carrier_amount2
end type

type p_4 from w_a_print`p_4 within c1w_prt_carrier_amount2
end type

type gb_1 from w_a_print`gb_1 within c1w_prt_carrier_amount2
end type

type p_port from w_a_print`p_port within c1w_prt_carrier_amount2
end type

type p_land from w_a_print`p_land within c1w_prt_carrier_amount2
end type

type gb_cond from w_a_print`gb_cond within c1w_prt_carrier_amount2
integer width = 1600
end type

type p_saveas from w_a_print`p_saveas within c1w_prt_carrier_amount2
end type
