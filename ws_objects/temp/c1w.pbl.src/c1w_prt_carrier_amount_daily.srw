$PBExportHeader$c1w_prt_carrier_amount_daily.srw
$PBExportComments$[ssong] 회선정산료레포트(합산)
forward
global type c1w_prt_carrier_amount_daily from w_a_print
end type
end forward

global type c1w_prt_carrier_amount_daily from w_a_print
end type
global c1w_prt_carrier_amount_daily c1w_prt_carrier_amount_daily

type variables
String is_ratetype
end variables

on c1w_prt_carrier_amount_daily.create
call super::create
end on

on c1w_prt_carrier_amount_daily.destroy
call super::destroy
end on
...
type dw_cond from w_a_print`dw_cond within c1w_prt_carrier_amount_daily
integer y = 40
integer width = 1102
integer height = 332
...
type p_ok from w_a_print`p_ok within c1w_prt_carrier_amount_daily
integer x = 1298
integer y = 140
end type

type p_close from w_a_print`p_close within c1w_prt_carrier_amount_daily
integer x = 1600
integer y = 140
end type

type dw_list from w_a_print`dw_list within c1w_prt_carrier_amount_daily
integer y = 396
integer height = 1216
string dataobject = "c1dw_prt_reg_carrier_amount_daily"
end type

type p_1 from w_a_print`p_1 within c1w_prt_carrier_amount_daily
end type

type p_2 from w_a_print`p_2 within c1w_prt_carrier_amount_daily
end type

type p_3 from w_a_print`p_3 within c1w_prt_carrier_amount_daily
end type

type p_5 from w_a_print`p_5 within c1w_prt_carrier_amount_daily
end type

type p_6 from w_a_print`p_6 within c1w_prt_carrier_amount_daily
end type

type p_7 from w_a_print`p_7 within c1w_prt_carrier_amount_daily
end type

type p_8 from w_a_print`p_8 within c1w_prt_carrier_amount_daily
end type

type p_9 from w_a_print`p_9 within c1w_prt_carrier_amount_daily
end type

type p_4 from w_a_print`p_4 within c1w_prt_carrier_amount_daily
end type

type gb_1 from w_a_print`gb_1 within c1w_prt_carrier_amount_daily
end type

type p_port from w_a_print`p_port within c1w_prt_carrier_amount_daily
end type

type p_land from w_a_print`p_land within c1w_prt_carrier_amount_daily
end type

type gb_cond from w_a_print`gb_cond within c1w_prt_carrier_amount_daily
integer width = 1202
integer height = 388
end type

type p_saveas from w_a_print`p_saveas within c1w_prt_carrier_amount_daily
end type
