$PBExportHeader$c1w_prt_wholesaledet_currency_type_v20.srw
$PBExportComments$[ohj] wholesale 사업자 대역 정산 보고서(통화유형별) v20
forward
global type c1w_prt_wholesaledet_currency_type_v20 from w_a_print
end type
end forward

global type c1w_prt_wholesaledet_currency_type_v20 from w_a_print
end type
global c1w_prt_wholesaledet_currency_type_v20 c1w_prt_wholesaledet_currency_type_v20

on c1w_prt_wholesaledet_currency_type_v20.create
call super::create
end on

on c1w_prt_wholesaledet_currency_type_v20.destroy
call super::destroy
end on
...
If ls_customerid <> "" Then
    ...
    ls_where += " a.customerid = '" + ls_customerid + "' "
	 dw_list.Object.customerid_t.text = dw_cond.Describe("evaluate('lookupdisplay(customerid)',1 )")
	 
else
	dw_list.Object.customerid_t.text = 'ALL'	
End If
...
type dw_cond from w_a_print`dw_cond within c1w_prt_wholesaledet_currency_type_v20
integer y = 48
integer height = 416
string dataobject = "c1dw_prt_cnd_wholesaledet_currency_v20"
...
type p_ok from w_a_print`p_ok within c1w_prt_wholesaledet_currency_type_v20
end type

type p_close from w_a_print`p_close within c1w_prt_wholesaledet_currency_type_v20
end type

type dw_list from w_a_print`dw_list within c1w_prt_wholesaledet_currency_type_v20
integer x = 32
integer y = 500
integer height = 1104
string dataobject = "c1dw_prt_det_wholesaledet_currency_v20"
end type

type p_1 from w_a_print`p_1 within c1w_prt_wholesaledet_currency_type_v20
end type

type p_2 from w_a_print`p_2 within c1w_prt_wholesaledet_currency_type_v20
end type

type p_3 from w_a_print`p_3 within c1w_prt_wholesaledet_currency_type_v20
end type

type p_5 from w_a_print`p_5 within c1w_prt_wholesaledet_currency_type_v20
end type

type p_6 from w_a_print`p_6 within c1w_prt_wholesaledet_currency_type_v20
end type

type p_7 from w_a_print`p_7 within c1w_prt_wholesaledet_currency_type_v20
end type

type p_8 from w_a_print`p_8 within c1w_prt_wholesaledet_currency_type_v20
end type

type p_9 from w_a_print`p_9 within c1w_prt_wholesaledet_currency_type_v20
end type

type p_4 from w_a_print`p_4 within c1w_prt_wholesaledet_currency_type_v20
end type

type gb_1 from w_a_print`gb_1 within c1w_prt_wholesaledet_currency_type_v20
end type

type p_port from w_a_print`p_port within c1w_prt_wholesaledet_currency_type_v20
end type

type p_land from w_a_print`p_land within c1w_prt_wholesaledet_currency_type_v20
end type

type gb_cond from w_a_print`gb_cond within c1w_prt_wholesaledet_currency_type_v20
integer height = 480
end type

type p_saveas from w_a_print`p_saveas within c1w_prt_wholesaledet_currency_type_v20
end type
