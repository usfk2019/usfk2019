$PBExportHeader$c1w_reg_arezoncod2_v20.srw
$PBExportComments$[ohj] 홀세일 지역별 대역정의 v20
forward
global type c1w_reg_arezoncod2_v20 from w_a_reg_m
end type
type cb_load from commandbutton within c1w_reg_arezoncod2_v20
end type
type p_reload from u_p_reload within c1w_reg_arezoncod2_v20
end type
type p_saveas from u_p_saveas within c1w_reg_arezoncod2_v20
end type
type p_fileread from u_p_fileread within c1w_reg_arezoncod2_v20
end type
end forward
...
global c1w_reg_arezoncod2_v20 c1w_reg_arezoncod2_v20

type variables
String is_type, is_svctype[]
end variables
...
on c1w_reg_arezoncod2_v20.create
int iCurrent
call super::create
...
on c1w_reg_arezoncod2_v20.destroy
call super::destroy
...
event open;call super::open;/*------------------------------------------------------------------------
	Name	:	c1w_reg_arezoncod2_v20
	Desc	:  홀세일용 서비스,가격정책 발신지별 대역 등록
	Ver	:	1.0
	Date	: 	2006.01.10
...
If is_type = 'Y' Then
	dw_cond.dataObject = "c1dw_cnd_reg_arezoncod2_svc_v20"
...
Else
	dw_cond.dataObject = "c1dw_cnd_reg_arezoncod2_v20"
	dw_cond.SetTransObject(SQLCA)
	dw_cond.insertrow(0)
...
type dw_cond from w_a_reg_m`dw_cond within c1w_reg_arezoncod2_v20
integer y = 80
integer width = 3246
integer height = 248
string dataobject = "c1dw_cnd_reg_arezoncod2_svc_v20"
...
type p_ok from w_a_reg_m`p_ok within c1w_reg_arezoncod2_v20
integer x = 3360
integer y = 72
end type

type p_close from w_a_reg_m`p_close within c1w_reg_arezoncod2_v20
integer x = 3666
integer y = 72
end type

type gb_cond from w_a_reg_m`gb_cond within c1w_reg_arezoncod2_v20
integer width = 3291
integer height = 364
end type

type p_delete from w_a_reg_m`p_delete within c1w_reg_arezoncod2_v20
integer x = 329
integer y = 1632
end type

type p_insert from w_a_reg_m`p_insert within c1w_reg_arezoncod2_v20
integer y = 1632
end type

type p_save from w_a_reg_m`p_save within c1w_reg_arezoncod2_v20
integer x = 626
integer y = 1632
end type

type dw_detail from w_a_reg_m`dw_detail within c1w_reg_arezoncod2_v20
integer y = 380
integer width = 3936
integer height = 1216
string dataobject = "c1dw_reg_areazoncod2_v20"
end type
...
If dwo.name = "arezoncod2_areacod" Then
		...
		lu_dbmgr.is_caller = "c1w_reg_standard_zone%display"
...
type p_reset from w_a_reg_m`p_reset within c1w_reg_arezoncod2_v20
integer x = 1221
integer y = 1632
end type
...
//Open
//표준대역 윈도우 연다.
OpenWithParm(c1w_inq_areazoncod_popup2_v20, iu_cust_msg)  
