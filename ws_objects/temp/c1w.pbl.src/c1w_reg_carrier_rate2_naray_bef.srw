$PBExportHeader$c1w_reg_carrier_rate2_naray_bef.srw
$PBExportComments$[ssong] 회선정산요율 naray old virsion
forward
global type c1w_reg_carrier_rate2_naray_bef from w_a_reg_m
end type
end forward
...
global c1w_reg_carrier_rate2_naray_bef c1w_reg_carrier_rate2_naray_bef

type variables
String is_ratetype
end variables

on c1w_reg_carrier_rate2_naray_bef.create
call super::create
end on

on c1w_reg_carrier_rate2_naray_bef.destroy
call super::destroy
end on
...
type dw_cond from w_a_reg_m`dw_cond within c1w_reg_carrier_rate2_naray_bef
integer width = 1152
integer height = 164
...
type p_ok from w_a_reg_m`p_ok within c1w_reg_carrier_rate2_naray_bef
integer x = 1349
integer y = 44
end type

type p_close from w_a_reg_m`p_close within c1w_reg_carrier_rate2_naray_bef
integer x = 1655
integer y = 44
boolean originalsize = false
end type

type gb_cond from w_a_reg_m`gb_cond within c1w_reg_carrier_rate2_naray_bef
integer width = 1189
integer height = 240
end type

type p_delete from w_a_reg_m`p_delete within c1w_reg_carrier_rate2_naray_bef
integer x = 334
integer y = 1576
end type

type p_insert from w_a_reg_m`p_insert within c1w_reg_carrier_rate2_naray_bef
integer x = 41
integer y = 1576
end type

type p_save from w_a_reg_m`p_save within c1w_reg_carrier_rate2_naray_bef
integer x = 631
integer y = 1576
end type

type dw_detail from w_a_reg_m`dw_detail within c1w_reg_carrier_rate2_naray_bef
integer y = 256
integer height = 1264
string dataobject = "c1dw_inq_reg_carrier_rate2_naray_bef"
end type

event dw_detail::constructor;call super::constructor;dw_detail.setrowfocusindicator(off!)
end event

type p_reset from w_a_reg_m`p_reset within c1w_reg_carrier_rate2_naray_bef
integer x = 1147
integer y = 1576
end type
