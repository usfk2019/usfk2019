$PBExportHeader$p0w_prc_cardmst_1.srw
$PBExportComments$[chooys]  카드발행 Window
forward
global type p0w_prc_cardmst_1 from w_a_prc
end type
end forward
...
global p0w_prc_cardmst_1 p0w_prc_cardmst_1
...
on p0w_prc_cardmst_1.create
call super::create
end on

on p0w_prc_cardmst_1.destroy
call super::destroy
end on
...
type p_ok from w_a_prc`p_ok within p0w_prc_cardmst_1
integer x = 1833
integer y = 56
end type

type dw_input from w_a_prc`dw_input within p0w_prc_cardmst_1
integer width = 1714
integer height = 816
string dataobject = "p0dw_cnd_prc_cardmst_1"
...
type dw_msg_time from w_a_prc`dw_msg_time within p0w_prc_cardmst_1
integer y = 1468
integer width = 2080
end type

type dw_msg_processing from w_a_prc`dw_msg_processing within p0w_prc_cardmst_1
integer y = 924
integer width = 2080
integer height = 524
end type

type ln_up from w_a_prc`ln_up within p0w_prc_cardmst_1
integer beginy = 904
integer endx = 2098
integer endy = 904
end type

type ln_down from w_a_prc`ln_down within p0w_prc_cardmst_1
integer beginy = 1764
integer endx = 2098
integer endy = 1764
end type

type p_close from w_a_prc`p_close within p0w_prc_cardmst_1
integer x = 1833
integer y = 164
end type

type gb_cond from w_a_prc`gb_cond within p0w_prc_cardmst_1
integer width = 1765
integer height = 880
end type
