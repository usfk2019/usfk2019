$PBExportHeader$p0w_prc_cardmst_anyuser.srw
$PBExportComments$[juede]  카드발행 Window_cyberpass pin 자리수 적용 & 기본료 & 기본율 & 유효기간
forward
global type p0w_prc_cardmst_anyuser from w_a_prc
end type
end forward
...
global p0w_prc_cardmst_anyuser p0w_prc_cardmst_anyuser
...
on p0w_prc_cardmst_anyuser.create
call super::create
end on

on p0w_prc_cardmst_anyuser.destroy
call super::destroy
end on
...
IF is_confirm = "N" THEN  
	iu_db.is_caller = "p0w_prc_cardmst_anyuser%sale_no"
	iu_db.uf_prc_db_02()
ELSEIF is_confirm = "Y" THEN 
	iu_db.is_caller = "p0w_prc_cardmst_anyuser%sale_yes"
	iu_db.uf_prc_db_02()
END IF
...
type p_ok from w_a_prc`p_ok within p0w_prc_cardmst_anyuser
integer x = 1833
integer y = 56
end type

type dw_input from w_a_prc`dw_input within p0w_prc_cardmst_anyuser
integer width = 1714
integer height = 816
...
type dw_msg_time from w_a_prc`dw_msg_time within p0w_prc_cardmst_anyuser
integer y = 1468
integer width = 2080
end type

type dw_msg_processing from w_a_prc`dw_msg_processing within p0w_prc_cardmst_anyuser
integer y = 924
integer width = 2080
integer height = 524
end type

type ln_up from w_a_prc`ln_up within p0w_prc_cardmst_anyuser
integer beginy = 904
integer endx = 2098
integer endy = 904
end type

type ln_down from w_a_prc`ln_down within p0w_prc_cardmst_anyuser
integer beginy = 1764
integer endx = 2098
integer endy = 1764
end type

type p_close from w_a_prc`p_close within p0w_prc_cardmst_anyuser
integer x = 1833
integer y = 164
end type

type gb_cond from w_a_prc`gb_cond within p0w_prc_cardmst_anyuser
integer width = 1765
integer height = 880
end type
