$PBExportHeader$p0w_prc_out_1.srw
$PBExportComments$[y.k.min] 카드판매출고처리
forward
global type p0w_prc_out_1 from w_a_prc
end type
end forward
...
global p0w_prc_out_1 p0w_prc_out_1
...
on p0w_prc_out_1.create
call super::create
end on

on p0w_prc_out_1.destroy
call super::destroy
end on
...
iu_db = Create p0c_dbmgr

iu_db.is_title = Title
iu_db.is_caller = "p0w_prc_out_1%saleout"
...
iu_db.is_data[10] = is_dealy			// 모델에 대한 dynamic 연장일수 	
iu_db.uf_prc_db_01()
...
type p_ok from w_a_prc`p_ok within p0w_prc_out_1
integer x = 1934
integer y = 72
end type

type dw_input from w_a_prc`dw_input within p0w_prc_out_1
integer y = 56
integer width = 1783
integer height = 880
...
String ls_filter
Integer li_dealy, li_extdays

//카드 금액을 가져오기 위한 것
Choose Case dwo.name
	Case "opendt"
		ld_opendt =This.object.opendt[1]
		//li_dealy = Integer(is_dealy)
		...
		li_extdays = ldc_model.GetItemNumber(ll_row, "extdays")
		
		ld_nextdate = fd_date_next(ld_opendt, li_extdays)
	...
	Case "model" 
		...
		// 선택한 모델에 대한 연장일수 global 변수에 저장
		is_dealy = String(li_extdays)
...
type dw_msg_time from w_a_prc`dw_msg_time within p0w_prc_out_1
integer y = 1536
integer width = 2185
end type

type dw_msg_processing from w_a_prc`dw_msg_processing within p0w_prc_out_1
integer y = 1024
integer width = 2185
integer height = 480
end type

type ln_up from w_a_prc`ln_up within p0w_prc_out_1
integer beginx = 37
integer beginy = 1004
integer endx = 1787
integer endy = 1004
...
type ln_down from w_a_prc`ln_down within p0w_prc_out_1
integer beginx = 37
integer beginy = 1832
integer endx = 1787
integer endy = 1832
...
type p_close from w_a_prc`p_close within p0w_prc_out_1
integer x = 1934
integer y = 184
end type

type gb_cond from w_a_prc`gb_cond within p0w_prc_out_1
integer x = 27
integer width = 1856
integer height = 972
end type
