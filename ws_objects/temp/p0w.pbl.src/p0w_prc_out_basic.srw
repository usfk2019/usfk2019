$PBExportHeader$p0w_prc_out_basic.srw
$PBExportComments$[y.k.min] 카드판매출고처리
forward
global type p0w_prc_out_basic from w_a_prc
end type
end forward
...
global p0w_prc_out_basic p0w_prc_out_basic
...
on p0w_prc_out_basic.create
call super::create
end on

on p0w_prc_out_basic.destroy
call super::destroy
end on
...
type p_ok from w_a_prc`p_ok within p0w_prc_out_basic
integer x = 1934
integer y = 72
end type

type dw_input from w_a_prc`dw_input within p0w_prc_out_basic
integer y = 56
integer width = 1783
integer height = 880
...
type dw_msg_time from w_a_prc`dw_msg_time within p0w_prc_out_basic
integer y = 1536
integer width = 2185
end type

type dw_msg_processing from w_a_prc`dw_msg_processing within p0w_prc_out_basic
integer y = 1024
integer width = 2185
integer height = 480
end type

type ln_up from w_a_prc`ln_up within p0w_prc_out_basic
integer beginx = 37
integer beginy = 1004
integer endx = 1787
integer endy = 1004
...
type ln_down from w_a_prc`ln_down within p0w_prc_out_basic
integer beginx = 37
integer beginy = 1832
integer endx = 1787
integer endy = 1832
...
type p_close from w_a_prc`p_close within p0w_prc_out_basic
integer x = 1934
integer y = 184
end type

type gb_cond from w_a_prc`gb_cond within p0w_prc_out_basic
integer x = 27
integer width = 1856
integer height = 972
end type
