$PBExportHeader$p1w_hlp_logid.srw
$PBExportComments$[ceusee] LogID Check
forward
global type p1w_hlp_logid from w_a_hlp
end type
end forward
...
global p1w_hlp_logid p1w_hlp_logid

type variables

end variables

on p1w_hlp_logid.create
call super::create
end on

on p1w_hlp_logid.destroy
call super::destroy
end on
...
type p_1 from w_a_hlp`p_1 within p1w_hlp_logid
integer x = 567
integer y = 488
end type

type dw_cond from w_a_hlp`dw_cond within p1w_hlp_logid
integer x = 27
integer width = 1230
integer height = 184
string dataobject = "p1dw_cnd_reg_logid"
boolean livescroll = false
end type

type p_ok from w_a_hlp`p_ok within p1w_hlp_logid
integer x = 869
integer y = 488
end type

type p_close from w_a_hlp`p_close within p1w_hlp_logid
integer x = 1170
integer y = 488
end type

type gb_cond from w_a_hlp`gb_cond within p1w_hlp_logid
integer x = 23
integer width = 1266
integer height = 240
end type

type dw_hlp from w_a_hlp`dw_hlp within p1w_hlp_logid
integer x = 23
integer y = 252
integer width = 1454
integer height = 216
string dataobject = "p1dw_cnd_logid"
