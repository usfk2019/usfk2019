$PBExportHeader$p1w_inq_cdryyyymmdd.srw
$PBExportComments$[uhmjj] 선불카드 고객관리/일자별통화내역
forward
global type p1w_inq_cdryyyymmdd from w_a_inq_m
end type
type dw_tmp from u_d_base within p1w_inq_cdryyyymmdd
end type
type p_1 from u_p_saveas within p1w_inq_cdryyyymmdd
end type
end forward
...
global p1w_inq_cdryyyymmdd p1w_inq_cdryyyymmdd
...
on p1w_inq_cdryyyymmdd.destroy
call super::destroy
destroy(this.dw_tmp)
destroy(this.p_1)
end on
...
event open;call super::open;/*-------------------------------------------------------------------------
	Name	:	p1w_inq_cdryyyymmdd
	Desc.	:	선불카드/일자별통화내역
	Ver	: 	1.0
	Date	: 	2004.10.25
	Prgromer : Uhm Jae Jun(uhmjj)
---------------------------------------------------------------------------*/
Date ld_sysdate
...
dw_cond.Object.svctype[1] = ls_svctype
...
type dw_cond from w_a_inq_m`dw_cond within p1w_inq_cdryyyymmdd
integer x = 59
integer y = 52
integer width = 2807
integer height = 280
string dataobject = "p1dw_cnd_inq_cdryyyymmdd"
...
type p_ok from w_a_inq_m`p_ok within p1w_inq_cdryyyymmdd
integer x = 2939
integer y = 44
end type

type p_close from w_a_inq_m`p_close within p1w_inq_cdryyyymmdd
integer x = 3561
integer y = 44
boolean originalsize = false
end type

type gb_cond from w_a_inq_m`gb_cond within p1w_inq_cdryyyymmdd
integer width = 2866
integer height = 348
end type

type dw_detail from w_a_inq_m`dw_detail within p1w_inq_cdryyyymmdd
integer y = 368
integer width = 3849
integer height = 1356
string dataobject = "p1dw_inq_cdryyyymmdd1"
end type
