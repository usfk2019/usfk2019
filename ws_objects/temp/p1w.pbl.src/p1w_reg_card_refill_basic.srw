$PBExportHeader$p1w_reg_card_refill_basic.srw
$PBExportComments$[islim] 카드 충전 -충전기본료적용
forward
global type p1w_reg_card_refill_basic from w_a_reg_m_sql
end type
end forward
...
global p1w_reg_card_refill_basic p1w_reg_card_refill_basic
...
on p1w_reg_card_refill_basic.create
call super::create
end on

on p1w_reg_card_refill_basic.destroy
call super::destroy
end on
...
iu_db.is_caller = "p1w_reg_card_refill_basic%save"
...
type dw_cond from w_a_reg_m_sql`dw_cond within p1w_reg_card_refill_basic
integer x = 41
integer y = 60
integer width = 2181
integer height = 908
...
type p_ok from w_a_reg_m_sql`p_ok within p1w_reg_card_refill_basic
integer x = 2359
boolean originalsize = false
end type

type p_close from w_a_reg_m_sql`p_close within p1w_reg_card_refill_basic
integer x = 2359
end type

type gb_cond from w_a_reg_m_sql`gb_cond within p1w_reg_card_refill_basic
integer width = 2240
integer height = 988
end type

type p_save from w_a_reg_m_sql`p_save within p1w_reg_card_refill_basic
integer x = 2359
end type

type dw_detail from w_a_reg_m_sql`dw_detail within p1w_reg_card_refill_basic
integer y = 1012
integer width = 2816
integer height = 1332
