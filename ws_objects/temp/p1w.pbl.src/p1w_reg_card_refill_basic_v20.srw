$PBExportHeader$p1w_reg_card_refill_basic_v20.srw
$PBExportComments$[islim] 카드 충전 -충전기본료적용
forward
global type p1w_reg_card_refill_basic_v20 from w_a_reg_m_sql
end type
end forward
...
global p1w_reg_card_refill_basic_v20 p1w_reg_card_refill_basic_v20
...
on p1w_reg_card_refill_basic_v20.create
call super::create
end on

on p1w_reg_card_refill_basic_v20.destroy
call super::destroy
end on
...
iu_db.is_caller = "p1w_reg_card_refill_basic_v20%save"
...
type dw_cond from w_a_reg_m_sql`dw_cond within p1w_reg_card_refill_basic_v20
integer x = 41
integer y = 60
integer width = 2181
integer height = 908
...
Choose Case dwo.name
	...
	Case "refill_type"
		   ...
		   If is_refill_type <> data Then
		      ...
		      ldc_refill_amt = This.object.refill_amt[1]
				...
				If ls_partner<>"" And ls_refilldt <> "" And ls_priceplan<>"" Then
					//2005.08.11 modify
	...
	Case "partner_prefix" 
		If is_refill_type <> ls_refill_type Then
			...
			If ls_refilldt <> "" And ls_priceplan<> "" Then
...
type p_ok from w_a_reg_m_sql`p_ok within p1w_reg_card_refill_basic_v20
integer x = 2359
boolean originalsize = false
end type

type p_close from w_a_reg_m_sql`p_close within p1w_reg_card_refill_basic_v20
integer x = 2359
end type

type gb_cond from w_a_reg_m_sql`gb_cond within p1w_reg_card_refill_basic_v20
integer width = 2240
integer height = 988
end type

type p_save from w_a_reg_m_sql`p_save within p1w_reg_card_refill_basic_v20
integer x = 2359
end type

type dw_detail from w_a_reg_m_sql`dw_detail within p1w_reg_card_refill_basic_v20
integer y = 1012
integer width = 2816
integer height = 1332
