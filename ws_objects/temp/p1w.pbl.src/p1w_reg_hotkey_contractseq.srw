$PBExportHeader$p1w_reg_hotkey_contractseq.srw
$PBExportComments$[ssong]insert hotkey by contractseq
forward
global type p1w_reg_hotkey_contractseq from w_a_reg_m_m
end type
end forward

global type p1w_reg_hotkey_contractseq from w_a_reg_m_m
end type
global p1w_reg_hotkey_contractseq p1w_reg_hotkey_contractseq
...
on p1w_reg_hotkey_contractseq.create
call super::create
end on

on p1w_reg_hotkey_contractseq.destroy
call super::destroy
end on
...
String	ls_where
String	ls_customerid, ls_validkey, ls_contractseq
...
If ls_contractseq <> "" Then
	If ls_where <> "" Then ls_where += " AND "
	ls_where += " B.CONTRACTSEQ = '" + ls_contractseq + "' "
End If
...
type dw_cond from w_a_reg_m_m`dw_cond within p1w_reg_hotkey_contractseq
integer x = 59
integer y = 60
integer width = 2267
integer height = 204
...
type p_ok from w_a_reg_m_m`p_ok within p1w_reg_hotkey_contractseq
end type

type p_close from w_a_reg_m_m`p_close within p1w_reg_hotkey_contractseq
end type

type gb_cond from w_a_reg_m_m`gb_cond within p1w_reg_hotkey_contractseq
integer height = 292
end type

type dw_master from w_a_reg_m_m`dw_master within p1w_reg_hotkey_contractseq
...
type dw_detail from w_a_reg_m_m`dw_detail within p1w_reg_hotkey_contractseq
...
type p_insert from w_a_reg_m_m`p_insert within p1w_reg_hotkey_contractseq
end type

type p_delete from w_a_reg_m_m`p_delete within p1w_reg_hotkey_contractseq
end type

type p_save from w_a_reg_m_m`p_save within p1w_reg_hotkey_contractseq
end type

type p_reset from w_a_reg_m_m`p_reset within p1w_reg_hotkey_contractseq
end type

type st_horizontal from w_a_reg_m_m`st_horizontal within p1w_reg_hotkey_contractseq
end type
