$PBExportHeader$p1w_reg_master.srw
$PBExportComments$[chooys] 선불카드관리 Window
forward
global type p1w_reg_master from w_a_reg_m_tm2
end type
type p_find from u_p_find within p1w_reg_master
end type
type dw_workdt from u_d_help within p1w_reg_master
end type
end forward
...
global p1w_reg_master p1w_reg_master
...
type dw_cond from w_a_reg_m_tm2`dw_cond within p1w_reg_master
integer width = 2597
integer height = 376
string dataobject = "p1dw_cnd_reg_master"
end type

type p_ok from w_a_reg_m_tm2`p_ok within p1w_reg_master
integer x = 2807
end type

type p_close from w_a_reg_m_tm2`p_close within p1w_reg_master
integer x = 3109
end type

type gb_cond from w_a_reg_m_tm2`gb_cond within p1w_reg_master
integer width = 2647
integer height = 432
end type

type dw_master from w_a_reg_m_tm2`dw_master within p1w_reg_master
integer y = 460
integer width = 3611
integer height = 636
...
type p_insert from w_a_reg_m_tm2`p_insert within p1w_reg_master
boolean visible = false
end type

type p_delete from w_a_reg_m_tm2`p_delete within p1w_reg_master
boolean visible = false
end type

type p_save from w_a_reg_m_tm2`p_save within p1w_reg_master
end type

type p_reset from w_a_reg_m_tm2`p_reset within p1w_reg_master
end type

type tab_1 from w_a_reg_m_tm2`tab_1 within p1w_reg_master
integer y = 1140
integer width = 3616
integer height = 668
end type
...
String ls_where, ls_langtype, ls_ref_desc
Long ll_row, i
...
type st_horizontal from w_a_reg_m_tm2`st_horizontal within p1w_reg_master
integer x = 37
integer y = 1100
end type
