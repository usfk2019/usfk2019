$PBExportHeader$p1w_reg_master_all.srw
$PBExportComments$[victory] Master 일괄 수정
forward
global type p1w_reg_master_all from w_a_reg_m_sql
end type
end forward
...
global p1w_reg_master_all p1w_reg_master_all
...
on p1w_reg_master_all.create
call super::create
end on

on p1w_reg_master_all.destroy
call super::destroy
end on
...
type dw_cond from w_a_reg_m_sql`dw_cond within p1w_reg_master_all
integer x = 46
integer y = 44
integer width = 2226
integer height = 856
string dataobject = "p1d_cnd_reg_master_all"
boolean hscrollbar = false
boolean vscrollbar = false
end type

type p_ok from w_a_reg_m_sql`p_ok within p1w_reg_master_all
integer x = 2409
integer y = 44
end type

type p_close from w_a_reg_m_sql`p_close within p1w_reg_master_all
integer x = 2409
integer y = 296
end type

type gb_cond from w_a_reg_m_sql`gb_cond within p1w_reg_master_all
integer width = 2263
integer height = 912
end type

type p_save from w_a_reg_m_sql`p_save within p1w_reg_master_all
integer x = 2409
integer y = 172
end type

type dw_detail from w_a_reg_m_sql`dw_detail within p1w_reg_master_all
integer y = 928
integer width = 2862
integer height = 1340
string dataobject = "p1d_reg_master_all"
end type
