$PBExportHeader$p1w_reg_partnermst.srw
$PBExportComments$[ceusee] 대리점정보등록
forward
global type p1w_reg_partnermst from w_a_reg_m_tm2
end type
end forward
...
global p1w_reg_partnermst p1w_reg_partnermst
...
on p1w_reg_partnermst.create
int iCurrent
call super::create
end on

on p1w_reg_partnermst.destroy
call super::destroy
end on
...
String ls_hprefixno, ls_hprefixno_1, ls_prefixno, ls_sql, ls_bondtype, ls_fromdt, ls_bondamt
...
type dw_cond from w_a_reg_m_tm2`dw_cond within p1w_reg_partnermst
integer x = 55
integer y = 40
integer width = 2665
integer height = 240
string dataobject = "p1dw_cnd_reg_partnermst"
boolean livescroll = false
end type

type p_ok from w_a_reg_m_tm2`p_ok within p1w_reg_partnermst
integer x = 2889
integer y = 56
end type

type p_close from w_a_reg_m_tm2`p_close within p1w_reg_partnermst
integer x = 3195
integer y = 56
boolean originalsize = false
end type

type gb_cond from w_a_reg_m_tm2`gb_cond within p1w_reg_partnermst
integer width = 2747
integer height = 292
end type

type dw_master from w_a_reg_m_tm2`dw_master within p1w_reg_partnermst
integer y = 320
integer width = 3470
integer height = 604
string dataobject = "p1dw_inq_partnermst"
end type
...
type p_insert from w_a_reg_m_tm2`p_insert within p1w_reg_partnermst
integer y = 1920
end type

type p_delete from w_a_reg_m_tm2`p_delete within p1w_reg_partnermst
integer y = 1920
end type

type p_save from w_a_reg_m_tm2`p_save within p1w_reg_partnermst
integer y = 1920
end type

type p_reset from w_a_reg_m_tm2`p_reset within p1w_reg_partnermst
integer y = 1920
end type

type tab_1 from w_a_reg_m_tm2`tab_1 within p1w_reg_partnermst
integer y = 964
integer width = 3461
integer height = 928
...
is_dwobject[1] = "p1dw_reg_partnermst_t1"
is_dwobject[2] = "p1dw_reg_partnermst_t2"
...
type st_horizontal from w_a_reg_m_tm2`st_horizontal within p1w_reg_partnermst
integer y = 924
end type
