$PBExportHeader$p1w_reg_pintopin.srw
$PBExportComments$[ceusee] Pin To Pin 충전
forward
global type p1w_reg_pintopin from w_a_reg_m_m
end type
end forward
...
global p1w_reg_pintopin p1w_reg_pintopin
...
on p1w_reg_pintopin.create
call super::create
end on

on p1w_reg_pintopin.destroy
call super::destroy
end on
...
type dw_cond from w_a_reg_m_m`dw_cond within p1w_reg_pintopin
integer width = 2647
integer height = 376
...
type p_ok from w_a_reg_m_m`p_ok within p1w_reg_pintopin
integer x = 2839
integer y = 64
end type

type p_close from w_a_reg_m_m`p_close within p1w_reg_pintopin
integer x = 3145
integer y = 64
end type

type gb_cond from w_a_reg_m_m`gb_cond within p1w_reg_pintopin
integer width = 2688
integer height = 444
end type

type dw_master from w_a_reg_m_m`dw_master within p1w_reg_pintopin
integer y = 456
integer width = 3534
integer height = 480
...
type dw_detail from w_a_reg_m_m`dw_detail within p1w_reg_pintopin
integer y = 968
integer width = 3538
string dataobject = "p1dw_reg_pintopin"
end type
...
type p_insert from w_a_reg_m_m`p_insert within p1w_reg_pintopin
boolean visible = false
integer y = 1844
end type

type p_delete from w_a_reg_m_m`p_delete within p1w_reg_pintopin
boolean visible = false
integer y = 1848
end type

type p_save from w_a_reg_m_m`p_save within p1w_reg_pintopin
integer x = 73
integer y = 1856
end type

type p_reset from w_a_reg_m_m`p_reset within p1w_reg_pintopin
integer x = 443
integer y = 1856
end type

type st_horizontal from w_a_reg_m_m`st_horizontal within p1w_reg_pintopin
integer y = 936
end type
