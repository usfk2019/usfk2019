$PBExportHeader$p2w_prc_appendpre_bilcdr_v20.srw
$PBExportComments$[ohj] 선불 일자별 CDR Append v20
forward
global type p2w_prc_appendpre_bilcdr_v20 from w_a_prc
end type
end forward
...
global p2w_prc_appendpre_bilcdr_v20 p2w_prc_appendpre_bilcdr_v20

type variables

end variables

on p2w_prc_appendpre_bilcdr_v20.create
call super::create
end on

on p2w_prc_appendpre_bilcdr_v20.destroy
call super::destroy
end on
...
//처리부분...
SQLCA.P2AppendPre_bilcdr_v2(ls_yyyymmdd_to, 1000, 100, ll_return, ls_errmsg, lb_count)
...
ls_temp = ""
ls_temp = fs_get_control('B1','A101', ls_ref_desc)
...
type p_ok from w_a_prc`p_ok within p2w_prc_appendpre_bilcdr_v20
integer x = 1449
integer y = 36
end type

type dw_input from w_a_prc`dw_input within p2w_prc_appendpre_bilcdr_v20
integer x = 64
integer y = 44
integer width = 1230
integer height = 148
string dataobject = "p2dw_cnd_prc_appendpost_bilcdr_v20"
boolean hscrollbar = false
boolean vscrollbar = false
end type

type dw_msg_time from w_a_prc`dw_msg_time within p2w_prc_appendpre_bilcdr_v20
integer y = 744
integer width = 1856
end type

type dw_msg_processing from w_a_prc`dw_msg_processing within p2w_prc_appendpre_bilcdr_v20
integer y = 280
integer width = 1856
end type

type ln_up from w_a_prc`ln_up within p2w_prc_appendpre_bilcdr_v20
integer beginy = 264
integer endx = 1838
integer endy = 264
end type

type ln_down from w_a_prc`ln_down within p2w_prc_appendpre_bilcdr_v20
integer beginy = 1024
integer endx = 1838
integer endy = 1024
end type

type p_close from w_a_prc`p_close within p2w_prc_appendpre_bilcdr_v20
integer x = 1449
integer y = 148
end type

type gb_cond from w_a_prc`gb_cond within p2w_prc_appendpre_bilcdr_v20
integer width = 1307
integer height = 232
end type
