$PBExportHeader$p2w_prc_pre_item.srw
$PBExportComments$[ceusee] 선불 매출 실적
forward
global type p2w_prc_pre_item from w_a_prc
end type
end forward
...
global p2w_prc_pre_item p2w_prc_pre_item

type variables
String ls_test
end variables

on p2w_prc_pre_item.create
call super::create
end on

on p2w_prc_pre_item.destroy
call super::destroy
end on
...
SQLCA.APPENDITEMSALE_PRE_BILCDR(ls_fromdt, ls_todt,gs_user_id, ll_return,ls_errmsg,lb_count)
...
type p_ok from w_a_prc`p_ok within p2w_prc_pre_item
integer x = 1339
integer y = 52
end type

type dw_input from w_a_prc`dw_input within p2w_prc_pre_item
integer x = 46
integer y = 72
integer width = 1179
integer height = 172
...
type dw_msg_time from w_a_prc`dw_msg_time within p2w_prc_pre_item
integer x = 18
integer y = 796
integer width = 1888
end type

type dw_msg_processing from w_a_prc`dw_msg_processing within p2w_prc_pre_item
integer x = 18
integer y = 332
integer width = 1893
end type

type ln_up from w_a_prc`ln_up within p2w_prc_pre_item
integer beginx = 18
integer beginy = 316
integer endx = 1769
integer endy = 316
...
type ln_down from w_a_prc`ln_down within p2w_prc_pre_item
integer beginx = 18
integer beginy = 1076
integer endx = 1769
integer endy = 1076
...
type p_close from w_a_prc`p_close within p2w_prc_pre_item
integer x = 1637
integer y = 52
end type

type gb_cond from w_a_prc`gb_cond within p2w_prc_pre_item
integer width = 1239
integer height = 272
end type
