$PBExportHeader$p2w_prt_call_pin.srw
$PBExportComments$[y.k.min] 통화명세서(Pin#)
forward
global type p2w_prt_call_pin from w_a_print
end type
end forward
...
global p2w_prt_call_pin p2w_prt_call_pin

on p2w_prt_call_pin.create
call super::create
end on

on p2w_prt_call_pin.destroy
call super::destroy
end on
...
type dw_cond from w_a_print`dw_cond within p2w_prt_call_pin
integer y = 40
integer width = 2226
...
type p_ok from w_a_print`p_ok within p2w_prt_call_pin
end type

type p_close from w_a_print`p_close within p2w_prt_call_pin
end type

type dw_list from w_a_print`dw_list within p2w_prt_call_pin
integer x = 27
integer y = 352
string dataobject = "p2dw_prt_call_pin"
end type

type p_1 from w_a_print`p_1 within p2w_prt_call_pin
end type

type p_2 from w_a_print`p_2 within p2w_prt_call_pin
end type

type p_3 from w_a_print`p_3 within p2w_prt_call_pin
end type

type p_5 from w_a_print`p_5 within p2w_prt_call_pin
end type

type p_6 from w_a_print`p_6 within p2w_prt_call_pin
end type

type p_7 from w_a_print`p_7 within p2w_prt_call_pin
end type

type p_8 from w_a_print`p_8 within p2w_prt_call_pin
end type

type p_9 from w_a_print`p_9 within p2w_prt_call_pin
end type

type p_4 from w_a_print`p_4 within p2w_prt_call_pin
end type

type gb_1 from w_a_print`gb_1 within p2w_prt_call_pin
end type

type p_port from w_a_print`p_port within p2w_prt_call_pin
end type

type p_land from w_a_print`p_land within p2w_prt_call_pin
end type

type gb_cond from w_a_print`gb_cond within p2w_prt_call_pin
end type

type p_saveas from w_a_print`p_saveas within p2w_prt_call_pin
end type
