$PBExportHeader$p2w_reg_partner_model.srw
$PBExportComments$[chooys]
forward
global type p2w_reg_partner_model from w_a_reg_m_m
end type
end forward
...
global p2w_reg_partner_model p2w_reg_partner_model

type variables
string is_partner_yn
end variables

on p2w_reg_partner_model.create
call super::create
end on

on p2w_reg_partner_model.destroy
call super::destroy
end on
...
type dw_cond from w_a_reg_m_m`dw_cond within p2w_reg_partner_model
integer x = 41
integer width = 2345
integer height = 232
...
type p_ok from w_a_reg_m_m`p_ok within p2w_reg_partner_model
integer x = 2464
end type

type p_close from w_a_reg_m_m`p_close within p2w_reg_partner_model
integer x = 2770
end type

type gb_cond from w_a_reg_m_m`gb_cond within p2w_reg_partner_model
integer width = 2386
integer height = 304
end type

type dw_master from w_a_reg_m_m`dw_master within p2w_reg_partner_model
integer y = 336
integer height = 392
...
type dw_detail from w_a_reg_m_m`dw_detail within p2w_reg_partner_model
integer x = 32
integer y = 768
string dataobject = "p2dw_reg_partner_model"
end type
...
type p_insert from w_a_reg_m_m`p_insert within p2w_reg_partner_model
end type

type p_delete from w_a_reg_m_m`p_delete within p2w_reg_partner_model
end type

type p_save from w_a_reg_m_m`p_save within p2w_reg_partner_model
end type

type p_reset from w_a_reg_m_m`p_reset within p2w_reg_partner_model
end type

type st_horizontal from w_a_reg_m_m`st_horizontal within p2w_reg_partner_model
end type
