$PBExportHeader$p2w_reg_refillpolicy_basic.srw
$PBExportComments$[islim] 판매금액 Rate 등록
forward
global type p2w_reg_refillpolicy_basic from w_a_reg_m_m
end type
type p_all from u_p_all within p2w_reg_refillpolicy_basic
end type
end forward
...
global p2w_reg_refillpolicy_basic p2w_reg_refillpolicy_basic
...
on p2w_reg_refillpolicy_basic.create
int iCurrent
call super::create
...
on p2w_reg_refillpolicy_basic.destroy
call super::destroy
destroy(this.p_all)
end on
...
type dw_cond from w_a_reg_m_m`dw_cond within p2w_reg_refillpolicy_basic
integer x = 37
integer y = 44
integer width = 1353
integer height = 164
string dataobject = "p2dw_cnd_refillpolicy_basic"
boolean hscrollbar = false
boolean vscrollbar = false
boolean livescroll = false
end type

type p_ok from w_a_reg_m_m`p_ok within p2w_reg_refillpolicy_basic
integer x = 1541
integer y = 40
end type

type p_close from w_a_reg_m_m`p_close within p2w_reg_refillpolicy_basic
integer x = 1847
integer y = 40
end type

type gb_cond from w_a_reg_m_m`gb_cond within p2w_reg_refillpolicy_basic
integer x = 23
integer y = 4
integer width = 1394
integer height = 208
...
type dw_master from w_a_reg_m_m`dw_master within p2w_reg_refillpolicy_basic
integer x = 23
integer y = 256
integer height = 448
integer taborder = 30
...
type dw_detail from w_a_reg_m_m`dw_detail within p2w_reg_refillpolicy_basic
integer x = 23
integer y = 740
integer height = 888
integer taborder = 40
string dataobject = "p2dw_reg_refillpolicy_basic"
end type
...
type p_insert from w_a_reg_m_m`p_insert within p2w_reg_refillpolicy_basic
end type

type p_delete from w_a_reg_m_m`p_delete within p2w_reg_refillpolicy_basic
integer y = 1656
end type

type p_save from w_a_reg_m_m`p_save within p2w_reg_refillpolicy_basic
integer x = 617
integer y = 1656
end type

type p_reset from w_a_reg_m_m`p_reset within p2w_reg_refillpolicy_basic
integer x = 1353
end type

type st_horizontal from w_a_reg_m_m`st_horizontal within p2w_reg_refillpolicy_basic
integer y = 708
end type
