$PBExportHeader$p2w_reg_salepricemodel.srw
$PBExportComments$[chooys] 카드모델관리 Window
forward
global type p2w_reg_salepricemodel from w_a_reg_s
end type
end forward
...
global p2w_reg_salepricemodel p2w_reg_salepricemodel

on p2w_reg_salepricemodel.create
call super::create
end on

on p2w_reg_salepricemodel.destroy
call super::destroy
end on
...
type dw_cond from w_a_reg_s`dw_cond within p2w_reg_salepricemodel
integer width = 1083
integer height = 112
string dataobject = "p2dw_cnd_reg_salepricemodel"
boolean hscrollbar = false
boolean vscrollbar = false
boolean livescroll = false
end type

type p_ok from w_a_reg_s`p_ok within p2w_reg_salepricemodel
integer x = 1239
integer y = 60
end type

type p_close from w_a_reg_s`p_close within p2w_reg_salepricemodel
integer x = 1541
integer y = 60
end type

type gb_cond from w_a_reg_s`gb_cond within p2w_reg_salepricemodel
integer x = 23
integer width = 1129
integer height = 188
end type

type dw_detail from w_a_reg_s`dw_detail within p2w_reg_salepricemodel
integer x = 27
integer y = 216
integer width = 2862
integer height = 1380
string dataobject = "p2dw_reg_salepricemodel"
end type

type p_delete from w_a_reg_s`p_delete within p2w_reg_salepricemodel
end type

type p_insert from w_a_reg_s`p_insert within p2w_reg_salepricemodel
end type

type p_save from w_a_reg_s`p_save within p2w_reg_salepricemodel
end type

type p_reset from w_a_reg_s`p_reset within p2w_reg_salepricemodel
end type
