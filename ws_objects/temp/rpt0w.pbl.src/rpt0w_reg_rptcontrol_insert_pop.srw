$PBExportHeader$rpt0w_reg_rptcontrol_insert_pop.srw
$PBExportComments$[parkkh] rptcontrol insert popup window
forward
global type rpt0w_reg_rptcontrol_insert_pop from w_a_reg_m
end type
end forward
...
global rpt0w_reg_rptcontrol_insert_pop rpt0w_reg_rptcontrol_insert_pop

type variables

String is_pgm_id, is_rptcontgroup



end variables

on rpt0w_reg_rptcontrol_insert_pop.create
call super::create
end on

on rpt0w_reg_rptcontrol_insert_pop.destroy
call super::destroy
end on

event open;call super::open;/*------------------------------------------------------------------------
	Name	:	rpt0w_reg_rptcontrol_insert_pop
	Desc	: 	계정control 등록 - insert popup
	Ver.	:	1.0
	Date	: 	2003.10.29
	programer : park kyung hae(parkkh)
-------------------------------------------------------------------------*/
//window 중앙에
f_center_window(rpt0w_reg_rptcontrol_insert_pop)

is_rptcontgroup = iu_cust_msg.is_data[1]    //rptcontgroup
...
dw_detail.object.crtdt[al_insert_row] = fdt_get_dbserver_now()			//등록일자
dw_detail.object.crt_user[al_insert_row] = gs_user_id					//등록자	
dw_detail.object.pgm_id[al_insert_row] = is_pgm_id			
dw_detail.object.updt_user[al_insert_row] = gs_user_id	
dw_detail.object.updtdt[al_insert_row] = fdt_get_dbserver_now()
dw_detail.object.rptcontgroup[al_insert_row] = is_rptcontgroup
...
type dw_cond from w_a_reg_m`dw_cond within rpt0w_reg_rptcontrol_insert_pop
...
type p_ok from w_a_reg_m`p_ok within rpt0w_reg_rptcontrol_insert_pop
boolean visible = false
integer x = 585
integer y = 1228
end type

type p_close from w_a_reg_m`p_close within rpt0w_reg_rptcontrol_insert_pop
integer x = 2798
integer y = 576
end type

type gb_cond from w_a_reg_m`gb_cond within rpt0w_reg_rptcontrol_insert_pop
boolean visible = false
end type

type p_delete from w_a_reg_m`p_delete within rpt0w_reg_rptcontrol_insert_pop
boolean visible = false
integer x = 50
integer y = 1432
end type

type p_insert from w_a_reg_m`p_insert within rpt0w_reg_rptcontrol_insert_pop
boolean visible = false
end type

type p_save from w_a_reg_m`p_save within rpt0w_reg_rptcontrol_insert_pop
integer x = 2487
integer y = 576
boolean enabled = true
end type

type dw_detail from w_a_reg_m`dw_detail within rpt0w_reg_rptcontrol_insert_pop
integer y = 52
integer width = 3058
integer height = 468
integer taborder = 20
string dataobject = "rpt0dw_reg_rptcontrol_insert_pop"
end type
...
type p_reset from w_a_reg_m`p_reset within rpt0w_reg_rptcontrol_insert_pop
boolean visible = false
integer x = 270
integer y = 1224
boolean enabled = true
