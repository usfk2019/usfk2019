$PBExportHeader$ubs_w_pop_equipmaker.srw
$PBExportComments$[jhchoi] 인증장비 메이커 등록 팝업 - 2011.02.16
forward
global type ubs_w_pop_equipmaker from w_a_hlp
end type
type p_insert from u_p_insert within ubs_w_pop_equipmaker
end type
type p_delete from u_p_delete within ubs_w_pop_equipmaker
end type
type p_save from u_p_save within ubs_w_pop_equipmaker
end type
type gb_1 from groupbox within ubs_w_pop_equipmaker
end type
end forward
...
global ubs_w_pop_equipmaker ubs_w_pop_equipmaker
...
on ubs_w_pop_equipmaker.create
int iCurrent
call super::create
...
on ubs_w_pop_equipmaker.destroy
call super::destroy
...
type p_1 from w_a_hlp`p_1 within ubs_w_pop_equipmaker
...
type dw_cond from w_a_hlp`dw_cond within ubs_w_pop_equipmaker
boolean visible = false
boolean enabled = false
end type

type p_ok from w_a_hlp`p_ok within ubs_w_pop_equipmaker
boolean visible = false
integer x = 2574
integer y = 1640
boolean enabled = false
...
type p_close from w_a_hlp`p_close within ubs_w_pop_equipmaker
integer x = 937
integer y = 964
end type

type gb_cond from w_a_hlp`gb_cond within ubs_w_pop_equipmaker
boolean visible = false
boolean enabled = false
end type

type dw_hlp from w_a_hlp`dw_hlp within ubs_w_pop_equipmaker
integer x = 18
integer y = 20
integer width = 3721
integer height = 888
string dataobject = "ubs_dw_pop_equipmaker_mas"
