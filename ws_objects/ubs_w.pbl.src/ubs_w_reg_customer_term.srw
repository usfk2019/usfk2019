$PBExportHeader$ubs_w_reg_customer_term.srw
$PBExportComments$[jhchoi] 해지자 고객정보 조회
forward
global type ubs_w_reg_customer_term from w_a_reg_m_tm2
end type
type p_view from u_p_view within ubs_w_reg_customer_term
end type
type p_active from picture within ubs_w_reg_customer_term
end type
end forward
...
global ubs_w_reg_customer_term ubs_w_reg_customer_term
...
on ubs_w_reg_customer_term.create
int iCurrent
call super::create
...
on ubs_w_reg_customer_term.destroy
call super::destroy
destroy(this.p_view)
...
type dw_cond from w_a_reg_m_tm2`dw_cond within ubs_w_reg_customer_term
integer x = 82
integer y = 52
integer width = 3282
integer height = 368
string dataobject = "ubs_dw_reg_customer_term"
end type

type p_ok from w_a_reg_m_tm2`p_ok within ubs_w_reg_customer_term
integer x = 3429
integer y = 40
end type

type p_close from w_a_reg_m_tm2`p_close within ubs_w_reg_customer_term
integer x = 3730
integer y = 40
end type

type gb_cond from w_a_reg_m_tm2`gb_cond within ubs_w_reg_customer_term
integer x = 37
integer width = 3365
integer height = 432
end type

type dw_master from w_a_reg_m_tm2`dw_master within ubs_w_reg_customer_term
integer y = 464
integer width = 3534
integer height = 548
string dataobject = "ubs_dw_inq_customer_term"
end type
...
type p_insert from w_a_reg_m_tm2`p_insert within ubs_w_reg_customer_term
integer y = 2056
end type

type p_delete from w_a_reg_m_tm2`p_delete within ubs_w_reg_customer_term
integer y = 2056
end type

type p_save from w_a_reg_m_tm2`p_save within ubs_w_reg_customer_term
integer x = 622
integer y = 2056
end type

type p_reset from w_a_reg_m_tm2`p_reset within ubs_w_reg_customer_term
integer x = 1207
integer y = 2056
end type

type tab_1 from w_a_reg_m_tm2`tab_1 within ubs_w_reg_customer_term
...
type st_horizontal from w_a_reg_m_tm2`st_horizontal within ubs_w_reg_customer_term
integer y = 1024
end type
