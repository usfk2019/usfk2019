$PBExportHeader$b1w_inq_svcorder_popup_v20_new.srw
$PBExportComments$[ohj] 고객에 따른 서비스신청 품목popup v20
forward
global type b1w_inq_svcorder_popup_v20_new from w_base
end type
type p_close from u_p_close within b1w_inq_svcorder_popup_v20_new
end type
type dw_detail from u_d_sort within b1w_inq_svcorder_popup_v20_new
end type
type st_name from statictext within b1w_inq_svcorder_popup_v20_new
end type
type st_customerid from statictext within b1w_inq_svcorder_popup_v20_new
end type
type st_1 from statictext within b1w_inq_svcorder_popup_v20_new
end type
type ln_1 from line within b1w_inq_svcorder_popup_v20_new
end type
type ln_2 from line within b1w_inq_svcorder_popup_v20_new
end type
type ln_3 from line within b1w_inq_svcorder_popup_v20_new
end type
end forward
...
global b1w_inq_svcorder_popup_v20_new b1w_inq_svcorder_popup_v20_new
...
on b1w_inq_svcorder_popup_v20_new.create
int iCurrent
call super::create
...
on b1w_inq_svcorder_popup_v20_new.destroy
call super::destroy
...
f_center_window(b1w_inq_svcorder_popup_v20_new)
is_orderno = ""
...
integer height = 836
integer taborder = 10
string dataobject = "b1dw_inq_admstlog_new_mobile_t5_pop_v20"
