$PBExportHeader$b1w_reg_chg_customer_mobile.srw
$PBExportComments$[lys] 모바일 명의변경 관리 - 2015.03.07. lys
forward
global type b1w_reg_chg_customer_mobile from w_a_reg_m_tm2
end type
type cb_new from commandbutton within b1w_reg_chg_customer_mobile
end type
end forward
...
global b1w_reg_chg_customer_mobile b1w_reg_chg_customer_mobile
...
on b1w_reg_chg_customer_mobile.create
int iCurrent
call super::create
...
on b1w_reg_chg_customer_mobile.destroy
call super::destroy
destroy(this.cb_new)
end on
...
type dw_cond from w_a_reg_m_tm2`dw_cond within b1w_reg_chg_customer_mobile
integer y = 92
integer width = 2368
integer height = 196
...
type p_ok from w_a_reg_m_tm2`p_ok within b1w_reg_chg_customer_mobile
integer x = 2661
end type

type p_close from w_a_reg_m_tm2`p_close within b1w_reg_chg_customer_mobile
integer x = 2962
end type

type gb_cond from w_a_reg_m_tm2`gb_cond within b1w_reg_chg_customer_mobile
integer width = 2423
integer taborder = 20
end type

type dw_master from w_a_reg_m_tm2`dw_master within b1w_reg_chg_customer_mobile
integer taborder = 30
...
type p_insert from w_a_reg_m_tm2`p_insert within b1w_reg_chg_customer_mobile
boolean visible = false
end type

type p_delete from w_a_reg_m_tm2`p_delete within b1w_reg_chg_customer_mobile
boolean visible = false
end type

type p_save from w_a_reg_m_tm2`p_save within b1w_reg_chg_customer_mobile
integer x = 37
end type

type p_reset from w_a_reg_m_tm2`p_reset within b1w_reg_chg_customer_mobile
integer x = 329
end type

type tab_1 from w_a_reg_m_tm2`tab_1 within b1w_reg_chg_customer_mobile
integer taborder = 40
end type
...
type st_horizontal from w_a_reg_m_tm2`st_horizontal within b1w_reg_chg_customer_mobile
end type
