$PBExportHeader$b1w_reg_chg_customer_mobile_new.srw
$PBExportComments$[lys] 모바일 명의변경 관리 - 2015.03.07. lys
forward
global type b1w_reg_chg_customer_mobile_new from w_a_reg_m_tm2
end type
type cb_new from commandbutton within b1w_reg_chg_customer_mobile_new
end type
end forward
...
global b1w_reg_chg_customer_mobile_new b1w_reg_chg_customer_mobile_new
...
on b1w_reg_chg_customer_mobile_new.create
int iCurrent
call super::create
...
on b1w_reg_chg_customer_mobile_new.destroy
call super::destroy
destroy(this.cb_new)
end on
...
Choose Case li_tab
	Case 1
      ...
      INSERT INTO SVCORDER (
		...
		//3. INSERT INTO BILLINGINFO_LOG_DELETE
		INSERT INTO BILLINGINFO_LOG_DELETE 
		( 	ORDERNO, CUSTOMERID, BILCYCLE, 
			INV_METHOD, CURRENCY_TYPE, PAY_METHOD, 
			BIL_ZIPCOD, BIL_ADDRTYPE, BIL_ADDR1, 
			BIL_ADDR2, BIL_EMAIL, INV_YN, 
			INVDETAIL_YN, INV_TYPE, TAX_YN, 
			TAXTYPE, OVERDUE_YN, OVERDUE_MONTHS, 
			BANKSHOP, BANK, ACCTNO, 
			ACCT_OWNER, ACCT_SSNO, DRAWINGREQDT, 
			DRAWINGTYPE, DRAWINGRESULT, RECEIPTCOD, 
			RECEIPTDT, RESULTCOD, BEF_BANKSHOP, 
			BEF_BANK, BEF_ACCTNO, BEF_ACCT_OWNER, 
			BEF_ACCT_SSNO, BEF_DRAWINGREQDT, BEF_DRAWINGTYPE, 
			BEF_DRAWINGRESULT, BEF_RECEIPTDT, BEF_RECEIPTCOD, 
			BEF_RESULTCOD, CREDITREQDT, CARD_TYPE, 
			CARD_NO, CARD_EXPDT, CARD_HOLDER, 
			CARD_SSNO, CARD_AUTHYN, CARD_REMARK1, 
			CARD_GROUP1, CHG_YN, ADDING_TYPE, 
			ADDING_KEY, CRT_USER, UPDT_USER, 
			CRTDT, UPDTDT, PGM_ID, 
			BIL_PROVINCE, BIL_CITYCOD, TRANSDT
		)
		SELECT   :ll_orderno, CUSTOMERID, BILCYCLE, 
					INV_METHOD, CURRENCY_TYPE, PAY_METHOD, 
					BIL_ZIPCOD, BIL_ADDRTYPE, BIL_ADDR1, 
					BIL_ADDR2, BIL_EMAIL, INV_YN, 
					INVDETAIL_YN, INV_TYPE, TAX_YN, 
					...
					ADDING_KEY, CRT_USER, UPDT_USER, 
					CRTDT, UPDTDT, PGM_ID, 
					BIL_PROVINCE, BIL_CITYCOD, SYSDATE
				FROM BILLINGINFO
		WHERE CUSTOMERID = :ls_customerid;
		
		If SQLCA.SQLCODE <> 0 Then
			f_msg_sql_err(SQLCA.SQLERRTEXT, "INSERT BILLINGINFO_LOG_DELETE Fail. (CUSTOMERID=" + ls_customerid + ")")
			Return -1
		End If	
...
type dw_cond from w_a_reg_m_tm2`dw_cond within b1w_reg_chg_customer_mobile_new
integer y = 92
integer width = 2368
integer height = 196
...
type p_ok from w_a_reg_m_tm2`p_ok within b1w_reg_chg_customer_mobile_new
integer x = 2661
end type

type p_close from w_a_reg_m_tm2`p_close within b1w_reg_chg_customer_mobile_new
integer x = 2962
end type

type gb_cond from w_a_reg_m_tm2`gb_cond within b1w_reg_chg_customer_mobile_new
integer width = 2423
integer taborder = 20
end type

type dw_master from w_a_reg_m_tm2`dw_master within b1w_reg_chg_customer_mobile_new
integer taborder = 30
...
type p_insert from w_a_reg_m_tm2`p_insert within b1w_reg_chg_customer_mobile_new
boolean visible = false
end type

type p_delete from w_a_reg_m_tm2`p_delete within b1w_reg_chg_customer_mobile_new
boolean visible = false
end type

type p_save from w_a_reg_m_tm2`p_save within b1w_reg_chg_customer_mobile_new
integer x = 37
end type

type p_reset from w_a_reg_m_tm2`p_reset within b1w_reg_chg_customer_mobile_new
integer x = 329
end type

type tab_1 from w_a_reg_m_tm2`tab_1 within b1w_reg_chg_customer_mobile_new
integer taborder = 40
end type
...
type st_horizontal from w_a_reg_m_tm2`st_horizontal within b1w_reg_chg_customer_mobile_new
end type
