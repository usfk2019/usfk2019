$PBExportHeader$b1w_reg_hot_req_prc_mobile.srw
$PBExportComments$부가서비스 등록/해지 신청 - 2015.03.12. lys
forward
global type b1w_reg_hot_req_prc_mobile from w_a_reg_m_m
end type
type dw_rate from u_d_external within b1w_reg_hot_req_prc_mobile
end type
end forward
...
global b1w_reg_hot_req_prc_mobile b1w_reg_hot_req_prc_mobile

type variables
String is_operator, is_operatornm, is_partner
end variables

on b1w_reg_hot_req_prc_mobile.create
int iCurrent
call super::create
...
on b1w_reg_hot_req_prc_mobile.destroy
call super::destroy
...
//환율표시
dw_rate.Retrieve(string(today(), 'yyyymmdd'))
...
type dw_cond from w_a_reg_m_m`dw_cond within b1w_reg_hot_req_prc_mobile
integer y = 64
integer width = 3145
integer height = 212
...
type p_ok from w_a_reg_m_m`p_ok within b1w_reg_hot_req_prc_mobile
integer x = 3415
end type

type p_close from w_a_reg_m_m`p_close within b1w_reg_hot_req_prc_mobile
integer x = 3721
end type

type gb_cond from w_a_reg_m_m`gb_cond within b1w_reg_hot_req_prc_mobile
integer width = 3186
integer height = 444
integer taborder = 20
end type

type dw_master from w_a_reg_m_m`dw_master within b1w_reg_hot_req_prc_mobile
integer y = 460
integer height = 644
integer taborder = 30
...
type dw_detail from w_a_reg_m_m`dw_detail within b1w_reg_hot_req_prc_mobile
integer x = 41
integer y = 1152
integer width = 4165
integer height = 896
...
type p_insert from w_a_reg_m_m`p_insert within b1w_reg_hot_req_prc_mobile
boolean visible = false
integer y = 2396
end type

type p_delete from w_a_reg_m_m`p_delete within b1w_reg_hot_req_prc_mobile
boolean visible = false
integer y = 2396
end type

type p_save from w_a_reg_m_m`p_save within b1w_reg_hot_req_prc_mobile
integer x = 32
integer y = 2072
end type

type p_reset from w_a_reg_m_m`p_reset within b1w_reg_hot_req_prc_mobile
integer x = 617
integer y = 2072
end type

type st_horizontal from w_a_reg_m_m`st_horizontal within b1w_reg_hot_req_prc_mobile
integer y = 1108
end type
