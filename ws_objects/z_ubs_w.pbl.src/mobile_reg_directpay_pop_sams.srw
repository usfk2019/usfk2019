$PBExportHeader$mobile_reg_directpay_pop_sams.srw
$PBExportComments$서비스 신청시 장비/할부 등록
forward
global type mobile_reg_directpay_pop_sams from w_a_reg_m
end type
type dw_detail2 from datawindow within mobile_reg_directpay_pop_sams
end type
end forward
...
global mobile_reg_directpay_pop_sams mobile_reg_directpay_pop_sams
...
on mobile_reg_directpay_pop_sams.create
int iCurrent
call super::create
...
on mobile_reg_directpay_pop_sams.destroy
call super::destroy
...
type dw_cond from w_a_reg_m`dw_cond within mobile_reg_directpay_pop_sams
integer x = 46
integer y = 40
integer width = 2981
integer height = 596
...
type p_ok from w_a_reg_m`p_ok within mobile_reg_directpay_pop_sams
...
type p_close from w_a_reg_m`p_close within mobile_reg_directpay_pop_sams
integer x = 3058
integer y = 180
boolean originalsize = false
end type

type gb_cond from w_a_reg_m`gb_cond within mobile_reg_directpay_pop_sams
integer width = 3013
integer height = 644
end type

type p_delete from w_a_reg_m`p_delete within mobile_reg_directpay_pop_sams
boolean visible = false
integer x = 1010
integer y = 1884
end type

type p_insert from w_a_reg_m`p_insert within mobile_reg_directpay_pop_sams
boolean visible = false
integer x = 709
integer y = 1884
end type

type p_save from w_a_reg_m`p_save within mobile_reg_directpay_pop_sams
integer x = 50
integer y = 1884
end type

type dw_detail from w_a_reg_m`dw_detail within mobile_reg_directpay_pop_sams
boolean visible = false
integer x = 23
integer y = 1828
integer width = 3013
...
type p_reset from w_a_reg_m`p_reset within mobile_reg_directpay_pop_sams
integer x = 352
integer y = 1884
